...
const Ur=t=>null!=t?t:H;let Or,Tr,Br=t=>t;class Hr extends Cr{static get properties(){return{disabled:{attribute:"disabled",type:Boolean,reflect:!0},max:{attribute:"max",type:Number,reflect:!0},min:{attribute:"min",type:Number,reflect:!0},step:{attribute:"step",type:Number,reflect:!0},value:{attribute:"value",type:Number,reflect:!0}}}constructor(){super(),this.disabled=!1,this.max=void 0,this.min=void 0,this.step=void 0,this.value=void 0}changed(t){this.value=t.target.value,this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0}))}inputted(t){this.value=t.target.value}static get styles(){return[super.styles,s(Or||(Or=Br`
    ...
    `),`${this.uniqueId}-slider`,`${this.uniqueId}-slider`,Ur(this.min),Ur(this.max),Ur(this.step),this.value,this.changed.bind(this),this.inputted.bind(this),Ur(this.min),Ur(this.max),Ur(this.step),this.value,this.inputted.bind(this))}}customElements.define("decidables-slider",Hr);let zr,Dr,Ir=t=>t;class qr extends Cr{static get properties(){return{disabled:{attribute:"disabled",type:Boolean,reflect:!0},max:{attribute:"max",type:Number,reflect:!0},min:{attribute:"min",type:Number,reflect:!0},step:{attribute:"step",type:Number,reflect:!0},value:{attribute:"value",type:Number,reflect:!0}}}constructor(){super(),this.disabled=!1,this.max=void 0,this.min=void 0,this.step=void 0,this.value=void 0}inputted(t){this.value=t.target.value}static get styles(){return[super.styles,s(zr||(zr=Ir`
        :host {
      ...
      `))]}render(){return O(Dr||(Dr=Ir`
      <label>
        <slot></slot>
        <input ?disabled=${0} type="number" min=${0} max=${0} step=${0} .value=${0} @input=${0}>
      </label>
    `),this.disabled,Ur(this.min),Ur(this.max),Ur(this.step),this.value,this.inputted.bind(this))}}customElements.define("decidables-spinner",qr);let jr,Lr,Vr=t=>t;class Fr extends Cr{static get properties(){return{checked:{attribute:"checked",type:Boolean,reflect:!0},disabled:{attribute:"disabled",type:Boolean,reflect:!0}}}constructor(){super(),this.checked=!1,this.disabled=!1}changed(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0}))}static get styles(){return[super.styles,s(jr||(jr=Vr`
        :host {
          display: flex;
    ...
    `),`${this.uniqueId}-checkbox`,this.checked,this.disabled,this.changed.bind(this),`${this.uniqueId}-checkbox`,`${this.uniqueId}-checkbox`)}}customElements.define("decidables-switch",Fr);let Xr,Yr,Kr=t=>t;class Gr extends Cr{static get properties(){return{disabled:{attribute:"disabled",type:Boolean,reflect:!0}}}constructor(){super(),this.disabled=!1}static get styles(){return[super.styles,s(Xr||(Xr=Kr`
        fieldset {
          display: flex;
    ...
    `),`${this.uniqueId}-radio`,this.name,this.value,this.checked,this.changed.bind(this),`${this.uniqueId}-radio`)}}customElements.define("decidables-toggle-option",Qr);const ti={fromAttribute:t=>t.split(/\s+/).map((t=>Number.parseFloat(t))),toAttribute:t=>t.length?t.map((t=>t.toFixed(3))).join(" "):null},ei={fromAttribute:t=>new Set(t.split(/\s+/)),toAttribute:t=>t.size?[...t].join(" "):null};t.DecidablesButton=Mr,t.DecidablesConverterArray=ti,t.DecidablesConverterSet=ei,t.DecidablesElement=Cr,t.DecidablesSlider=Hr,t.DecidablesSpinner=qr,t.DecidablesSwitch=Fr,t.DecidablesToggle=Gr,t.DecidablesToggleOption=Qr,Object.defineProperty(t,"__esModule",{value:!0})}));
