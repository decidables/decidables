...
describe('sdt-example-human', () => {
  it('has a shadowDom', async () => {
    const el = await fixture(html`
      <sdt-example-human trials="10" duration="1000" coherence="0.5">
  ...
  it('has a lightDom', async () => {
    ...
    expect(el).lightDom.to.equal(`
      <detectable-control coherence="0.5" duration="1000" pause reset run trials="10"></detectable-control>
      <rdk-task coherence="0.5" count="100" duration="1000" iti="1000" probability="0.5" trials="10" wait="1000"></rdk-task>
      <detectable-response correct-rejection-payoff="100" false-alarm-payoff="-100" feedback="outcome" hit-payoff="0" interactive miss-payoff="0" no-response-payoff="0" payoff="none" trial></detectable-response>
      <detectable-table color="all" correct-rejection-payoff="100" correct-rejections="0" false-alarm-payoff="-100" false-alarms="0" hit-payoff="0" hits="0" miss-payoff="0" misses="0" numeric summary="stimulusRates accuracy"></detectable-table>
      <roc-space far="0.5" hr="0.5" iso-c="all" iso-d="all" point="all"></roc-space>
      <sdt-model bias c="0" color="outcome" d="0" distributions histogram s="1" sensitivity threshold></sdt-model>
      <sdt-parameters d c s="1"></sdt-parameters>
    `);
  });
