...
describe('sdt-example-human', () => {
  ...
  it('has a lightDom', async () => {
    ...
    expect(el).lightDom.to.equal(`
      ...
      <detectable-response class="keyboard" correct-rejection-payoff="100" false-alarm-payoff="-100" feedback="outcome" hit-payoff="0" interactive miss-payoff="0" no-response-payoff="0" payoff="none" trial></detectable-response>
