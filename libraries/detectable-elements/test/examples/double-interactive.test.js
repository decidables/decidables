...
describe('sdt-example-double-interactive', () => {
  ...
  it('has a lightDom', async () => {
    ...
    expect(el).lightDom.to.equal(`
      <sdt-model interactive threshold bias distributions sensitivity color="outcome"></sdt-model>
      <detectable-table color="all" numeric interactive summary="stimulusRates accuracy" hits="95" misses="5" false-alarms="35" correct-rejections="65"></detectable-table>
      <roc-space contour="accuracy" interactive iso-c="none" iso-d="none" point="all"></roc-space>
      <detectable-table color="all" numeric interactive summary="stimulusRates accuracy" hits="40" misses="60" false-alarms="20" correct-rejections="80"></detectable-table>
      <sdt-model interactive threshold bias distributions sensitivity color="outcome"></sdt-model>
