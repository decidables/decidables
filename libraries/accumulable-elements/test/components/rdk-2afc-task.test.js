...
describe('rdk-2afc-task', () => {
  ...
  it('can run a trial', async () => {
    const el = await fixture(html`<rdk-2afc-task duration="100" wait="100" iti="100"></rdk-2afc-task>`);
    setTimeout(() => { el.running = true; });
  ...
  it('can run a block', async () => {
    const el = await fixture(html`<rdk-2afc-task duration="100" wait="100" iti="100" trials="2"></rdk-2afc-task>`);
    setTimeout(() => { el.running = true; });
