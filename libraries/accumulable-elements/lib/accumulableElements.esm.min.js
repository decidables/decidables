...
const la=t=>t??J;customElements.define("decidables-slider",class extends oa{static get properties(){return{disabled:{attribute:"disabled",type:Boolean,reflect:!0},max:{attribute:"max",type:Number,reflect:!0},min:{attribute:"min",type:Number,reflect:!0},step:{attribute:"step",type:Number,reflect:!0},value:{attribute:"value",type:Number,reflect:!0}}}constructor(){super(),this.disabled=!1,this.max=void 0,this.min=void 0,this.step=void 0,this.value=void 0}changed(t){this.value=t.target.value,this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0}))}inputted(t){this.value=t.target.value}static get styles(){return[super.styles,n`
    ...
    `}}customElements.define("ddm-fit",Ua);class fa extends da{static get properties(){return{a:{attribute:"boundary-separation",type:Number,reflect:!0},z:{attribute:"starting-point",type:Number,reflect:!0},v:{attribute:"drift-rate",type:Number,reflect:!0},t0:{attribute:"nondecision-time",type:Number,reflect:!0}}}constructor(){super(),this.a=void 0,this.z=void 0,this.v=void 0,this.t0=void 0}setBoundarySeparation(t){this.a=+t.target.value,this.dispatchEvent(new CustomEvent("ddm-parameters-a",{detail:{a:this.a},bubbles:!0}))}setStartingPoint(t){this.z=+t.target.value,this.dispatchEvent(new CustomEvent("ddm-parameters-z",{detail:{z:this.z},bubbles:!0}))}setDriftRate(t){this.v=+t.target.value,this.dispatchEvent(new CustomEvent("ddm-parameters-v",{detail:{v:this.v},bubbles:!0}))}setNondecisionTime(t){this.t0=+t.target.value,this.dispatchEvent(new CustomEvent("ddm-parameters-t0",{detail:{t0:this.t0},bubbles:!0}))}static get styles(){return[super.styles,n`
      ...
      `]}render(){return W``}willUpdate(){this.alignState()}update(t){if(super.update(t),Number.isNaN(this.width)||Number.isNaN(this.height)||Number.isNaN(this.rem))return;const e=this.width,i=this.height;let s,r;e/i>1.5?(r=i,s=1.5*r):(s=e,r=s/1.5);const a=1*this.rem,n=3*this.rem,o=3.75*this.rem,l=3.25*this.rem,c=r-(a+n),d=s-(o+l),h=.75*this.rem,u=.5*c,g=.25*c-h,p=.75*this.rem,m=.9*d,b=.1*d-p,Q=parseInt(this.getComputedStyleValue("---transition-duration"),10),y=jr().domain([this.scale.time.min,this.scale.time.max]).range([0,m]),B=jr().domain([this.scale.evidence.min,this.scale.evidence.max]).range([u,0]),U=jr().domain([this.scale.density.min,this.scale.density.max]).range([g,0]),f=jr().domain([this.scale.density.min,this.scale.density.max]).range([0,g]),I=jr().domain([0,1]).range([0,c]),F=di().subject(((t,e)=>({x:y(e.t0),y:B(e.startingPoint)}))).on("start",(t=>{Ze(t.currentTarget).classed("dragging",!0)})).on("drag",(t=>{this.drag=!0;const e=!!t.sourceEvent.shiftKey&&(Math.abs(t.x-t.subject.x)>Math.abs(t.y-t.subject.y)?"t0":"z");let i=y.invert(t.x),s=(B.invert(t.y)+this.a/2)/this.a;i="z"===e?y.invert(t.subject.x):i<0?0:i>500?500:i,s="t0"===e?(B.invert(t.subject.y)+this.a/2)/this.a:s<.01?.01:s>.99?.99:s,this.t0=i,this.z=s,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-t0",{detail:{t0:this.t0},bubbles:!0})),this.dispatchEvent(new CustomEvent("ddm-model-z",{detail:{z:this.z},bubbles:!0}))})).on("end",(t=>{Ze(t.currentTarget).classed("dragging",!1),this.drag=!1})),C=di().on("start",(t=>{Ze(t.currentTarget).classed("dragging",!0)})).on("drag",(t=>{this.drag=!0;let e=(B.invert(t.y)-this.startingPoint)/(y.invert(t.x)-this.t0)*1e3;e=e<.01?.01:e>5?5:e,this.v=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-v",{detail:{v:this.v},bubbles:!0}))})).on("end",(t=>{Ze(t.currentTarget).classed("dragging",!1),this.drag=!1})),v=di().subject(((t,e)=>({x:0,y:B(e.value)}))).on("start",(t=>{Ze(t.currentTarget).classed("dragging",!0)})).on("drag",((t,e)=>{this.drag=!0;let i=B.invert(t.y);i=i<this.scale.evidence.min?this.scale.evidence.min:i>this.scale.evidence.max?this.scale.evidence.max:"upper"===e.bound&&i<.005?.005:"lower"===e.bound&&i>-.005?-.005:i,this.a=Math.abs(2*i),this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-a",{detail:{a:this.a},bubbles:!0}))})).on("end",(t=>{Ze(t.currentTarget).classed("dragging",!1),this.drag=!1})),x=aa().x((t=>y(t.t))).y((t=>B(t.e))),A=aa().x((t=>y(t.t))).y((t=>U(t.d))),E=aa().x((t=>y(t.t))).y((t=>f(t.d))),R=Ze(this.renderRoot).selectAll(".main").data([{width:this.width,height:this.height,rem:this.rem}]),N=R.enter().append("svg").classed("main",!0).html(da.svgDefs),S=N.append("defs");S.append("marker").attr("id","measure-arrow").attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","2").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10").append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("d","M -3 -3 l 6 3 l -6 3 z"),S.append("marker").attr("id","model-sd-cap").attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","0").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10").append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("stroke-width","2").attr("d","M 0 -4 l 0 8"),S.append("marker").attr("id","data-sd-cap").attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","0").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10").append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("stroke-width","2").attr("d","M 0 -3 l 0 6");const w=S.append("linearGradient").attr("id","path-animate").attr("gradientUnits","userSpaceOnUse").attr("color-interpolation","linearRGB").attr("x1","0").attr("x2","0").attr("y1",B(this.bounds.upper)).attr("y2",B(this.bounds.lower));w.append("stop").classed("stop-0",!0).attr("offset","0%"),w.append("stop").classed("stop-100",!0).attr("offset","100%");const L=N.merge(R).attr("viewBox",`0 0 ${s} ${r}`),D=L.selectAll(".plot.density").data([{outcome:"correct",data:{meanRT:this.data.correctMeanRT,sdRT:this.data.correctSDRT},model:{meanRT:this.model.correctMeanRT,sdRT:this.model.correctSDRT,dist:this.model.correctDist},densityScale:U,densityLine:A,alignDistribution:this.alignCorrectDistribution.bind(this)},{outcome:"error",data:{meanRT:this.data.errorMeanRT,sdRT:this.data.errorSDRT},model:{meanRT:this.model.errorMeanRT,sdRT:this.model.errorSDRT,dist:this.model.errorDist},densityScale:f,densityLine:E,alignDistribution:this.alignErrorDistribution.bind(this)}]),k=N.append("g").classed("plot evidence",!0),M=D.enter().append("g").attr("class",(t=>`plot density ${t.outcome}`)),T=N.append("g").classed("plot accuracy",!0),H=L.select(".plot.evidence").attr("transform",`translate(${o}, ${a+g+h})`),$=M.merge(D).attr("transform",(t=>`translate(${o}, ${"correct"===t.outcome?a:a+g+u+2*h})`)),G=L.select(".plot.accuracy").attr("transform",`translate(${o+m+p}, ${a})`);k.append("clipPath").attr("id","clip-evidence").append("rect"),H.select("clipPath rect").attr("y",B(this.bounds.upper)).attr("height",B(this.bounds.lower)-B(this.bounds.upper)+1).attr("width",m+1);const V=k.append("g").classed("underlayer",!0),z=M.append("g").classed("underlayer",!0),W=T.append("g").classed("underlayer",!0),Y=H.select(".underlayer"),_=$.select(".underlayer"),J=G.select(".underlayer");k.append("g").classed("content",!0).append("g").classed("paths",!0);const K=M.append("g").classed("content",!0);T.append("g").classed("content",!0);const X=H.select(".content"),Z=$.select(".content"),P=G.select(".content");k.append("g").classed("overlayer",!0),M.append("g").classed("overlayer",!0),T.append("g").classed("overlayer",!0);const O=H.select(".overlayer"),j=$.select(".overlayer");V.append("rect").classed("background",!0),z.append("rect").classed("background",!0),Y.select(".background").transition().duration(this.drag?0:Q).ease(gr).attr("y",B(this.bounds.upper)).attr("height",B(this.bounds.lower)-B(this.bounds.upper)).attr("width",m),_.select(".background").transition().duration(Q).ease(gr).attr("height",g).attr("width",m),z.filter((t=>"error"===t.outcome)).append("g").classed("axis time",!0);const q=_.filter((t=>"error"===t.outcome)).select(".axis.time").attr("transform",`translate(0, ${g+.25*this.rem})`);var tt;q.transition().duration(Q).ease(gr).call((tt=y,Nt(It,tt))).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null);const et=z.filter((t=>"error"===t.outcome)).append("text").classed("title time",!0).attr("text-anchor","middle");et.append("tspan").classed("name",!0).text("Time (ms)"),_.filter((t=>"error"===t.outcome)).select(".title.time").transition().duration(Q).ease(gr).attr("transform",`translate(${m/2}, ${g+2.5*this.rem})`),V.append("g").classed("axis evidence",!0),z.append("g").attr("class",(t=>`axis density ${t.outcome}`)),W.append("g").classed("axis accuracy",!0);const it=Y.select(".axis.evidence").attr("transform",`translate(${-.25*this.rem}, 0)`),st=_.select(".axis.density").attr("transform",`translate(${-.25*this.rem}, 0)`),rt=J.select(".axis.accuracy").attr("transform",`translate(${b+.25*this.rem}, 0)`),at=it.transition().duration(Q).ease(gr).call(St(B)).attr("font-size",null).attr("font-family",null),nt=st.transition().duration(Q).ease(gr).each(((t,e,i)=>{St(t.densityScale).ticks(2)(Ze(i[e]))})).attr("font-size",null).attr("font-family",null),ot=rt.transition().duration(Q).ease(gr).call(function(t){return Nt(ft,t)}(I)).attr("font-size",null).attr("font-family",null);at.selectAll("line, path").attr("stroke",null),nt.selectAll("line, path").attr("stroke",null),ot.selectAll("line, path").attr("stroke",null);const lt=V.append("text").classed("title evidence",!0).attr("text-anchor","middle"),ct=z.append("text").attr("class",(t=>`title density ${t.outcome}`)).attr("text-anchor","middle"),dt=W.append("text").classed("title accuracy",!0).attr("text-anchor","middle");lt.append("tspan").classed("name",!0).text("Evidence"),ct.append("tspan").classed("name",!0).text("Density"),dt.append("tspan").classed("name",!0).text("Accuracy"),Y.select(".title.evidence").transition().duration(Q).ease(gr).attr("transform",`translate(${-2.5*this.rem}, ${u/2})rotate(-90)`),_.select(".title.density").transition().duration(Q).ease(gr).attr("transform",`translate(${-2.5*this.rem}, ${g/2})rotate(-90)`),J.select(".title.accuracy").transition().duration(Q).ease(gr).attr("transform",`translate(${b+2.25*this.rem}, ${c/2})rotate(90)`);const ht=X.select(".paths").selectAll(".path").data(this.data.trials.filter((t=>void 0!==t.path))),ut=Oe(),gt=ht.enter().append("g").classed("path",!0).attr("data-new-trial-ease-time",0).on("pointerenter",((t,e)=>{if(!this.drag){Ze(t.currentTarget).classed("highlight",!0).raise();const i=O.append("g").classed(`rt-label ${e.outcome}`,!0),s=i.append("rect"),r=i.append("text").text(`RT = ${e.rt.toFixed()}`).attr("x",y(e.rt)).attr("y","correct"===e.outcome?B(this.bounds.upper)-.25*this.rem:B(this.bounds.lower)+.125*this.rem).node().getBBox();s.attr("x",r.x-.125*this.rem).attr("y",r.y+.125*this.rem).attr("width",r.width+.25*this.rem).attr("height",r.height-.25*this.rem),ut.set(t.currentTarget,i)}})).on("pointerout",((t,e)=>{this.drag||(Ze(t.currentTarget).classed("highlight",!1).lower(),t.currentTarget.parentNode.insertBefore(t.currentTarget,t.currentTarget.parentNode.children[e.index]),ut.get(t.currentTarget).remove())}));gt.append("path").classed("curve",!0).attr("clip-path","url(#clip-evidence)").attr("pathLength",1).attr("stroke-dashoffset",1);const pt=gt.merge(ht).attr("class",(t=>`path ${t.outcome}`));pt.select(".curve").transition().duration(this.drag?0:Q).ease(gr).attr("stroke",(t=>this.getComputedStyleValue(`---color-${t.outcome}`))).attrTween("d",((t,e,i)=>{const s=i[e],r=ss(void 0!==s.a?s.a:this.a,this.a),a=ss(void 0!==s.z?s.z:this.z,this.z),n=ss(void 0!==s.v?s.v:this.v,this.v),o=ss(void 0!==s.t0?s.t0:this.t0,this.t0);return e=>{s.a=r(e),s.z=a(e),s.v=n(e),s.t0=o(e);const i=this.alignPath(t.seed,s.a,s.z,s.v,s.t0);return x(i)}}));const mt=pt.filter((t=>t.animate&&!this.paused));if(!mt.empty()){const t=mt.attr("data-new-trial-ease-time"),e=e=>jr().domain([0,1]).range([t,1])(e),i=e=>i=>jr().domain([e(t),1]).range([0,1])(e(i));mt.classed("animate",!0).select(".curve").attr("stroke-dasharray",1),mt.transition("new").duration((e=>Math.floor(1.5*e.rt*(1-t)))).ease(e).attr("data-new-trial-ease-time",1).select(".curve").attrTween("stroke-dashoffset",((t,e,s)=>{const r=ss(s[e].getAttribute("stroke-dashoffset"),0);return t=>r(i(ur)(t))})).on("end",((t,e,i)=>{Ze(i[e].parentElement).classed("animate",!1).attr("data-new-trial-ease-time",null),t.animate=!1,this.animate=!1,this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("accumulable-response",{detail:{outcome:t.outcome,data:this.data,model:this.model},bubbles:!0}))}))}const bt=pt.filter((t=>t.animate&&this.paused));if(!bt.empty()){const t=bt.attr("data-new-trial-ease-time");bt.classed("animate",!0).select(".curve").attr("stroke-dasharray",1).attr("stroke-dashoffset",(()=>ss(1,0)(ur(t))))}pt.filter((t=>!t.animate)).attr("data-new-trial-ease-time",null),ht.exit().remove();const Qt=K.append("g").attr("class",(t=>`dist ${t.outcome}`));Qt.append("path").classed("curve",!0),Z.select(".dist").select(".curve").transition().duration(this.drag?0:Q).ease(gr).attrTween("d",((t,e,i)=>{const s=i[e],r=ss(void 0!==s.a?s.a:this.a,this.a),a=ss(void 0!==s.z?s.z:this.z,this.z),n=ss(void 0!==s.v?s.v:this.v,this.v),o=ss(void 0!==s.t0?s.t0:this.t0,this.t0);return e=>{s.a=r(e),s.z=a(e),s.v=n(e),s.t0=o(e);const i=t.alignDistribution(s.a,s.z,s.v,s.t0);return t.densityLine(i)}}));const yt=X.selectAll(".rt").data(this.data.trials),Bt=yt.enter().append("g");Bt.append("line").classed("mark",!0).attr("x1",(t=>y(t.rt))).attr("x2",(t=>y(t.rt))).attr("y1",(t=>"correct"===t.outcome?B(1)-.125*this.rem:B(-1)+.125*this.rem)).attr("y2",(t=>"correct"===t.outcome?B(1)-.675*this.rem:B(-1)+.675*this.rem));const Ut=Bt.merge(yt).attr("class",(t=>`rt ${t.outcome}`));Ut.filter((t=>!t.animate)).select(".mark").transition().duration(this.drag?0:Q).ease(gr).attr("stroke",(t=>this.getComputedStyleValue(`---color-${t.outcome}`))).attr("x1",(t=>y(t.rt))).attr("x2",(t=>y(t.rt))).attr("y1",(t=>"correct"===t.outcome?B(1)-.125*this.rem:B(-1)+.125*this.rem)).attr("y2",(t=>"correct"===t.outcome?B(1)-.675*this.rem:B(-1)+.675*this.rem)),yt.exit().remove();const Ft=P.selectAll(".accuracy.model").data([this.model.accuracy,1-this.model.accuracy]),Ct=Ft.enter().append("g").attr("class",((t,e)=>"accuracy model "+(0===e?"correct":"error")));Ct.append("rect").classed("bar",!0).attr("x",0),Ct.merge(Ft).select("rect").transition().duration(this.drag?0:Q).ease(gr).attr("y",((t,e)=>I(0===e?0:1-t))).attr("width",b).attr("height",(t=>I(t))),Ft.exit().remove();const vt=P.selectAll(".accuracy.data").data(Number.isNaN(this.data.accuracy)?[]:[this.data.accuracy]),xt=vt.enter().append("g").classed("accuracy data",!0);xt.append("line").classed("mark",!0);const At=xt.merge(vt).attr("class",(t=>"accuracy data "+(t<this.model.accuracy.correct?"correct":"error")));At.select(".mark").transition().duration(this.drag?0:Q).ease(gr).attr("x1",0+.25*this.rem).attr("x2",b-.25*this.rem).attr("y1",(t=>I(t)-1)).attr("y2",(t=>I(t)-1)),vt.exit().remove();const Et=O.selectAll(".boundary").data([{bound:"upper",value:this.bounds.upper},{bound:"lower",value:this.bounds.lower}]),Rt=Et.enter().append("g").attr("class",((t,e)=>"boundary "+(0===e?"correct":"error")));Rt.append("line").classed("line",!0);const wt=Rt.merge(Et).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?(t,e)=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let i=this.a;switch(t.key){case"ArrowUp":i+="upper"===e.bound?t.shiftKey?.01:.1:t.shiftKey?-.01:-.1;break;case"ArrowDown":i+="upper"===e.bound?t.shiftKey?-.01:-.1:t.shiftKey?.01:.1}i=i<.01?.01:i>2*this.scale.evidence.max?2*this.scale.evidence.max:i,this.a=i,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-a",{detail:{a:this.a},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?wt.call(v):wt.on(".drag",null)),wt.select(".line").transition().duration(this.drag?0:Q).ease(gr).attr("x1",y(this.scale.time.min)).attr("x2",y(this.scale.time.max)).attr("y1",(t=>B(t.value))).attr("y2",(t=>B(t.value))),Et.exit().remove();const Lt=O.selectAll(".drift").data([{v:this.v,t0:this.t0,startingPoint:this.startingPoint}]),Dt=Lt.enter().append("g").classed("drift",!0);Dt.append("line").classed("line",!0),Dt.append("path").classed("arrow",!0);const kt=Dt.merge(Lt).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?t=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let e=this.v;switch(t.key){case"ArrowUp":e+=t.shiftKey?.01:.1;break;case"ArrowDown":e-=t.shiftKey?.01:.1}e=e<.01?.01:e>5?5:e,this.v=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-v",{detail:{v:this.v},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?kt.call(C):kt.on(".drag",null));const Mt=(B(0)-B(1))/(y(1)-y(0));kt.transition().duration(this.drag?0:Q).ease(gr).attr("transform",(t=>`translate(${y(t.t0)}, ${B(t.startingPoint)})\n          rotate(${-Math.atan(t.v/1e3*Mt)*(180/Math.PI)})`)),kt.select(".line").attr("x2",y(200)),kt.select(".arrow").attr("d",`\n        M ${y(200)-.5*this.rem},${.5*-this.rem}\n        l ${.5*this.rem},${.5*this.rem}\n        l ${.5*-this.rem},${.5*this.rem}\n      `),Lt.exit().remove();const Tt=O.selectAll(".t0z").data([{t0:this.t0,startingPoint:this.startingPoint}]),Ht=Tt.enter().append("g").classed("t0z",!0);Ht.append("line").classed("line",!0),Ht.append("circle").classed("point",!0);const $t=Ht.merge(Tt).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?t=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let e=this.z;switch(t.key){case"ArrowUp":e+=t.shiftKey?.01:.1;break;case"ArrowDown":e-=t.shiftKey?.01:.1}e=e<.01?.01:e>.99?.99:e,this.z=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-z",{detail:{z:this.z},bubbles:!0})),t.preventDefault()}if(["ArrowLeft","ArrowRight"].includes(t.key)){let e=this.t0;switch(t.key){case"ArrowRight":e+=t.shiftKey?1:10;break;case"ArrowLeft":e-=t.shiftKey?1:10}e=e<0?0:e>500?500:e,this.t0=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-t0",{detail:{t0:this.t0},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?$t.call(F):$t.on(".drag",null)),$t.select(".line").transition().duration(this.drag?0:Q).ease(gr).attr("x1",y(0)).attr("x2",(t=>y(t.t0))).attr("y1",(t=>B(t.startingPoint))).attr("y2",(t=>B(t.startingPoint))),$t.select(".point").transition().duration(this.drag?0:Q).ease(gr).attr("cx",(t=>y(t.t0))).attr("cy",(t=>B(t.startingPoint))),Tt.exit().remove();const Gt=O.selectAll(".measure.a").data(this.measures?[this.a]:[]),Vt=Gt.enter().append("g").classed("measure a",!0);Vt.append("line").classed("line",!0).attr("marker-start","url(#measure-arrow)").attr("marker-end","url(#measure-arrow)");const zt=Vt.append("text").classed("label",!0);zt.append("tspan").classed("a math-var",!0).text("a"),zt.append("tspan").classed("equals",!0).text(" = "),zt.append("tspan").classed("value",!0);const Wt=Vt.merge(Gt);Wt.select(".line").transition().duration(this.drag?0:Q).ease(gr).attr("x1",y(this.scale.time.max)-.75*this.rem).attr("y1",B(this.bounds.upper)+2).attr("x2",y(this.scale.time.max)-.75*this.rem).attr("y2",B(this.bounds.lower)-2);Wt.select(".label").transition().duration(this.drag?0:Q).ease(gr).attr("x",y(this.scale.time.max)).attr("y",B(this.bounds.upper)-.25*this.rem).select(".value").text(wr(".2f")(this.a)),Gt.exit().remove();const Yt=O.selectAll(".measure.z").data(this.measures?[this.z]:[]),_t=Yt.enter().append("g").classed("measure z",!0);_t.append("line").classed("line",!0).attr("marker-start","url(#measure-arrow)").attr("marker-end","url(#measure-arrow)");const Jt=_t.append("text").classed("label",!0);Jt.append("tspan").classed("z math-var",!0).text("z"),Jt.append("tspan").classed("equals",!0).text(" = "),Jt.append("tspan").classed("value",!0);const Kt=_t.merge(Yt);Kt.select(".line").transition().duration(this.drag?0:Q).ease(gr).attr("x1",y(this.scale.time.min)+.75*this.rem).attr("y1",B(this.startingPoint)+2).attr("x2",y(this.scale.time.min)+.75*this.rem).attr("y2",B(this.bounds.lower)-2);Kt.select(".label").transition().duration(this.drag?0:Q).ease(gr).attr("x",y(this.scale.time.min)).attr("y",B(this.bounds.lower)+.125*this.rem).select(".value").text(wr(".0%")(this.z)),Yt.exit().remove();const Xt=O.selectAll(".measure.v").data(this.measures?[this.v]:[]),Zt=Xt.enter().append("g").classed("measure v",!0);Zt.append("path").classed("line",!0).attr("marker-start","url(#measure-arrow)").attr("marker-end","url(#measure-arrow)");const Pt=Zt.append("text").classed("label",!0);Pt.append("tspan").classed("v math-var",!0).text("v"),Pt.append("tspan").classed("equals",!0).text(" = "),Pt.append("tspan").classed("value",!0);const Ot=Math.atan(this.v/1e3*Mt),jt=y(200)-y(0)+.75*this.rem,qt=Math.cos(Ot)*jt,te=Math.sin(Ot)*jt,ee=Zt.merge(Xt);ee.select(".line").transition().duration(this.drag?0:Q).ease(gr).attr("d",`\n        M ${y(this.t0+200)+.75*this.rem}, ${B(this.startingPoint)}\n        A ${y(200)-y(0)} ${y(200)-y(0)} 0 0 0 ${y(this.t0)+qt} ${B(this.startingPoint)-te}\n      `);ee.select(".label").transition().duration(this.drag?0:Q).ease(gr).attr("x",y(this.t0+200)+.5*this.rem).attr("y",B(this.bounds.upper)-.25*this.rem).select(".value").text(wr(".2f")(this.v)),Xt.exit().remove();const ie=O.selectAll(".measure.t0").data(this.measures?[this.t0]:[]),se=ie.enter().append("g").classed("measure t0",!0);se.append("line").classed("line",!0).attr("marker-start","url(#measure-arrow)").attr("marker-end","url(#measure-arrow)");const re=se.append("text").classed("label",!0);re.append("tspan").classed("t0 math-var",!0).text("t₀"),re.append("tspan").classed("equals",!0).text(" = "),re.append("tspan").classed("value",!0);const ae=se.merge(ie);ae.select(".line").transition().duration(this.drag?0:Q).ease(gr).attr("x1",y(0)+2).attr("y1",B(this.startingPoint)-.75*this.rem).attr("x2",y(this.t0)-2).attr("y2",B(this.startingPoint)-.75*this.rem);ae.select(".label").transition().duration(this.drag?0:Q).ease(gr).attr("x",y(this.t0)+.25*this.rem).attr("y",B(this.bounds.upper)-.25*this.rem).select(".value").text(wr("d")(this.t0)),ie.exit().remove();const ne=j.selectAll(".model.mean").data((t=>this.means?[t]:[])),oe=ne.enter().append("g").attr("class",(t=>`model mean ${t.outcome}`));oe.append("line").classed("indicator",!0);oe.merge(ne).select(".indicator").transition().duration(this.drag?0:Q).ease(gr).attr("x1",(t=>y(t.model.meanRT))).attr("x2",(t=>y(t.model.meanRT))).attr("y1",(t=>t.densityScale(this.scale.density.min))).attr("y2",(t=>t.densityScale(this.scale.density.max))),ne.exit().remove();const le=j.selectAll(".data.mean").data((t=>this.means&&!Number.isNaN(t.data.meanRT)?[t]:[])),ce=le.enter().append("g").attr("class",(t=>`data mean ${t.outcome}`));ce.append("line").classed("indicator",!0).attr("y1",(t=>t.densityScale(0)+("correct"===t.outcome?.125:-.125)*this.rem)).attr("y2",(t=>t.densityScale(0)+("correct"===t.outcome?.675:-.675)*this.rem));ce.merge(le).select(".indicator").transition().duration(this.drag?0:Q).ease(gr).attr("x1",(t=>y(t.data.meanRT))).attr("x2",(t=>y(t.data.meanRT))).attr("y1",(t=>t.densityScale(0)+("correct"===t.outcome?.125:-.125)*this.rem)).attr("y2",(t=>t.densityScale(0)+("correct"===t.outcome?.675:-.675)*this.rem)),le.exit().select(".indicator").transition().duration(this.drag?0:Q).ease(gr).attr("x1",0).attr("x2",0).on("end",((t,e,i)=>{Ze(i[e].parentElement).remove()}));const de=j.selectAll(".model.sd").data((t=>this.sds?[t]:[])),he=de.enter().append("g").attr("class",(t=>`model sd ${t.outcome}`));he.append("line").classed("indicator",!0).attr("marker-start","url(#model-sd-cap)").attr("marker-end","url(#model-sd-cap)");he.merge(de).select(".indicator").transition().duration(this.drag?0:Q).ease(gr).attr("x1",(t=>y(t.model.meanRT-t.model.sdRT/2))).attr("x2",(t=>y(t.model.meanRT+t.model.sdRT/2))).attr("y1",(t=>t.densityScale(5))).attr("y2",(t=>t.densityScale(5))),de.exit().remove();const ue=j.selectAll(".data.sd").data((t=>!this.sds||Number.isNaN(t.data.meanRT)||Number.isNaN(t.data.sdRT)?[]:[t])),ge=ue.enter().append("g").attr("class",(t=>`data sd ${t.outcome}`));ge.append("line").classed("indicator",!0).attr("marker-start","url(#data-sd-cap)").attr("marker-end","url(#data-sd-cap)").attr("y1",(t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem)).attr("y2",(t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem));ge.merge(ue).select(".indicator").transition().duration(this.drag?0:Q).ease(gr).attr("x1",(t=>y(t.data.meanRT-t.data.sdRT/2))).attr("x2",(t=>y(t.data.meanRT+t.data.sdRT/2))).attr("y1",(t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem)).attr("y2",(t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem)),ue.exit().select(".indicator").transition().duration(this.drag?0:Q).ease(gr).attr("x1",0).attr("x2",0).on("end",((t,e,i)=>{Ze(i[e].parentElement).remove()})),this.firstUpdate=!1}}customElements.define("ddm-model",Ia);class Fa extends(ca(da)){static get properties(){return{coherence:{attribute:"coherence",type:Number,reflect:!0},count:{attribute:"count",type:Number,reflect:!0},probability:{attribute:"probability",type:Number,reflect:!0},duration:{attribute:"duration",type:Number,reflect:!0},wait:{attribute:"wait",type:Number,reflect:!0},iti:{attribute:"iti",type:Number,reflect:!0},trials:{attribute:"trials",type:Number,reflect:!0},running:{attribute:"running",type:Boolean,reflect:!0},lifetime:{attribute:!1,type:Number,reflect:!1},speed:{attribute:!1,type:Number,reflect:!1}}}constructor(){super(),this.coherence=.5,this.count=100,this.probability=.5,this.duration=2e3,this.wait=2e3,this.iti=2e3,this.trials=5,this.running=!1,this.lifetime=400,this.speed=50,this.firstUpdate=!0,this.COHERENT=0,this.RANDOM=1,this.dots=[[],[]],this.trial=0,this.states=["resetted","iti","stimulus","wait","ended"],this.state="resetted",this.baseTime=0,this.pauseTime=0,this.startTime=0,this.lastTime=0,this.LEFT=180,this.RIGHT=0,this.currentDirection=void 0,this.signals=["left","right"],this.signal=void 0,this.runner=void 0,this.xScale=void 0,this.yScale=void 0}static get styles(){return[super.styles,n`
        :host {
          display: inline-block;
      ...
      </div>`}}customElements.define("ddm-equation-azvt02m",xa);class Aa extends da{static get styles(){return[super.styles,n`
        :host {
          ---border: var(--border, 1px solid var(---color-border));
          display: inline-block;
