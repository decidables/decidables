...
## About <span class="accumulable"><span class="math-var">a</span>ccumulable</span>

Created by
: [Adam Krawitz](https://web.uvic.ca/~akrawitz/)
...
: [bayes.js](https://github.com/rasmusab/bayes.js),
  ...
  [Lit](https://lit.dev/),
  and [Observable Plot](https://observablehq.com/plot/)
...
: [GitHub](https://github.com/)
  ...
  as [**`sites/accumulable`**](https://github.com/decidables/decidables/tree/main/sites/accumulable)

Published to
: [GitHub Pages](https://pages.github.com/)
  with [GitHub Actions](https://docs.github.com/en/actions)
  as [<span class="dec-site"><span class="math-var">a</span>ccumulable</span>](https://decidables.github.io/accumulable/)
  and [npm](https://www.npmjs.com/)
  with [lerna](https://github.com/lerna/lerna),
  [husky](https://typicode.github.io/husky/),
  and [commitlint](https://commitlint.js.org/)
  as [**`@decidables/accumulable-math`**](https://www.npmjs.com/package/@decidables/accumulable-math),
  and [**`@decidables/accumulable-elements`**](https://www.npmjs.com/package/@decidables/accumulable-elements)
