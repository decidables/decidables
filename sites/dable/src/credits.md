...
## About <span class="dec-name">dab’le</span>
...
: [Bootstrap](https://getbootstrap.com/),
  ...
  and [Plotly.js](https://plotly.com/javascript/)
...
: [GitHub](https://github.com/)
  ...
  as [**`sites/dable`**](https://github.com/decidables/decidables/tree/main/sites/dable)

Published to
: [GitHub Pages](https://pages.github.com/)
  with [GitHub Actions](https://docs.github.com/en/actions)
  as [<span class="dec-name">dab’le</span>](https://decidables.github.io/dable/)
