...
var ordinaryToPrimitive$1 = function (input, pref) {
  var fn, val;
  if (pref === 'string' && isCallable$e(fn = input.toString) && !isObject$7(val = call$9(fn, input))) return val;
  if (isCallable$e(fn = input.valueOf) && !isObject$7(val = call$9(fn, input))) return val;
  if (pref !== 'string' && isCallable$e(fn = input.toString) && !isObject$7(val = call$9(fn, input))) return val;
...
if (!NATIVE_ARRAY_BUFFER_VIEWS || !isCallable$5(TypedArray) || TypedArray === Function.prototype) {
  ...
  if (NATIVE_ARRAY_BUFFER_VIEWS) for (NAME$4 in TypedArrayConstructorsList) {
    if (global$a[NAME$4]) setPrototypeOf$1(global$a[NAME$4], TypedArray);
  }
}
if (!NATIVE_ARRAY_BUFFER_VIEWS || !TypedArrayPrototype || TypedArrayPrototype === ObjectPrototype) {
  TypedArrayPrototype = TypedArray.prototype;
  if (NATIVE_ARRAY_BUFFER_VIEWS) for (NAME$4 in TypedArrayConstructorsList) {
    if (global$a[NAME$4]) setPrototypeOf$1(global$a[NAME$4].prototype, TypedArrayPrototype);
  }
}
...
if (DESCRIPTORS$3 && !hasOwn$4(TypedArrayPrototype, TO_STRING_TAG)) {
  ...
  for (NAME$4 in TypedArrayConstructorsList) if (global$a[NAME$4]) {
    createNonEnumerableProperty$1(global$a[NAME$4], TYPED_ARRAY_TAG, NAME$4);
  }
}
