...
$$n({
  ...
  toSpliced: function toSpliced(start, deleteCount /* , ...items */) {
    ...
    if (argumentsLength === 0) {
      ...
      actualDeleteCount = min$2(max$2(toIntegerOrInfinity$4(deleteCount), 0), len - actualStart);
    }
...
if (!NATIVE_ARRAY_BUFFER_VIEWS || !isCallable$5(TypedArray) || TypedArray === Function.prototype) {
  ...
  if (NATIVE_ARRAY_BUFFER_VIEWS) for (NAME$4 in TypedArrayConstructorsList) {
    if (global$7[NAME$4]) setPrototypeOf$1(global$7[NAME$4], TypedArray);
  }
}
if (!NATIVE_ARRAY_BUFFER_VIEWS || !TypedArrayPrototype || TypedArrayPrototype === ObjectPrototype) {
  TypedArrayPrototype = TypedArray.prototype;
  if (NATIVE_ARRAY_BUFFER_VIEWS) for (NAME$4 in TypedArrayConstructorsList) {
    if (global$7[NAME$4]) setPrototypeOf$1(global$7[NAME$4].prototype, TypedArrayPrototype);
  }
}
...
if (DESCRIPTORS$4 && !hasOwn$4(TypedArrayPrototype, TO_STRING_TAG)) {
  ...
  for (NAME$4 in TypedArrayConstructorsList) if (global$7[NAME$4]) {
    createNonEnumerableProperty$1(global$7[NAME$4], TYPED_ARRAY_TAG, NAME$4);
  }
}
