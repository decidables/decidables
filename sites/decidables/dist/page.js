...
const o=t=>t??T;class DecidablesSlider extends DecidablesElement{static get properties(){return{disabled:{attribute:"disabled",type:Boolean,reflect:!0},max:{attribute:"max",type:Number,reflect:!0},min:{attribute:"min",type:Number,reflect:!0},step:{attribute:"step",type:Number,reflect:!0},value:{attribute:"value",type:Number,reflect:!0}}}constructor(){super(),this.disabled=!1,this.max=void 0,this.min=void 0,this.step=void 0,this.value=void 0}changed(t){this.value=t.target.value,this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0}))}inputted(t){this.value=t.target.value}static get styles(){return[super.styles,i$2`
    ...
    `}sendEvent(){this.dispatchEvent(new CustomEvent("sdt-model-change",{detail:{d:this.d,c:this.c,s:this.s,far:this.far,hr:this.hr,h:this.h,m:this.m,fa:this.fa,cr:this.cr},bubbles:!0}))}willUpdate(){this.alignState()}update(t){if(super.update(t),Number.isNaN(this.width)||Number.isNaN(this.height)||Number.isNaN(this.rem))return;const e=this.width,r=this.height;let n,i;e/r>1.8?(i=r,n=1.8*i):(n=e,i=n/1.8);const a=2*this.rem,s=3*this.rem,o=3*this.rem,l=i-(a+s),c=n-(o+(this.histogram&&this.distributions?3:.75)*this.rem),u=parseInt(this.getComputedStyleValue("---transition-duration"),10),h=linear().domain([-3,3]).range([0,c]),d=linear().domain([.5,0]).range([0,l]),p=h(this.binWidth)-h(0),f=linear().domain([l/p,0]).range([0,l]),m=drag().subject((()=>({x:h(this.l),y:0}))).on("start",(t=>{select(t.currentTarget).classed("dragging",!0)})).on("drag",(t=>{this.drag=!0;let e=h.invert(t.x);e=e<h.domain()[0]?h.domain()[0]:e>h.domain()[1]?h.domain()[1]:e,this.c=SDTMath.l2C(e,this.s),this.alignState(),this.sendEvent()})).on("end",(t=>{select(t.currentTarget).classed("dragging",!1)})),g=drag().subject((()=>({x:h(this.muN),y:0}))).on("start",(t=>{select(t.currentTarget).classed("dragging",!0)})).on("drag",(t=>{this.drag=!0;let e=h.invert(t.x);e=e<h.domain()[0]?h.domain()[0]:e>h.domain()[1]?h.domain()[1]:e,this.d=SDTMath.muN2D(e,this.s),this.alignState(),this.sendEvent()})).on("end",(t=>{select(t.currentTarget).classed("dragging",!1)})),y=drag().subject((()=>({x:h(this.muS),y:d(this.hS)}))).on("start",((t,e)=>{select(t.currentTarget).classed("dragging",!0),e.startX=t.x,e.startY=t.y,e.startHS=this.hS,e.startMuS=this.muS})).on("drag",((t,e)=>{this.drag=!0;let r=this.muS;this.interactive&&(r=h.invert(t.x),r=r<h.domain()[0]?h.domain()[0]:r>h.domain()[1]?h.domain()[1]:r);let n=this.hS;this.unequal&&(n=d.invert(t.y),n=n<.01?.01:n>d.domain()[0]?d.domain()[0]:n),this.interactive&&this.unequal&&t.sourceEvent.shiftKey&&(Math.abs(t.x-e.startX)>Math.abs(t.y-e.startY)?n=e.startHS:r=e.startMuS),this.unequal&&(this.s=SDTMath.h2S(n),this.c=SDTMath.l2C(this.l,this.s)),this.d=SDTMath.muS2D(r,this.s),this.alignState(),this.sendEvent()})).on("end",(t=>{select(t.currentTarget).classed("dragging",!1)})),b=line().x((t=>h(t.e))).y((t=>d(t.p))),$=select(this.renderRoot).selectAll(".main").data([{width:this.width,height:this.height,rem:this.rem}]),v=$.enter().append("svg").classed("main",!0),x=v.merge($).attr("viewBox",`0 0 ${n} ${i}`),w=v.append("g").classed("plot",!0),S=x.select(".plot").attr("transform",`translate(${o}, ${a})`),E=w.append("g").classed("underlayer",!0),T=S.select(".underlayer");E.append("rect").classed("background",!0),T.select(".background").attr("height",l).attr("width",c),E.append("g").classed("axis-x",!0);T.select(".axis-x").attr("transform",`translate(0, ${l})`).call(axisBottom(h)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null),E.append("text").classed("title-x",!0).attr("text-anchor","middle").text("Evidence"),T.select(".title-x").attr("transform",`translate(${c/2}, ${l+2.25*this.rem})`);const _=T.selectAll(".axis-y").data(this.distributions?[{}]:[]);_.enter().append("g").classed("axis-y",!0).merge(_).call(axisLeft(d).ticks(5)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null),_.exit().remove();const A=T.selectAll(".title-y").data(this.distributions?[{}]:[]);A.enter().append("text").classed("title-y",!0).attr("text-anchor","middle").text("Probability").merge(A).attr("transform",`translate(${-2*this.rem}, ${l/2})rotate(-90)`),A.exit().remove();const R=T.selectAll(".axis-y2").data(this.histogram?[{}]:[]);R.enter().append("g").classed("axis-y2",!0).merge(R).attr("transform",this.distributions?`translate(${c}, 0)`:"").call(this.distributions?axisRight(f).ticks(10):axisLeft(f).ticks(10)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null),R.exit().remove();const k=T.selectAll(".title-y2").data(this.histogram?[{}]:[]);k.enter().append("text").classed("title-y2",!0).attr("text-anchor","middle").text("Count").merge(k).attr("transform",this.distributions?`translate(${c+1.5*this.rem}, ${l/2})rotate(90)`:`translate(${-1.5*this.rem}, ${l/2})rotate(-90)`),k.exit().remove(),w.append("g").classed("content",!0);const C=S.select(".content"),O=C.selectAll(".signal-noise").data(this.distributions?[{}]:[]),M=O.enter().append("g").classed("signal-noise",!0),N=M.merge(O);O.exit().remove();const P=M.append("g").classed("noise",!0),I=N.selectAll(".noise").attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?t=>{if(["ArrowRight","ArrowLeft"].includes(t.key)){let e=this.muN;switch(t.key){case"ArrowRight":e+=t.shiftKey?.01:.1;break;case"ArrowLeft":e-=t.shiftKey?.01:.1}e=e<h.domain()[0]?h.domain()[0]:e>h.domain()[1]?h.domain()[1]:e,e!==this.muN&&(this.d=SDTMath.muN2D(e,this.s),this.alignState(),this.sendEvent()),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?I.call(g):I.on(".drag",null)),P.append("path").classed("curve-cr",!0),I.select(".curve-cr").transition().duration(this.drag?0:u).ease(cubicOut).attrTween("d",((t,e,r)=>{const n=r[e],i=interpolate$1(void 0!==n.d?n.d:this.d,this.d),a=interpolate$1(void 0!==n.c?n.c:this.c,this.c),s=interpolate$1(void 0!==n.s?n.s:this.s,this.s);return t=>{n.d=i(t),n.c=a(t),n.s=s(t);const e=range(h.domain()[0],SDTMath.c2L(n.c,n.s),.05).map((t=>({e:t,p:jStat.normal.pdf(t,SDTMath.d2MuN(n.d,n.s),1)})));return e.push({e:SDTMath.c2L(n.c,n.s),p:jStat.normal.pdf(SDTMath.c2L(n.c,n.s),SDTMath.d2MuN(n.d,n.s),1)}),e.push({e:SDTMath.c2L(n.c,n.s),p:0}),e.push({e:h.domain()[0],p:0}),b(e)}})),P.append("path").classed("curve-fa",!0),I.select(".curve-fa").transition().duration(this.drag?0:u).ease(cubicOut).attrTween("d",((t,e,r)=>{const n=r[e],i=interpolate$1(void 0!==n.d?n.d:this.d,this.d),a=interpolate$1(void 0!==n.c?n.c:this.c,this.c),s=interpolate$1(void 0!==n.s?n.s:this.s,this.s);return t=>{n.d=i(t),n.c=a(t),n.s=s(t);const e=range(SDTMath.c2L(n.c,n.s),h.domain()[1],.05).map((t=>({e:t,p:jStat.normal.pdf(t,SDTMath.d2MuN(n.d,n.s),1)})));return e.push({e:h.domain()[1],p:jStat.normal.pdf(h.domain()[1],SDTMath.d2MuN(n.d,n.s),1)}),e.push({e:h.domain()[1],p:0}),e.push({e:SDTMath.c2L(n.c,n.s),p:0}),b(e)}})),P.append("path").classed("curve-noise",!0),I.select(".curve-noise").transition().duration(this.drag?0:u).ease(cubicOut).attrTween("d",((t,e,r)=>{const n=r[e],i=interpolate$1(void 0!==n.d?n.d:this.d,this.d),a=interpolate$1(void 0!==n.s?n.s:this.s,this.s);return t=>{n.d=i(t),n.s=a(t);const e=range(h.domain()[0],h.domain()[1],.05).map((t=>({e:t,p:jStat.normal.pdf(t,SDTMath.d2MuN(n.d,n.s),1)})));return e.push({e:h.domain()[1],p:jStat.normal.pdf(h.domain()[1],SDTMath.d2MuN(n.d,n.s),1)}),b(e)}}));const D=M.append("g").classed("signal",!0),L=N.selectAll(".signal").attr("tabindex",this.interactive||this.unequal?0:null).classed("interactive",this.interactive).classed("unequal",this.unequal).on("keydown.sensitivity",this.interactive?t=>{if(["ArrowRight","ArrowLeft"].includes(t.key)){let e=this.muS;switch(t.key){case"ArrowRight":e+=t.shiftKey?.01:.1;break;case"ArrowLeft":e-=t.shiftKey?.01:.1}e=e<h.domain()[0]?h.domain()[0]:e>h.domain()[1]?h.domain()[1]:e,e!==this.muS&&(this.d=SDTMath.muS2D(e,this.s),this.alignState(),this.sendEvent()),t.preventDefault()}}:null).on("keydown.variance",this.unequal?t=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let e=this.hS;switch(t.key){case"ArrowUp":e+=t.shiftKey?.002:.02;break;case"ArrowDown":e-=t.shiftKey?.002:.02}e=e<.01?.01:e>d.domain()[0]?d.domain()[0]:e,e!==this.hS&&(this.s=SDTMath.h2S(e),this.d=SDTMath.muN2D(this.muN,this.s),this.c=SDTMath.l2C(this.l,this.s),this.alignState(),this.sendEvent()),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive")||t.has("unequal"))&&(this.interactive||this.unequal?L.call(y):L.on(".drag",null)),D.append("path").classed("curve-m",!0),L.select(".curve-m").transition().duration(this.drag?0:u).ease(cubicOut).attrTween("d",((t,e,r)=>{const n=r[e],i=interpolate$1(void 0!==n.d?n.d:this.d,this.d),a=interpolate$1(void 0!==n.c?n.c:this.c,this.c),s=interpolate$1(void 0!==n.s?n.s:this.s,this.s);return t=>{n.d=i(t),n.c=a(t),n.s=s(t);const e=range(h.domain()[0],SDTMath.c2L(n.c,n.s),.05).map((t=>({e:t,p:jStat.normal.pdf(t,SDTMath.d2MuS(n.d,n.s),n.s)})));return e.push({e:SDTMath.c2L(n.c,n.s),p:jStat.normal.pdf(SDTMath.c2L(n.c,n.s),SDTMath.d2MuS(n.d,n.s),n.s)}),e.push({e:SDTMath.c2L(n.c,n.s),p:0}),e.push({e:h.domain()[0],p:0}),b(e)}})),D.append("path").classed("curve-h",!0),L.select(".curve-h").transition().duration(this.drag?0:u).ease(cubicOut).attrTween("d",((t,e,r)=>{const n=r[e],i=interpolate$1(void 0!==n.d?n.d:this.d,this.d),a=interpolate$1(void 0!==n.c?n.c:this.c,this.c),s=interpolate$1(void 0!==n.s?n.s:this.s,this.s);return t=>{n.d=i(t),n.c=a(t),n.s=s(t);const e=range(SDTMath.c2L(n.c,n.s),h.domain()[1],.05).map((t=>({e:t,p:jStat.normal.pdf(t,SDTMath.d2MuS(n.d,n.s),n.s)})));return e.push({e:h.domain()[1],p:jStat.normal.pdf(h.domain()[1],SDTMath.d2MuS(n.d,n.s),n.s)}),e.push({e:h.domain()[1],p:0}),e.push({e:SDTMath.c2L(n.c,n.s),p:0}),b(e)}})),D.append("path").classed("curve-signal",!0),L.select(".curve-signal").transition().duration(this.drag?0:u).ease(cubicOut).attrTween("d",((t,e,r)=>{const n=r[e],i=interpolate$1(void 0!==n.d?n.d:this.d,this.d),a=interpolate$1(void 0!==n.s?n.s:this.s,this.s);return t=>{n.d=i(t),n.s=a(t);const e=range(h.domain()[0],h.domain()[1],.05).map((t=>({e:t,p:jStat.normal.pdf(t,SDTMath.d2MuS(n.d,n.s),n.s)})));return e.push({e:h.domain()[1],p:jStat.normal.pdf(h.domain()[1],SDTMath.d2MuS(n.d,n.s),n.s)}),b(e)}}));const U=C.selectAll(".measure-d").data(this.sensitivity?[{}]:[]),j=U.enter().append("g").classed("measure-d",!0);j.append("line").classed("line",!0),j.append("line").classed("cap-left",!0),j.append("line").classed("cap-right",!0);const F=j.append("text").classed("label",!0);F.append("tspan").classed("d math-var",!0).text("d′"),F.append("tspan").classed("equals",!0).text(" = "),F.append("tspan").classed("value",!0);const B=j.merge(U);B.select(".line").transition().duration(this.drag?0:u).ease(cubicOut).attr("x1",h(this.muN)).attr("y1",d(.43)).attr("x2",h(this.muS)).attr("y2",d(.43)),B.select(".cap-left").transition().duration(this.drag?0:u).ease(cubicOut).attr("x1",h(this.muN)).attr("y1",d(.43)+5).attr("x2",h(this.muN)).attr("y2",d(.43)-5),B.select(".cap-right").transition().duration(this.drag?0:u).ease(cubicOut).attr("x1",h(this.muS)).attr("y1",d(.43)+5).attr("x2",h(this.muS)).attr("y2",d(.43)-5);B.select(".label").transition().duration(this.drag?0:u).ease(cubicOut).attr("x",h(this.muN>this.muS?this.muN:this.muS)+5).attr("y",d(.43)+3).select(".value").tween("text",((t,e,r)=>{const n=r[e],i=interpolate$1(void 0!==n.d?n.d:this.d,this.d);return t=>{n.d=i(t),select(n).text(format(".3")(n.d))}})),U.exit().remove();const z=C.selectAll(".measure-c").data(this.bias?[{}]:[]),V=z.enter().append("g").classed("measure-c",!0);V.append("line").classed("line",!0),V.append("line").classed("cap-zero",!0);const H=V.append("text").classed("label",!0);H.append("tspan").classed("c math-var",!0).text("c"),H.append("tspan").classed("equals",!0).text(" = "),H.append("tspan").classed("value",!0);const q=V.merge(z);q.select(".line").transition().duration(this.drag?0:u).ease(cubicOut).attr("x1",h(this.l)).attr("y1",d(.47)).attr("x2",h(0)).attr("y2",d(.47)),q.select(".cap-zero").transition().duration(this.drag?0:u).ease(cubicOut).attr("x1",h(0)).attr("y1",d(.47)+5).attr("x2",h(0)).attr("y2",d(.47)-5);q.select(".label").transition().duration(this.drag?0:u).ease(cubicOut).attr("x",h(0)+(this.l<0?5:-5)).attr("y",d(.47)+3).attr("text-anchor",this.c<0?"start":"end").select(".value").tween("text",((t,e,r)=>{const n=r[e],i=interpolate$1(void 0!==n.c?n.c:this.c,this.c);return t=>{n.c=i(t),select(n).text(format(".3")(n.c))}})),z.exit().remove();const K=C.selectAll(".measure-s").data(this.variance?[{}]:[]),G=K.enter().append("g").classed("measure-s",!0);G.append("line").classed("line",!0),G.append("line").classed("cap-left",!0),G.append("line").classed("cap-right",!0);const Y=G.append("text").classed("label",!0);Y.append("tspan").classed("s math-var",!0).text("σ"),Y.append("tspan").classed("equals",!0).text(" = "),Y.append("tspan").classed("value",!0);const W=G.merge(K);W.select(".line").transition().duration(this.drag?0:u).ease(cubicOut).attr("x1",h(this.muS-this.s)).attr("y1",d(jStat.normal.pdf(this.s,0,this.s))+10/this.s).attr("x2",h(this.muS+this.s)).attr("y2",d(jStat.normal.pdf(this.s,0,this.s))+10/this.s),W.select(".cap-left").transition().duration(this.drag?0:u).ease(cubicOut).attr("x1",h(this.muS-this.s)).attr("y1",d(jStat.normal.pdf(this.s,0,this.s))+10/this.s+5).attr("x2",h(this.muS-this.s)).attr("y2",d(jStat.normal.pdf(this.s,0,this.s))+10/this.s-5),W.select(".cap-right").transition().duration(this.drag?0:u).ease(cubicOut).attr("x1",h(this.muS+this.s)).attr("y1",d(jStat.normal.pdf(this.s,0,this.s))+10/this.s+5).attr("x2",h(this.muS+this.s)).attr("y2",d(jStat.normal.pdf(this.s,0,this.s))+10/this.s-5);W.select(".label").transition().duration(this.drag?0:u).ease(cubicOut).attr("x",h(this.muS)).attr("y",d(jStat.normal.pdf(this.s,0,this.s))+10/this.s-3).select(".value").tween("text",((t,e,r)=>{const n=r[e],i=interpolate$1(void 0!==n.s?n.s:this.s,this.s);return t=>{n.s=i(t),select(n).text(format(".3")(n.s))}})),K.exit().remove();const X=C.selectAll(".threshold").data(this.threshold?[{}]:[]),Z=X.enter().append("g").classed("threshold",!0);Z.append("line").classed("line",!0),Z.append("circle").classed("handle",!0);const Q=Z.merge(X).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive);(this.firstUpdate||t.has("interactive"))&&(this.interactive?Q.call(m).on("keydown",(t=>{if(["ArrowRight","ArrowLeft"].includes(t.key)){let e=this.l;switch(t.key){case"ArrowRight":e+=t.shiftKey?.01:.1;break;case"ArrowLeft":e-=t.shiftKey?.01:.1}e=e<h.domain()[0]?h.domain()[0]:e>h.domain()[1]?h.domain()[1]:e,e!==this.l&&(this.c=SDTMath.l2C(e,this.s),this.alignState(),this.sendEvent()),t.preventDefault()}})):Q.on("drag",null).on("keydown",null)),Q.select(".line").transition().duration(this.drag?0:u).ease(cubicOut).attr("x1",h(this.l)).attr("y1",d(0)).attr("x2",h(this.l)).attr("y2",d(.54)),Q.select(".handle").transition().duration(this.drag?0:u).ease(cubicOut).attr("cx",h(this.l)).attr("cy",d(.54)),X.exit().remove();const J=C.selectAll(".histogram").data(this.histogram?[{}]:[]),tt=J.enter().append("g").classed("histogram",!0).merge(J);if(J.exit().remove(),this.histogram){const t=bin().value((t=>t.trueEvidence)).domain(h.domain()).thresholds(range(this.binRange[0],this.binRange[1],this.binWidth)),e=t(this.trials);let r=-1,n=-1;for(let t=0;t<e.length;t+=1)for(let i=0;i<e[t].length;i+=1)e[t][i].binValue=e[t].x0,e[t][i].binCount=i,0===t&&(r=i),t===e.length-1&&(n=i);for(let t=0;t<this.trials.length;t+=1)this.trials[t].trueEvidence<this.binRange[0]&&(r+=1,this.trials[t].binCount=r,this.trials[t].binValue=e[0].x0),this.trials[t].trueEvidence>this.binRange[1]&&(n+=1,this.trials[t].binCount=n,this.trials[t].binValue=e[e.length-1].x0);const i=tt.selectAll(".trial").data(this.trials,(t=>t.trial)),a=i.enter().append("rect").attr("stroke-width",3).attr("data-new-trial-ease-time",0).attr("stroke",this.getComputedStyleValue("---color-acc")).attr("fill",this.getComputedStyleValue("---color-acc-light")).merge(i).attr("class",(t=>`trial ${t.outcome}`)).attr("width",p-3).attr("height",p-3),s=a.filter((t=>t.new&&!t.paused));if(!s.empty()){const t=s.attr("data-new-trial-ease-time"),e=e=>linear().domain([0,1]).range([t,1])(e),r=e=>r=>linear().domain([e(t),1]).range([0,1])(e(r));s.transition("new").duration((e=>Math.floor((.75*e.duration+.25*e.wait)*(1-t)))).ease(e).attr("data-new-trial-ease-time",1).attrTween("stroke",((t,e,n)=>{const i=n[e],a=interpolateRgb(i.getAttribute("stroke"),"stimulus"===this.color?"present"===t.signal?this.getComputedStyleValue("---color-hr"):this.getComputedStyleValue("---color-far"):"response"===this.color?this.getComputedStyleValue(`---color-${t.response}`):"outcome"===this.color?this.getComputedStyleValue(`---color-${t.outcome}`):this.getComputedStyleValue("---color-acc"));return t=>a(r(cubicIn)(t))})).attrTween("fill",((t,e,n)=>{const i=n[e],a=interpolateRgb(i.getAttribute("fill"),"stimulus"===this.color?"present"===t.signal?this.getComputedStyleValue("---color-hr-light"):this.getComputedStyleValue("---color-far-light"):"response"===this.color?this.getComputedStyleValue(`---color-${t.response}-light`):"outcome"===this.color?this.getComputedStyleValue(`---color-${t.outcome}-light`):this.getComputedStyleValue("---color-acc-light"));return t=>a(r(cubicIn)(t))})).attrTween("x",((t,e,n)=>{const i=interpolate$1(n[e].getAttribute("x"),h(t.binValue)+1.5);return t=>i(r(cubicOut)(t))})).attrTween("y",((t,e,n)=>{const i=interpolate$1(n[e].getAttribute("y"),d(0)+1.5-(t.binCount+1)*p);return t=>i(r(cubicIn)(t))})).on("end",((t,e,r)=>{r[e].removeAttribute("data-new-trial-ease-time"),t.new=!1,this.alignTrial(t),this.dispatchEvent(new CustomEvent("detectable-response",{detail:{stimulus:t.signal,response:t.response,outcome:t.outcome,h:this.h,m:this.m,fa:this.fa,cr:this.cr,nr:0},bubbles:!0}))}))}const o=a.filter((t=>t.new&&t.paused));if(!o.empty()){const t=o.attr("data-new-trial-ease-time");o.transition().duration(u).ease(cubicOut).attr("x",(e=>interpolate$1(0,h(e.binValue)+1.5)(cubicOut(t)))).attr("y",(e=>interpolate$1(0,d(0)+1.5-(e.binCount+1)*p)(cubicIn(t)))).attr("stroke",(e=>interpolateRgb(this.getComputedStyleValue("---color-acc"),"stimulus"===this.color?"present"===e.signal?this.getComputedStyleValue("---color-hr"):this.getComputedStyleValue("---color-far"):"response"===this.color?this.getComputedStyleValue(`---color-${e.response}`):"outcome"===this.color?this.getComputedStyleValue(`---color-${e.outcome}`):this.getComputedStyleValue("---color-acc"))(cubicIn(t)))).attr("fill",(e=>interpolateRgb(this.getComputedStyleValue("---color-acc-light"),"stimulus"===this.color?"present"===e.signal?this.getComputedStyleValue("---color-hr-light"):this.getComputedStyleValue("---color-far-light"):"response"===this.color?this.getComputedStyleValue(`---color-${e.response}-light`):"outcome"===this.color?this.getComputedStyleValue(`---color-${e.outcome}-light`):this.getComputedStyleValue("---color-acc-light"))(cubicIn(t))))}a.filter((t=>!t.new)).transition().duration(u).ease(cubicOut).attr("x",(t=>h(t.binValue)+1.5)).attr("y",(t=>d(0)+1.5-(t.binCount+1)*p)).attr("stroke",(t=>"stimulus"===this.color?"present"===t.signal?this.getComputedStyleValue("---color-hr"):this.getComputedStyleValue("---color-far"):"response"===this.color?this.getComputedStyleValue(`---color-${t.response}`):"outcome"===this.color?this.getComputedStyleValue(`---color-${t.outcome}`):this.getComputedStyleValue("---color-acc"))).attr("fill",(t=>"stimulus"===this.color?"present"===t.signal?this.getComputedStyleValue("---color-hr-light"):this.getComputedStyleValue("---color-far-light"):"response"===this.color?this.getComputedStyleValue(`---color-${t.response}-light`):"outcome"===this.color?this.getComputedStyleValue(`---color-${t.outcome}-light`):this.getComputedStyleValue("---color-acc-light"))),i.exit().transition().duration(u).ease(linear$1).attrTween("stroke",((t,e,r)=>{const n=r[e],i=interpolateRgb(n.getAttribute("stroke"),this.getComputedStyleValue("---color-acc"));return t=>i(cubicIn(t))})).attrTween("fill",((t,e,r)=>{const n=r[e],i=interpolateRgb(n.getAttribute("fill"),this.getComputedStyleValue("---color-acc-light"));return t=>i(cubicIn(t))})).attrTween("x",((t,e,r)=>{const n=interpolate$1(r[e].getAttribute("x"),0);return t=>n(cubicIn(t))})).attrTween("y",((t,e,r)=>{const n=interpolate$1(r[e].getAttribute("y"),0);return t=>n(cubicOut(t))})).remove()}const et=w.append("g").classed("overlayer",!0),rt=S.select(".overlayer");et.append("rect").classed("background",!0),rt.select(".background").attr("height",l).attr("width",c),this.drag=!1,this.firstUpdate=!1}pauseTrial(){const t=select(this.renderRoot).select(".trial[data-new-trial-ease-time]");t.interrupt("new"),t.datum((t=>(t.paused=!0,t)))}resumeTrial(){select(this.renderRoot).select(".trial[data-new-trial-ease-time]").datum((t=>(t.paused=!1,t))),this.requestUpdate()}}customElements.define("sdt-model",SDTModel);class DetectableTable extends DetectableElement{static get properties(){return{numeric:{attribute:"numeric",type:Boolean,reflect:!0},summary:{attribute:"summary",converter:DecidablesConverterSet,reflect:!0},color:{attribute:"color",type:String,reflect:!0},h:{attribute:"hits",type:Number,reflect:!0},m:{attribute:"misses",type:Number,reflect:!0},fa:{attribute:"false-alarms",type:Number,reflect:!0},cr:{attribute:"correct-rejections",type:Number,reflect:!0},payoff:{attribute:"payoff",type:Boolean,reflect:!0},hPayoff:{attribute:"hit-payoff",type:Number,reflect:!0},mPayoff:{attribute:"miss-payoff",type:Number,reflect:!0},faPayoff:{attribute:"false-alarm-payoff",type:Number,reflect:!0},crPayoff:{attribute:"correct-rejection-payoff",type:Number,reflect:!0},far:{attribute:!1,type:Number,reflect:!1},hr:{attribute:!1,type:Number,reflect:!1},acc:{attribute:!1,type:Number,reflect:!1},ppv:{attribute:!1,type:Number,reflect:!1},fomr:{attribute:!1,type:Number,reflect:!1}}}constructor(){super(),this.numeric=!1,this.summaries=["stimulusRates","responseRates","accuracy"],this.summary=new Set,this.colors=["none","accuracy","stimulus","response","outcome","all"],this.color="all",this.payoff=!1,this.hPayoff=void 0,this.mPayoff=void 0,this.crPayoff=void 0,this.faPayoff=void 0,this.h=40,this.m=60,this.fa=75,this.cr=25,this.alignState()}alignState(){this.hr=SDTMath.hM2Hr(this.h,this.m),this.far=SDTMath.faCr2Far(this.fa,this.cr),this.acc=SDTMath.hMFaCr2Acc(this.h,this.m,this.fa,this.cr),this.ppv=SDTMath.hFa2Ppv(this.h,this.fa),this.fomr=SDTMath.mCr2Fomr(this.m,this.cr)}sendEvent(){this.dispatchEvent(new CustomEvent("detectable-table-change",{detail:{h:this.h,m:this.m,hr:this.hr,fa:this.fa,cr:this.cr,far:this.far,acc:this.acc,ppv:this.ppv,fomr:this.fomr},bubbles:!0}))}hInput(t){this.h=parseInt(t.target.value,10),this.alignState(),this.sendEvent()}mInput(t){this.m=parseInt(t.target.value,10),this.alignState(),this.sendEvent()}faInput(t){this.fa=parseInt(t.target.value,10),this.alignState(),this.sendEvent()}crInput(t){this.cr=parseInt(t.target.value,10),this.alignState(),this.sendEvent()}hrInput(t){const e=parseFloat(t.target.value),r=this.h+this.m;this.h=Math.round(e*r),this.m=r-this.h,this.alignState(),this.sendEvent()}farInput(t){const e=parseFloat(t.target.value),r=this.fa+this.cr;this.fa=Math.round(e*r),this.cr=r-this.fa,this.alignState(),this.sendEvent()}accInput(t){const e=parseFloat(t.target.value),r=this.h+this.m,n=this.fa+this.cr,i=(this.hr+this.far-1)/2;let a=i+e,s=1+i-e;s>1&&(s=1,a=s+2*e-1),s<0&&(s=0,a=s+2*e-1),a>1&&(a=1,s=a-2*e+1),a<0&&(a=0,s=a-2*e+1),this.h=Math.round(a*r),this.m=r-this.h,this.fa=Math.round(s*n),this.cr=n-this.fa,this.alignState(),this.sendEvent()}ppvInput(t){const e=parseFloat(t.target.value),r=this.h+this.fa;this.h=Math.round(e*r),this.fa=r-this.h,this.alignState(),this.sendEvent()}fomrInput(t){const e=parseFloat(t.target.value),r=this.m+this.cr;this.m=Math.round(e*r),this.cr=r-this.m,this.alignState(),this.sendEvent()}static get styles(){return[super.styles,i$2`
      ...
      `]}willUpdate(){this.alignState()}render(){const t=new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",minimumFractionDigits:0,maximumFractionDigits:0}),e=e=>t.formatToParts(e).map((({type:t,value:e})=>"minusSign"===t?"−":e)).reduce(((t,e)=>t+e));let r,n,i,a,s,o,l,c,u;return this.numeric?(r=x$1`
    ...
    `}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver((t=>{t.some((t=>"childList"===t.type||"attributes"===t.type&&t.target!==this))&&this.requestUpdate()})),this.mutationObserver.observe(this,{subtree:!0,childList:!0,attributes:!0})}disconnectedCallback(){this.mutationObserver.disconnect(),super.disconnectedCallback()}update(t){if(super.update(t),Number.isNaN(this.width)||Number.isNaN(this.height)||Number.isNaN(this.rem))return;const e=this.width,r=this.height,n=Math.min(e,r),i=n-(0+0),a=n-(0+0),s=this.querySelectorAll("risky-outcome"),o=s.length?-s[0].p:0,l=pie().startAngle(o*Math.PI-Math.PI).endAngle(o*Math.PI+Math.PI).sortValues(null).value((t=>t.p))(s),c=l.filter((t=>!t.data.interactive)),u=l.filter((t=>t.data.interactive));function h(t){const e=(t+2*Math.PI)%(2*Math.PI);return e>Math.PI?e-2*Math.PI:e<-Math.PI?e+2*Math.PI:e}const d=drag().subject(((t,e)=>{const r=h((e.endAngle+e.startAngle)/2),n=h(Math.atan2(t.y,t.x)+Math.PI/2);return s.forEach((t=>{t.startP=t.p})),{arcAngle:r,startAngle:h(n-r)}})).on("start",((t,e)=>{if(!e.data.interactive)return;select(t.currentTarget).classed("dragging",!0)})).on("drag",((t,e)=>{if(!e.data.interactive)return;const r=h(Math.atan2(t.y,t.x)+Math.PI/2),n=h(r-t.subject.arcAngle),i=h(t.subject.startAngle>0?n-t.subject.startAngle:t.subject.startAngle-n)/Math.PI,a=e.data.startP+i,o=a>.99?.99:a<.01?.01:a;s.forEach((t=>{t.p=t===e.data?o:t.startP/(1-e.data.startP)*(1-o)})),this.dispatchEvent(new CustomEvent("risky-outcome-change",{detail:{x:e.data.x,p:e.data.p,name:e.data.name},bubbles:!0}))})).on("end",((t,e)=>{if(!e.data.interactive)return;select(t.currentTarget).classed("dragging",!1)})),p=select(this.renderRoot).selectAll(".main").data([{width:this.width,height:this.height,rem:this.rem}]),f=p.enter().append("svg").classed("main",!0),m=f.merge(p).attr("viewBox",`0 0 ${n} ${n}`),g=f.append("g").classed("pie",!0),y=m.select(".pie").attr("transform",`translate(${a/2}, ${i/2})`);g.append("circle").classed("outline",!0),y.select(".outline").attr("r",Math.min(a,i)/2-1);const b=y.selectAll(".arc").data(l),$=b.enter().append("path").call(d).on("keydown",((t,e)=>{if(["ArrowUp","ArrowDown"].includes(t.key)){const r=e.data.p;let n=e.data.p;switch(t.key){case"ArrowUp":n-=t.shiftKey?.01:.05;break;case"ArrowDown":n+=t.shiftKey?.01:.05}const i=n>.99?.99:n<.01?.01:n;s.forEach((t=>{t.p=t===e.data?i:t.p/(1-r)*(1-i)})),this.dispatchEvent(new CustomEvent("risky-outcome-change",{detail:{x:e.data.x,p:e.data.p,name:e.data.name},bubbles:!0})),t.preventDefault()}}));$.merge(b).attr("tabindex",(t=>u.includes(t)&&l.length>1?0:null)).attr("class",(t=>`arc ${t.data.name}`)).classed("interactive",(t=>u.includes(t)&&l.length>1)).attr("d",arc().innerRadius(0).outerRadius(Math.min(a,i)/2-1)),b.exit().remove();const v=y.selectAll(".label.static").data(c),x=y.selectAll(".label.interactive").data(u),w=v.enter().append("text"),S=x.enter().append("foreignObject");S.append("xhtml:decidables-spinner").on("input",((t,e)=>{e.data.x=parseFloat(t.target.value),this.dispatchEvent(new CustomEvent("risky-outcome-change",{detail:{x:e.data.x,p:e.data.p,name:e.data.name},bubbles:!0}))})),w.merge(v).attr("class",(t=>`label static ${t.data.name}`)).attr("transform",(t=>{if(1===l.length)return"translate(0, 0)";const e=Math.min(a,i)/2*.6;return`translate(${arc().innerRadius(e).outerRadius(e).centroid(t)})`})).text((t=>`$${t.data.x.toFixed(0)}`));const E=S.merge(x).attr("class",(t=>`label interactive ${t.data.name}`)).attr("transform",(t=>{const e=parseFloat(this.getComputedStyleValue("--decidables-spinner-input-width")),r=parseFloat(this.getComputedStyleValue("--decidables-spinner-font-size")),n=parseFloat(getComputedStyle(document.documentElement).getPropertyValue("font-size"),10),s=e*n/-2,o=r*n*1.5/-2;if(1===l.length)return`translate(${s}, ${o})`;const c=Math.min(a,i)/2*.6,u=arc().innerRadius(c).outerRadius(c);return`translate(${u.centroid(t)[0]+s}, ${u.centroid(t)[1]+o})`}));E.select("decidables-spinner").attr("value",(t=>`${t.data.x.toFixed(0)}`)),v.exit().remove(),x.exit().remove()}}customElements.define("risky-option",RiskyOption);class RiskyOutcome extends ProspectableElement{static get properties(){return{x:{attribute:"value",type:Number,reflect:!0},p:{attribute:"probability",type:Number,reflect:!0},name:{attribute:"name",type:String,reflect:!0}}}constructor(){super(),this.x=0,this.p=0,this.name=""}static get styles(){return[i$2`
      ...
      `]}render(){return x$1``}willUpdate(){this.alignState()}update(t){if(super.update(t),Number.isNaN(this.width)||Number.isNaN(this.height)||Number.isNaN(this.rem))return;const e=this.width,r=this.height;let n,i;e/r>1.8?(i=r,n=1.8*i):(n=e,i=n/1.8);const a=2*this.rem,s=3*this.rem,o=3*this.rem,l=i-(a+s),c=n-(o+2*this.rem),u=parseInt(this.getComputedStyleValue("---transition-duration"),10),h=linear().domain([this.scale.time.min,this.scale.time.max]).range([0,c]),d=linear().domain([this.scale.value.min,this.scale.value.max]).range([l,0]),p=line().x((t=>h(t.d))).y((t=>d(t.v))),f=select(this.renderRoot).selectAll(".main").data([{width:this.width,height:this.height,rem:this.rem}]),m=f.enter().append("svg").classed("main",!0);m.html(DiscountableElement.svgDefs);const g=m.merge(f).attr("viewBox",`0 0 ${n} ${i}`),y=m.append("g").classed("plot",!0),b=g.select(".plot").attr("transform",`translate(${o}, ${a})`);y.append("clipPath").attr("id","clip-htd-curves").append("rect"),b.select("clipPath rect").attr("height",l+1).attr("width",c+1);const $=y.append("g").classed("underlayer",!0),v=b.select(".underlayer");$.append("rect").classed("background",!0),v.select(".background").attr("height",l).attr("width",c),$.append("g").classed("axis-x",!0);v.select(".axis-x").attr("transform",`translate(0, ${d(0)})`).transition().duration(2*u).ease(cubicOut).call(axisBottom(h)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null);const x=$.append("text").classed("title-x",!0).attr("text-anchor","middle");x.append("tspan").classed("name",!0).text("Delay ("),x.append("tspan").classed("math-var d",!0).text("D"),x.append("tspan").classed("name",!0).text(")"),v.select(".title-x").attr("transform",`translate(${c/2}, ${l+2.25*this.rem})`),$.append("g").classed("axis-y",!0);v.select(".axis-y").transition().duration(2*u).ease(cubicOut).call(axisLeft(d)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null);const w=$.append("text").classed("title-y",!0).attr("text-anchor","middle");w.append("tspan").classed("name",!0).text("Value ("),w.append("tspan").classed("math-var v",!0).text("V"),w.append("tspan").classed("name",!0).text(")"),v.select(".title-y").attr("transform",`translate(${-2*this.rem}, ${l/2})rotate(-90)`),y.append("g").classed("content",!0);const S=b.select(".content").selectAll(".option").data(this.options.filter((t=>null!==t.a&&null!==t.d)),(t=>t.name)),E=S.enter().append("g").classed("option",!0);E.append("path").classed("curve",!0).attr("clip-path","url(#clip-htd-curves)").attr("d",(t=>{const e=range(h(t.d),h(0),-1).map((e=>({d:h.invert(e),v:HTDMath.adk2v(t.a,t.d-h.invert(e),this.k)})));return p(e)})).attr("stroke-dasharray",((t,e,r)=>{if(t.trial){return`0,${r[e].getTotalLength()}`}return"none"})),E.append("line").classed("bar",!0).attr("x1",(t=>h(t.d))).attr("x2",(t=>h(t.d))).attr("y1",d(0)).attr("y2",(t=>d(t.a))).attr("stroke-dasharray",((t,e,r)=>{if(t.trial){return`0,${r[e].getTotalLength()}`}return"none"}));const T=E.append("g").classed("point",!0).attr("transform",(t=>`translate(${h(t.d)}, ${d(t.a)})`)).attr("opacity",(t=>t.trial?0:1));T.append("circle").classed("mark",!0),T.append("text").classed("label",!0);const _=E.merge(S);_.filter(((t,e,r)=>this.interactive&&!r[e].classList.contains("interactive"))).select(".curve").classed("interactive",!0).attr("tabindex",0).call(drag().subject((t=>({x:t.x,y:t.y}))).on("start",(t=>{select(t.currentTarget).classed("dragging",!0)})).on("drag",((t,e)=>{this.drag=!0;const r=e.d-h.invert(t.x),n=r<0?0:r>e.d?e.d:r,i=d.invert(t.y),a=i<=0?.001:i>e.a?e.a:i,s=HTDMath.adv2k(e.a,n,a);this.k=s<this.scale.discount.min?this.scale.discount.min:s>this.scale.discount.max?this.scale.discount.max:this.scale.discount.round(s),this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("htd-curves-change",{detail:{name:e.name,a:e.a,d:e.d,k:this.k,label:e.label},bubbles:!0}))})).on("end",(t=>{select(t.currentTarget).classed("dragging",!1)}))).on("keydown",((t,e)=>{if(["ArrowUp","ArrowDown","ArrowRight","ArrowLeft"].includes(t.key)){let r=this.k;switch(t.key){case"ArrowUp":case"ArrowLeft":r*=t.shiftKey?.95:.85;break;case"ArrowDown":case"ArrowRight":r*=t.shiftKey?1.05:1.15}r=r<this.scale.discount.min?this.scale.discount.min:r>this.scale.discount.max?this.scale.discount.max:this.scale.discount.round(r),r!==this.k&&(this.k=r,this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("htd-curves-change",{detail:{name:e.name,a:e.a,d:e.d,k:this.k,label:e.label},bubbles:!0}))),t.preventDefault()}})),_.filter(((t,e,r)=>this.interactive&&!t.trial&&!r[e].classList.contains("interactive"))).select(".bar").classed("interactive",!0).attr("tabindex",0).call(drag().subject(((t,e)=>({x:h(e.d),y:d(e.a)}))).on("start",(t=>{select(t.currentTarget).classed("dragging",!0)})).on("drag",((t,e)=>{this.drag=!0;const r=h.invert(t.x);e.d=r<this.scale.time.min?this.scale.time.min:r>this.scale.time.max?this.scale.time.max:this.scale.time.round(r),"default"===e.name&&(this.d=e.d),this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("htd-curves-change",{detail:{name:e.name,a:e.a,d:e.d,k:this.k,label:e.label},bubbles:!0}))})).on("end",(t=>{select(t.currentTarget).classed("dragging",!1)}))).on("keydown",((t,e)=>{if(["ArrowLeft","ArrowRight"].includes(t.key)){let r=e.d;switch(t.key){case"ArrowRight":r+=t.shiftKey?1:5;break;case"ArrowLeft":r-=t.shiftKey?1:5}r=r<this.scale.time.min?this.scale.time.min:r>this.scale.time.max?this.scale.time.max:r,r!==e.d&&(e.d=r,"default"===e.name&&(this.d=e.d),this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("htd-curves-change",{detail:{name:e.name,a:e.a,d:e.d,k:this.k,label:e.label},bubbles:!0}))),t.preventDefault()}})),_.filter(((t,e,r)=>this.interactive&&!t.trial&&!r[e].classList.contains("interactive"))).select(".point").classed("interactive",!0).attr("tabindex",0).call(drag().subject(((t,e)=>({x:h(e.d),y:d(e.a)}))).on("start",(t=>{select(t.currentTarget).classed("dragging",!0)})).on("drag",((t,e)=>{this.drag=!0;const r=d.invert(t.y);e.a=r<this.scale.value.min?this.scale.value.min:r>this.scale.value.max?this.scale.value.max:this.scale.value.round(r),"default"===e.name&&(this.a=e.a),this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("htd-curves-change",{detail:{name:e.name,a:e.a,d:e.d,k:this.k,label:e.label},bubbles:!0}))})).on("end",(t=>{select(t.currentTarget).classed("dragging",!1)}))).on("keydown",((t,e)=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let r=e.a;switch(t.key){case"ArrowUp":r+=t.shiftKey?1:5;break;case"ArrowDown":r-=t.shiftKey?1:5}r=r<this.scale.value.min?this.scale.value.min:r>this.scale.value.max?this.scale.value.max:r,r!==e.a&&(e.a=r,"default"===e.name&&(this.a=e.a),this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("htd-curves-change",{detail:{name:e.name,a:e.a,d:e.d,k:this.k,label:e.label},bubbles:!0}))),t.preventDefault()}})),_.filter(((t,e,r)=>!this.interactive&&r[e].classList.contains("interactive"))).select(".curve").classed("interactive",!1).attr("tabindex",null).on("drag",null).on("keydown",null),_.filter(((t,e,r)=>(!this.interactive||t.trial)&&r[e].classList.contains("interactive"))).select(".bar").classed("interactive",!1).attr("tabindex",null).on("drag",null).on("keydown",null),_.filter(((t,e,r)=>(!this.interactive||t.trial)&&r[e].classList.contains("interactive"))).select(".point").classed("interactive",!1).attr("tabindex",null).on("drag",null).on("keydown",null),_.filter((t=>t.new)).select(".curve").transition().duration(u).delay(u+u/10).ease(linear$1).attrTween("stroke-dasharray",((t,e,r)=>{const n=r[e].getTotalLength();return interpolate$1(`0,${n}`,`${n},0`)})).on("end",(t=>{t.new=!1,this.dispatchEvent(new CustomEvent("discountable-response",{detail:{trial:this.trialCount,as:this.as,ds:this.ds,al:this.al,dl:this.dl,response:this.response},bubbles:!0}))})),_.filter((t=>t.new)).select(".bar").transition().duration(u).ease(linear$1).attrTween("stroke-dasharray",((t,e,r)=>{const n=r[e].getTotalLength();return interpolate$1(`0,${n}`,`${n},${n}`)})),_.filter((t=>t.new)).select(".point").transition().duration(u/10).delay(u).ease(linear$1).attrTween("opacity",(()=>interpolate$1(0,1))),S.select(".curve").transition().duration(this.drag?0:this.firstUpdate?2*u:u).ease(cubicOut).attrTween("d",((t,e,r)=>{const n=r[e],i=interpolate$1(void 0!==n.a?n.a:t.a,t.a),a=interpolate$1(void 0!==n.d?n.d:t.d,t.d);return t=>{n.a=i(t),n.d=a(t);const e=range(h(n.d),h(0),-1).map((t=>({d:h.invert(t),v:HTDMath.adk2v(n.a,n.d-h.invert(t),this.k)})));return p(e)}})),S.select(".bar").transition().duration(this.drag?0:this.firstUpdate?2*u:u).ease(cubicOut).attrTween("x1",((t,e,r)=>{const n=r[e],i=interpolate$1(void 0!==n.d?n.d:t.d,t.d);return t=>(n.d=i(t),`${h(n.d)}`)})).attrTween("x2",((t,e,r)=>{const n=r[e],i=interpolate$1(void 0!==n.d?n.d:t.d,t.d);return t=>(n.d=i(t),`${h(n.d)}`)})).attrTween("y2",((t,e,r)=>{const n=r[e],i=interpolate$1(void 0!==n.a?n.a:t.a,t.a);return t=>(n.a=i(t),`${d(n.a)}`)})),S.select(".point").transition().duration(this.drag?0:this.firstUpdate?2*u:u).ease(cubicOut).attrTween("transform",((t,e,r)=>{const n=r[e],i=interpolate$1(void 0!==n.d?n.d:t.d,t.d),a=interpolate$1(void 0!==n.a?n.a:t.a,t.a);return t=>(n.d=i(t),n.a=a(t),`translate(${h(n.d)}, ${d(n.a)})`)})),_.select(".point .label").text((t=>t.label)),S.exit().remove(),this.drag=!1,this.firstUpdate=!1}}customElements.define("htd-curves",HTDCurves);class ITCOption extends DiscountableElement{static get properties(){return{state:{attribute:"state",type:String,reflect:!0},a:{attribute:"amount",type:Number,reflect:!0},d:{attribute:"delay",type:Number,reflect:!0}}}constructor(){super(),this.states=["choice","fixation","blank"],this.state="choice",this.a=0,this.d=0}static get styles(){return[super.styles,i$2`
        :host {
          display: inline-block;
    ...
    `}}customElements.define("itc-option",ITCOption);class ITCChoice extends DiscountableElement{static get properties(){return{state:{attribute:"state",type:String,reflect:!0},as:{attribute:"amount-ss",type:Number,reflect:!0},ds:{attribute:"delay-ss",type:Number,reflect:!0},al:{attribute:"amount-ll",type:Number,reflect:!0},dl:{attribute:"delay-ll",type:Number,reflect:!0}}}constructor(){super(),this.states=["choice","fixation","blank"],this.state="choice",this.as=10,this.ds=5,this.al=40,this.dl=30}static get styles(){return[super.styles,i$2`
      ...
      `]}render(){return x$1``}willUpdate(){this.alignState()}update(t){if(super.update(t),Number.isNaN(this.width)||Number.isNaN(this.height)||Number.isNaN(this.rem))return;const e=this.width,r=this.height;let n,i;e/r>1.5?(i=r,n=1.5*i):(n=e,i=n/1.5);const a=1*this.rem,s=3*this.rem,o=3.75*this.rem,l=3.25*this.rem,c=i-(a+s),u=n-(o+l),h=.75*this.rem,d=.5*c,p=.25*c-h,f=.75*this.rem,m=.9*u,g=.1*u-f,y=parseInt(this.getComputedStyleValue("---transition-duration"),10),b=linear().domain([this.scale.time.min,this.scale.time.max]).range([0,m]),$=linear().domain([this.scale.evidence.min,this.scale.evidence.max]).range([d,0]),v=linear().domain([this.scale.density.min,this.scale.density.max]).range([p,0]),x=linear().domain([this.scale.density.min,this.scale.density.max]).range([0,p]),w=linear().domain([0,1]).range([0,c]),S=drag().subject(((t,e)=>({x:b(e.t0),y:$(e.startingPoint)}))).on("start",(t=>{select(t.currentTarget).classed("dragging",!0)})).on("drag",(t=>{this.drag=!0;const e=!!t.sourceEvent.shiftKey&&(Math.abs(t.x-t.subject.x)>Math.abs(t.y-t.subject.y)?"t0":"z");let r=b.invert(t.x),n=($.invert(t.y)+this.a/2)/this.a;r="z"===e?b.invert(t.subject.x):r<0?0:r>500?500:r,n="t0"===e?($.invert(t.subject.y)+this.a/2)/this.a:n<.01?.01:n>.99?.99:n,this.t0=r,this.z=n,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-t0",{detail:{t0:this.t0},bubbles:!0})),this.dispatchEvent(new CustomEvent("ddm-model-z",{detail:{z:this.z},bubbles:!0}))})).on("end",(t=>{select(t.currentTarget).classed("dragging",!1),this.drag=!1})),E=drag().on("start",(t=>{select(t.currentTarget).classed("dragging",!0)})).on("drag",(t=>{this.drag=!0;let e=($.invert(t.y)-this.startingPoint)/(b.invert(t.x)-this.t0)*1e3;e=e<.01?.01:e>5?5:e,this.v=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-v",{detail:{v:this.v},bubbles:!0}))})).on("end",(t=>{select(t.currentTarget).classed("dragging",!1),this.drag=!1})),T=drag().subject(((t,e)=>({x:0,y:$(e.value)}))).on("start",(t=>{select(t.currentTarget).classed("dragging",!0)})).on("drag",((t,e)=>{this.drag=!0;let r=$.invert(t.y);r=r<this.scale.evidence.min?this.scale.evidence.min:r>this.scale.evidence.max?this.scale.evidence.max:"upper"===e.bound&&r<.005?.005:"lower"===e.bound&&r>-.005?-.005:r,this.a=Math.abs(2*r),this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-a",{detail:{a:this.a},bubbles:!0}))})).on("end",(t=>{select(t.currentTarget).classed("dragging",!1),this.drag=!1})),_=line().x((t=>b(t.t))).y((t=>$(t.e))),A=line().x((t=>b(t.t))).y((t=>v(t.d))),R=line().x((t=>b(t.t))).y((t=>x(t.d))),k=select(this.renderRoot).selectAll(".main").data([{width:this.width,height:this.height,rem:this.rem}]),C=k.enter().append("svg").classed("main",!0).html(AccumulableElement.svgDefs),O=C.append("defs");O.append("marker").attr("id","measure-arrow").attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","2").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10").append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("d","M -3 -3 l 6 3 l -6 3 z"),O.append("marker").attr("id","model-sd-cap").attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","0").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10").append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("stroke-width","2").attr("d","M 0 -4 l 0 8"),O.append("marker").attr("id","data-sd-cap").attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","0").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10").append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("stroke-width","2").attr("d","M 0 -3 l 0 6");const M=O.append("linearGradient").attr("id","path-animate").attr("gradientUnits","userSpaceOnUse").attr("color-interpolation","linearRGB").attr("x1","0").attr("x2","0").attr("y1",$(this.bounds.upper)).attr("y2",$(this.bounds.lower));M.append("stop").classed("stop-0",!0).attr("offset","0%"),M.append("stop").classed("stop-100",!0).attr("offset","100%");const N=C.merge(k).attr("viewBox",`0 0 ${n} ${i}`),P=N.selectAll(".plot.density").data([{outcome:"correct",data:{meanRT:this.data.correctMeanRT,sdRT:this.data.correctSDRT},model:{meanRT:this.model.correctMeanRT,sdRT:this.model.correctSDRT,dist:this.model.correctDist},densityScale:v,densityLine:A,alignDistribution:this.alignCorrectDistribution.bind(this)},{outcome:"error",data:{meanRT:this.data.errorMeanRT,sdRT:this.data.errorSDRT},model:{meanRT:this.model.errorMeanRT,sdRT:this.model.errorSDRT,dist:this.model.errorDist},densityScale:x,densityLine:R,alignDistribution:this.alignErrorDistribution.bind(this)}]),I=C.append("g").classed("plot evidence",!0),D=P.enter().append("g").attr("class",(t=>`plot density ${t.outcome}`)),L=C.append("g").classed("plot accuracy",!0),U=N.select(".plot.evidence").attr("transform",`translate(${o}, ${a+p+h})`),j=D.merge(P).attr("transform",(t=>`translate(${o}, ${"correct"===t.outcome?a:a+p+d+2*h})`)),F=N.select(".plot.accuracy").attr("transform",`translate(${o+m+f}, ${a})`);I.append("clipPath").attr("id","clip-evidence").append("rect"),U.select("clipPath rect").attr("y",$(this.bounds.upper)).attr("height",$(this.bounds.lower)-$(this.bounds.upper)+1).attr("width",m+1);const B=I.append("g").classed("underlayer",!0),z=D.append("g").classed("underlayer",!0),V=L.append("g").classed("underlayer",!0),H=U.select(".underlayer"),q=j.select(".underlayer"),K=F.select(".underlayer");I.append("g").classed("content",!0).append("g").classed("paths",!0);const G=D.append("g").classed("content",!0);L.append("g").classed("content",!0);const Y=U.select(".content"),W=j.select(".content"),X=F.select(".content");I.append("g").classed("overlayer",!0),D.append("g").classed("overlayer",!0),L.append("g").classed("overlayer",!0);const Z=U.select(".overlayer"),Q=j.select(".overlayer");B.append("rect").classed("background",!0),z.append("rect").classed("background",!0),H.select(".background").transition().duration(this.drag?0:y).ease(cubicOut).attr("y",$(this.bounds.upper)).attr("height",$(this.bounds.lower)-$(this.bounds.upper)).attr("width",m),q.select(".background").transition().duration(y).ease(cubicOut).attr("height",p).attr("width",m),z.filter((t=>"error"===t.outcome)).append("g").classed("axis time",!0);const J=q.filter((t=>"error"===t.outcome)).select(".axis.time").attr("transform",`translate(0, ${p+.25*this.rem})`);J.transition().duration(y).ease(cubicOut).call(axisBottom(b)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null);const tt=z.filter((t=>"error"===t.outcome)).append("text").classed("title time",!0).attr("text-anchor","middle");tt.append("tspan").classed("name",!0).text("Time (ms)"),q.filter((t=>"error"===t.outcome)).select(".title.time").transition().duration(y).ease(cubicOut).attr("transform",`translate(${m/2}, ${p+2.5*this.rem})`),B.append("g").classed("axis evidence",!0),z.append("g").attr("class",(t=>`axis density ${t.outcome}`)),V.append("g").classed("axis accuracy",!0);const et=H.select(".axis.evidence").attr("transform",`translate(${-.25*this.rem}, 0)`),rt=q.select(".axis.density").attr("transform",`translate(${-.25*this.rem}, 0)`),nt=K.select(".axis.accuracy").attr("transform",`translate(${g+.25*this.rem}, 0)`),it=et.transition().duration(y).ease(cubicOut).call(axisLeft($)).attr("font-size",null).attr("font-family",null),at=rt.transition().duration(y).ease(cubicOut).each(((t,e,r)=>{axisLeft(t.densityScale).ticks(2)(select(r[e]))})).attr("font-size",null).attr("font-family",null),st=nt.transition().duration(y).ease(cubicOut).call(axisRight(w)).attr("font-size",null).attr("font-family",null);it.selectAll("line, path").attr("stroke",null),at.selectAll("line, path").attr("stroke",null),st.selectAll("line, path").attr("stroke",null);const ot=B.append("text").classed("title evidence",!0).attr("text-anchor","middle"),lt=z.append("text").attr("class",(t=>`title density ${t.outcome}`)).attr("text-anchor","middle"),ct=V.append("text").classed("title accuracy",!0).attr("text-anchor","middle");ot.append("tspan").classed("name",!0).text("Evidence"),lt.append("tspan").classed("name",!0).text("Density"),ct.append("tspan").classed("name",!0).text("Accuracy"),H.select(".title.evidence").transition().duration(y).ease(cubicOut).attr("transform",`translate(${-2.5*this.rem}, ${d/2})rotate(-90)`),q.select(".title.density").transition().duration(y).ease(cubicOut).attr("transform",`translate(${-2.5*this.rem}, ${p/2})rotate(-90)`),K.select(".title.accuracy").transition().duration(y).ease(cubicOut).attr("transform",`translate(${g+2.25*this.rem}, ${c/2})rotate(90)`);const ut=Y.select(".paths").selectAll(".path").data(this.data.trials.filter((t=>void 0!==t.path))),ht=local(),dt=ut.enter().append("g").classed("path",!0).attr("data-new-trial-ease-time",0).on("pointerenter",((t,e)=>{if(!this.drag){select(t.currentTarget).classed("highlight",!0).raise();const r=Z.append("g").classed(`rt-label ${e.outcome}`,!0),n=r.append("rect"),i=r.append("text").text(`RT = ${e.rt.toFixed()}`).attr("x",b(e.rt)).attr("y","correct"===e.outcome?$(this.bounds.upper)-.25*this.rem:$(this.bounds.lower)+.125*this.rem).node().getBBox();n.attr("x",i.x-.125*this.rem).attr("y",i.y+.125*this.rem).attr("width",i.width+.25*this.rem).attr("height",i.height-.25*this.rem),ht.set(t.currentTarget,r)}})).on("pointerout",((t,e)=>{this.drag||(select(t.currentTarget).classed("highlight",!1).lower(),t.currentTarget.parentNode.insertBefore(t.currentTarget,t.currentTarget.parentNode.children[e.index]),ht.get(t.currentTarget).remove())}));dt.append("path").classed("curve",!0).attr("clip-path","url(#clip-evidence)").attr("pathLength",1).attr("stroke-dashoffset",1);const pt=dt.merge(ut).attr("class",(t=>`path ${t.outcome}`));pt.select(".curve").transition().duration(this.drag?0:y).ease(cubicOut).attr("stroke",(t=>this.getComputedStyleValue(`---color-${t.outcome}`))).attrTween("d",((t,e,r)=>{const n=r[e],i=interpolate$1(void 0!==n.a?n.a:this.a,this.a),a=interpolate$1(void 0!==n.z?n.z:this.z,this.z),s=interpolate$1(void 0!==n.v?n.v:this.v,this.v),o=interpolate$1(void 0!==n.t0?n.t0:this.t0,this.t0);return e=>{n.a=i(e),n.z=a(e),n.v=s(e),n.t0=o(e);const r=this.alignPath(t.seed,n.a,n.z,n.v,n.t0);return _(r)}}));const ft=pt.filter((t=>t.animate&&!this.paused));if(!ft.empty()){const t=ft.attr("data-new-trial-ease-time"),e=e=>linear().domain([0,1]).range([t,1])(e),r=e=>r=>linear().domain([e(t),1]).range([0,1])(e(r));ft.classed("animate",!0).select(".curve").attr("stroke-dasharray",1),ft.transition("new").duration((e=>Math.floor(1.5*e.rt*(1-t)))).ease(e).attr("data-new-trial-ease-time",1).select(".curve").attrTween("stroke-dashoffset",((t,e,n)=>{const i=interpolate$1(n[e].getAttribute("stroke-dashoffset"),0);return t=>i(r(linear$1)(t))})).on("end",((t,e,r)=>{select(r[e].parentElement).classed("animate",!1).attr("data-new-trial-ease-time",null),t.animate=!1,this.animate=!1,this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("accumulable-response",{detail:{outcome:t.outcome,data:this.data,model:this.model},bubbles:!0}))}))}const mt=pt.filter((t=>t.animate&&this.paused));if(!mt.empty()){const t=mt.attr("data-new-trial-ease-time");mt.classed("animate",!0).select(".curve").attr("stroke-dasharray",1).attr("stroke-dashoffset",(()=>interpolate$1(1,0)(linear$1(t))))}pt.filter((t=>!t.animate)).attr("data-new-trial-ease-time",null),ut.exit().remove();const gt=G.append("g").attr("class",(t=>`dist ${t.outcome}`));gt.append("path").classed("curve",!0),W.select(".dist").select(".curve").transition().duration(this.drag?0:y).ease(cubicOut).attrTween("d",((t,e,r)=>{const n=r[e],i=interpolate$1(void 0!==n.a?n.a:this.a,this.a),a=interpolate$1(void 0!==n.z?n.z:this.z,this.z),s=interpolate$1(void 0!==n.v?n.v:this.v,this.v),o=interpolate$1(void 0!==n.t0?n.t0:this.t0,this.t0);return e=>{n.a=i(e),n.z=a(e),n.v=s(e),n.t0=o(e);const r=t.alignDistribution(n.a,n.z,n.v,n.t0);return t.densityLine(r)}}));const yt=Y.selectAll(".rt").data(this.data.trials),bt=yt.enter().append("g");bt.append("line").classed("mark",!0).attr("x1",(t=>b(t.rt))).attr("x2",(t=>b(t.rt))).attr("y1",(t=>"correct"===t.outcome?$(1)-.125*this.rem:$(-1)+.125*this.rem)).attr("y2",(t=>"correct"===t.outcome?$(1)-.675*this.rem:$(-1)+.675*this.rem));const $t=bt.merge(yt).attr("class",(t=>`rt ${t.outcome}`));$t.filter((t=>!t.animate)).select(".mark").transition().duration(this.drag?0:y).ease(cubicOut).attr("stroke",(t=>this.getComputedStyleValue(`---color-${t.outcome}`))).attr("x1",(t=>b(t.rt))).attr("x2",(t=>b(t.rt))).attr("y1",(t=>"correct"===t.outcome?$(1)-.125*this.rem:$(-1)+.125*this.rem)).attr("y2",(t=>"correct"===t.outcome?$(1)-.675*this.rem:$(-1)+.675*this.rem)),yt.exit().remove();const vt=X.selectAll(".accuracy.model").data([this.model.accuracy,1-this.model.accuracy]),xt=vt.enter().append("g").attr("class",((t,e)=>"accuracy model "+(0===e?"correct":"error")));xt.append("rect").classed("bar",!0).attr("x",0),xt.merge(vt).select("rect").transition().duration(this.drag?0:y).ease(cubicOut).attr("y",((t,e)=>w(0===e?0:1-t))).attr("width",g).attr("height",(t=>w(t))),vt.exit().remove();const wt=X.selectAll(".accuracy.data").data(Number.isNaN(this.data.accuracy)?[]:[this.data.accuracy]),St=wt.enter().append("g").classed("accuracy data",!0);St.append("line").classed("mark",!0);const Et=St.merge(wt).attr("class",(t=>"accuracy data "+(t<this.model.accuracy.correct?"correct":"error")));Et.select(".mark").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",0+.25*this.rem).attr("x2",g-.25*this.rem).attr("y1",(t=>w(t)-1)).attr("y2",(t=>w(t)-1)),wt.exit().remove();const Tt=Z.selectAll(".boundary").data([{bound:"upper",value:this.bounds.upper},{bound:"lower",value:this.bounds.lower}]),_t=Tt.enter().append("g").attr("class",((t,e)=>"boundary "+(0===e?"correct":"error")));_t.append("line").classed("line",!0);const At=_t.merge(Tt).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?(t,e)=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let r=this.a;switch(t.key){case"ArrowUp":r+="upper"===e.bound?t.shiftKey?.01:.1:t.shiftKey?-.01:-.1;break;case"ArrowDown":r+="upper"===e.bound?t.shiftKey?-.01:-.1:t.shiftKey?.01:.1}r=r<.01?.01:r>2*this.scale.evidence.max?2*this.scale.evidence.max:r,this.a=r,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-a",{detail:{a:this.a},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?At.call(T):At.on(".drag",null)),At.select(".line").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",b(this.scale.time.min)).attr("x2",b(this.scale.time.max)).attr("y1",(t=>$(t.value))).attr("y2",(t=>$(t.value))),Tt.exit().remove();const Rt=Z.selectAll(".drift").data([{v:this.v,t0:this.t0,startingPoint:this.startingPoint}]),kt=Rt.enter().append("g").classed("drift",!0);kt.append("line").classed("line",!0),kt.append("path").classed("arrow",!0);const Ct=kt.merge(Rt).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?t=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let e=this.v;switch(t.key){case"ArrowUp":e+=t.shiftKey?.01:.1;break;case"ArrowDown":e-=t.shiftKey?.01:.1}e=e<.01?.01:e>5?5:e,this.v=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-v",{detail:{v:this.v},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?Ct.call(E):Ct.on(".drag",null));const Ot=($(0)-$(1))/(b(1)-b(0));Ct.transition().duration(this.drag?0:y).ease(cubicOut).attr("transform",(t=>`translate(${b(t.t0)}, ${$(t.startingPoint)})\n          rotate(${-Math.atan(t.v/1e3*Ot)*(180/Math.PI)})`)),Ct.select(".line").attr("x2",b(200)),Ct.select(".arrow").attr("d",`\n        M ${b(200)-.5*this.rem},${.5*-this.rem}\n        l ${.5*this.rem},${.5*this.rem}\n        l ${.5*-this.rem},${.5*this.rem}\n      `),Rt.exit().remove();const Mt=Z.selectAll(".t0z").data([{t0:this.t0,startingPoint:this.startingPoint}]),Nt=Mt.enter().append("g").classed("t0z",!0);Nt.append("line").classed("line",!0),Nt.append("circle").classed("point",!0);const Pt=Nt.merge(Mt).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?t=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let e=this.z;switch(t.key){case"ArrowUp":e+=t.shiftKey?.01:.1;break;case"ArrowDown":e-=t.shiftKey?.01:.1}e=e<.01?.01:e>.99?.99:e,this.z=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-z",{detail:{z:this.z},bubbles:!0})),t.preventDefault()}if(["ArrowLeft","ArrowRight"].includes(t.key)){let e=this.t0;switch(t.key){case"ArrowRight":e+=t.shiftKey?1:10;break;case"ArrowLeft":e-=t.shiftKey?1:10}e=e<0?0:e>500?500:e,this.t0=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-t0",{detail:{t0:this.t0},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?Pt.call(S):Pt.on(".drag",null)),Pt.select(".line").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",b(0)).attr("x2",(t=>b(t.t0))).attr("y1",(t=>$(t.startingPoint))).attr("y2",(t=>$(t.startingPoint))),Pt.select(".point").transition().duration(this.drag?0:y).ease(cubicOut).attr("cx",(t=>b(t.t0))).attr("cy",(t=>$(t.startingPoint))),Mt.exit().remove();const It=Z.selectAll(".measure.a").data(this.measures?[this.a]:[]),Dt=It.enter().append("g").classed("measure a",!0);Dt.append("line").classed("line",!0).attr("marker-start","url(#measure-arrow)").attr("marker-end","url(#measure-arrow)");const Lt=Dt.append("text").classed("label",!0);Lt.append("tspan").classed("a math-var",!0).text("a"),Lt.append("tspan").classed("equals",!0).text(" = "),Lt.append("tspan").classed("value",!0);const Ut=Dt.merge(It);Ut.select(".line").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",b(this.scale.time.max)-.75*this.rem).attr("y1",$(this.bounds.upper)+2).attr("x2",b(this.scale.time.max)-.75*this.rem).attr("y2",$(this.bounds.lower)-2);Ut.select(".label").transition().duration(this.drag?0:y).ease(cubicOut).attr("x",b(this.scale.time.max)).attr("y",$(this.bounds.upper)-.25*this.rem).select(".value").text(format(".2f")(this.a)),It.exit().remove();const jt=Z.selectAll(".measure.z").data(this.measures?[this.z]:[]),Ft=jt.enter().append("g").classed("measure z",!0);Ft.append("line").classed("line",!0).attr("marker-start","url(#measure-arrow)").attr("marker-end","url(#measure-arrow)");const Bt=Ft.append("text").classed("label",!0);Bt.append("tspan").classed("z math-var",!0).text("z"),Bt.append("tspan").classed("equals",!0).text(" = "),Bt.append("tspan").classed("value",!0);const zt=Ft.merge(jt);zt.select(".line").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",b(this.scale.time.min)+.75*this.rem).attr("y1",$(this.startingPoint)+2).attr("x2",b(this.scale.time.min)+.75*this.rem).attr("y2",$(this.bounds.lower)-2);zt.select(".label").transition().duration(this.drag?0:y).ease(cubicOut).attr("x",b(this.scale.time.min)).attr("y",$(this.bounds.lower)+.125*this.rem).select(".value").text(format(".0%")(this.z)),jt.exit().remove();const Vt=Z.selectAll(".measure.v").data(this.measures?[this.v]:[]),Ht=Vt.enter().append("g").classed("measure v",!0);Ht.append("path").classed("line",!0).attr("marker-start","url(#measure-arrow)").attr("marker-end","url(#measure-arrow)");const qt=Ht.append("text").classed("label",!0);qt.append("tspan").classed("v math-var",!0).text("v"),qt.append("tspan").classed("equals",!0).text(" = "),qt.append("tspan").classed("value",!0);const Kt=Math.atan(this.v/1e3*Ot),Gt=b(200)-b(0)+.75*this.rem,Yt=Math.cos(Kt)*Gt,Wt=Math.sin(Kt)*Gt,Xt=Ht.merge(Vt);Xt.select(".line").transition().duration(this.drag?0:y).ease(cubicOut).attr("d",`\n        M ${b(this.t0+200)+.75*this.rem}, ${$(this.startingPoint)}\n        A ${b(200)-b(0)} ${b(200)-b(0)} 0 0 0 ${b(this.t0)+Yt} ${$(this.startingPoint)-Wt}\n      `);Xt.select(".label").transition().duration(this.drag?0:y).ease(cubicOut).attr("x",b(this.t0+200)+.5*this.rem).attr("y",$(this.bounds.upper)-.25*this.rem).select(".value").text(format(".2f")(this.v)),Vt.exit().remove();const Zt=Z.selectAll(".measure.t0").data(this.measures?[this.t0]:[]),Qt=Zt.enter().append("g").classed("measure t0",!0);Qt.append("line").classed("line",!0).attr("marker-start","url(#measure-arrow)").attr("marker-end","url(#measure-arrow)");const Jt=Qt.append("text").classed("label",!0);Jt.append("tspan").classed("t0 math-var",!0).text("t₀"),Jt.append("tspan").classed("equals",!0).text(" = "),Jt.append("tspan").classed("value",!0);const te=Qt.merge(Zt);te.select(".line").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",b(0)+2).attr("y1",$(this.startingPoint)-.75*this.rem).attr("x2",b(this.t0)-2).attr("y2",$(this.startingPoint)-.75*this.rem);te.select(".label").transition().duration(this.drag?0:y).ease(cubicOut).attr("x",b(this.t0)+.25*this.rem).attr("y",$(this.bounds.upper)-.25*this.rem).select(".value").text(format("d")(this.t0)),Zt.exit().remove();const ee=Q.selectAll(".model.mean").data((t=>this.means?[t]:[])),re=ee.enter().append("g").attr("class",(t=>`model mean ${t.outcome}`));re.append("line").classed("indicator",!0);re.merge(ee).select(".indicator").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",(t=>b(t.model.meanRT))).attr("x2",(t=>b(t.model.meanRT))).attr("y1",(t=>t.densityScale(this.scale.density.min))).attr("y2",(t=>t.densityScale(this.scale.density.max))),ee.exit().remove();const ne=Q.selectAll(".data.mean").data((t=>this.means&&!Number.isNaN(t.data.meanRT)?[t]:[])),ie=ne.enter().append("g").attr("class",(t=>`data mean ${t.outcome}`));ie.append("line").classed("indicator",!0).attr("y1",(t=>t.densityScale(0)+("correct"===t.outcome?.125:-.125)*this.rem)).attr("y2",(t=>t.densityScale(0)+("correct"===t.outcome?.675:-.675)*this.rem));ie.merge(ne).select(".indicator").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",(t=>b(t.data.meanRT))).attr("x2",(t=>b(t.data.meanRT))).attr("y1",(t=>t.densityScale(0)+("correct"===t.outcome?.125:-.125)*this.rem)).attr("y2",(t=>t.densityScale(0)+("correct"===t.outcome?.675:-.675)*this.rem)),ne.exit().select(".indicator").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",0).attr("x2",0).on("end",((t,e,r)=>{select(r[e].parentElement).remove()}));const ae=Q.selectAll(".model.sd").data((t=>this.sds?[t]:[])),se=ae.enter().append("g").attr("class",(t=>`model sd ${t.outcome}`));se.append("line").classed("indicator",!0).attr("marker-start","url(#model-sd-cap)").attr("marker-end","url(#model-sd-cap)");se.merge(ae).select(".indicator").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",(t=>b(t.model.meanRT-t.model.sdRT/2))).attr("x2",(t=>b(t.model.meanRT+t.model.sdRT/2))).attr("y1",(t=>t.densityScale(5))).attr("y2",(t=>t.densityScale(5))),ae.exit().remove();const oe=Q.selectAll(".data.sd").data((t=>!this.sds||Number.isNaN(t.data.meanRT)||Number.isNaN(t.data.sdRT)?[]:[t])),le=oe.enter().append("g").attr("class",(t=>`data sd ${t.outcome}`));le.append("line").classed("indicator",!0).attr("marker-start","url(#data-sd-cap)").attr("marker-end","url(#data-sd-cap)").attr("y1",(t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem)).attr("y2",(t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem));le.merge(oe).select(".indicator").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",(t=>b(t.data.meanRT-t.data.sdRT/2))).attr("x2",(t=>b(t.data.meanRT+t.data.sdRT/2))).attr("y1",(t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem)).attr("y2",(t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem)),oe.exit().select(".indicator").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",0).attr("x2",0).on("end",((t,e,r)=>{select(r[e].parentElement).remove()})),this.firstUpdate=!1}}customElements.define("ddm-model",DDMModel);class RDK2AFCTask extends(DecidablesMixinResizeable(AccumulableElement)){static get properties(){return{coherence:{attribute:"coherence",type:Number,reflect:!0},count:{attribute:"count",type:Number,reflect:!0},probability:{attribute:"probability",type:Number,reflect:!0},duration:{attribute:"duration",type:Number,reflect:!0},wait:{attribute:"wait",type:Number,reflect:!0},iti:{attribute:"iti",type:Number,reflect:!0},trials:{attribute:"trials",type:Number,reflect:!0},running:{attribute:"running",type:Boolean,reflect:!0},lifetime:{attribute:!1,type:Number,reflect:!1},speed:{attribute:!1,type:Number,reflect:!1}}}constructor(){super(),this.coherence=.5,this.count=100,this.probability=.5,this.duration=2e3,this.wait=2e3,this.iti=2e3,this.trials=5,this.running=!1,this.lifetime=400,this.speed=50,this.firstUpdate=!0,this.COHERENT=0,this.RANDOM=1,this.dots=[[],[]],this.trial=0,this.states=["resetted","iti","stimulus","wait","ended"],this.state="resetted",this.baseTime=0,this.pauseTime=0,this.startTime=0,this.lastTime=0,this.LEFT=180,this.RIGHT=0,this.currentDirection=void 0,this.signals=["left","right"],this.signal=void 0,this.runner=void 0,this.xScale=void 0,this.yScale=void 0}static get styles(){return[super.styles,i$2`
        :host {
          display: inline-block;
