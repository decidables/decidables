...
if (!NATIVE_ARRAY_BUFFER_VIEWS || !isCallable$5(TypedArray) || TypedArray === Function.prototype) {
  ...
  if (NATIVE_ARRAY_BUFFER_VIEWS) for (NAME$2 in TypedArrayConstructorsList) {
    if (global$9[NAME$2]) setPrototypeOf$1(global$9[NAME$2], TypedArray);
  }
}
if (!NATIVE_ARRAY_BUFFER_VIEWS || !TypedArrayPrototype || TypedArrayPrototype === ObjectPrototype) {
  TypedArrayPrototype = TypedArray.prototype;
  if (NATIVE_ARRAY_BUFFER_VIEWS) for (NAME$2 in TypedArrayConstructorsList) {
    if (global$9[NAME$2]) setPrototypeOf$1(global$9[NAME$2].prototype, TypedArrayPrototype);
  }
}
...
if (DESCRIPTORS$1 && !hasOwn$4(TypedArrayPrototype, TO_STRING_TAG)) {
  ...
  for (NAME$2 in TypedArrayConstructorsList) if (global$9[NAME$2]) {
    createNonEnumerableProperty$1(global$9[NAME$2], TYPED_ARRAY_TAG, NAME$2);
  }
}
