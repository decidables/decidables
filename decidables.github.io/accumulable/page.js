...
const o=t=>t??E;class DecidablesSlider extends DecidablesElement{static get properties(){return{disabled:{attribute:"disabled",type:Boolean,reflect:!0},scale:{attribute:"scale",type:Boolean,reflect:!0},max:{attribute:"max",type:Number,reflect:!0},min:{attribute:"min",type:Number,reflect:!0},step:{attribute:"step",type:Number,reflect:!0},value:{attribute:"value",type:Number,reflect:!0},nonlinear:{attribute:!1,type:Boolean,reflect:!1}}}constructor(){super(),this.disabled=!1,this.scale=!1,this.max=void 0,this.min=void 0,this.step=void 0,this.value=void 0,this.nonlinear=!1,this.rangeMax=void 0,this.rangeMin=void 0,this.rangeStep=void 0,this.rangeValue=void 0,this.toRange=void 0,this.fromRange=void 0}nonlinearRange(t,e,r){this.nonlinear=t,this.toRange=t?e:void 0,this.fromRange=t?r:void 0}rangeChanged(t){this.value=this.nonlinear?this.fromRange(t.target.value):t.target.value,this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0}))}rangeInputted(t){this.value=this.nonlinear?this.fromRange(t.target.value):t.target.value}spinnerInputted(t){this.value=t.target.value}willUpdate(){this.rangeMax=void 0===this.max?void 0:this.nonlinear?this.toRange(this.max):this.max,this.rangeMin=void 0===this.min?void 0:this.nonlinear?this.toRange(this.min):this.min,this.rangeStep=void 0===this.step?void 0:this.nonlinear?"any":this.step,this.rangeValue=void 0===this.value?void 0:this.nonlinear?this.toRange(this.value):this.value}static get styles(){return[super.styles,i$3`
    ...
    `}}customElements.define("ddm-fit",DDMFit);class DDMParameters extends AccumulableElement{static get properties(){return{a:{attribute:"boundary-separation",type:Number,reflect:!0},z:{attribute:"starting-point",type:Number,reflect:!0},v:{attribute:"drift-rate",type:Number,reflect:!0},t0:{attribute:"nondecision-time",type:Number,reflect:!0}}}constructor(){super(),this.a=void 0,this.z=void 0,this.v=void 0,this.t0=void 0}setBoundarySeparation(t){this.a=+t.target.value,this.dispatchEvent(new CustomEvent("ddm-parameters-a",{detail:{a:this.a},bubbles:!0}))}setStartingPoint(t){this.z=+t.target.value,this.dispatchEvent(new CustomEvent("ddm-parameters-z",{detail:{z:this.z},bubbles:!0}))}setDriftRate(t){this.v=+t.target.value,this.dispatchEvent(new CustomEvent("ddm-parameters-v",{detail:{v:this.v},bubbles:!0}))}setNondecisionTime(t){this.t0=+t.target.value,this.dispatchEvent(new CustomEvent("ddm-parameters-t0",{detail:{t0:this.t0},bubbles:!0}))}static get styles(){return[super.styles,i$3`
      ...
      `]}render(){return x$1``}willUpdate(){this.alignState()}update(t){if(super.update(t),Number.isNaN(this.width)||Number.isNaN(this.height)||Number.isNaN(this.rem))return;const e=this.width,r=this.height;let n,a;e/r>1.5?(a=r,n=1.5*a):(n=e,a=n/1.5);const i=1*this.rem,o=3*this.rem,s=3.75*this.rem,l=3.25*this.rem,c=a-(i+o),u=n-(s+l),d=.75*this.rem,h=.5*c,p=.25*c-d,g=.75*this.rem,y=.9*u,b=.1*u-g,f=parseInt(this.getComputedStyleValue("---transition-duration"),10),$=linear().domain([this.scale.time.min,this.scale.time.max]).range([0,y]),m=linear().domain([this.scale.evidence.min,this.scale.evidence.max]).range([h,0]),I=linear().domain([this.scale.density.min,this.scale.density.max]).range([p,0]),E=linear().domain([this.scale.density.min,this.scale.density.max]).range([0,p]),C=linear().domain([0,1]).range([0,c]),A=drag().subject((t,e)=>({x:$(e.t0),y:m(e.startingPoint)})).on("start",t=>{select(t.currentTarget).classed("dragging",!0)}).on("drag",t=>{this.drag=!0;const e=!!t.sourceEvent.shiftKey&&(Math.abs(t.x-t.subject.x)>Math.abs(t.y-t.subject.y)?"t0":"z");let r=$.invert(t.x),n=(m.invert(t.y)+this.a/2)/this.a;r="z"===e?$.invert(t.subject.x):r<DDMMath.t0.MIN?DDMMath.t0.MIN:r>DDMMath.t0.MAX?DDMMath.t0.MAX:r,n="t0"===e?(m.invert(t.subject.y)+this.a/2)/this.a:n<DDMMath.z.MIN?DDMMath.z.MIN:n>DDMMath.z.MAX?DDMMath.z.MAX:n,this.t0=r,this.z=n,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-t0",{detail:{t0:this.t0},bubbles:!0})),this.dispatchEvent(new CustomEvent("ddm-model-z",{detail:{z:this.z},bubbles:!0}))}).on("end",t=>{select(t.currentTarget).classed("dragging",!1),this.drag=!1}),v=drag().on("start",t=>{select(t.currentTarget).classed("dragging",!0)}).on("drag",t=>{this.drag=!0;let e=(m.invert(t.y)-this.startingPoint)/($.invert(t.x)-this.t0)*1e3;e=e<DDMMath.v.MIN?DDMMath.v.MIN:e>DDMMath.v.MAX?DDMMath.v.MAX:e,this.v=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-v",{detail:{v:this.v},bubbles:!0}))}).on("end",t=>{select(t.currentTarget).classed("dragging",!1),this.drag=!1}),S=drag().subject((t,e)=>({x:0,y:m(e.value)})).on("start",t=>{select(t.currentTarget).classed("dragging",!0)}).on("drag",t=>{this.drag=!0;const e=m.invert(t.y);let r=Math.abs(2*e);r=r<DDMMath.a.MIN?DDMMath.a.MIN:r>DDMMath.a.MAX?DDMMath.a.MAX:r,this.a=r,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-a",{detail:{a:this.a},bubbles:!0}))}).on("end",t=>{select(t.currentTarget).classed("dragging",!1),this.drag=!1}),U=line().x(t=>$(t.t)).y(t=>m(t.e)),R=line().x(t=>$(t.t)).y(t=>I(t.d)),F=line().x(t=>$(t.t)).y(t=>E(t.d)),T=select(this.renderRoot).selectAll(".main").data([{width:this.width,height:this.height,rem:this.rem}]),Q=T.enter().append("svg").classed("main",!0).each((t,e,r)=>{B(AccumulableElement.svgFilters,r[e])}),x=Q.append("defs").classed("markers",!0),D=t=>{x.append("marker").attr("id",`measure-arrow-${t}`).attr("class",`measure-arrow ${t}`).attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-10 -6 12 12").attr("refX","0").attr("refY","0").attr("markerWidth","12").attr("markerHeight","12").append("path").attr("class","arrow").attr("d","M -7 -3 l 6 3 l -6 3 z")},N=t=>{const e=x.append("marker").attr("id",`measure-capped-arrow-${t}`).attr("class",`measure-arrow capped ${t}`).attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-10 -6 12 12").attr("refX","0").attr("refY","0").attr("markerWidth","12").attr("markerHeight","12");e.append("path").attr("class","arrow").attr("d","M -7 -3 l 6 3 l -6 3 z"),e.append("path").attr("class","cap").attr("d","M 0 -4 l 0 8")};D("a"),D("z"),N("v"),D("t0"),N("t0");const w=t=>{x.append("marker").attr("id",`model-sd-cap-${t}`).attr("class",`model-sd cap ${t}`).attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","0").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10").append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("stroke-width","2").attr("d","M 0 -4 l 0 8"),x.append("marker").attr("id",`data-sd-cap-${t}`).attr("class",`data-sd cap ${t}`).attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","0").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10").append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("stroke-width","2").attr("d","M 0 -3 l 0 6")};w("error"),w("correct");const M=x.append("linearGradient").attr("id","path-animate").attr("gradientUnits","userSpaceOnUse").attr("color-interpolation","linearRGB").attr("x1","0").attr("x2","0").attr("y1",m(this.bounds.upper)).attr("y2",m(this.bounds.lower));M.append("stop").classed("stop-0",!0).attr("offset","0%"),M.append("stop").classed("stop-100",!0).attr("offset","100%");const O=Q.merge(T).attr("viewBox",`0 0 ${n} ${a}`),_=O.selectAll(".plot.density").data([{outcome:"correct",data:{meanRT:this.data.correctMeanRT,sdRT:this.data.correctSDRT},model:{meanRT:this.model.correctMeanRT,sdRT:this.model.correctSDRT,dist:this.model.correctDist},densityScale:I,densityLine:R,alignDistribution:this.alignCorrectDistribution.bind(this)},{outcome:"error",data:{meanRT:this.data.errorMeanRT,sdRT:this.data.errorSDRT},model:{meanRT:this.model.errorMeanRT,sdRT:this.model.errorSDRT,dist:this.model.errorDist},densityScale:E,densityLine:F,alignDistribution:this.alignErrorDistribution.bind(this)}]),L=Q.append("g").classed("plot evidence",!0),k=_.enter().append("g").attr("class",t=>`plot density ${t.outcome}`),P=Q.append("g").classed("plot accuracy",!0),V=O.select(".plot.evidence").attr("transform",`translate(${s}, ${i+p+d})`),H=k.merge(_).attr("transform",t=>`translate(${s}, ${"correct"===t.outcome?i:i+p+h+2*d})`),G=O.select(".plot.accuracy").attr("transform",`translate(${s+y+g}, ${i})`);L.append("clipPath").attr("id","clip-evidence").append("rect"),V.select("clipPath rect").attr("y",m(this.bounds.upper)).attr("height",m(this.bounds.lower)-m(this.bounds.upper)+1).attr("width",y+1);const W=L.append("g").classed("underlayer",!0),Y=k.append("g").classed("underlayer",!0),z=P.append("g").classed("underlayer",!0),j=V.select(".underlayer"),K=H.select(".underlayer"),X=G.select(".underlayer");L.append("g").classed("content",!0).append("g").classed("paths",!0);const J=k.append("g").classed("content",!0);P.append("g").classed("content",!0);const Z=V.select(".content"),q=H.select(".content"),tt=G.select(".content");L.append("g").classed("overlayer",!0),k.append("g").classed("overlayer",!0),P.append("g").classed("overlayer",!0);const et=V.select(".overlayer"),rt=H.select(".overlayer");W.append("rect").classed("background",!0),Y.append("rect").classed("background",!0),j.select(".background").transition().duration(this.drag?0:f).ease(cubicOut).attr("y",m(this.bounds.upper)).attr("height",m(this.bounds.lower)-m(this.bounds.upper)).attr("width",y),K.select(".background").transition().duration(f).ease(cubicOut).attr("height",p).attr("width",y),Y.filter(t=>"error"===t.outcome).append("g").classed("axis time",!0);const nt=K.filter(t=>"error"===t.outcome).select(".axis.time").attr("transform",`translate(0, ${p+.25*this.rem})`);nt.transition().duration(f).ease(cubicOut).call(axisBottom($)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null);const at=Y.filter(t=>"error"===t.outcome).append("text").classed("title time",!0).attr("text-anchor","middle");at.append("tspan").classed("name",!0).text("Time (ms)"),K.filter(t=>"error"===t.outcome).select(".title.time").transition().duration(f).ease(cubicOut).attr("transform",`translate(${y/2}, ${p+2.5*this.rem})`),W.append("g").classed("axis evidence",!0),Y.append("g").attr("class",t=>`axis density ${t.outcome}`),z.append("g").classed("axis accuracy",!0);const it=j.select(".axis.evidence").attr("transform",`translate(${-.25*this.rem}, 0)`),ot=K.select(".axis.density").attr("transform",`translate(${-.25*this.rem}, 0)`),st=X.select(".axis.accuracy").attr("transform",`translate(${b+.25*this.rem}, 0)`),lt=it.transition().duration(f).ease(cubicOut).call(axisLeft(m)).attr("font-size",null).attr("font-family",null),ct=ot.transition().duration(f).ease(cubicOut).each((t,e,r)=>{axisLeft(t.densityScale).ticks(2)(select(r[e]))}).attr("font-size",null).attr("font-family",null),ut=st.transition().duration(f).ease(cubicOut).call(axisRight(C)).attr("font-size",null).attr("font-family",null);lt.selectAll("line, path").attr("stroke",null),ct.selectAll("line, path").attr("stroke",null),ut.selectAll("line, path").attr("stroke",null);const dt=W.append("text").classed("title evidence",!0).attr("text-anchor","middle"),ht=Y.append("text").attr("class",t=>`title density ${t.outcome}`).attr("text-anchor","middle"),pt=z.append("text").classed("title accuracy",!0).attr("text-anchor","middle");dt.append("tspan").classed("name",!0).text("Evidence"),ht.append("tspan").classed("name",!0).text("Density"),pt.append("tspan").classed("name",!0).text("Accuracy"),j.select(".title.evidence").transition().duration(f).ease(cubicOut).attr("transform",`translate(${-2.5*this.rem}, ${h/2})rotate(-90)`),K.select(".title.density").transition().duration(f).ease(cubicOut).attr("transform",`translate(${-2.5*this.rem}, ${p/2})rotate(-90)`),X.select(".title.accuracy").transition().duration(f).ease(cubicOut).attr("transform",`translate(${b+2.25*this.rem}, ${c/2})rotate(90)`);const gt=Z.select(".paths").selectAll(".path").data(this.data.trials.filter(t=>void 0!==t.path)),yt=local(),bt=gt.enter().append("g").classed("path",!0).attr("data-new-trial-ease-time",0).on("pointerenter",(t,e)=>{if(!this.drag){select(t.currentTarget).classed("highlight",!0).raise();const r=et.append("g").classed(`rt-label ${e.outcome}`,!0),n=r.append("rect"),a=r.append("text").text(`RT = ${e.rt.toFixed()}`).attr("x",$(e.rt)).attr("y","correct"===e.outcome?m(this.bounds.upper)-.25*this.rem:m(this.bounds.lower)+.125*this.rem).node().getBBox();n.attr("x",a.x-.125*this.rem).attr("y",a.y+.125*this.rem).attr("width",a.width+.25*this.rem).attr("height",a.height-.25*this.rem),yt.set(t.currentTarget,r)}}).on("pointerout",(t,e)=>{this.drag||(select(t.currentTarget).classed("highlight",!1).lower(),t.currentTarget.parentNode.insertBefore(t.currentTarget,t.currentTarget.parentNode.children[e.index]),yt.get(t.currentTarget).remove())});bt.append("path").classed("curve",!0).attr("clip-path","url(#clip-evidence)").attr("pathLength",1).attr("stroke-dashoffset",1);const ft=bt.merge(gt).attr("class",t=>`path ${t.outcome}`);ft.select(".curve").transition().duration(this.drag?0:f).ease(cubicOut).attr("stroke",t=>this.getComputedStyleValue(`---color-${t.outcome}`)).attrTween("d",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.a?n.a:this.a,this.a),i=interpolate$1(void 0!==n.z?n.z:this.z,this.z),o=interpolate$1(void 0!==n.v?n.v:this.v,this.v),s=interpolate$1(void 0!==n.t0?n.t0:this.t0,this.t0);return e=>{n.a=a(e),n.z=i(e),n.v=o(e),n.t0=s(e);const r=this.alignPath(t.seed,n.a,n.z,n.v,n.t0);return U(r)}});const $t=ft.filter(t=>t.animate&&!this.paused);if(!$t.empty()){const t=$t.attr("data-new-trial-ease-time"),e=e=>linear().domain([0,1]).range([t,1])(e),r=e=>r=>linear().domain([e(t),1]).range([0,1])(e(r));$t.classed("animate",!0).select(".curve").attr("stroke-dasharray",1),$t.transition("new").duration(e=>Math.floor(1.5*e.rt*(1-t))).ease(e).attr("data-new-trial-ease-time",1).select(".curve").attrTween("stroke-dashoffset",(t,e,n)=>{const a=interpolate$1(n[e].getAttribute("stroke-dashoffset"),0);return t=>a(r(linear$1)(t))}).on("end",(t,e,r)=>{select(r[e].parentElement).classed("animate",!1).attr("data-new-trial-ease-time",null),t.animate=!1,this.animate=!1,this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("accumulable-response",{detail:{outcome:t.outcome,data:this.data,model:this.model},bubbles:!0}))})}const mt=ft.filter(t=>t.animate&&this.paused);if(!mt.empty()){const t=mt.attr("data-new-trial-ease-time");mt.classed("animate",!0).select(".curve").attr("stroke-dasharray",1).attr("stroke-dashoffset",()=>interpolate$1(1,0)(linear$1(t)))}ft.filter(t=>!t.animate).attr("data-new-trial-ease-time",null),gt.exit().remove();const It=J.append("g").attr("class",t=>`dist ${t.outcome}`);It.append("path").classed("curve",!0),q.select(".dist").select(".curve").transition().duration(this.drag?0:f).ease(cubicOut).attrTween("d",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.a?n.a:this.a,this.a),i=interpolate$1(void 0!==n.z?n.z:this.z,this.z),o=interpolate$1(void 0!==n.v?n.v:this.v,this.v),s=interpolate$1(void 0!==n.t0?n.t0:this.t0,this.t0);return e=>{n.a=a(e),n.z=i(e),n.v=o(e),n.t0=s(e);const r=t.alignDistribution(n.a,n.z,n.v,n.t0);return t.densityLine(r)}});const Et=Z.selectAll(".rt").data(this.data.trials),Ct=Et.enter().append("g");Ct.append("line").classed("mark",!0).attr("x1",t=>$(t.rt)).attr("x2",t=>$(t.rt)).attr("y1",t=>"correct"===t.outcome?m(1)-.125*this.rem:m(-1)+.125*this.rem).attr("y2",t=>"correct"===t.outcome?m(1)-.675*this.rem:m(-1)+.675*this.rem);const At=Ct.merge(Et).attr("class",t=>`rt ${t.outcome}`);At.filter(t=>!t.animate).select(".mark").transition().duration(this.drag?0:f).ease(cubicOut).attr("stroke",t=>this.getComputedStyleValue(`---color-${t.outcome}`)).attr("x1",t=>$(t.rt)).attr("x2",t=>$(t.rt)).attr("y1",t=>"correct"===t.outcome?m(1)-.125*this.rem:m(-1)+.125*this.rem).attr("y2",t=>"correct"===t.outcome?m(1)-.675*this.rem:m(-1)+.675*this.rem),Et.exit().remove();const vt=tt.selectAll(".accuracy.model").data([this.model.accuracy,1-this.model.accuracy]),St=vt.enter().append("g").attr("class",(t,e)=>"accuracy model "+(0===e?"correct":"error"));St.append("rect").classed("bar",!0).attr("x",0),St.merge(vt).select("rect").transition().duration(this.drag?0:f).ease(cubicOut).attr("y",(t,e)=>C(0===e?0:1-t)).attr("width",b).attr("height",t=>C(t)),vt.exit().remove();const Bt=tt.selectAll(".accuracy.data").data(Number.isNaN(this.data.accuracy)?[]:[this.data.accuracy]),Ut=Bt.enter().append("g").classed("accuracy data",!0);Ut.append("line").classed("mark",!0);const Rt=Ut.merge(Bt).attr("class",t=>"accuracy data "+(t<this.model.accuracy.correct?"correct":"error"));Rt.select(".mark").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",0+.25*this.rem).attr("x2",b-.25*this.rem).attr("y1",t=>C(t)-1).attr("y2",t=>C(t)-1),Bt.exit().remove();const Ft=et.selectAll(".boundary").data([{bound:"upper",value:this.bounds.upper},{bound:"lower",value:this.bounds.lower}]),Tt=Ft.enter().append("g").attr("class",(t,e)=>"boundary "+(0===e?"correct":"error"));Tt.append("line").classed("line",!0),Tt.append("line").classed("line touch",!0);const Qt=Tt.merge(Ft).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?(t,e)=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let{a:r}=this;switch(t.key){case"ArrowUp":r+="upper"===e.bound?t.shiftKey?DDMMath.a.STEP:DDMMath.a.JUMP:t.shiftKey?-.01:-.1;break;case"ArrowDown":r+="upper"===e.bound?t.shiftKey?-.01:-.1:t.shiftKey?DDMMath.a.STEP:DDMMath.a.JUMP}r=r<DDMMath.a.MIN?DDMMath.a.MIN:r>DDMMath.a.MAX?DDMMath.a.MAX:r,this.a=r,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-a",{detail:{a:this.a},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?Qt.call(S):Qt.on(".drag",null)),Qt.select(".line").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",$(this.scale.time.min)).attr("x2",$(this.scale.time.max)).attr("y1",t=>m(t.value)).attr("y2",t=>m(t.value)),Qt.select(".line.touch").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",$(this.scale.time.min)).attr("x2",$(this.scale.time.max)).attr("y1",t=>m(t.value)).attr("y2",t=>m(t.value)),Ft.exit().remove();const xt=et.selectAll(".drift").data([{v:this.v,t0:this.t0,startingPoint:this.startingPoint}]),Dt=xt.enter().append("g").classed("drift",!0);Dt.append("line").classed("line",!0),Dt.append("line").classed("line touch",!0),Dt.append("path").classed("arrow",!0),Dt.append("path").classed("arrow touch",!0);const Nt=Dt.merge(xt).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?t=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let{v:e}=this;switch(t.key){case"ArrowUp":e+=t.shiftKey?DDMMath.v.STEP:DDMMath.v.JUMP;break;case"ArrowDown":e-=t.shiftKey?DDMMath.v.STEP:DDMMath.v.JUMP}e=e<DDMMath.v.MIN?DDMMath.v.MIN:e>DDMMath.v.MAX?DDMMath.v.MAX:e,this.v=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-v",{detail:{v:this.v},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?Nt.call(v):Nt.on(".drag",null));const wt=(m(0)-m(1))/($(1)-$(0));Nt.transition().duration(this.drag?0:f).ease(cubicOut).attr("transform",t=>`translate(${$(t.t0)}, ${m(t.startingPoint)})\n          rotate(${-Math.atan(t.v/1e3*wt)*(180/Math.PI)})`),Nt.select(".line").attr("x2",$(200)),Nt.select(".line.touch").attr("x2",$(200)),Nt.select(".arrow").attr("d",`\n        M ${$(200)-.5*this.rem},${.5*-this.rem}\n        l ${.5*this.rem},${.5*this.rem}\n        l ${.5*-this.rem},${.5*this.rem}\n      `),Nt.select(".arrow.touch").attr("d",`\n        M ${$(200)-.5*this.rem},${.5*-this.rem}\n        l ${.5*this.rem},${.5*this.rem}\n        l ${.5*-this.rem},${.5*this.rem}\n      `),xt.exit().remove();const Mt=et.selectAll(".t0z").data([{t0:this.t0,startingPoint:this.startingPoint}]),Ot=Mt.enter().append("g").classed("t0z",!0);Ot.append("line").classed("line",!0),Ot.append("line").classed("line touch",!0),Ot.append("circle").classed("point touch",!0);const _t=Ot.merge(Mt).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?t=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let{z:e}=this;switch(t.key){case"ArrowUp":e+=t.shiftKey?DDMMath.z.STEP:DDMMath.z.JUMP;break;case"ArrowDown":e-=t.shiftKey?DDMMath.z.STEP:DDMMath.z.JUMP}e=e<DDMMath.z.MIN?DDMMath.z.MIN:e>DDMMath.z.MAX?DDMMath.z.MAX:e,this.z=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-z",{detail:{z:this.z},bubbles:!0})),t.preventDefault()}if(["ArrowLeft","ArrowRight"].includes(t.key)){let e=this.t0;switch(t.key){case"ArrowRight":e+=t.shiftKey?DDMMath.t0.STEP:DDMMath.t0.JUMP;break;case"ArrowLeft":e-=t.shiftKey?DDMMath.t0.STEP:DDMMath.t0.JUMP}e=e<DDMMath.t0.MIN?DDMMath.t0.MIN:e>DDMMath.t0.MAX?DDMMath.t0.MAX:e,this.t0=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-t0",{detail:{t0:this.t0},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?_t.call(A):_t.on(".drag",null)),_t.select(".line").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",$(0)).attr("x2",t=>$(t.t0)).attr("y1",t=>m(t.startingPoint)).attr("y2",t=>m(t.startingPoint)),_t.select(".line.touch").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",$(0)).attr("x2",t=>$(t.t0)).attr("y1",t=>m(t.startingPoint)).attr("y2",t=>m(t.startingPoint)),_t.select(".point").transition().duration(this.drag?0:f).ease(cubicOut).attr("cx",t=>$(t.t0)).attr("cy",t=>m(t.startingPoint)),Mt.exit().remove();const Lt=et.selectAll(".measure.a").data(this.measures?[this.a]:[]),kt=Lt.enter().append("g").classed("measure a",!0);kt.append("line").classed("line",!0),kt.append("line").classed("markers",!0).attr("marker-start","url(#measure-arrow-a)").attr("marker-end","url(#measure-arrow-a)");const Pt=kt.append("text").classed("label",!0);Pt.append("tspan").classed("a math-var",!0).text("a"),Pt.append("tspan").classed("equals",!0).text(" = "),Pt.append("tspan").classed("value",!0);const Vt=Math.abs(m(this.bounds.upper)-m(this.bounds.lower))<=4,Ht=kt.merge(Lt);Ht.select(".line").classed("short",Vt).transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",$(this.scale.time.max)-.75*this.rem).attr("y1",m(this.bounds.upper)+2).attr("x2",$(this.scale.time.max)-.75*this.rem).attr("y2",m(this.bounds.lower)-2),Ht.select(".markers").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",$(this.scale.time.max)-.75*this.rem).attr("y1",m(this.bounds.upper)).attr("x2",$(this.scale.time.max)-.75*this.rem).attr("y2",m(this.bounds.lower));Ht.select(".label").transition().duration(this.drag?0:f).ease(cubicOut).attr("x",$(this.scale.time.max)).attr("y",m(this.bounds.upper)-.25*this.rem).select(".value").text(format(".2f")(this.a)),Lt.exit().remove();const Gt=et.selectAll(".measure.z").data(this.measures?[this.z]:[]),Wt=Gt.enter().append("g").classed("measure z",!0);Wt.append("line").classed("line",!0),Wt.append("line").classed("markers",!0).attr("marker-start","url(#measure-arrow-z)").attr("marker-end","url(#measure-arrow-z)");const Yt=Wt.append("text").classed("label",!0);Yt.append("tspan").classed("z math-var",!0).text("z"),Yt.append("tspan").classed("equals",!0).text(" = "),Yt.append("tspan").classed("value",!0);const zt=Math.abs(m(this.startingPoint)-m(this.bounds.lower))<=4,jt=Wt.merge(Gt);jt.select(".line").classed("short",zt).transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",$(this.scale.time.min)+.75*this.rem).attr("y1",m(this.startingPoint)+2).attr("x2",$(this.scale.time.min)+.75*this.rem).attr("y2",m(this.bounds.lower)-2),jt.select(".markers").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",$(this.scale.time.min)+.75*this.rem).attr("y1",m(this.startingPoint)).attr("x2",$(this.scale.time.min)+.75*this.rem).attr("y2",m(this.bounds.lower));jt.select(".label").transition().duration(this.drag?0:f).ease(cubicOut).attr("x",$(this.scale.time.min)).attr("y",m(this.bounds.lower)+.125*this.rem).select(".value").text(format(".0%")(this.z)),Gt.exit().remove();const Kt=et.selectAll(".measure.v").data(this.measures?[this.v]:[]),Xt=Kt.enter().append("g").classed("measure v",!0);Xt.append("path").classed("line",!0),Xt.append("path").classed("markers",!0).attr("marker-start","url(#measure-capped-arrow-v)").attr("marker-end","url(#measure-capped-arrow-v)");const Jt=Xt.append("text").classed("label",!0);Jt.append("tspan").classed("v math-var",!0).text("v"),Jt.append("tspan").classed("equals",!0).text(" = "),Jt.append("tspan").classed("value",!0);const Zt=$(200)-$(0)+.75*this.rem,qt=Math.atan(this.v/1e3*wt),te=Math.cos(qt)*Zt,ee=Math.sin(qt)*Zt,re=2/Zt,ne=Math.atan(this.v/1e3*wt)-re,ae=Math.cos(re)*Zt,ie=Math.sin(re)*Zt,oe=Math.cos(ne)*Zt,se=Math.sin(ne)*Zt,le=ne*Zt<=4,ce=Xt.merge(Kt);ce.select(".line").classed("short",le).transition().duration(this.drag?0:f).ease(cubicOut).attr("d",`\n        M ${$(this.t0)+ae}, ${m(this.startingPoint)-ie}\n        A ${$(200)-$(0)+.75*this.rem} ${$(200)-$(0)+.75*this.rem} 0 0 0 ${$(this.t0)+oe} ${m(this.startingPoint)-se}\n      `),ce.select(".markers").transition().duration(this.drag?0:f).ease(cubicOut).attr("d",`\n        M ${$(this.t0+200)+.75*this.rem}, ${m(this.startingPoint)}\n        A ${$(200)-$(0)+.75*this.rem} ${$(200)-$(0)+.75*this.rem} 0 0 0 ${$(this.t0)+te} ${m(this.startingPoint)-ee}\n      `);ce.select(".label").transition().duration(this.drag?0:f).ease(cubicOut).attr("x",$(this.t0+200)+.5*this.rem).attr("y",m(this.bounds.upper)-.25*this.rem).select(".value").text(format(".2f")(this.v)),Kt.exit().remove();const ue=et.selectAll(".measure.t0").data(this.measures?[this.t0]:[]),de=ue.enter().append("g").classed("measure t0",!0);de.append("line").classed("line",!0),de.append("line").classed("markers",!0).attr("marker-start","url(#measure-arrow-t0)").attr("marker-end","url(#measure-capped-arrow-t0)");const he=de.append("text").classed("label",!0);he.append("tspan").classed("t0 math-var",!0).text("t₀"),he.append("tspan").classed("equals",!0).text(" = "),he.append("tspan").classed("value",!0);const pe=Math.abs($(0)-$(this.t0))<=4,ge=de.merge(ue);ge.select(".line").classed("short",pe).transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",$(0)+2).attr("y1",m(this.startingPoint)-.75*this.rem).attr("x2",$(this.t0)-2).attr("y2",m(this.startingPoint)-.75*this.rem),ge.select(".markers").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",$(0)).attr("y1",m(this.startingPoint)-.75*this.rem).attr("x2",$(this.t0)).attr("y2",m(this.startingPoint)-.75*this.rem);ge.select(".label").transition().duration(this.drag?0:f).ease(cubicOut).attr("x",$(this.t0)+.25*this.rem).attr("y",m(this.bounds.upper)-.25*this.rem).select(".value").text(format("d")(this.t0)),ue.exit().remove();const ye=rt.selectAll(".model.mean").data(t=>this.means?[t]:[]),be=ye.enter().append("g").attr("class",t=>`model mean ${t.outcome}`);be.append("line").classed("indicator",!0);be.merge(ye).select(".indicator").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",t=>$(t.model.meanRT)).attr("x2",t=>$(t.model.meanRT)).attr("y1",t=>t.densityScale(this.scale.density.min)).attr("y2",t=>t.densityScale(this.scale.density.max)),ye.exit().remove();const fe=rt.selectAll(".data.mean").data(t=>this.means&&!Number.isNaN(t.data.meanRT)?[t]:[]),$e=fe.enter().append("g").attr("class",t=>`data mean ${t.outcome}`);$e.append("line").classed("indicator",!0).attr("y1",t=>t.densityScale(0)+("correct"===t.outcome?.125:-.125)*this.rem).attr("y2",t=>t.densityScale(0)+("correct"===t.outcome?.675:-.675)*this.rem);$e.merge(fe).select(".indicator").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",t=>$(t.data.meanRT)).attr("x2",t=>$(t.data.meanRT)).attr("y1",t=>t.densityScale(0)+("correct"===t.outcome?.125:-.125)*this.rem).attr("y2",t=>t.densityScale(0)+("correct"===t.outcome?.675:-.675)*this.rem),fe.exit().select(".indicator").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",0).attr("x2",0).on("end",(t,e,r)=>{select(r[e].parentElement).remove()});const me=rt.selectAll(".model.sd").data(t=>this.sds?[t]:[]),Ie=me.enter().append("g").attr("class",t=>`model sd ${t.outcome}`);Ie.append("line").classed("indicator",!0).attr("marker-start",t=>`url(#model-sd-cap-${t.outcome})`).attr("marker-end",t=>`url(#model-sd-cap-${t.outcome})`);Ie.merge(me).select(".indicator").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",t=>$(t.model.meanRT-t.model.sdRT/2)).attr("x2",t=>$(t.model.meanRT+t.model.sdRT/2)).attr("y1",t=>t.densityScale(5)).attr("y2",t=>t.densityScale(5)),me.exit().remove();const Ee=rt.selectAll(".data.sd").data(t=>!this.sds||Number.isNaN(t.data.meanRT)||Number.isNaN(t.data.sdRT)?[]:[t]),Ce=Ee.enter().append("g").attr("class",t=>`data sd ${t.outcome}`);Ce.append("line").classed("indicator",!0).attr("marker-start",t=>`url(#data-sd-cap-${t.outcome})`).attr("marker-end",t=>`url(#data-sd-cap-${t.outcome})`).attr("y1",t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem).attr("y2",t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem);Ce.merge(Ee).select(".indicator").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",t=>$(t.data.meanRT-t.data.sdRT/2)).attr("x2",t=>$(t.data.meanRT+t.data.sdRT/2)).attr("y1",t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem).attr("y2",t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem),Ee.exit().select(".indicator").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",0).attr("x2",0).on("end",(t,e,r)=>{select(r[e].parentElement).remove()}),this.firstUpdate=!1}}customElements.define("ddm-model",DDMModel);class RDK2AFCTask extends(DecidablesMixinResizeable(AccumulableElement)){static get properties(){return{coherence:{attribute:"coherence",type:Number,reflect:!0},count:{attribute:"count",type:Number,reflect:!0},probability:{attribute:"probability",type:Number,reflect:!0},duration:{attribute:"duration",type:Number,reflect:!0},wait:{attribute:"wait",type:Number,reflect:!0},iti:{attribute:"iti",type:Number,reflect:!0},trials:{attribute:"trials",type:Number,reflect:!0},running:{attribute:"running",type:Boolean,reflect:!0},lifetime:{attribute:!1,type:Number,reflect:!1},speed:{attribute:!1,type:Number,reflect:!1}}}constructor(){super(),this.coherence=.5,this.count=100,this.probability=.5,this.duration=2e3,this.wait=2e3,this.iti=2e3,this.trials=5,this.running=!1,this.lifetime=400,this.speed=50,this.firstUpdate=!0,this.COHERENT=0,this.RANDOM=1,this.dots=[[],[]],this.trial=0,this.states=["resetted","iti","stimulus","wait","ended"],this.state="resetted",this.baseTime=0,this.pauseTime=0,this.startTime=0,this.lastTime=0,this.LEFT=180,this.RIGHT=0,this.currentDirection=void 0,this.signals=["left","right"],this.signal=void 0,this.runner=void 0,this.xScale=void 0,this.yScale=void 0}static get styles(){return[super.styles,i$3`
        :host {
          display: inline-block;
