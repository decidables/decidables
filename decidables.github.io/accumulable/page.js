...
const o=t=>t??E;class DecidablesSlider extends DecidablesElement{static get properties(){return{disabled:{attribute:"disabled",type:Boolean,reflect:!0},scale:{attribute:"scale",type:Boolean,reflect:!0},max:{attribute:"max",type:Number,reflect:!0},min:{attribute:"min",type:Number,reflect:!0},step:{attribute:"step",type:Number,reflect:!0},value:{attribute:"value",type:Number,reflect:!0},nonlinear:{attribute:!1,type:Boolean,reflect:!1}}}constructor(){super(),this.disabled=!1,this.scale=!1,this.max=void 0,this.min=void 0,this.step=void 0,this.value=void 0,this.nonlinear=!1,this.rangeMax=void 0,this.rangeMin=void 0,this.rangeStep=void 0,this.rangeValue=void 0,this.toRange=void 0,this.fromRange=void 0}nonlinearRange(t,e,r){this.nonlinear=t,this.toRange=t?e:void 0,this.fromRange=t?r:void 0}rangeChanged(t){this.value=this.nonlinear?this.fromRange(t.target.value):t.target.value,this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0}))}rangeInputted(t){this.value=this.nonlinear?this.fromRange(t.target.value):t.target.value}spinnerInputted(t){this.value=t.target.value}willUpdate(){this.rangeMax=void 0===this.max?void 0:this.nonlinear?this.toRange(this.max):this.max,this.rangeMin=void 0===this.min?void 0:this.nonlinear?this.toRange(this.min):this.min,this.rangeStep=void 0===this.step?void 0:this.nonlinear?"any":this.step,this.rangeValue=void 0===this.value?void 0:this.nonlinear?this.toRange(this.value):this.value}static get styles(){return[super.styles,i$3`
    ...
    `}}customElements.define("ddm-fit",DDMFit);class DDMParameters extends AccumulableElement{static get properties(){return{a:{attribute:"boundary-separation",type:Number,reflect:!0},z:{attribute:"starting-point",type:Number,reflect:!0},v:{attribute:"drift-rate",type:Number,reflect:!0},t0:{attribute:"nondecision-time",type:Number,reflect:!0}}}constructor(){super(),this.a=void 0,this.z=void 0,this.v=void 0,this.t0=void 0}setBoundarySeparation(t){this.a=+t.target.value,this.dispatchEvent(new CustomEvent("ddm-parameters-a",{detail:{a:this.a},bubbles:!0}))}setStartingPoint(t){this.z=+t.target.value,this.dispatchEvent(new CustomEvent("ddm-parameters-z",{detail:{z:this.z},bubbles:!0}))}setDriftRate(t){this.v=+t.target.value,this.dispatchEvent(new CustomEvent("ddm-parameters-v",{detail:{v:this.v},bubbles:!0}))}setNondecisionTime(t){this.t0=+t.target.value,this.dispatchEvent(new CustomEvent("ddm-parameters-t0",{detail:{t0:this.t0},bubbles:!0}))}static get styles(){return[super.styles,i$3`
      ...
      `]}render(){return x$1``}willUpdate(){this.alignState()}update(t){if(super.update(t),Number.isNaN(this.width)||Number.isNaN(this.height)||Number.isNaN(this.rem))return;const e=this.width,r=this.height;let n,a;e/r>1.5?(a=r,n=1.5*a):(n=e,a=n/1.5);const i=1*this.rem,o=3*this.rem,s=3.75*this.rem,l=3.25*this.rem,c=a-(i+o),u=n-(s+l),d=.75*this.rem,h=.5*c,p=.25*c-d,g=.75*this.rem,y=.9*u,b=.1*u-g,f=parseInt(this.getComputedStyleValue("---transition-duration"),10),$=linear().domain([this.scale.time.min,this.scale.time.max]).range([0,y]),m=linear().domain([this.scale.evidence.min,this.scale.evidence.max]).range([h,0]),I=linear().domain([this.scale.density.min,this.scale.density.max]).range([p,0]),E=linear().domain([this.scale.density.min,this.scale.density.max]).range([0,p]),A=linear().domain([0,1]).range([0,c]),C=drag().subject((t,e)=>({x:$(e.t0),y:m(e.startingPoint)})).on("start",t=>{select(t.currentTarget).classed("dragging",!0)}).on("drag",t=>{this.drag=!0;const e=!!t.sourceEvent.shiftKey&&(Math.abs(t.x-t.subject.x)>Math.abs(t.y-t.subject.y)?"t0":"z");let r=$.invert(t.x),n=(m.invert(t.y)+this.a/2)/this.a;r="z"===e?$.invert(t.subject.x):r<DDMMath.t0.MIN?DDMMath.t0.MIN:r>DDMMath.t0.MAX?DDMMath.t0.MAX:r,n="t0"===e?(m.invert(t.subject.y)+this.a/2)/this.a:n<DDMMath.z.MIN?DDMMath.z.MIN:n>DDMMath.z.MAX?DDMMath.z.MAX:n,this.t0=r,this.z=n,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-t0",{detail:{t0:this.t0},bubbles:!0})),this.dispatchEvent(new CustomEvent("ddm-model-z",{detail:{z:this.z},bubbles:!0}))}).on("end",t=>{select(t.currentTarget).classed("dragging",!1),this.drag=!1}),S=drag().on("start",t=>{select(t.currentTarget).classed("dragging",!0)}).on("drag",t=>{this.drag=!0;let e=(m.invert(t.y)-this.startingPoint)/($.invert(t.x)-this.t0)*1e3;e=e<DDMMath.v.MIN?DDMMath.v.MIN:e>DDMMath.v.MAX?DDMMath.v.MAX:e,this.v=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-v",{detail:{v:this.v},bubbles:!0}))}).on("end",t=>{select(t.currentTarget).classed("dragging",!1),this.drag=!1}),v=drag().subject((t,e)=>({x:0,y:m(e.value)})).on("start",t=>{select(t.currentTarget).classed("dragging",!0)}).on("drag",t=>{this.drag=!0;const e=m.invert(t.y);let r=Math.abs(2*e);r=r<DDMMath.a.MIN?DDMMath.a.MIN:r>DDMMath.a.MAX?DDMMath.a.MAX:r,this.a=r,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-a",{detail:{a:this.a},bubbles:!0}))}).on("end",t=>{select(t.currentTarget).classed("dragging",!1),this.drag=!1}),B=line().x(t=>$(t.t)).y(t=>m(t.e)),U=line().x(t=>$(t.t)).y(t=>I(t.d)),R=line().x(t=>$(t.t)).y(t=>E(t.d)),F=select(this.renderRoot).selectAll(".main").data([{width:this.width,height:this.height,rem:this.rem}]),T=F.enter().append("svg").classed("main",!0).html(AccumulableElement.svgDefs),Q=T.append("defs");Q.append("marker").attr("id","measure-arrow").attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","2").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10").append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("d","M -3 -3 l 6 3 l -6 3 z"),Q.append("marker").attr("id","model-sd-cap").attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","0").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10").append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("stroke-width","2").attr("d","M 0 -4 l 0 8"),Q.append("marker").attr("id","data-sd-cap").attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","0").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10").append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("stroke-width","2").attr("d","M 0 -3 l 0 6");const x=Q.append("linearGradient").attr("id","path-animate").attr("gradientUnits","userSpaceOnUse").attr("color-interpolation","linearRGB").attr("x1","0").attr("x2","0").attr("y1",m(this.bounds.upper)).attr("y2",m(this.bounds.lower));x.append("stop").classed("stop-0",!0).attr("offset","0%"),x.append("stop").classed("stop-100",!0).attr("offset","100%");const D=T.merge(F).attr("viewBox",`0 0 ${n} ${a}`),N=D.selectAll(".plot.density").data([{outcome:"correct",data:{meanRT:this.data.correctMeanRT,sdRT:this.data.correctSDRT},model:{meanRT:this.model.correctMeanRT,sdRT:this.model.correctSDRT,dist:this.model.correctDist},densityScale:I,densityLine:U,alignDistribution:this.alignCorrectDistribution.bind(this)},{outcome:"error",data:{meanRT:this.data.errorMeanRT,sdRT:this.data.errorSDRT},model:{meanRT:this.model.errorMeanRT,sdRT:this.model.errorSDRT,dist:this.model.errorDist},densityScale:E,densityLine:R,alignDistribution:this.alignErrorDistribution.bind(this)}]),w=T.append("g").classed("plot evidence",!0),M=N.enter().append("g").attr("class",t=>`plot density ${t.outcome}`),O=T.append("g").classed("plot accuracy",!0),L=D.select(".plot.evidence").attr("transform",`translate(${s}, ${i+p+d})`),_=M.merge(N).attr("transform",t=>`translate(${s}, ${"correct"===t.outcome?i:i+p+h+2*d})`),P=D.select(".plot.accuracy").attr("transform",`translate(${s+y+g}, ${i})`);w.append("clipPath").attr("id","clip-evidence").append("rect"),L.select("clipPath rect").attr("y",m(this.bounds.upper)).attr("height",m(this.bounds.lower)-m(this.bounds.upper)+1).attr("width",y+1);const k=w.append("g").classed("underlayer",!0),V=M.append("g").classed("underlayer",!0),H=O.append("g").classed("underlayer",!0),G=L.select(".underlayer"),W=_.select(".underlayer"),j=P.select(".underlayer");w.append("g").classed("content",!0).append("g").classed("paths",!0);const Y=M.append("g").classed("content",!0);O.append("g").classed("content",!0);const z=L.select(".content"),K=_.select(".content"),X=P.select(".content");w.append("g").classed("overlayer",!0),M.append("g").classed("overlayer",!0),O.append("g").classed("overlayer",!0);const J=L.select(".overlayer"),Z=_.select(".overlayer");k.append("rect").classed("background",!0),V.append("rect").classed("background",!0),G.select(".background").transition().duration(this.drag?0:f).ease(cubicOut).attr("y",m(this.bounds.upper)).attr("height",m(this.bounds.lower)-m(this.bounds.upper)).attr("width",y),W.select(".background").transition().duration(f).ease(cubicOut).attr("height",p).attr("width",y),V.filter(t=>"error"===t.outcome).append("g").classed("axis time",!0);const q=W.filter(t=>"error"===t.outcome).select(".axis.time").attr("transform",`translate(0, ${p+.25*this.rem})`);q.transition().duration(f).ease(cubicOut).call(axisBottom($)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null);const tt=V.filter(t=>"error"===t.outcome).append("text").classed("title time",!0).attr("text-anchor","middle");tt.append("tspan").classed("name",!0).text("Time (ms)"),W.filter(t=>"error"===t.outcome).select(".title.time").transition().duration(f).ease(cubicOut).attr("transform",`translate(${y/2}, ${p+2.5*this.rem})`),k.append("g").classed("axis evidence",!0),V.append("g").attr("class",t=>`axis density ${t.outcome}`),H.append("g").classed("axis accuracy",!0);const et=G.select(".axis.evidence").attr("transform",`translate(${-.25*this.rem}, 0)`),rt=W.select(".axis.density").attr("transform",`translate(${-.25*this.rem}, 0)`),nt=j.select(".axis.accuracy").attr("transform",`translate(${b+.25*this.rem}, 0)`),at=et.transition().duration(f).ease(cubicOut).call(axisLeft(m)).attr("font-size",null).attr("font-family",null),it=rt.transition().duration(f).ease(cubicOut).each((t,e,r)=>{axisLeft(t.densityScale).ticks(2)(select(r[e]))}).attr("font-size",null).attr("font-family",null),ot=nt.transition().duration(f).ease(cubicOut).call(axisRight(A)).attr("font-size",null).attr("font-family",null);at.selectAll("line, path").attr("stroke",null),it.selectAll("line, path").attr("stroke",null),ot.selectAll("line, path").attr("stroke",null);const st=k.append("text").classed("title evidence",!0).attr("text-anchor","middle"),lt=V.append("text").attr("class",t=>`title density ${t.outcome}`).attr("text-anchor","middle"),ct=H.append("text").classed("title accuracy",!0).attr("text-anchor","middle");st.append("tspan").classed("name",!0).text("Evidence"),lt.append("tspan").classed("name",!0).text("Density"),ct.append("tspan").classed("name",!0).text("Accuracy"),G.select(".title.evidence").transition().duration(f).ease(cubicOut).attr("transform",`translate(${-2.5*this.rem}, ${h/2})rotate(-90)`),W.select(".title.density").transition().duration(f).ease(cubicOut).attr("transform",`translate(${-2.5*this.rem}, ${p/2})rotate(-90)`),j.select(".title.accuracy").transition().duration(f).ease(cubicOut).attr("transform",`translate(${b+2.25*this.rem}, ${c/2})rotate(90)`);const ut=z.select(".paths").selectAll(".path").data(this.data.trials.filter(t=>void 0!==t.path)),dt=local(),ht=ut.enter().append("g").classed("path",!0).attr("data-new-trial-ease-time",0).on("pointerenter",(t,e)=>{if(!this.drag){select(t.currentTarget).classed("highlight",!0).raise();const r=J.append("g").classed(`rt-label ${e.outcome}`,!0),n=r.append("rect"),a=r.append("text").text(`RT = ${e.rt.toFixed()}`).attr("x",$(e.rt)).attr("y","correct"===e.outcome?m(this.bounds.upper)-.25*this.rem:m(this.bounds.lower)+.125*this.rem).node().getBBox();n.attr("x",a.x-.125*this.rem).attr("y",a.y+.125*this.rem).attr("width",a.width+.25*this.rem).attr("height",a.height-.25*this.rem),dt.set(t.currentTarget,r)}}).on("pointerout",(t,e)=>{this.drag||(select(t.currentTarget).classed("highlight",!1).lower(),t.currentTarget.parentNode.insertBefore(t.currentTarget,t.currentTarget.parentNode.children[e.index]),dt.get(t.currentTarget).remove())});ht.append("path").classed("curve",!0).attr("clip-path","url(#clip-evidence)").attr("pathLength",1).attr("stroke-dashoffset",1);const pt=ht.merge(ut).attr("class",t=>`path ${t.outcome}`);pt.select(".curve").transition().duration(this.drag?0:f).ease(cubicOut).attr("stroke",t=>this.getComputedStyleValue(`---color-${t.outcome}`)).attrTween("d",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.a?n.a:this.a,this.a),i=interpolate$1(void 0!==n.z?n.z:this.z,this.z),o=interpolate$1(void 0!==n.v?n.v:this.v,this.v),s=interpolate$1(void 0!==n.t0?n.t0:this.t0,this.t0);return e=>{n.a=a(e),n.z=i(e),n.v=o(e),n.t0=s(e);const r=this.alignPath(t.seed,n.a,n.z,n.v,n.t0);return B(r)}});const gt=pt.filter(t=>t.animate&&!this.paused);if(!gt.empty()){const t=gt.attr("data-new-trial-ease-time"),e=e=>linear().domain([0,1]).range([t,1])(e),r=e=>r=>linear().domain([e(t),1]).range([0,1])(e(r));gt.classed("animate",!0).select(".curve").attr("stroke-dasharray",1),gt.transition("new").duration(e=>Math.floor(1.5*e.rt*(1-t))).ease(e).attr("data-new-trial-ease-time",1).select(".curve").attrTween("stroke-dashoffset",(t,e,n)=>{const a=interpolate$1(n[e].getAttribute("stroke-dashoffset"),0);return t=>a(r(linear$1)(t))}).on("end",(t,e,r)=>{select(r[e].parentElement).classed("animate",!1).attr("data-new-trial-ease-time",null),t.animate=!1,this.animate=!1,this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("accumulable-response",{detail:{outcome:t.outcome,data:this.data,model:this.model},bubbles:!0}))})}const yt=pt.filter(t=>t.animate&&this.paused);if(!yt.empty()){const t=yt.attr("data-new-trial-ease-time");yt.classed("animate",!0).select(".curve").attr("stroke-dasharray",1).attr("stroke-dashoffset",()=>interpolate$1(1,0)(linear$1(t)))}pt.filter(t=>!t.animate).attr("data-new-trial-ease-time",null),ut.exit().remove();const bt=Y.append("g").attr("class",t=>`dist ${t.outcome}`);bt.append("path").classed("curve",!0),K.select(".dist").select(".curve").transition().duration(this.drag?0:f).ease(cubicOut).attrTween("d",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.a?n.a:this.a,this.a),i=interpolate$1(void 0!==n.z?n.z:this.z,this.z),o=interpolate$1(void 0!==n.v?n.v:this.v,this.v),s=interpolate$1(void 0!==n.t0?n.t0:this.t0,this.t0);return e=>{n.a=a(e),n.z=i(e),n.v=o(e),n.t0=s(e);const r=t.alignDistribution(n.a,n.z,n.v,n.t0);return t.densityLine(r)}});const ft=z.selectAll(".rt").data(this.data.trials),$t=ft.enter().append("g");$t.append("line").classed("mark",!0).attr("x1",t=>$(t.rt)).attr("x2",t=>$(t.rt)).attr("y1",t=>"correct"===t.outcome?m(1)-.125*this.rem:m(-1)+.125*this.rem).attr("y2",t=>"correct"===t.outcome?m(1)-.675*this.rem:m(-1)+.675*this.rem);const mt=$t.merge(ft).attr("class",t=>`rt ${t.outcome}`);mt.filter(t=>!t.animate).select(".mark").transition().duration(this.drag?0:f).ease(cubicOut).attr("stroke",t=>this.getComputedStyleValue(`---color-${t.outcome}`)).attr("x1",t=>$(t.rt)).attr("x2",t=>$(t.rt)).attr("y1",t=>"correct"===t.outcome?m(1)-.125*this.rem:m(-1)+.125*this.rem).attr("y2",t=>"correct"===t.outcome?m(1)-.675*this.rem:m(-1)+.675*this.rem),ft.exit().remove();const It=X.selectAll(".accuracy.model").data([this.model.accuracy,1-this.model.accuracy]),Et=It.enter().append("g").attr("class",(t,e)=>"accuracy model "+(0===e?"correct":"error"));Et.append("rect").classed("bar",!0).attr("x",0),Et.merge(It).select("rect").transition().duration(this.drag?0:f).ease(cubicOut).attr("y",(t,e)=>A(0===e?0:1-t)).attr("width",b).attr("height",t=>A(t)),It.exit().remove();const At=X.selectAll(".accuracy.data").data(Number.isNaN(this.data.accuracy)?[]:[this.data.accuracy]),Ct=At.enter().append("g").classed("accuracy data",!0);Ct.append("line").classed("mark",!0);const St=Ct.merge(At).attr("class",t=>"accuracy data "+(t<this.model.accuracy.correct?"correct":"error"));St.select(".mark").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",0+.25*this.rem).attr("x2",b-.25*this.rem).attr("y1",t=>A(t)-1).attr("y2",t=>A(t)-1),At.exit().remove();const vt=J.selectAll(".boundary").data([{bound:"upper",value:this.bounds.upper},{bound:"lower",value:this.bounds.lower}]),Bt=vt.enter().append("g").attr("class",(t,e)=>"boundary "+(0===e?"correct":"error"));Bt.append("line").classed("line",!0),Bt.append("line").classed("line touch",!0);const Ut=Bt.merge(vt).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?(t,e)=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let{a:r}=this;switch(t.key){case"ArrowUp":r+="upper"===e.bound?t.shiftKey?DDMMath.a.STEP:DDMMath.a.JUMP:t.shiftKey?-.01:-.1;break;case"ArrowDown":r+="upper"===e.bound?t.shiftKey?-.01:-.1:t.shiftKey?DDMMath.a.STEP:DDMMath.a.JUMP}r=r<DDMMath.a.MIN?DDMMath.a.MIN:r>DDMMath.a.MAX?DDMMath.a.MAX:r,this.a=r,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-a",{detail:{a:this.a},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?Ut.call(v):Ut.on(".drag",null)),Ut.select(".line").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",$(this.scale.time.min)).attr("x2",$(this.scale.time.max)).attr("y1",t=>m(t.value)).attr("y2",t=>m(t.value)),Ut.select(".line.touch").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",$(this.scale.time.min)).attr("x2",$(this.scale.time.max)).attr("y1",t=>m(t.value)).attr("y2",t=>m(t.value)),vt.exit().remove();const Rt=J.selectAll(".drift").data([{v:this.v,t0:this.t0,startingPoint:this.startingPoint}]),Ft=Rt.enter().append("g").classed("drift",!0);Ft.append("line").classed("line",!0),Ft.append("line").classed("line touch",!0),Ft.append("path").classed("arrow",!0),Ft.append("path").classed("arrow touch",!0);const Tt=Ft.merge(Rt).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?t=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let{v:e}=this;switch(t.key){case"ArrowUp":e+=t.shiftKey?DDMMath.v.STEP:DDMMath.v.JUMP;break;case"ArrowDown":e-=t.shiftKey?DDMMath.v.STEP:DDMMath.v.JUMP}e=e<DDMMath.v.MIN?DDMMath.v.MIN:e>DDMMath.v.MAX?DDMMath.v.MAX:e,this.v=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-v",{detail:{v:this.v},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?Tt.call(S):Tt.on(".drag",null));const Qt=(m(0)-m(1))/($(1)-$(0));Tt.transition().duration(this.drag?0:f).ease(cubicOut).attr("transform",t=>`translate(${$(t.t0)}, ${m(t.startingPoint)})\n          rotate(${-Math.atan(t.v/1e3*Qt)*(180/Math.PI)})`),Tt.select(".line").attr("x2",$(200)),Tt.select(".line.touch").attr("x2",$(200)),Tt.select(".arrow").attr("d",`\n        M ${$(200)-.5*this.rem},${.5*-this.rem}\n        l ${.5*this.rem},${.5*this.rem}\n        l ${.5*-this.rem},${.5*this.rem}\n      `),Tt.select(".arrow.touch").attr("d",`\n        M ${$(200)-.5*this.rem},${.5*-this.rem}\n        l ${.5*this.rem},${.5*this.rem}\n        l ${.5*-this.rem},${.5*this.rem}\n      `),Rt.exit().remove();const xt=J.selectAll(".t0z").data([{t0:this.t0,startingPoint:this.startingPoint}]),Dt=xt.enter().append("g").classed("t0z",!0);Dt.append("line").classed("line",!0),Dt.append("line").classed("line touch",!0),Dt.append("circle").classed("point touch",!0);const Nt=Dt.merge(xt).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?t=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let{z:e}=this;switch(t.key){case"ArrowUp":e+=t.shiftKey?DDMMath.z.STEP:DDMMath.z.JUMP;break;case"ArrowDown":e-=t.shiftKey?DDMMath.z.STEP:DDMMath.z.JUMP}e=e<DDMMath.z.MIN?DDMMath.z.MIN:e>DDMMath.z.MAX?DDMMath.z.MAX:e,this.z=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-z",{detail:{z:this.z},bubbles:!0})),t.preventDefault()}if(["ArrowLeft","ArrowRight"].includes(t.key)){let e=this.t0;switch(t.key){case"ArrowRight":e+=t.shiftKey?DDMMath.t0.STEP:DDMMath.t0.JUMP;break;case"ArrowLeft":e-=t.shiftKey?DDMMath.t0.STEP:DDMMath.t0.JUMP}e=e<DDMMath.t0.MIN?DDMMath.t0.MIN:e>DDMMath.t0.MAX?DDMMath.t0.MAX:e,this.t0=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-t0",{detail:{t0:this.t0},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?Nt.call(C):Nt.on(".drag",null)),Nt.select(".line").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",$(0)).attr("x2",t=>$(t.t0)).attr("y1",t=>m(t.startingPoint)).attr("y2",t=>m(t.startingPoint)),Nt.select(".line.touch").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",$(0)).attr("x2",t=>$(t.t0)).attr("y1",t=>m(t.startingPoint)).attr("y2",t=>m(t.startingPoint)),Nt.select(".point").transition().duration(this.drag?0:f).ease(cubicOut).attr("cx",t=>$(t.t0)).attr("cy",t=>m(t.startingPoint)),xt.exit().remove();const wt=J.selectAll(".measure.a").data(this.measures?[this.a]:[]),Mt=wt.enter().append("g").classed("measure a",!0);Mt.append("line").classed("line",!0).attr("marker-start","url(#measure-arrow)").attr("marker-end","url(#measure-arrow)");const Ot=Mt.append("text").classed("label",!0);Ot.append("tspan").classed("a math-var",!0).text("a"),Ot.append("tspan").classed("equals",!0).text(" = "),Ot.append("tspan").classed("value",!0);const Lt=Mt.merge(wt);Lt.select(".line").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",$(this.scale.time.max)-.75*this.rem).attr("y1",m(this.bounds.upper)+2).attr("x2",$(this.scale.time.max)-.75*this.rem).attr("y2",m(this.bounds.lower)-2);Lt.select(".label").transition().duration(this.drag?0:f).ease(cubicOut).attr("x",$(this.scale.time.max)).attr("y",m(this.bounds.upper)-.25*this.rem).select(".value").text(format(".2f")(this.a)),wt.exit().remove();const _t=J.selectAll(".measure.z").data(this.measures?[this.z]:[]),Pt=_t.enter().append("g").classed("measure z",!0);Pt.append("line").classed("line",!0).attr("marker-start","url(#measure-arrow)").attr("marker-end","url(#measure-arrow)");const kt=Pt.append("text").classed("label",!0);kt.append("tspan").classed("z math-var",!0).text("z"),kt.append("tspan").classed("equals",!0).text(" = "),kt.append("tspan").classed("value",!0);const Vt=Pt.merge(_t);Vt.select(".line").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",$(this.scale.time.min)+.75*this.rem).attr("y1",m(this.startingPoint)+2).attr("x2",$(this.scale.time.min)+.75*this.rem).attr("y2",m(this.bounds.lower)-2);Vt.select(".label").transition().duration(this.drag?0:f).ease(cubicOut).attr("x",$(this.scale.time.min)).attr("y",m(this.bounds.lower)+.125*this.rem).select(".value").text(format(".0%")(this.z)),_t.exit().remove();const Ht=J.selectAll(".measure.v").data(this.measures?[this.v]:[]),Gt=Ht.enter().append("g").classed("measure v",!0);Gt.append("path").classed("line",!0).attr("marker-start","url(#measure-arrow)").attr("marker-end","url(#measure-arrow)");const Wt=Gt.append("text").classed("label",!0);Wt.append("tspan").classed("v math-var",!0).text("v"),Wt.append("tspan").classed("equals",!0).text(" = "),Wt.append("tspan").classed("value",!0);const jt=Math.atan(this.v/1e3*Qt),Yt=$(200)-$(0)+.75*this.rem,zt=Math.cos(jt)*Yt,Kt=Math.sin(jt)*Yt,Xt=Gt.merge(Ht);Xt.select(".line").transition().duration(this.drag?0:f).ease(cubicOut).attr("d",`\n        M ${$(this.t0+200)+.75*this.rem}, ${m(this.startingPoint)}\n        A ${$(200)-$(0)} ${$(200)-$(0)} 0 0 0 ${$(this.t0)+zt} ${m(this.startingPoint)-Kt}\n      `);Xt.select(".label").transition().duration(this.drag?0:f).ease(cubicOut).attr("x",$(this.t0+200)+.5*this.rem).attr("y",m(this.bounds.upper)-.25*this.rem).select(".value").text(format(".2f")(this.v)),Ht.exit().remove();const Jt=J.selectAll(".measure.t0").data(this.measures?[this.t0]:[]),Zt=Jt.enter().append("g").classed("measure t0",!0);Zt.append("line").classed("line",!0).attr("marker-start","url(#measure-arrow)").attr("marker-end","url(#measure-arrow)");const qt=Zt.append("text").classed("label",!0);qt.append("tspan").classed("t0 math-var",!0).text("t₀"),qt.append("tspan").classed("equals",!0).text(" = "),qt.append("tspan").classed("value",!0);const te=Zt.merge(Jt);te.select(".line").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",$(0)+2).attr("y1",m(this.startingPoint)-.75*this.rem).attr("x2",$(this.t0)-2).attr("y2",m(this.startingPoint)-.75*this.rem);te.select(".label").transition().duration(this.drag?0:f).ease(cubicOut).attr("x",$(this.t0)+.25*this.rem).attr("y",m(this.bounds.upper)-.25*this.rem).select(".value").text(format("d")(this.t0)),Jt.exit().remove();const ee=Z.selectAll(".model.mean").data(t=>this.means?[t]:[]),re=ee.enter().append("g").attr("class",t=>`model mean ${t.outcome}`);re.append("line").classed("indicator",!0);re.merge(ee).select(".indicator").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",t=>$(t.model.meanRT)).attr("x2",t=>$(t.model.meanRT)).attr("y1",t=>t.densityScale(this.scale.density.min)).attr("y2",t=>t.densityScale(this.scale.density.max)),ee.exit().remove();const ne=Z.selectAll(".data.mean").data(t=>this.means&&!Number.isNaN(t.data.meanRT)?[t]:[]),ae=ne.enter().append("g").attr("class",t=>`data mean ${t.outcome}`);ae.append("line").classed("indicator",!0).attr("y1",t=>t.densityScale(0)+("correct"===t.outcome?.125:-.125)*this.rem).attr("y2",t=>t.densityScale(0)+("correct"===t.outcome?.675:-.675)*this.rem);ae.merge(ne).select(".indicator").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",t=>$(t.data.meanRT)).attr("x2",t=>$(t.data.meanRT)).attr("y1",t=>t.densityScale(0)+("correct"===t.outcome?.125:-.125)*this.rem).attr("y2",t=>t.densityScale(0)+("correct"===t.outcome?.675:-.675)*this.rem),ne.exit().select(".indicator").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",0).attr("x2",0).on("end",(t,e,r)=>{select(r[e].parentElement).remove()});const ie=Z.selectAll(".model.sd").data(t=>this.sds?[t]:[]),oe=ie.enter().append("g").attr("class",t=>`model sd ${t.outcome}`);oe.append("line").classed("indicator",!0).attr("marker-start","url(#model-sd-cap)").attr("marker-end","url(#model-sd-cap)");oe.merge(ie).select(".indicator").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",t=>$(t.model.meanRT-t.model.sdRT/2)).attr("x2",t=>$(t.model.meanRT+t.model.sdRT/2)).attr("y1",t=>t.densityScale(5)).attr("y2",t=>t.densityScale(5)),ie.exit().remove();const se=Z.selectAll(".data.sd").data(t=>!this.sds||Number.isNaN(t.data.meanRT)||Number.isNaN(t.data.sdRT)?[]:[t]),le=se.enter().append("g").attr("class",t=>`data sd ${t.outcome}`);le.append("line").classed("indicator",!0).attr("marker-start","url(#data-sd-cap)").attr("marker-end","url(#data-sd-cap)").attr("y1",t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem).attr("y2",t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem);le.merge(se).select(".indicator").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",t=>$(t.data.meanRT-t.data.sdRT/2)).attr("x2",t=>$(t.data.meanRT+t.data.sdRT/2)).attr("y1",t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem).attr("y2",t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem),se.exit().select(".indicator").transition().duration(this.drag?0:f).ease(cubicOut).attr("x1",0).attr("x2",0).on("end",(t,e,r)=>{select(r[e].parentElement).remove()}),this.firstUpdate=!1}}customElements.define("ddm-model",DDMModel);class RDK2AFCTask extends(DecidablesMixinResizeable(AccumulableElement)){static get properties(){return{coherence:{attribute:"coherence",type:Number,reflect:!0},count:{attribute:"count",type:Number,reflect:!0},probability:{attribute:"probability",type:Number,reflect:!0},duration:{attribute:"duration",type:Number,reflect:!0},wait:{attribute:"wait",type:Number,reflect:!0},iti:{attribute:"iti",type:Number,reflect:!0},trials:{attribute:"trials",type:Number,reflect:!0},running:{attribute:"running",type:Boolean,reflect:!0},lifetime:{attribute:!1,type:Number,reflect:!1},speed:{attribute:!1,type:Number,reflect:!1}}}constructor(){super(),this.coherence=.5,this.count=100,this.probability=.5,this.duration=2e3,this.wait=2e3,this.iti=2e3,this.trials=5,this.running=!1,this.lifetime=400,this.speed=50,this.firstUpdate=!0,this.COHERENT=0,this.RANDOM=1,this.dots=[[],[]],this.trial=0,this.states=["resetted","iti","stimulus","wait","ended"],this.state="resetted",this.baseTime=0,this.pauseTime=0,this.startTime=0,this.lastTime=0,this.LEFT=180,this.RIGHT=0,this.currentDirection=void 0,this.signals=["left","right"],this.signal=void 0,this.runner=void 0,this.xScale=void 0,this.yScale=void 0}static get styles(){return[super.styles,i$3`
        :host {
          display: inline-block;
