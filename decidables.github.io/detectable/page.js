 ...
 */class zT extends ZM{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=DT(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return xT}}zT._$litElement$=!0,zT.finalized=!0,jT.litElementHydrateSupport?.({LitElement:zT});const qT=jT.litElementPolyfillSupport;function UT(t,e){return null==t||null==e?NaN:t<e?-1:t>e?1:t>=e?0:NaN}function LT(t,e){return null==t||null==e?NaN:e<t?-1:e>t?1:e>=t?0:NaN}function HT(t){let e,r,n;function i(t,n,i=0,a=t.length){if(i<a){if(0!==e(n,n))return a;do{const e=i+a>>>1;r(t[e],n)<0?i=e+1:a=e}while(i<a)}return i}return 2!==t.length?(e=UT,r=(e,r)=>UT(t(e),r),n=(e,r)=>t(e)-r):(e=t===UT||t===LT?t:BT,r=t,n=t),{left:i,center:function(t,e,r=0,a=t.length){const s=i(t,e,r,a-1);return s>r&&n(t[s-1],e)>-n(t[s],e)?s-1:s},right:function(t,n,i=0,a=t.length){if(i<a){if(0!==e(n,n))return a;do{const e=i+a>>>1;r(t[e],n)<=0?i=e+1:a=e}while(i<a)}return i}}}function BT(){return 0}qT?.({LitElement:zT}),(jT.litElementVersions??=[]).push("4.2.2");const VT=HT(UT).right;function WT(t,e){let r,n;if(void 0===e)for(const e of t)null!=e&&(void 0===r?e>=e&&(r=n=e):(r>e&&(r=e),n<e&&(n=e)));else{let i=-1;for(let a of t)null!=(a=e(a,++i,t))&&(void 0===r?a>=a&&(r=n=a):(r>a&&(r=a),n<a&&(n=a)))}return[r,n]}HT(function(t){return null===t?NaN:+t}).center;class XT{constructor(){this._partials=new Float64Array(32),this._n=0}add(t){const e=this._partials;let r=0;for(let n=0;n<this._n&&n<32;n++){const i=e[n],a=t+i,s=Math.abs(t)<Math.abs(i)?t-(a-i):i-(a-t);s&&(e[r++]=s),t=a}return e[r]=t,this._n=r+1,this}valueOf(){const t=this._partials;let e,r,n,i=this._n,a=0;if(i>0){for(a=t[--i];i>0&&(e=a,r=t[--i],a=e+r,n=r-(a-e),!n););i>0&&(n<0&&t[i-1]<0||n>0&&t[i-1]>0)&&(r=2*n,e=a+r,r==e-a&&(a=e))}return a}}function YT(t){return t}var KT=Array.prototype.slice;function ZT(t){return()=>t}const GT=Math.sqrt(50),JT=Math.sqrt(10),QT=Math.sqrt(2);function tN(t,e,r){const n=(e-t)/Math.max(0,r),i=Math.floor(Math.log10(n)),a=n/Math.pow(10,i),s=a>=GT?10:a>=JT?5:a>=QT?2:1;let o,l,c;return i<0?(c=Math.pow(10,-i)/s,o=Math.round(t*c),l=Math.round(e*c),o/c<t&&++o,l/c>e&&--l,c=-c):(c=Math.pow(10,i)*s,o=Math.round(t/c),l=Math.round(e/c),o*c<t&&++o,l*c>e&&--l),l<o&&.5<=r&&r<2?tN(t,e,2*r):[o,l,c]}function eN(t,e,r){if(!((r=+r)>0))return[];if((t=+t)===(e=+e))return[t];const n=e<t,[i,a,s]=n?tN(e,t,r):tN(t,e,r);if(!(a>=i))return[];const o=a-i+1,l=new Array(o);if(n)if(s<0)for(let t=0;t<o;++t)l[t]=(a-t)/-s;else for(let t=0;t<o;++t)l[t]=(a-t)*s;else if(s<0)for(let t=0;t<o;++t)l[t]=(i+t)/-s;else for(let t=0;t<o;++t)l[t]=(i+t)*s;return l}function rN(t,e,r){return tN(t=+t,e=+e,r=+r)[2]}function nN(t,e,r){let n;for(;;){const i=rN(t,e,r);if(i===n||0===i||!isFinite(i))return[t,e];i>0?(t=Math.floor(t/i)*i,e=Math.ceil(e/i)*i):i<0&&(t=Math.ceil(t*i)/i,e=Math.floor(e*i)/i),n=i}}function iN(t){return Math.max(1,Math.ceil(Math.log(function(t){let e=0;for(let r of t)null!=r&&(r=+r)>=r&&++e;return e}(t))/Math.LN2)+1)}function aN(t,e,r){t=+t,e=+e,r=(i=arguments.length)<2?(e=t,t=0,1):i<3?1:+r;for(var n=-1,i=0|Math.max(0,Math.ceil((e-t)/r)),a=new Array(i);++n<i;)a[n]=t+n*r;return a}function sN(t){return t}var oN=1e-6;function lN(t){return"translate("+t+",0)"}function cN(t){return"translate(0,"+t+")"}function uN(t){return e=>+t(e)}function hN(t,e){return e=Math.max(0,t.bandwidth()-2*e)/2,t.round()&&(e=Math.round(e)),r=>+t(r)+e}function dN(){return!this.__axis}function fN(t,e){var r=[],n=null,i=null,a=6,s=6,o=3,l="undefined"!=typeof window&&window.devicePixelRatio>1?0:.5,c=1===t||4===t?-1:1,u=4===t||2===t?"x":"y",h=1===t||3===t?lN:cN;function d(d){var f=null==n?e.ticks?e.ticks.apply(e,r):e.domain():n,p=null==i?e.tickFormat?e.tickFormat.apply(e,r):sN:i,m=Math.max(a,0)+o,g=e.range(),b=+g[0]+l,v=+g[g.length-1]+l,y=(e.bandwidth?hN:uN)(e.copy(),l),w=d.selection?d.selection():d,x=w.selectAll(".domain").data([null]),k=w.selectAll(".tick").data(f,e).order(),$=k.exit(),S=k.enter().append("g").attr("class","tick"),_=k.select("line"),A=k.select("text");x=x.merge(x.enter().insert("path",".tick").attr("class","domain").attr("stroke","currentColor")),k=k.merge(S),_=_.merge(S.append("line").attr("stroke","currentColor").attr(u+"2",c*a)),A=A.merge(S.append("text").attr("fill","currentColor").attr(u,c*m).attr("dy",1===t?"0em":3===t?"0.71em":"0.32em")),d!==w&&(x=x.transition(d),k=k.transition(d),_=_.transition(d),A=A.transition(d),$=$.transition(d).attr("opacity",oN).attr("transform",function(t){return isFinite(t=y(t))?h(t+l):this.getAttribute("transform")}),S.attr("opacity",oN).attr("transform",function(t){var e=this.parentNode.__axis;return h((e&&isFinite(e=e(t))?e:y(t))+l)})),$.remove(),x.attr("d",4===t||2===t?s?"M"+c*s+","+b+"H"+l+"V"+v+"H"+c*s:"M"+l+","+b+"V"+v:s?"M"+b+","+c*s+"V"+l+"H"+v+"V"+c*s:"M"+b+","+l+"H"+v),k.attr("opacity",1).attr("transform",function(t){return h(y(t)+l)}),_.attr(u+"2",c*a),A.attr(u,c*m).text(p),w.filter(dN).attr("fill","none").attr("font-size",10).attr("font-family","sans-serif").attr("text-anchor",2===t?"start":4===t?"end":"middle"),w.each(function(){this.__axis=y})}return d.scale=function(t){return arguments.length?(e=t,d):e},d.ticks=function(){return r=Array.from(arguments),d},d.tickArguments=function(t){return arguments.length?(r=null==t?[]:Array.from(t),d):r.slice()},d.tickValues=function(t){return arguments.length?(n=null==t?null:Array.from(t),d):n&&n.slice()},d.tickFormat=function(t){return arguments.length?(i=t,d):i},d.tickSize=function(t){return arguments.length?(a=s=+t,d):a},d.tickSizeInner=function(t){return arguments.length?(a=+t,d):a},d.tickSizeOuter=function(t){return arguments.length?(s=+t,d):s},d.tickPadding=function(t){return arguments.length?(o=+t,d):o},d.offset=function(t){return arguments.length?(l=+t,d):l},d}function pN(t){return fN(3,t)}function mN(t){return fN(4,t)}var gN={value:()=>{}};function bN(){for(var t,e=0,r=arguments.length,n={};e<r;++e){if(!(t=arguments[e]+"")||t in n||/[\s.]/.test(t))throw new Error("illegal type: "+t);n[t]=[]}return new vN(n)}function vN(t){this._=t}function yN(t,e){for(var r,n=0,i=t.length;n<i;++n)if((r=t[n]).name===e)return r.value}function wN(t,e,r){for(var n=0,i=t.length;n<i;++n)if(t[n].name===e){t[n]=gN,t=t.slice(0,n).concat(t.slice(n+1));break}return null!=r&&t.push({name:e,value:r}),t}vN.prototype=bN.prototype={constructor:vN,on:function(t,e){var r,n,i=this._,a=(n=i,(t+"").trim().split(/^|\s+/).map(function(t){var e="",r=t.indexOf(".");if(r>=0&&(e=t.slice(r+1),t=t.slice(0,r)),t&&!n.hasOwnProperty(t))throw new Error("unknown type: "+t);return{type:t,name:e}})),s=-1,o=a.length;if(!(arguments.length<2)){if(null!=e&&"function"!=typeof e)throw new Error("invalid callback: "+e);for(;++s<o;)if(r=(t=a[s]).type)i[r]=wN(i[r],t.name,e);else if(null==e)for(r in i)i[r]=wN(i[r],t.name,null);return this}for(;++s<o;)if((r=(t=a[s]).type)&&(r=yN(i[r],t.name)))return r},copy:function(){var t={},e=this._;for(var r in e)t[r]=e[r].slice();return new vN(t)},call:function(t,e){if((r=arguments.length-2)>0)for(var r,n,i=new Array(r),a=0;a<r;++a)i[a]=arguments[a+2];if(!this._.hasOwnProperty(t))throw new Error("unknown type: "+t);for(a=0,r=(n=this._[t]).length;a<r;++a)n[a].value.apply(e,i)},apply:function(t,e,r){if(!this._.hasOwnProperty(t))throw new Error("unknown type: "+t);for(var n=this._[t],i=0,a=n.length;i<a;++i)n[i].value.apply(e,r)}};var xN="http://www.w3.org/1999/xhtml",kN={svg:"http://www.w3.org/2000/svg",xhtml:xN,xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"};function $N(t){var e=t+="",r=e.indexOf(":");return r>=0&&"xmlns"!==(e=t.slice(0,r))&&(t=t.slice(r+1)),kN.hasOwnProperty(e)?{space:kN[e],local:t}:t}function SN(t){return function(){var e=this.ownerDocument,r=this.namespaceURI;return r===xN&&e.documentElement.namespaceURI===xN?e.createElement(t):e.createElementNS(r,t)}}function _N(t){return function(){return this.ownerDocument.createElementNS(t.space,t.local)}}function AN(t){var e=$N(t);return(e.local?_N:SN)(e)}function EN(){}function MN(t){return null==t?EN:function(){return this.querySelector(t)}}function TN(){return[]}function NN(t){return null==t?TN:function(){return this.querySelectorAll(t)}}function CN(t){return function(){return function(t){return null==t?[]:Array.isArray(t)?t:Array.from(t)}(t.apply(this,arguments))}}function RN(t){return function(){return this.matches(t)}}function ON(t){return function(e){return e.matches(t)}}var PN=Array.prototype.find;function IN(){return this.firstElementChild}var FN=Array.prototype.filter;function DN(){return Array.from(this.children)}function jN(t){return new Array(t.length)}function zN(t,e){this.ownerDocument=t.ownerDocument,this.namespaceURI=t.namespaceURI,this._next=null,this._parent=t,this.__data__=e}function qN(t,e,r,n,i,a){for(var s,o=0,l=e.length,c=a.length;o<c;++o)(s=e[o])?(s.__data__=a[o],n[o]=s):r[o]=new zN(t,a[o]);for(;o<l;++o)(s=e[o])&&(i[o]=s)}function UN(t,e,r,n,i,a,s){var o,l,c,u=new Map,h=e.length,d=a.length,f=new Array(h);for(o=0;o<h;++o)(l=e[o])&&(f[o]=c=s.call(l,l.__data__,o,e)+"",u.has(c)?i[o]=l:u.set(c,l));for(o=0;o<d;++o)c=s.call(t,a[o],o,a)+"",(l=u.get(c))?(n[o]=l,l.__data__=a[o],u.delete(c)):r[o]=new zN(t,a[o]);for(o=0;o<h;++o)(l=e[o])&&u.get(f[o])===l&&(i[o]=l)}function LN(t){return t.__data__}function HN(t){return"object"==typeof t&&"length"in t?t:Array.from(t)}function BN(t,e){return t<e?-1:t>e?1:t>=e?0:NaN}function VN(t){return function(){this.removeAttribute(t)}}function WN(t){return function(){this.removeAttributeNS(t.space,t.local)}}function XN(t,e){return function(){this.setAttribute(t,e)}}function YN(t,e){return function(){this.setAttributeNS(t.space,t.local,e)}}function KN(t,e){return function(){var r=e.apply(this,arguments);null==r?this.removeAttribute(t):this.setAttribute(t,r)}}function ZN(t,e){return function(){var r=e.apply(this,arguments);null==r?this.removeAttributeNS(t.space,t.local):this.setAttributeNS(t.space,t.local,r)}}function GN(t){return t.ownerDocument&&t.ownerDocument.defaultView||t.document&&t||t.defaultView}function JN(t){return function(){this.style.removeProperty(t)}}function QN(t,e,r){return function(){this.style.setProperty(t,e,r)}}function tC(t,e,r){return function(){var n=e.apply(this,arguments);null==n?this.style.removeProperty(t):this.style.setProperty(t,n,r)}}function eC(t,e){return t.style.getPropertyValue(e)||GN(t).getComputedStyle(t,null).getPropertyValue(e)}function rC(t){return function(){delete this[t]}}function nC(t,e){return function(){this[t]=e}}function iC(t,e){return function(){var r=e.apply(this,arguments);null==r?delete this[t]:this[t]=r}}function aC(t){return t.trim().split(/^|\s+/)}function sC(t){return t.classList||new oC(t)}function oC(t){this._node=t,this._names=aC(t.getAttribute("class")||"")}function lC(t,e){for(var r=sC(t),n=-1,i=e.length;++n<i;)r.add(e[n])}function cC(t,e){for(var r=sC(t),n=-1,i=e.length;++n<i;)r.remove(e[n])}function uC(t){return function(){lC(this,t)}}function hC(t){return function(){cC(this,t)}}function dC(t,e){return function(){(e.apply(this,arguments)?lC:cC)(this,t)}}function fC(){this.textContent=""}function pC(t){return function(){this.textContent=t}}function mC(t){return function(){var e=t.apply(this,arguments);this.textContent=null==e?"":e}}function gC(){this.innerHTML=""}function bC(t){return function(){this.innerHTML=t}}function vC(t){return function(){var e=t.apply(this,arguments);this.innerHTML=null==e?"":e}}function yC(){this.nextSibling&&this.parentNode.appendChild(this)}function wC(){this.previousSibling&&this.parentNode.insertBefore(this,this.parentNode.firstChild)}function xC(){return null}function kC(){var t=this.parentNode;t&&t.removeChild(this)}function $C(){var t=this.cloneNode(!1),e=this.parentNode;return e?e.insertBefore(t,this.nextSibling):t}function SC(){var t=this.cloneNode(!0),e=this.parentNode;return e?e.insertBefore(t,this.nextSibling):t}function _C(t){return function(){var e=this.__on;if(e){for(var r,n=0,i=-1,a=e.length;n<a;++n)r=e[n],t.type&&r.type!==t.type||r.name!==t.name?e[++i]=r:this.removeEventListener(r.type,r.listener,r.options);++i?e.length=i:delete this.__on}}}function AC(t,e,r){return function(){var n,i=this.__on,a=function(t){return function(e){t.call(this,e,this.__data__)}}(e);if(i)for(var s=0,o=i.length;s<o;++s)if((n=i[s]).type===t.type&&n.name===t.name)return this.removeEventListener(n.type,n.listener,n.options),this.addEventListener(n.type,n.listener=a,n.options=r),void(n.value=e);this.addEventListener(t.type,a,r),n={type:t.type,name:t.name,value:e,listener:a,options:r},i?i.push(n):this.__on=[n]}}function EC(t,e,r){var n=GN(t),i=n.CustomEvent;"function"==typeof i?i=new i(e,r):(i=n.document.createEvent("Event"),r?(i.initEvent(e,r.bubbles,r.cancelable),i.detail=r.detail):i.initEvent(e,!1,!1)),t.dispatchEvent(i)}function MC(t,e){return function(){return EC(this,t,e)}}function TC(t,e){return function(){return EC(this,t,e.apply(this,arguments))}}zN.prototype={constructor:zN,appendChild:function(t){return this._parent.insertBefore(t,this._next)},insertBefore:function(t,e){return this._parent.insertBefore(t,e)},querySelector:function(t){return this._parent.querySelector(t)},querySelectorAll:function(t){return this._parent.querySelectorAll(t)}},oC.prototype={add:function(t){this._names.indexOf(t)<0&&(this._names.push(t),this._node.setAttribute("class",this._names.join(" ")))},remove:function(t){var e=this._names.indexOf(t);e>=0&&(this._names.splice(e,1),this._node.setAttribute("class",this._names.join(" ")))},contains:function(t){return this._names.indexOf(t)>=0}};var NC=[null];function CC(t,e){this._groups=t,this._parents=e}function RC(){return new CC([[document.documentElement]],NC)}function OC(t){return"string"==typeof t?new CC([[document.querySelector(t)]],[document.documentElement]):new CC([[t]],NC)}function PC(t,e){if(t=function(t){let e;for(;e=t.sourceEvent;)t=e;return t}(t),void 0===e&&(e=t.currentTarget),e){var r=e.ownerSVGElement||e;if(r.createSVGPoint){var n=r.createSVGPoint();return n.x=t.clientX,n.y=t.clientY,[(n=n.matrixTransform(e.getScreenCTM().inverse())).x,n.y]}if(e.getBoundingClientRect){var i=e.getBoundingClientRect();return[t.clientX-i.left-e.clientLeft,t.clientY-i.top-e.clientTop]}}return[t.pageX,t.pageY]}CC.prototype=RC.prototype={constructor:CC,select:function(t){"function"!=typeof t&&(t=MN(t));for(var e=this._groups,r=e.length,n=new Array(r),i=0;i<r;++i)for(var a,s,o=e[i],l=o.length,c=n[i]=new Array(l),u=0;u<l;++u)(a=o[u])&&(s=t.call(a,a.__data__,u,o))&&("__data__"in a&&(s.__data__=a.__data__),c[u]=s);return new CC(n,this._parents)},selectAll:function(t){t="function"==typeof t?CN(t):NN(t);for(var e=this._groups,r=e.length,n=[],i=[],a=0;a<r;++a)for(var s,o=e[a],l=o.length,c=0;c<l;++c)(s=o[c])&&(n.push(t.call(s,s.__data__,c,o)),i.push(s));return new CC(n,i)},selectChild:function(t){return this.select(null==t?IN:function(t){return function(){return PN.call(this.children,t)}}("function"==typeof t?t:ON(t)))},selectChildren:function(t){return this.selectAll(null==t?DN:function(t){return function(){return FN.call(this.children,t)}}("function"==typeof t?t:ON(t)))},filter:function(t){"function"!=typeof t&&(t=RN(t));for(var e=this._groups,r=e.length,n=new Array(r),i=0;i<r;++i)for(var a,s=e[i],o=s.length,l=n[i]=[],c=0;c<o;++c)(a=s[c])&&t.call(a,a.__data__,c,s)&&l.push(a);return new CC(n,this._parents)},data:function(t,e){if(!arguments.length)return Array.from(this,LN);var r=e?UN:qN,n=this._parents,i=this._groups;"function"!=typeof t&&(t=function(t){return function(){return t}}(t));for(var a=i.length,s=new Array(a),o=new Array(a),l=new Array(a),c=0;c<a;++c){var u=n[c],h=i[c],d=h.length,f=HN(t.call(u,u&&u.__data__,c,n)),p=f.length,m=o[c]=new Array(p),g=s[c]=new Array(p);r(u,h,m,g,l[c]=new Array(d),f,e);for(var b,v,y=0,w=0;y<p;++y)if(b=m[y]){for(y>=w&&(w=y+1);!(v=g[w])&&++w<p;);b._next=v||null}}return(s=new CC(s,n))._enter=o,s._exit=l,s},enter:function(){return new CC(this._enter||this._groups.map(jN),this._parents)},exit:function(){return new CC(this._exit||this._groups.map(jN),this._parents)},join:function(t,e,r){var n=this.enter(),i=this,a=this.exit();return"function"==typeof t?(n=t(n))&&(n=n.selection()):n=n.append(t+""),null!=e&&(i=e(i))&&(i=i.selection()),null==r?a.remove():r(a),n&&i?n.merge(i).order():i},merge:function(t){for(var e=t.selection?t.selection():t,r=this._groups,n=e._groups,i=r.length,a=n.length,s=Math.min(i,a),o=new Array(i),l=0;l<s;++l)for(var c,u=r[l],h=n[l],d=u.length,f=o[l]=new Array(d),p=0;p<d;++p)(c=u[p]||h[p])&&(f[p]=c);for(;l<i;++l)o[l]=r[l];return new CC(o,this._parents)},selection:function(){return this},order:function(){for(var t=this._groups,e=-1,r=t.length;++e<r;)for(var n,i=t[e],a=i.length-1,s=i[a];--a>=0;)(n=i[a])&&(s&&4^n.compareDocumentPosition(s)&&s.parentNode.insertBefore(n,s),s=n);return this},sort:function(t){function e(e,r){return e&&r?t(e.__data__,r.__data__):!e-!r}t||(t=BN);for(var r=this._groups,n=r.length,i=new Array(n),a=0;a<n;++a){for(var s,o=r[a],l=o.length,c=i[a]=new Array(l),u=0;u<l;++u)(s=o[u])&&(c[u]=s);c.sort(e)}return new CC(i,this._parents).order()},call:function(){var t=arguments[0];return arguments[0]=this,t.apply(null,arguments),this},nodes:function(){return Array.from(this)},node:function(){for(var t=this._groups,e=0,r=t.length;e<r;++e)for(var n=t[e],i=0,a=n.length;i<a;++i){var s=n[i];if(s)return s}return null},size:function(){let t=0;for(const e of this)++t;return t},empty:function(){return!this.node()},each:function(t){for(var e=this._groups,r=0,n=e.length;r<n;++r)for(var i,a=e[r],s=0,o=a.length;s<o;++s)(i=a[s])&&t.call(i,i.__data__,s,a);return this},attr:function(t,e){var r=$N(t);if(arguments.length<2){var n=this.node();return r.local?n.getAttributeNS(r.space,r.local):n.getAttribute(r)}return this.each((null==e?r.local?WN:VN:"function"==typeof e?r.local?ZN:KN:r.local?YN:XN)(r,e))},style:function(t,e,r){return arguments.length>1?this.each((null==e?JN:"function"==typeof e?tC:QN)(t,e,null==r?"":r)):eC(this.node(),t)},property:function(t,e){return arguments.length>1?this.each((null==e?rC:"function"==typeof e?iC:nC)(t,e)):this.node()[t]},classed:function(t,e){var r=aC(t+"");if(arguments.length<2){for(var n=sC(this.node()),i=-1,a=r.length;++i<a;)if(!n.contains(r[i]))return!1;return!0}return this.each(("function"==typeof e?dC:e?uC:hC)(r,e))},text:function(t){return arguments.length?this.each(null==t?fC:("function"==typeof t?mC:pC)(t)):this.node().textContent},html:function(t){return arguments.length?this.each(null==t?gC:("function"==typeof t?vC:bC)(t)):this.node().innerHTML},raise:function(){return this.each(yC)},lower:function(){return this.each(wC)},append:function(t){var e="function"==typeof t?t:AN(t);return this.select(function(){return this.appendChild(e.apply(this,arguments))})},insert:function(t,e){var r="function"==typeof t?t:AN(t),n=null==e?xC:"function"==typeof e?e:MN(e);return this.select(function(){return this.insertBefore(r.apply(this,arguments),n.apply(this,arguments)||null)})},remove:function(){return this.each(kC)},clone:function(t){return this.select(t?SC:$C)},datum:function(t){return arguments.length?this.property("__data__",t):this.node().__data__},on:function(t,e,r){var n,i,a=function(t){return t.trim().split(/^|\s+/).map(function(t){var e="",r=t.indexOf(".");return r>=0&&(e=t.slice(r+1),t=t.slice(0,r)),{type:t,name:e}})}(t+""),s=a.length;if(!(arguments.length<2)){for(o=e?AC:_C,n=0;n<s;++n)this.each(o(a[n],e,r));return this}var o=this.node().__on;if(o)for(var l,c=0,u=o.length;c<u;++c)for(n=0,l=o[c];n<s;++n)if((i=a[n]).type===l.type&&i.name===l.name)return l.value},dispatch:function(t,e){return this.each(("function"==typeof e?TC:MC)(t,e))},[Symbol.iterator]:function*(){for(var t=this._groups,e=0,r=t.length;e<r;++e)for(var n,i=t[e],a=0,s=i.length;a<s;++a)(n=i[a])&&(yield n)}};const IC={passive:!1},FC={capture:!0,passive:!1};function DC(t){t.stopImmediatePropagation()}function jC(t){t.preventDefault(),t.stopImmediatePropagation()}var zC=t=>()=>t;function qC(t,{sourceEvent:e,subject:r,target:n,identifier:i,active:a,x:s,y:o,dx:l,dy:c,dispatch:u}){Object.defineProperties(this,{type:{value:t,enumerable:!0,configurable:!0},sourceEvent:{value:e,enumerable:!0,configurable:!0},subject:{value:r,enumerable:!0,configurable:!0},target:{value:n,enumerable:!0,configurable:!0},identifier:{value:i,enumerable:!0,configurable:!0},active:{value:a,enumerable:!0,configurable:!0},x:{value:s,enumerable:!0,configurable:!0},y:{value:o,enumerable:!0,configurable:!0},dx:{value:l,enumerable:!0,configurable:!0},dy:{value:c,enumerable:!0,configurable:!0},_:{value:u}})}function UC(t){return!t.ctrlKey&&!t.button}function LC(){return this.parentNode}function HC(t,e){return null==e?{x:t.x,y:t.y}:e}function BC(){return navigator.maxTouchPoints||"ontouchstart"in this}function VC(){var t,e,r,n,i=UC,a=LC,s=HC,o=BC,l={},c=bN("start","drag","end"),u=0,h=0;function d(t){t.on("mousedown.drag",f).filter(o).on("touchstart.drag",g).on("touchmove.drag",b,IC).on("touchend.drag touchcancel.drag",v).style("touch-action","none").style("-webkit-tap-highlight-color","rgba(0,0,0,0)")}function f(s,o){if(!n&&i.call(this,s,o)){var l=y(this,a.call(this,s,o),s,o,"mouse");l&&(OC(s.view).on("mousemove.drag",p,FC).on("mouseup.drag",m,FC),function(t){var e=t.document.documentElement,r=OC(t).on("dragstart.drag",jC,FC);"onselectstart"in e?r.on("selectstart.drag",jC,FC):(e.__noselect=e.style.MozUserSelect,e.style.MozUserSelect="none")}(s.view),DC(s),r=!1,t=s.clientX,e=s.clientY,l("start",s))}}function p(n){if(jC(n),!r){var i=n.clientX-t,a=n.clientY-e;r=i*i+a*a>h}l.mouse("drag",n)}function m(t){OC(t.view).on("mousemove.drag mouseup.drag",null),function(t,e){var r=t.document.documentElement,n=OC(t).on("dragstart.drag",null);e&&(n.on("click.drag",jC,FC),setTimeout(function(){n.on("click.drag",null)},0)),"onselectstart"in r?n.on("selectstart.drag",null):(r.style.MozUserSelect=r.__noselect,delete r.__noselect)}(t.view,r),jC(t),l.mouse("end",t)}function g(t,e){if(i.call(this,t,e)){var r,n,s=t.changedTouches,o=a.call(this,t,e),l=s.length;for(r=0;r<l;++r)(n=y(this,o,t,e,s[r].identifier,s[r]))&&(DC(t),n("start",t,s[r]))}}function b(t){var e,r,n=t.changedTouches,i=n.length;for(e=0;e<i;++e)(r=l[n[e].identifier])&&(jC(t),r("drag",t,n[e]))}function v(t){var e,r,i=t.changedTouches,a=i.length;for(n&&clearTimeout(n),n=setTimeout(function(){n=null},500),e=0;e<a;++e)(r=l[i[e].identifier])&&(DC(t),r("end",t,i[e]))}function y(t,e,r,n,i,a){var o,h,f,p=c.copy(),m=PC(a||r,e);if(null!=(f=s.call(t,new qC("beforestart",{sourceEvent:r,target:d,identifier:i,active:u,x:m[0],y:m[1],dx:0,dy:0,dispatch:p}),n)))return o=f.x-m[0]||0,h=f.y-m[1]||0,function r(a,s,c){var g,b=m;switch(a){case"start":l[i]=r,g=u++;break;case"end":delete l[i],--u;case"drag":m=PC(c||s,e),g=u}p.call(a,t,new qC(a,{sourceEvent:s,subject:f,target:d,identifier:i,active:g,x:m[0]+o,y:m[1]+h,dx:m[0]-b[0],dy:m[1]-b[1],dispatch:p}),n)}}return d.filter=function(t){return arguments.length?(i="function"==typeof t?t:zC(!!t),d):i},d.container=function(t){return arguments.length?(a="function"==typeof t?t:zC(t),d):a},d.subject=function(t){return arguments.length?(s="function"==typeof t?t:zC(t),d):s},d.touchable=function(t){return arguments.length?(o="function"==typeof t?t:zC(!!t),d):o},d.on=function(){var t=c.on.apply(c,arguments);return t===c?d:t},d.clickDistance=function(t){return arguments.length?(h=(t=+t)*t,d):Math.sqrt(h)},d}function WC(t,e,r){t.prototype=e.prototype=r,r.constructor=t}function XC(t,e){var r=Object.create(t.prototype);for(var n in e)r[n]=e[n];return r}function YC(){}qC.prototype.on=function(){var t=this._.on.apply(this._,arguments);return t===this._?this:t};var KC=.7,ZC=1/KC,GC="\\s*([+-]?\\d+)\\s*",JC="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*",QC="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",tR=/^#([0-9a-f]{3,8})$/,eR=new RegExp(`^rgb\\(${GC},${GC},${GC}\\)$`),rR=new RegExp(`^rgb\\(${QC},${QC},${QC}\\)$`),nR=new RegExp(`^rgba\\(${GC},${GC},${GC},${JC}\\)$`),iR=new RegExp(`^rgba\\(${QC},${QC},${QC},${JC}\\)$`),aR=new RegExp(`^hsl\\(${JC},${QC},${QC}\\)$`),sR=new RegExp(`^hsla\\(${JC},${QC},${QC},${JC}\\)$`),oR={aliceblue:15792383,antiquewhite:16444375,aqua:65535,aquamarine:8388564,azure:15794175,beige:16119260,bisque:16770244,black:0,blanchedalmond:16772045,blue:255,blueviolet:9055202,brown:10824234,burlywood:14596231,cadetblue:6266528,chartreuse:8388352,chocolate:13789470,coral:16744272,cornflowerblue:6591981,cornsilk:16775388,crimson:14423100,cyan:65535,darkblue:139,darkcyan:35723,darkgoldenrod:12092939,darkgray:11119017,darkgreen:25600,darkgrey:11119017,darkkhaki:12433259,darkmagenta:9109643,darkolivegreen:5597999,darkorange:16747520,darkorchid:10040012,darkred:9109504,darksalmon:15308410,darkseagreen:9419919,darkslateblue:4734347,darkslategray:3100495,darkslategrey:3100495,darkturquoise:52945,darkviolet:9699539,deeppink:16716947,deepskyblue:49151,dimgray:6908265,dimgrey:6908265,dodgerblue:2003199,firebrick:11674146,floralwhite:16775920,forestgreen:2263842,fuchsia:16711935,gainsboro:14474460,ghostwhite:16316671,gold:16766720,goldenrod:14329120,gray:8421504,green:32768,greenyellow:11403055,grey:8421504,honeydew:15794160,hotpink:16738740,indianred:13458524,indigo:4915330,ivory:16777200,khaki:15787660,lavender:15132410,lavenderblush:16773365,lawngreen:8190976,lemonchiffon:16775885,lightblue:11393254,lightcoral:15761536,lightcyan:14745599,lightgoldenrodyellow:16448210,lightgray:13882323,lightgreen:9498256,lightgrey:13882323,lightpink:16758465,lightsalmon:16752762,lightseagreen:2142890,lightskyblue:8900346,lightslategray:7833753,lightslategrey:7833753,lightsteelblue:11584734,lightyellow:16777184,lime:65280,limegreen:3329330,linen:16445670,magenta:16711935,maroon:8388608,mediumaquamarine:6737322,mediumblue:205,mediumorchid:12211667,mediumpurple:9662683,mediumseagreen:3978097,mediumslateblue:8087790,mediumspringgreen:64154,mediumturquoise:4772300,mediumvioletred:13047173,midnightblue:1644912,mintcream:16121850,mistyrose:16770273,moccasin:16770229,navajowhite:16768685,navy:128,oldlace:16643558,olive:8421376,olivedrab:7048739,orange:16753920,orangered:16729344,orchid:14315734,palegoldenrod:15657130,palegreen:10025880,paleturquoise:11529966,palevioletred:14381203,papayawhip:16773077,peachpuff:16767673,peru:13468991,pink:16761035,plum:14524637,powderblue:11591910,purple:8388736,rebeccapurple:6697881,red:16711680,rosybrown:12357519,royalblue:4286945,saddlebrown:9127187,salmon:16416882,sandybrown:16032864,seagreen:3050327,seashell:16774638,sienna:10506797,silver:12632256,skyblue:8900331,slateblue:6970061,slategray:7372944,slategrey:7372944,snow:16775930,springgreen:65407,steelblue:4620980,tan:13808780,teal:32896,thistle:14204888,tomato:16737095,turquoise:4251856,violet:15631086,wheat:16113331,white:16777215,whitesmoke:16119285,yellow:16776960,yellowgreen:10145074};function lR(){return this.rgb().formatHex()}function cR(){return this.rgb().formatRgb()}function uR(t){var e,r;return t=(t+"").trim().toLowerCase(),(e=tR.exec(t))?(r=e[1].length,e=parseInt(e[1],16),6===r?hR(e):3===r?new pR(e>>8&15|e>>4&240,e>>4&15|240&e,(15&e)<<4|15&e,1):8===r?dR(e>>24&255,e>>16&255,e>>8&255,(255&e)/255):4===r?dR(e>>12&15|e>>8&240,e>>8&15|e>>4&240,e>>4&15|240&e,((15&e)<<4|15&e)/255):null):(e=eR.exec(t))?new pR(e[1],e[2],e[3],1):(e=rR.exec(t))?new pR(255*e[1]/100,255*e[2]/100,255*e[3]/100,1):(e=nR.exec(t))?dR(e[1],e[2],e[3],e[4]):(e=iR.exec(t))?dR(255*e[1]/100,255*e[2]/100,255*e[3]/100,e[4]):(e=aR.exec(t))?wR(e[1],e[2]/100,e[3]/100,1):(e=sR.exec(t))?wR(e[1],e[2]/100,e[3]/100,e[4]):oR.hasOwnProperty(t)?hR(oR[t]):"transparent"===t?new pR(NaN,NaN,NaN,0):null}function hR(t){return new pR(t>>16&255,t>>8&255,255&t,1)}function dR(t,e,r,n){return n<=0&&(t=e=r=NaN),new pR(t,e,r,n)}function fR(t,e,r,n){return 1===arguments.length?function(t){return t instanceof YC||(t=uR(t)),t?new pR((t=t.rgb()).r,t.g,t.b,t.opacity):new pR}(t):new pR(t,e,r,null==n?1:n)}function pR(t,e,r,n){this.r=+t,this.g=+e,this.b=+r,this.opacity=+n}function mR(){return`#${yR(this.r)}${yR(this.g)}${yR(this.b)}`}function gR(){const t=bR(this.opacity);return`${1===t?"rgb(":"rgba("}${vR(this.r)}, ${vR(this.g)}, ${vR(this.b)}${1===t?")":`, ${t})`}`}function bR(t){return isNaN(t)?1:Math.max(0,Math.min(1,t))}function vR(t){return Math.max(0,Math.min(255,Math.round(t)||0))}function yR(t){return((t=vR(t))<16?"0":"")+t.toString(16)}function wR(t,e,r,n){return n<=0?t=e=r=NaN:r<=0||r>=1?t=e=NaN:e<=0&&(t=NaN),new kR(t,e,r,n)}function xR(t){if(t instanceof kR)return new kR(t.h,t.s,t.l,t.opacity);if(t instanceof YC||(t=uR(t)),!t)return new kR;if(t instanceof kR)return t;var e=(t=t.rgb()).r/255,r=t.g/255,n=t.b/255,i=Math.min(e,r,n),a=Math.max(e,r,n),s=NaN,o=a-i,l=(a+i)/2;return o?(s=e===a?(r-n)/o+6*(r<n):r===a?(n-e)/o+2:(e-r)/o+4,o/=l<.5?a+i:2-a-i,s*=60):o=l>0&&l<1?0:s,new kR(s,o,l,t.opacity)}function kR(t,e,r,n){this.h=+t,this.s=+e,this.l=+r,this.opacity=+n}function $R(t){return(t=(t||0)%360)<0?t+360:t}function SR(t){return Math.max(0,Math.min(1,t||0))}function _R(t,e,r){return 255*(t<60?e+(r-e)*t/60:t<180?r:t<240?e+(r-e)*(240-t)/60:e)}WC(YC,uR,{copy(t){return Object.assign(new this.constructor,this,t)},displayable(){return this.rgb().displayable()},hex:lR,formatHex:lR,formatHex8:function(){return this.rgb().formatHex8()},formatHsl:function(){return xR(this).formatHsl()},formatRgb:cR,toString:cR}),WC(pR,fR,XC(YC,{brighter(t){return t=null==t?ZC:Math.pow(ZC,t),new pR(this.r*t,this.g*t,this.b*t,this.opacity)},darker(t){return t=null==t?KC:Math.pow(KC,t),new pR(this.r*t,this.g*t,this.b*t,this.opacity)},rgb(){return this},clamp(){return new pR(vR(this.r),vR(this.g),vR(this.b),bR(this.opacity))},displayable(){return-.5<=this.r&&this.r<255.5&&-.5<=this.g&&this.g<255.5&&-.5<=this.b&&this.b<255.5&&0<=this.opacity&&this.opacity<=1},hex:mR,formatHex:mR,formatHex8:function(){return`#${yR(this.r)}${yR(this.g)}${yR(this.b)}${yR(255*(isNaN(this.opacity)?1:this.opacity))}`},formatRgb:gR,toString:gR})),WC(kR,function(t,e,r,n){return 1===arguments.length?xR(t):new kR(t,e,r,null==n?1:n)},XC(YC,{brighter(t){return t=null==t?ZC:Math.pow(ZC,t),new kR(this.h,this.s,this.l*t,this.opacity)},darker(t){return t=null==t?KC:Math.pow(KC,t),new kR(this.h,this.s,this.l*t,this.opacity)},rgb(){var t=this.h%360+360*(this.h<0),e=isNaN(t)||isNaN(this.s)?0:this.s,r=this.l,n=r+(r<.5?r:1-r)*e,i=2*r-n;return new pR(_R(t>=240?t-240:t+120,i,n),_R(t,i,n),_R(t<120?t+240:t-120,i,n),this.opacity)},clamp(){return new kR($R(this.h),SR(this.s),SR(this.l),bR(this.opacity))},displayable(){return(0<=this.s&&this.s<=1||isNaN(this.s))&&0<=this.l&&this.l<=1&&0<=this.opacity&&this.opacity<=1},formatHsl(){const t=bR(this.opacity);return`${1===t?"hsl(":"hsla("}${$R(this.h)}, ${100*SR(this.s)}%, ${100*SR(this.l)}%${1===t?")":`, ${t})`}`}}));var AR=t=>()=>t;function ER(t){return 1===(t=+t)?MR:function(e,r){return r-e?function(t,e,r){return t=Math.pow(t,r),e=Math.pow(e,r)-t,r=1/r,function(n){return Math.pow(t+n*e,r)}}(e,r,t):AR(isNaN(e)?r:e)}}function MR(t,e){var r=e-t;return r?function(t,e){return function(r){return t+r*e}}(t,r):AR(isNaN(t)?e:t)}var TR=function t(e){var r=ER(e);function n(t,e){var n=r((t=fR(t)).r,(e=fR(e)).r),i=r(t.g,e.g),a=r(t.b,e.b),s=MR(t.opacity,e.opacity);return function(e){return t.r=n(e),t.g=i(e),t.b=a(e),t.opacity=s(e),t+""}}return n.gamma=t,n}(1);function NR(t,e){e||(e=[]);var r,n=t?Math.min(e.length,t.length):0,i=e.slice();return function(a){for(r=0;r<n;++r)i[r]=t[r]*(1-a)+e[r]*a;return i}}function CR(t,e){var r,n=e?e.length:0,i=t?Math.min(n,t.length):0,a=new Array(i),s=new Array(n);for(r=0;r<i;++r)a[r]=jR(t[r],e[r]);for(;r<n;++r)s[r]=e[r];return function(t){for(r=0;r<i;++r)s[r]=a[r](t);return s}}function RR(t,e){var r=new Date;return t=+t,e=+e,function(n){return r.setTime(t*(1-n)+e*n),r}}function OR(t,e){return t=+t,e=+e,function(r){return t*(1-r)+e*r}}function PR(t,e){var r,n={},i={};for(r in null!==t&&"object"==typeof t||(t={}),null!==e&&"object"==typeof e||(e={}),e)r in t?n[r]=jR(t[r],e[r]):i[r]=e[r];return function(t){for(r in n)i[r]=n[r](t);return i}}var IR=/[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,FR=new RegExp(IR.source,"g");function DR(t,e){var r,n,i,a=IR.lastIndex=FR.lastIndex=0,s=-1,o=[],l=[];for(t+="",e+="";(r=IR.exec(t))&&(n=FR.exec(e));)(i=n.index)>a&&(i=e.slice(a,i),o[s]?o[s]+=i:o[++s]=i),(r=r[0])===(n=n[0])?o[s]?o[s]+=n:o[++s]=n:(o[++s]=null,l.push({i:s,x:OR(r,n)})),a=FR.lastIndex;return a<e.length&&(i=e.slice(a),o[s]?o[s]+=i:o[++s]=i),o.length<2?l[0]?function(t){return function(e){return t(e)+""}}(l[0].x):function(t){return function(){return t}}(e):(e=l.length,function(t){for(var r,n=0;n<e;++n)o[(r=l[n]).i]=r.x(t);return o.join("")})}function jR(t,e){var r,n=typeof e;return null==e||"boolean"===n?AR(e):("number"===n?OR:"string"===n?(r=uR(e))?(e=r,TR):DR:e instanceof uR?TR:e instanceof Date?RR:function(t){return ArrayBuffer.isView(t)&&!(t instanceof DataView)}(e)?NR:Array.isArray(e)?CR:"function"!=typeof e.valueOf&&"function"!=typeof e.toString||isNaN(e)?PR:OR)(t,e)}function zR(t,e){return t=+t,e=+e,function(r){return Math.round(t*(1-r)+e*r)}}var qR,UR=180/Math.PI,LR={translateX:0,translateY:0,rotate:0,skewX:0,scaleX:1,scaleY:1};function HR(t,e,r,n,i,a){var s,o,l;return(s=Math.sqrt(t*t+e*e))&&(t/=s,e/=s),(l=t*r+e*n)&&(r-=t*l,n-=e*l),(o=Math.sqrt(r*r+n*n))&&(r/=o,n/=o,l/=o),t*n<e*r&&(t=-t,e=-e,l=-l,s=-s),{translateX:i,translateY:a,rotate:Math.atan2(e,t)*UR,skewX:Math.atan(l)*UR,scaleX:s,scaleY:o}}function BR(t,e,r,n){function i(t){return t.length?t.pop()+" ":""}return function(a,s){var o=[],l=[];return a=t(a),s=t(s),function(t,n,i,a,s,o){if(t!==i||n!==a){var l=s.push("translate(",null,e,null,r);o.push({i:l-4,x:OR(t,i)},{i:l-2,x:OR(n,a)})}else(i||a)&&s.push("translate("+i+e+a+r)}(a.translateX,a.translateY,s.translateX,s.translateY,o,l),function(t,e,r,a){t!==e?(t-e>180?e+=360:e-t>180&&(t+=360),a.push({i:r.push(i(r)+"rotate(",null,n)-2,x:OR(t,e)})):e&&r.push(i(r)+"rotate("+e+n)}(a.rotate,s.rotate,o,l),function(t,e,r,a){t!==e?a.push({i:r.push(i(r)+"skewX(",null,n)-2,x:OR(t,e)}):e&&r.push(i(r)+"skewX("+e+n)}(a.skewX,s.skewX,o,l),function(t,e,r,n,a,s){if(t!==r||e!==n){var o=a.push(i(a)+"scale(",null,",",null,")");s.push({i:o-4,x:OR(t,r)},{i:o-2,x:OR(e,n)})}else 1===r&&1===n||a.push(i(a)+"scale("+r+","+n+")")}(a.scaleX,a.scaleY,s.scaleX,s.scaleY,o,l),a=s=null,function(t){for(var e,r=-1,n=l.length;++r<n;)o[(e=l[r]).i]=e.x(t);return o.join("")}}}var VR,WR,XR=BR(function(t){const e=new("function"==typeof DOMMatrix?DOMMatrix:WebKitCSSMatrix)(t+"");return e.isIdentity?LR:HR(e.a,e.b,e.c,e.d,e.e,e.f)},"px, ","px)","deg)"),YR=BR(function(t){return null==t?LR:(qR||(qR=document.createElementNS("http://www.w3.org/2000/svg","g")),qR.setAttribute("transform",t),(t=qR.transform.baseVal.consolidate())?HR((t=t.matrix).a,t.b,t.c,t.d,t.e,t.f):LR)},", ",")",")"),KR=0,ZR=0,GR=0,JR=0,QR=0,tO=0,eO="object"==typeof performance&&performance.now?performance:Date,rO="object"==typeof window&&window.requestAnimationFrame?window.requestAnimationFrame.bind(window):function(t){setTimeout(t,17)};function nO(){return QR||(rO(iO),QR=eO.now()+tO)}function iO(){QR=0}function aO(){this._call=this._time=this._next=null}function sO(t,e,r){var n=new aO;return n.restart(t,e,r),n}function oO(){QR=(JR=eO.now())+tO,KR=ZR=0;try{!function(){nO(),++KR;for(var t,e=VR;e;)(t=QR-e._time)>=0&&e._call.call(void 0,t),e=e._next;--KR}()}finally{KR=0,function(){var t,e,r=VR,n=1/0;for(;r;)r._call?(n>r._time&&(n=r._time),t=r,r=r._next):(e=r._next,r._next=null,r=t?t._next=e:VR=e);WR=t,cO(n)}(),QR=0}}function lO(){var t=eO.now(),e=t-JR;e>1e3&&(tO-=e,JR=t)}function cO(t){KR||(ZR&&(ZR=clearTimeout(ZR)),t-QR>24?(t<1/0&&(ZR=setTimeout(oO,t-eO.now()-tO)),GR&&(GR=clearInterval(GR))):(GR||(JR=eO.now(),GR=setInterval(lO,1e3)),KR=1,rO(oO)))}function uO(t,e,r){var n=new aO;return e=null==e?0:+e,n.restart(r=>{n.stop(),t(r+e)},e,r),n}aO.prototype=sO.prototype={constructor:aO,restart:function(t,e,r){if("function"!=typeof t)throw new TypeError("callback is not a function");r=(null==r?nO():+r)+(null==e?0:+e),this._next||WR===this||(WR?WR._next=this:VR=this,WR=this),this._call=t,this._time=r,cO()},stop:function(){this._call&&(this._call=null,this._time=1/0,cO())}};var hO=bN("start","end","cancel","interrupt"),dO=[];function fO(t,e,r,n,i,a){var s=t.__transition;if(s){if(r in s)return}else t.__transition={};!function(t,e,r){var n,i=t.__transition;function a(t){r.state=1,r.timer.restart(s,r.delay,r.time),r.delay<=t&&s(t-r.delay)}function s(a){var c,u,h,d;if(1!==r.state)return l();for(c in i)if((d=i[c]).name===r.name){if(3===d.state)return uO(s);4===d.state?(d.state=6,d.timer.stop(),d.on.call("interrupt",t,t.__data__,d.index,d.group),delete i[c]):+c<e&&(d.state=6,d.timer.stop(),d.on.call("cancel",t,t.__data__,d.index,d.group),delete i[c])}if(uO(function(){3===r.state&&(r.state=4,r.timer.restart(o,r.delay,r.time),o(a))}),r.state=2,r.on.call("start",t,t.__data__,r.index,r.group),2===r.state){for(r.state=3,n=new Array(h=r.tween.length),c=0,u=-1;c<h;++c)(d=r.tween[c].value.call(t,t.__data__,r.index,r.group))&&(n[++u]=d);n.length=u+1}}function o(e){for(var i=e<r.duration?r.ease.call(null,e/r.duration):(r.timer.restart(l),r.state=5,1),a=-1,s=n.length;++a<s;)n[a].call(t,i);5===r.state&&(r.on.call("end",t,t.__data__,r.index,r.group),l())}function l(){for(var n in r.state=6,r.timer.stop(),delete i[e],i)return;delete t.__transition}i[e]=r,r.timer=sO(a,0,r.time)}(t,r,{name:e,index:n,group:i,on:hO,tween:dO,time:a.time,delay:a.delay,duration:a.duration,ease:a.ease,timer:null,state:0})}function pO(t,e){var r=gO(t,e);if(r.state>0)throw new Error("too late; already scheduled");return r}function mO(t,e){var r=gO(t,e);if(r.state>3)throw new Error("too late; already running");return r}function gO(t,e){var r=t.__transition;if(!r||!(r=r[e]))throw new Error("transition not found");return r}function bO(t,e){var r,n;return function(){var i=mO(this,t),a=i.tween;if(a!==r)for(var s=0,o=(n=r=a).length;s<o;++s)if(n[s].name===e){(n=n.slice()).splice(s,1);break}i.tween=n}}function vO(t,e,r){var n,i;if("function"!=typeof r)throw new Error;return function(){var a=mO(this,t),s=a.tween;if(s!==n){i=(n=s).slice();for(var o={name:e,value:r},l=0,c=i.length;l<c;++l)if(i[l].name===e){i[l]=o;break}l===c&&i.push(o)}a.tween=i}}function yO(t,e,r){var n=t._id;return t.each(function(){var t=mO(this,n);(t.value||(t.value={}))[e]=r.apply(this,arguments)}),function(t){return gO(t,n).value[e]}}function wO(t,e){var r;return("number"==typeof e?OR:e instanceof uR?TR:(r=uR(e))?(e=r,TR):DR)(t,e)}function xO(t){return function(){this.removeAttribute(t)}}function kO(t){return function(){this.removeAttributeNS(t.space,t.local)}}function $O(t,e,r){var n,i,a=r+"";return function(){var s=this.getAttribute(t);return s===a?null:s===n?i:i=e(n=s,r)}}function SO(t,e,r){var n,i,a=r+"";return function(){var s=this.getAttributeNS(t.space,t.local);return s===a?null:s===n?i:i=e(n=s,r)}}function _O(t,e,r){var n,i,a;return function(){var s,o,l=r(this);if(null!=l)return(s=this.getAttribute(t))===(o=l+"")?null:s===n&&o===i?a:(i=o,a=e(n=s,l));this.removeAttribute(t)}}function AO(t,e,r){var n,i,a;return function(){var s,o,l=r(this);if(null!=l)return(s=this.getAttributeNS(t.space,t.local))===(o=l+"")?null:s===n&&o===i?a:(i=o,a=e(n=s,l));this.removeAttributeNS(t.space,t.local)}}function EO(t,e){var r,n;function i(){var i=e.apply(this,arguments);return i!==n&&(r=(n=i)&&function(t,e){return function(r){this.setAttributeNS(t.space,t.local,e.call(this,r))}}(t,i)),r}return i._value=e,i}function MO(t,e){var r,n;function i(){var i=e.apply(this,arguments);return i!==n&&(r=(n=i)&&function(t,e){return function(r){this.setAttribute(t,e.call(this,r))}}(t,i)),r}return i._value=e,i}function TO(t,e){return function(){pO(this,t).delay=+e.apply(this,arguments)}}function NO(t,e){return e=+e,function(){pO(this,t).delay=e}}function CO(t,e){return function(){mO(this,t).duration=+e.apply(this,arguments)}}function RO(t,e){return e=+e,function(){mO(this,t).duration=e}}var OO=RC.prototype.constructor;function PO(t){return function(){this.style.removeProperty(t)}}var IO=0;function FO(t,e,r,n){this._groups=t,this._parents=e,this._name=r,this._id=n}function DO(){return++IO}var jO=RC.prototype;FO.prototype={constructor:FO,select:function(t){var e=this._name,r=this._id;"function"!=typeof t&&(t=MN(t));for(var n=this._groups,i=n.length,a=new Array(i),s=0;s<i;++s)for(var o,l,c=n[s],u=c.length,h=a[s]=new Array(u),d=0;d<u;++d)(o=c[d])&&(l=t.call(o,o.__data__,d,c))&&("__data__"in o&&(l.__data__=o.__data__),h[d]=l,fO(h[d],e,r,d,h,gO(o,r)));return new FO(a,this._parents,e,r)},selectAll:function(t){var e=this._name,r=this._id;"function"!=typeof t&&(t=NN(t));for(var n=this._groups,i=n.length,a=[],s=[],o=0;o<i;++o)for(var l,c=n[o],u=c.length,h=0;h<u;++h)if(l=c[h]){for(var d,f=t.call(l,l.__data__,h,c),p=gO(l,r),m=0,g=f.length;m<g;++m)(d=f[m])&&fO(d,e,r,m,f,p);a.push(f),s.push(l)}return new FO(a,s,e,r)},selectChild:jO.selectChild,selectChildren:jO.selectChildren,filter:function(t){"function"!=typeof t&&(t=RN(t));for(var e=this._groups,r=e.length,n=new Array(r),i=0;i<r;++i)for(var a,s=e[i],o=s.length,l=n[i]=[],c=0;c<o;++c)(a=s[c])&&t.call(a,a.__data__,c,s)&&l.push(a);return new FO(n,this._parents,this._name,this._id)},merge:function(t){if(t._id!==this._id)throw new Error;for(var e=this._groups,r=t._groups,n=e.length,i=r.length,a=Math.min(n,i),s=new Array(n),o=0;o<a;++o)for(var l,c=e[o],u=r[o],h=c.length,d=s[o]=new Array(h),f=0;f<h;++f)(l=c[f]||u[f])&&(d[f]=l);for(;o<n;++o)s[o]=e[o];return new FO(s,this._parents,this._name,this._id)},selection:function(){return new OO(this._groups,this._parents)},transition:function(){for(var t=this._name,e=this._id,r=DO(),n=this._groups,i=n.length,a=0;a<i;++a)for(var s,o=n[a],l=o.length,c=0;c<l;++c)if(s=o[c]){var u=gO(s,e);fO(s,t,r,c,o,{time:u.time+u.delay+u.duration,delay:0,duration:u.duration,ease:u.ease})}return new FO(n,this._parents,t,r)},call:jO.call,nodes:jO.nodes,node:jO.node,size:jO.size,empty:jO.empty,each:jO.each,on:function(t,e){var r=this._id;return arguments.length<2?gO(this.node(),r).on.on(t):this.each(function(t,e,r){var n,i,a=function(t){return(t+"").trim().split(/^|\s+/).every(function(t){var e=t.indexOf(".");return e>=0&&(t=t.slice(0,e)),!t||"start"===t})}(e)?pO:mO;return function(){var s=a(this,t),o=s.on;o!==n&&(i=(n=o).copy()).on(e,r),s.on=i}}(r,t,e))},attr:function(t,e){var r=$N(t),n="transform"===r?YR:wO;return this.attrTween(t,"function"==typeof e?(r.local?AO:_O)(r,n,yO(this,"attr."+t,e)):null==e?(r.local?kO:xO)(r):(r.local?SO:$O)(r,n,e))},attrTween:function(t,e){var r="attr."+t;if(arguments.length<2)return(r=this.tween(r))&&r._value;if(null==e)return this.tween(r,null);if("function"!=typeof e)throw new Error;var n=$N(t);return this.tween(r,(n.local?EO:MO)(n,e))},style:function(t,e,r){var n="transform"==(t+="")?XR:wO;return null==e?this.styleTween(t,function(t,e){var r,n,i;return function(){var a=eC(this,t),s=(this.style.removeProperty(t),eC(this,t));return a===s?null:a===r&&s===n?i:i=e(r=a,n=s)}}(t,n)).on("end.style."+t,PO(t)):"function"==typeof e?this.styleTween(t,function(t,e,r){var n,i,a;return function(){var s=eC(this,t),o=r(this),l=o+"";return null==o&&(this.style.removeProperty(t),l=o=eC(this,t)),s===l?null:s===n&&l===i?a:(i=l,a=e(n=s,o))}}(t,n,yO(this,"style."+t,e))).each(function(t,e){var r,n,i,a,s="style."+e,o="end."+s;return function(){var l=mO(this,t),c=l.on,u=null==l.value[s]?a||(a=PO(e)):void 0;c===r&&i===u||(n=(r=c).copy()).on(o,i=u),l.on=n}}(this._id,t)):this.styleTween(t,function(t,e,r){var n,i,a=r+"";return function(){var s=eC(this,t);return s===a?null:s===n?i:i=e(n=s,r)}}(t,n,e),r).on("end.style."+t,null)},styleTween:function(t,e,r){var n="style."+(t+="");if(arguments.length<2)return(n=this.tween(n))&&n._value;if(null==e)return this.tween(n,null);if("function"!=typeof e)throw new Error;return this.tween(n,function(t,e,r){var n,i;function a(){var a=e.apply(this,arguments);return a!==i&&(n=(i=a)&&function(t,e,r){return function(n){this.style.setProperty(t,e.call(this,n),r)}}(t,a,r)),n}return a._value=e,a}(t,e,null==r?"":r))},text:function(t){return this.tween("text","function"==typeof t?function(t){return function(){var e=t(this);this.textContent=null==e?"":e}}(yO(this,"text",t)):function(t){return function(){this.textContent=t}}(null==t?"":t+""))},textTween:function(t){var e="text";if(arguments.length<1)return(e=this.tween(e))&&e._value;if(null==t)return this.tween(e,null);if("function"!=typeof t)throw new Error;return this.tween(e,function(t){var e,r;function n(){var n=t.apply(this,arguments);return n!==r&&(e=(r=n)&&function(t){return function(e){this.textContent=t.call(this,e)}}(n)),e}return n._value=t,n}(t))},remove:function(){return this.on("end.remove",function(t){return function(){var e=this.parentNode;for(var r in this.__transition)if(+r!==t)return;e&&e.removeChild(this)}}(this._id))},tween:function(t,e){var r=this._id;if(t+="",arguments.length<2){for(var n,i=gO(this.node(),r).tween,a=0,s=i.length;a<s;++a)if((n=i[a]).name===t)return n.value;return null}return this.each((null==e?bO:vO)(r,t,e))},delay:function(t){var e=this._id;return arguments.length?this.each(("function"==typeof t?TO:NO)(e,t)):gO(this.node(),e).delay},duration:function(t){var e=this._id;return arguments.length?this.each(("function"==typeof t?CO:RO)(e,t)):gO(this.node(),e).duration},ease:function(t){var e=this._id;return arguments.length?this.each(function(t,e){if("function"!=typeof e)throw new Error;return function(){mO(this,t).ease=e}}(e,t)):gO(this.node(),e).ease},easeVarying:function(t){if("function"!=typeof t)throw new Error;return this.each(function(t,e){return function(){var r=e.apply(this,arguments);if("function"!=typeof r)throw new Error;mO(this,t).ease=r}}(this._id,t))},end:function(){var t,e,r=this,n=r._id,i=r.size();return new Promise(function(a,s){var o={value:s},l={value:function(){0===--i&&a()}};r.each(function(){var r=mO(this,n),i=r.on;i!==t&&((e=(t=i).copy())._.cancel.push(o),e._.interrupt.push(o),e._.end.push(l)),r.on=e}),0===i&&a()})},[Symbol.iterator]:jO[Symbol.iterator]};const zO=t=>+t;function qO(t){return t*t*t}function UO(t){return--t*t*t+1}var LO={time:null,delay:0,duration:250,ease:function(t){return((t*=2)<=1?t*t*t:(t-=2)*t*t+2)/2}};function HO(t,e){for(var r;!(r=t.__transition)||!(r=r[e]);)if(!(t=t.parentNode))throw new Error(`transition ${e} not found`);return r}RC.prototype.interrupt=function(t){return this.each(function(){!function(t,e){var r,n,i,a=t.__transition,s=!0;if(a){for(i in e=null==e?null:e+"",a)(r=a[i]).name===e?(n=r.state>2&&r.state<5,r.state=6,r.timer.stop(),r.on.call(n?"interrupt":"cancel",t,t.__data__,r.index,r.group),delete a[i]):s=!1;s&&delete t.__transition}}(this,t)})},RC.prototype.transition=function(t){var e,r;t instanceof FO?(e=t._id,t=t._name):(e=DO(),(r=LO).time=nO(),t=null==t?null:t+"");for(var n=this._groups,i=n.length,a=0;a<i;++a)for(var s,o=n[a],l=o.length,c=0;c<l;++c)(s=o[c])&&fO(s,t,e,c,o,r||HO(s,e));return new FO(n,this._parents,t,e)};const BO=Math.PI,VO=2*BO,WO=1e-6,XO=VO-WO;function YO(t){this._+=t[0];for(let e=1,r=t.length;e<r;++e)this._+=arguments[e]+t[e]}class KO{constructor(t){this._x0=this._y0=this._x1=this._y1=null,this._="",this._append=null==t?YO:function(t){let e=Math.floor(t);if(!(e>=0))throw new Error(`invalid digits: ${t}`);if(e>15)return YO;const r=10**e;return function(t){this._+=t[0];for(let e=1,n=t.length;e<n;++e)this._+=Math.round(arguments[e]*r)/r+t[e]}}(t)}moveTo(t,e){this._append`M${this._x0=this._x1=+t},${this._y0=this._y1=+e}`}closePath(){null!==this._x1&&(this._x1=this._x0,this._y1=this._y0,this._append`Z`)}lineTo(t,e){this._append`L${this._x1=+t},${this._y1=+e}`}quadraticCurveTo(t,e,r,n){this._append`Q${+t},${+e},${this._x1=+r},${this._y1=+n}`}bezierCurveTo(t,e,r,n,i,a){this._append`C${+t},${+e},${+r},${+n},${this._x1=+i},${this._y1=+a}`}arcTo(t,e,r,n,i){if(t=+t,e=+e,r=+r,n=+n,(i=+i)<0)throw new Error(`negative radius: ${i}`);let a=this._x1,s=this._y1,o=r-t,l=n-e,c=a-t,u=s-e,h=c*c+u*u;if(null===this._x1)this._append`M${this._x1=t},${this._y1=e}`;else if(h>WO)if(Math.abs(u*o-l*c)>WO&&i){let d=r-a,f=n-s,p=o*o+l*l,m=d*d+f*f,g=Math.sqrt(p),b=Math.sqrt(h),v=i*Math.tan((BO-Math.acos((p+h-m)/(2*g*b)))/2),y=v/b,w=v/g;Math.abs(y-1)>WO&&this._append`L${t+y*c},${e+y*u}`,this._append`A${i},${i},0,0,${+(u*d>c*f)},${this._x1=t+w*o},${this._y1=e+w*l}`}else this._append`L${this._x1=t},${this._y1=e}`;else;}arc(t,e,r,n,i,a){if(t=+t,e=+e,a=!!a,(r=+r)<0)throw new Error(`negative radius: ${r}`);let s=r*Math.cos(n),o=r*Math.sin(n),l=t+s,c=e+o,u=1^a,h=a?n-i:i-n;null===this._x1?this._append`M${l},${c}`:(Math.abs(this._x1-l)>WO||Math.abs(this._y1-c)>WO)&&this._append`L${l},${c}`,r&&(h<0&&(h=h%VO+VO),h>XO?this._append`A${r},${r},0,1,${u},${t-s},${e-o}A${r},${r},0,1,${u},${this._x1=l},${this._y1=c}`:h>WO&&this._append`A${r},${r},0,${+(h>=BO)},${u},${this._x1=t+r*Math.cos(i)},${this._y1=e+r*Math.sin(i)}`)}rect(t,e,r,n){this._append`M${this._x0=this._x1=+t},${this._y0=this._y1=+e}h${r=+r}v${+n}h${-r}Z`}toString(){return this._}}var ZO=Array.prototype.slice;function GO(t,e){return t-e}var JO=t=>()=>t;function QO(t,e){for(var r,n=-1,i=e.length;++n<i;)if(r=tP(t,e[n]))return r;return 0}function tP(t,e){for(var r=e[0],n=e[1],i=-1,a=0,s=t.length,o=s-1;a<s;o=a++){var l=t[a],c=l[0],u=l[1],h=t[o],d=h[0],f=h[1];if(eP(l,h,e))return 0;u>n!=f>n&&r<(d-c)*(n-u)/(f-u)+c&&(i=-i)}return i}function eP(t,e,r){var n;return function(t,e,r){return(e[0]-t[0])*(r[1]-t[1])===(r[0]-t[0])*(e[1]-t[1])}(t,e,r)&&function(t,e,r){return t<=e&&e<=r||r<=e&&e<=t}(t[n=+(t[0]===e[0])],r[n],e[n])}function rP(){}var nP=[[],[[[1,1.5],[.5,1]]],[[[1.5,1],[1,1.5]]],[[[1.5,1],[.5,1]]],[[[1,.5],[1.5,1]]],[[[1,1.5],[.5,1]],[[1,.5],[1.5,1]]],[[[1,.5],[1,1.5]]],[[[1,.5],[.5,1]]],[[[.5,1],[1,.5]]],[[[1,1.5],[1,.5]]],[[[.5,1],[1,.5]],[[1.5,1],[1,1.5]]],[[[1.5,1],[1,.5]]],[[[.5,1],[1.5,1]]],[[[1,1.5],[1.5,1]]],[[[.5,1],[1,1.5]]],[]];function iP(){var t=1,e=1,r=iN,n=o;function i(t){var e=r(t);if(Array.isArray(e))e=e.slice().sort(GO);else{const r=WT(t,aP);for(e=eN(...nN(r[0],r[1],e),e);e[e.length-1]>=r[1];)e.pop();for(;e[1]<r[0];)e.shift()}return e.map(e=>a(t,e))}function a(r,i){const a=null==i?NaN:+i;if(isNaN(a))throw new Error(`invalid value: ${i}`);var o=[],l=[];return function(r,n,i){var a,o,l,c,u,h,d=new Array,f=new Array;a=o=-1,c=sP(r[0],n),nP[c<<1].forEach(p);for(;++a<t-1;)l=c,c=sP(r[a+1],n),nP[l|c<<1].forEach(p);nP[c|0].forEach(p);for(;++o<e-1;){for(a=-1,c=sP(r[o*t+t],n),u=sP(r[o*t],n),nP[c<<1|u<<2].forEach(p);++a<t-1;)l=c,c=sP(r[o*t+t+a+1],n),h=u,u=sP(r[o*t+a+1],n),nP[l|c<<1|u<<2|h<<3].forEach(p);nP[c|u<<3].forEach(p)}a=-1,u=r[o*t]>=n,nP[u<<2].forEach(p);for(;++a<t-1;)h=u,u=sP(r[o*t+a+1],n),nP[u<<2|h<<3].forEach(p);function p(t){var e,r,n=[t[0][0]+a,t[0][1]+o],l=[t[1][0]+a,t[1][1]+o],c=s(n),u=s(l);(e=f[c])?(r=d[u])?(delete f[e.end],delete d[r.start],e===r?(e.ring.push(l),i(e.ring)):d[e.start]=f[r.end]={start:e.start,end:r.end,ring:e.ring.concat(r.ring)}):(delete f[e.end],e.ring.push(l),f[e.end=u]=e):(e=d[u])?(r=f[c])?(delete d[e.start],delete f[r.end],e===r?(e.ring.push(l),i(e.ring)):d[r.start]=f[e.end]={start:r.start,end:e.end,ring:r.ring.concat(e.ring)}):(delete d[e.start],e.ring.unshift(n),d[e.start=c]=e):d[c]=f[u]={start:c,end:u,ring:[n,l]}}nP[u<<3].forEach(p)}(r,a,function(t){n(t,r,a),function(t){for(var e=0,r=t.length,n=t[r-1][1]*t[0][0]-t[r-1][0]*t[0][1];++e<r;)n+=t[e-1][1]*t[e][0]-t[e-1][0]*t[e][1];return n}(t)>0?o.push([t]):l.push(t)}),l.forEach(function(t){for(var e,r=0,n=o.length;r<n;++r)if(-1!==QO((e=o[r])[0],t))return void e.push(t)}),{type:"MultiPolygon",value:i,coordinates:o}}function s(e){return 2*e[0]+e[1]*(t+1)*4}function o(r,n,i){r.forEach(function(r){var a=r[0],s=r[1],o=0|a,l=0|s,c=oP(n[l*t+o]);a>0&&a<t&&o===a&&(r[0]=lP(a,oP(n[l*t+o-1]),c,i)),s>0&&s<e&&l===s&&(r[1]=lP(s,oP(n[(l-1)*t+o]),c,i))})}return i.contour=a,i.size=function(r){if(!arguments.length)return[t,e];var n=Math.floor(r[0]),a=Math.floor(r[1]);if(!(n>=0&&a>=0))throw new Error("invalid size");return t=n,e=a,i},i.thresholds=function(t){return arguments.length?(r="function"==typeof t?t:Array.isArray(t)?JO(ZO.call(t)):JO(t),i):r},i.smooth=function(t){return arguments.length?(n=t?o:rP,i):n===o},i}function aP(t){return isFinite(t)?t:NaN}function sP(t,e){return null!=t&&+t>=e}function oP(t){return null==t||isNaN(t=+t)?-1/0:t}function lP(t,e,r,n){const i=n-e,a=r-e,s=isFinite(i)||isFinite(a)?i/a:Math.sign(i)/Math.sign(a);return isNaN(s)?t:t+s-.5}function cP(t,e){if(!isFinite(t)||0===t)return null;var r=(t=e?t.toExponential(e-1):t.toExponential()).indexOf("e"),n=t.slice(0,r);return[n.length>1?n[0]+n.slice(2):n,+t.slice(r+1)]}function uP(t){return(t=cP(Math.abs(t)))?t[1]:NaN}var hP,dP=/^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;function fP(t){if(!(e=dP.exec(t)))throw new Error("invalid format: "+t);var e;return new pP({fill:e[1],align:e[2],sign:e[3],symbol:e[4],zero:e[5],width:e[6],comma:e[7],precision:e[8]&&e[8].slice(1),trim:e[9],type:e[10]})}function pP(t){this.fill=void 0===t.fill?" ":t.fill+"",this.align=void 0===t.align?">":t.align+"",this.sign=void 0===t.sign?"-":t.sign+"",this.symbol=void 0===t.symbol?"":t.symbol+"",this.zero=!!t.zero,this.width=void 0===t.width?void 0:+t.width,this.comma=!!t.comma,this.precision=void 0===t.precision?void 0:+t.precision,this.trim=!!t.trim,this.type=void 0===t.type?"":t.type+""}function mP(t,e){var r=cP(t,e);if(!r)return t+"";var n=r[0],i=r[1];return i<0?"0."+new Array(-i).join("0")+n:n.length>i+1?n.slice(0,i+1)+"."+n.slice(i+1):n+new Array(i-n.length+2).join("0")}fP.prototype=pP.prototype,pP.prototype.toString=function(){return this.fill+this.align+this.sign+this.symbol+(this.zero?"0":"")+(void 0===this.width?"":Math.max(1,0|this.width))+(this.comma?",":"")+(void 0===this.precision?"":"."+Math.max(0,0|this.precision))+(this.trim?"~":"")+this.type};var gP={"%":(t,e)=>(100*t).toFixed(e),b:t=>Math.round(t).toString(2),c:t=>t+"",d:function(t){return Math.abs(t=Math.round(t))>=1e21?t.toLocaleString("en").replace(/,/g,""):t.toString(10)},e:(t,e)=>t.toExponential(e),f:(t,e)=>t.toFixed(e),g:(t,e)=>t.toPrecision(e),o:t=>Math.round(t).toString(8),p:(t,e)=>mP(100*t,e),r:mP,s:function(t,e){var r=cP(t,e);if(!r)return hP=void 0,t.toPrecision(e);var n=r[0],i=r[1],a=i-(hP=3*Math.max(-8,Math.min(8,Math.floor(i/3))))+1,s=n.length;return a===s?n:a>s?n+new Array(a-s+1).join("0"):a>0?n.slice(0,a)+"."+n.slice(a):"0."+new Array(1-a).join("0")+cP(t,Math.max(0,e+a-1))[0]},X:t=>Math.round(t).toString(16).toUpperCase(),x:t=>Math.round(t).toString(16)};function bP(t){return t}var vP,yP,wP,xP=Array.prototype.map,kP=["y","z","a","f","p","n","µ","m","","k","M","G","T","P","E","Z","Y"];function $P(t){var e,r,n=void 0===t.grouping||void 0===t.thousands?bP:(e=xP.call(t.grouping,Number),r=t.thousands+"",function(t,n){for(var i=t.length,a=[],s=0,o=e[0],l=0;i>0&&o>0&&(l+o+1>n&&(o=Math.max(1,n-l)),a.push(t.substring(i-=o,i+o)),!((l+=o+1)>n));)o=e[s=(s+1)%e.length];return a.reverse().join(r)}),i=void 0===t.currency?"":t.currency[0]+"",a=void 0===t.currency?"":t.currency[1]+"",s=void 0===t.decimal?".":t.decimal+"",o=void 0===t.numerals?bP:function(t){return function(e){return e.replace(/[0-9]/g,function(e){return t[+e]})}}(xP.call(t.numerals,String)),l=void 0===t.percent?"%":t.percent+"",c=void 0===t.minus?"−":t.minus+"",u=void 0===t.nan?"NaN":t.nan+"";function h(t,e){var r=(t=fP(t)).fill,h=t.align,d=t.sign,f=t.symbol,p=t.zero,m=t.width,g=t.comma,b=t.precision,v=t.trim,y=t.type;"n"===y?(g=!0,y="g"):gP[y]||(void 0===b&&(b=12),v=!0,y="g"),(p||"0"===r&&"="===h)&&(p=!0,r="0",h="=");var w=(e&&void 0!==e.prefix?e.prefix:"")+("$"===f?i:"#"===f&&/[boxX]/.test(y)?"0"+y.toLowerCase():""),x=("$"===f?a:/[%p]/.test(y)?l:"")+(e&&void 0!==e.suffix?e.suffix:""),k=gP[y],$=/[defgprs%]/.test(y);function S(t){var e,i,a,l=w,f=x;if("c"===y)f=k(t)+f,t="";else{var S=(t=+t)<0||1/t<0;if(t=isNaN(t)?u:k(Math.abs(t),b),v&&(t=function(t){t:for(var e,r=t.length,n=1,i=-1;n<r;++n)switch(t[n]){case".":i=e=n;break;case"0":0===i&&(i=n),e=n;break;default:if(!+t[n])break t;i>0&&(i=0)}return i>0?t.slice(0,i)+t.slice(e+1):t}(t)),S&&0===+t&&"+"!==d&&(S=!1),l=(S?"("===d?d:c:"-"===d||"("===d?"":d)+l,f=("s"!==y||isNaN(t)||void 0===hP?"":kP[8+hP/3])+f+(S&&"("===d?")":""),$)for(e=-1,i=t.length;++e<i;)if(48>(a=t.charCodeAt(e))||a>57){f=(46===a?s+t.slice(e+1):t.slice(e))+f,t=t.slice(0,e);break}}g&&!p&&(t=n(t,1/0));var _=l.length+t.length+f.length,A=_<m?new Array(m-_+1).join(r):"";switch(g&&p&&(t=n(A+t,A.length?m-f.length:1/0),A=""),h){case"<":t=l+t+f+A;break;case"=":t=l+A+t+f;break;case"^":t=A.slice(0,_=A.length>>1)+l+t+f+A.slice(_);break;default:t=A+l+t+f}return o(t)}return b=void 0===b?6:/[gprs]/.test(y)?Math.max(1,Math.min(21,b)):Math.max(0,Math.min(20,b)),S.toString=function(){return t+""},S}return{format:h,formatPrefix:function(t,e){var r=3*Math.max(-8,Math.min(8,Math.floor(uP(e)/3))),n=Math.pow(10,-r),i=h(((t=fP(t)).type="f",t),{suffix:kP[8+r/3]});return function(t){return i(n*t)}}}}vP=$P({thousands:",",grouping:[3],currency:["$",""]}),yP=vP.format,wP=vP.formatPrefix;var SP=1e-6,_P=Math.PI,AP=2*_P,EP=180/_P,MP=_P/180,TP=Math.abs,NP=Math.cos,CP=Math.sin,RP=Math.sqrt;function OP(){}function PP(t,e){t&&FP.hasOwnProperty(t.type)&&FP[t.type](t,e)}var IP={Feature:function(t,e){PP(t.geometry,e)},FeatureCollection:function(t,e){for(var r=t.features,n=-1,i=r.length;++n<i;)PP(r[n].geometry,e)}},FP={Sphere:function(t,e){e.sphere()},Point:function(t,e){t=t.coordinates,e.point(t[0],t[1],t[2])},MultiPoint:function(t,e){for(var r=t.coordinates,n=-1,i=r.length;++n<i;)t=r[n],e.point(t[0],t[1],t[2])},LineString:function(t,e){DP(t.coordinates,e,0)},MultiLineString:function(t,e){for(var r=t.coordinates,n=-1,i=r.length;++n<i;)DP(r[n],e,0)},Polygon:function(t,e){jP(t.coordinates,e)},MultiPolygon:function(t,e){for(var r=t.coordinates,n=-1,i=r.length;++n<i;)jP(r[n],e)},GeometryCollection:function(t,e){for(var r=t.geometries,n=-1,i=r.length;++n<i;)PP(r[n],e)}};function DP(t,e,r){var n,i=-1,a=t.length-r;for(e.lineStart();++i<a;)n=t[i],e.point(n[0],n[1],n[2]);e.lineEnd()}function jP(t,e){var r=-1,n=t.length;for(e.polygonStart();++r<n;)DP(t[r],e,1);e.polygonEnd()}function zP(t,e){t&&IP.hasOwnProperty(t.type)?IP[t.type](t,e):PP(t,e)}function qP(t,e,r,n){this.x=t,this.z=e,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function UP(t,e,r,n,i){var a,s,o=[],l=[];if(t.forEach(function(t){if(!((e=t.length-1)<=0)){var e,r,n=t[0],s=t[e];if(function(t,e){return TP(t[0]-e[0])<SP&&TP(t[1]-e[1])<SP}(n,s)){if(!n[2]&&!s[2]){for(i.lineStart(),a=0;a<e;++a)i.point((n=t[a])[0],n[1]);return void i.lineEnd()}s[0]+=2e-6}o.push(r=new qP(n,t,null,!0)),l.push(r.o=new qP(n,null,r,!1)),o.push(r=new qP(s,t,null,!1)),l.push(r.o=new qP(s,null,r,!0))}}),o.length){for(l.sort(e),LP(o),LP(l),a=0,s=l.length;a<s;++a)l[a].e=r=!r;for(var c,u,h=o[0];;){for(var d=h,f=!0;d.v;)if((d=d.n)===h)return;c=d.z,i.lineStart();do{if(d.v=d.o.v=!0,d.e){if(f)for(a=0,s=c.length;a<s;++a)i.point((u=c[a])[0],u[1]);else n(d.x,d.n.x,1,i);d=d.n}else{if(f)for(c=d.p.z,a=c.length-1;a>=0;--a)i.point((u=c[a])[0],u[1]);else n(d.x,d.p.x,-1,i);d=d.p}c=(d=d.o).z,f=!f}while(!d.v);i.lineEnd()}}}function LP(t){if(e=t.length){for(var e,r,n=0,i=t[0];++n<e;)i.n=r=t[n],r.p=i,i=r;i.n=r=t[0],r.p=i}}var HP=1e9,BP=-HP;function VP(t,e,r,n){function i(i,a){return t<=i&&i<=r&&e<=a&&a<=n}function a(i,a,o,c){var u=0,h=0;if(null==i||(u=s(i,o))!==(h=s(a,o))||l(i,a)<0^o>0)do{c.point(0===u||3===u?t:r,u>1?n:e)}while((u=(u+o+4)%4)!==h);else c.point(a[0],a[1])}function s(n,i){return TP(n[0]-t)<SP?i>0?0:3:TP(n[0]-r)<SP?i>0?2:1:TP(n[1]-e)<SP?i>0?1:0:i>0?3:2}function o(t,e){return l(t.x,e.x)}function l(t,e){var r=s(t,1),n=s(e,1);return r!==n?r-n:0===r?e[1]-t[1]:1===r?t[0]-e[0]:2===r?t[1]-e[1]:e[0]-t[0]}return function(s){var l,c,u,h,d,f,p,m,g,b,v,y=s,w=function(){var t,e=[];return{point:function(e,r,n){t.push([e,r,n])},lineStart:function(){e.push(t=[])},lineEnd:OP,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],t=null,r}}}(),x={point:k,lineStart:function(){x.point=$,c&&c.push(u=[]);b=!0,g=!1,p=m=NaN},lineEnd:function(){l&&($(h,d),f&&g&&w.rejoin(),l.push(w.result()));x.point=k,g&&y.lineEnd()},polygonStart:function(){y=w,l=[],c=[],v=!0},polygonEnd:function(){var e=function(){for(var e=0,r=0,i=c.length;r<i;++r)for(var a,s,o=c[r],l=1,u=o.length,h=o[0],d=h[0],f=h[1];l<u;++l)a=d,s=f,d=(h=o[l])[0],f=h[1],s<=n?f>n&&(d-a)*(n-s)>(f-s)*(t-a)&&++e:f<=n&&(d-a)*(n-s)<(f-s)*(t-a)&&--e;return e}(),r=v&&e,i=(h=l,l=Array.from(function*(t){for(const e of t)yield*e}(h))).length;var h;(r||i)&&(s.polygonStart(),r&&(s.lineStart(),a(null,null,1,s),s.lineEnd()),i&&UP(l,o,e,a,s),s.polygonEnd());y=s,l=c=u=null}};function k(t,e){i(t,e)&&y.point(t,e)}function $(a,s){var o=i(a,s);if(c&&u.push([a,s]),b)h=a,d=s,f=o,b=!1,o&&(y.lineStart(),y.point(a,s));else if(o&&g)y.point(a,s);else{var l=[p=Math.max(BP,Math.min(HP,p)),m=Math.max(BP,Math.min(HP,m))],w=[a=Math.max(BP,Math.min(HP,a)),s=Math.max(BP,Math.min(HP,s))];!function(t,e,r,n,i,a){var s,o=t[0],l=t[1],c=0,u=1,h=e[0]-o,d=e[1]-l;if(s=r-o,h||!(s>0)){if(s/=h,h<0){if(s<c)return;s<u&&(u=s)}else if(h>0){if(s>u)return;s>c&&(c=s)}if(s=i-o,h||!(s<0)){if(s/=h,h<0){if(s>u)return;s>c&&(c=s)}else if(h>0){if(s<c)return;s<u&&(u=s)}if(s=n-l,d||!(s>0)){if(s/=d,d<0){if(s<c)return;s<u&&(u=s)}else if(d>0){if(s>u)return;s>c&&(c=s)}if(s=a-l,d||!(s<0)){if(s/=d,d<0){if(s>u)return;s>c&&(c=s)}else if(d>0){if(s<c)return;s<u&&(u=s)}return c>0&&(t[0]=o+c*h,t[1]=l+c*d),u<1&&(e[0]=o+u*h,e[1]=l+u*d),!0}}}}}(l,w,t,e,r,n)?o&&(y.lineStart(),y.point(a,s),v=!1):(g||(y.lineStart(),y.point(l[0],l[1])),y.point(w[0],w[1]),o||y.lineEnd(),v=!1)}p=a,m=s,g=o}return x}}var WP,XP,YP,KP,ZP=t=>t,GP=new XT,JP=new XT,QP={point:OP,lineStart:OP,lineEnd:OP,polygonStart:function(){QP.lineStart=tI,QP.lineEnd=nI},polygonEnd:function(){QP.lineStart=QP.lineEnd=QP.point=OP,GP.add(TP(JP)),JP=new XT},result:function(){var t=GP/2;return GP=new XT,t}};function tI(){QP.point=eI}function eI(t,e){QP.point=rI,WP=YP=t,XP=KP=e}function rI(t,e){JP.add(KP*t-YP*e),YP=t,KP=e}function nI(){rI(WP,XP)}var iI=1/0,aI=iI,sI=-iI,oI=sI,lI={point:function(t,e){t<iI&&(iI=t);t>sI&&(sI=t);e<aI&&(aI=e);e>oI&&(oI=e)},lineStart:OP,lineEnd:OP,polygonStart:OP,polygonEnd:OP,result:function(){var t=[[iI,aI],[sI,oI]];return sI=oI=-(aI=iI=1/0),t}};var cI,uI,hI,dI,fI=0,pI=0,mI=0,gI=0,bI=0,vI=0,yI=0,wI=0,xI=0,kI={point:$I,lineStart:SI,lineEnd:EI,polygonStart:function(){kI.lineStart=MI,kI.lineEnd=TI},polygonEnd:function(){kI.point=$I,kI.lineStart=SI,kI.lineEnd=EI},result:function(){var t=xI?[yI/xI,wI/xI]:vI?[gI/vI,bI/vI]:mI?[fI/mI,pI/mI]:[NaN,NaN];return fI=pI=mI=gI=bI=vI=yI=wI=xI=0,t}};function $I(t,e){fI+=t,pI+=e,++mI}function SI(){kI.point=_I}function _I(t,e){kI.point=AI,$I(hI=t,dI=e)}function AI(t,e){var r=t-hI,n=e-dI,i=RP(r*r+n*n);gI+=i*(hI+t)/2,bI+=i*(dI+e)/2,vI+=i,$I(hI=t,dI=e)}function EI(){kI.point=$I}function MI(){kI.point=NI}function TI(){CI(cI,uI)}function NI(t,e){kI.point=CI,$I(cI=hI=t,uI=dI=e)}function CI(t,e){var r=t-hI,n=e-dI,i=RP(r*r+n*n);gI+=i*(hI+t)/2,bI+=i*(dI+e)/2,vI+=i,yI+=(i=dI*t-hI*e)*(hI+t),wI+=i*(dI+e),xI+=3*i,$I(hI=t,dI=e)}function RI(t){this._context=t}RI.prototype={_radius:4.5,pointRadius:function(t){return this._radius=t,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){0===this._line&&this._context.closePath(),this._point=NaN},point:function(t,e){switch(this._point){case 0:this._context.moveTo(t,e),this._point=1;break;case 1:this._context.lineTo(t,e);break;default:this._context.moveTo(t+this._radius,e),this._context.arc(t,e,this._radius,0,AP)}},result:OP};var OI,PI,II,FI,DI,jI=new XT,zI={point:OP,lineStart:function(){zI.point=qI},lineEnd:function(){OI&&UI(PI,II),zI.point=OP},polygonStart:function(){OI=!0},polygonEnd:function(){OI=null},result:function(){var t=+jI;return jI=new XT,t}};function qI(t,e){zI.point=UI,PI=FI=t,II=DI=e}function UI(t,e){FI-=t,DI-=e,jI.add(RP(FI*FI+DI*DI)),FI=t,DI=e}let LI,HI,BI,VI;class WI{constructor(t){this._append=null==t?XI:function(t){const e=Math.floor(t);if(!(e>=0))throw new RangeError(`invalid digits: ${t}`);if(e>15)return XI;if(e!==LI){const t=10**e;LI=e,HI=function(e){let r=1;this._+=e[0];for(const n=e.length;r<n;++r)this._+=Math.round(arguments[r]*t)/t+e[r]}}return HI}(t),this._radius=4.5,this._=""}pointRadius(t){return this._radius=+t,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){0===this._line&&(this._+="Z"),this._point=NaN}point(t,e){switch(this._point){case 0:this._append`M${t},${e}`,this._point=1;break;case 1:this._append`L${t},${e}`;break;default:if(this._append`M${t},${e}`,this._radius!==BI||this._append!==HI){const t=this._radius,e=this._;this._="",this._append`m0,${t}a${t},${t} 0 1,1 0,${-2*t}a${t},${t} 0 1,1 0,${2*t}z`,BI=t,HI=this._append,VI=this._,this._=e}this._+=VI}}result(){const t=this._;return this._="",t.length?t:null}}function XI(t){let e=1;this._+=t[0];for(const r=t.length;e<r;++e)this._+=arguments[e]+t[e]}function YI(t,e){let r,n,i=3,a=4.5;function s(t){return t&&("function"==typeof a&&n.pointRadius(+a.apply(this,arguments)),zP(t,r(n))),n.result()}return s.area=function(t){return zP(t,r(QP)),QP.result()},s.measure=function(t){return zP(t,r(zI)),zI.result()},s.bounds=function(t){return zP(t,r(lI)),lI.result()},s.centroid=function(t){return zP(t,r(kI)),kI.result()},s.projection=function(e){return arguments.length?(r=null==e?(t=null,ZP):(t=e).stream,s):t},s.context=function(t){return arguments.length?(n=null==t?(e=null,new WI(i)):new RI(e=t),"function"!=typeof a&&n.pointRadius(a),s):e},s.pointRadius=function(t){return arguments.length?(a="function"==typeof t?t:(n.pointRadius(+t),+t),s):a},s.digits=function(t){if(!arguments.length)return i;if(null==t)i=null;else{const e=Math.floor(t);if(!(e>=0))throw new RangeError(`invalid digits: ${t}`);i=e}return null===e&&(n=new WI(i)),s},s.projection(t).digits(i).context(e)}function KI(){}function ZI(t,e,r){var n=t.clipExtent&&t.clipExtent();return t.scale(150).translate([0,0]),null!=n&&t.clipExtent(null),zP(r,t.stream(lI)),e(lI.result()),null!=n&&t.clipExtent(n),t}function GI(t,e,r){return ZI(t,function(r){var n=e[1][0]-e[0][0],i=e[1][1]-e[0][1],a=Math.min(n/(r[1][0]-r[0][0]),i/(r[1][1]-r[0][1])),s=+e[0][0]+(n-a*(r[1][0]+r[0][0]))/2,o=+e[0][1]+(i-a*(r[1][1]+r[0][1]))/2;t.scale(150*a).translate([s,o])},r)}function JI(){var t,e,r,n,i,a,s,o,l=1,c=0,u=0,h=1,d=1,f=0,p=null,m=1,g=1,b=(o={point:function(t,e){var r=w([t,e]);this.stream.point(r[0],r[1])}},function(t){var e=new KI;for(var r in o)e[r]=o[r];return e.stream=t,e}),v=ZP;function y(){return m=l*h,g=l*d,a=s=null,w}function w(r){var n=r[0]*m,i=r[1]*g;if(f){var a=i*t-n*e;n=n*t+i*e,i=a}return[n+c,i+u]}return w.invert=function(r){var n=r[0]-c,i=r[1]-u;if(f){var a=i*t+n*e;n=n*t-i*e,i=a}return[n/m,i/g]},w.stream=function(t){return a&&s===t?a:a=b(v(s=t))},w.postclip=function(t){return arguments.length?(v=t,p=r=n=i=null,y()):v},w.clipExtent=function(t){return arguments.length?(v=null==t?(p=r=n=i=null,ZP):VP(p=+t[0][0],r=+t[0][1],n=+t[1][0],i=+t[1][1]),y()):null==p?null:[[p,r],[n,i]]},w.scale=function(t){return arguments.length?(l=+t,y()):l},w.translate=function(t){return arguments.length?(c=+t[0],u=+t[1],y()):[c,u]},w.angle=function(r){return arguments.length?(e=CP(f=r%360*MP),t=NP(f),y()):f*EP},w.reflectX=function(t){return arguments.length?(h=t?-1:1,y()):h<0},w.reflectY=function(t){return arguments.length?(d=t?-1:1,y()):d<0},w.fitExtent=function(t,e){return GI(w,t,e)},w.fitSize=function(t,e){return function(t,e,r){return GI(t,[[0,0],e],r)}(w,t,e)},w.fitWidth=function(t,e){return function(t,e,r){return ZI(t,function(r){var n=+e,i=n/(r[1][0]-r[0][0]),a=(n-i*(r[1][0]+r[0][0]))/2,s=-i*r[0][1];t.scale(150*i).translate([a,s])},r)}(w,t,e)},w.fitHeight=function(t,e){return function(t,e,r){return ZI(t,function(r){var n=+e,i=n/(r[1][1]-r[0][1]),a=-i*r[0][0],s=(n-i*(r[1][1]+r[0][1]))/2;t.scale(150*i).translate([a,s])},r)}(w,t,e)},w}function QI(t,e){switch(arguments.length){case 0:break;case 1:this.range(t);break;default:this.range(e).domain(t)}return this}function tF(t){return+t}KI.prototype={constructor:KI,point:function(t,e){this.stream.point(t,e)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};var eF=[0,1];function rF(t){return t}function nF(t,e){return(e-=t=+t)?function(r){return(r-t)/e}:function(t){return function(){return t}}(isNaN(e)?NaN:.5)}function iF(t,e,r){var n=t[0],i=t[1],a=e[0],s=e[1];return i<n?(n=nF(i,n),a=r(s,a)):(n=nF(n,i),a=r(a,s)),function(t){return a(n(t))}}function aF(t,e,r){var n=Math.min(t.length,e.length)-1,i=new Array(n),a=new Array(n),s=-1;for(t[n]<t[0]&&(t=t.slice().reverse(),e=e.slice().reverse());++s<n;)i[s]=nF(t[s],t[s+1]),a[s]=r(e[s],e[s+1]);return function(e){var r=VT(t,e,1,n)-1;return a[r](i[r](e))}}function sF(){var t,e,r,n,i,a,s=eF,o=eF,l=jR,c=rF;function u(){var t=Math.min(s.length,o.length);return c!==rF&&(c=function(t,e){var r;return t>e&&(r=t,t=e,e=r),function(r){return Math.max(t,Math.min(e,r))}}(s[0],s[t-1])),n=t>2?aF:iF,i=a=null,h}function h(e){return null==e||isNaN(e=+e)?r:(i||(i=n(s.map(t),o,l)))(t(c(e)))}return h.invert=function(r){return c(e((a||(a=n(o,s.map(t),OR)))(r)))},h.domain=function(t){return arguments.length?(s=Array.from(t,tF),u()):s.slice()},h.range=function(t){return arguments.length?(o=Array.from(t),u()):o.slice()},h.rangeRound=function(t){return o=Array.from(t),l=zR,u()},h.clamp=function(t){return arguments.length?(c=!!t||rF,u()):c!==rF},h.interpolate=function(t){return arguments.length?(l=t,u()):l},h.unknown=function(t){return arguments.length?(r=t,h):r},function(r,n){return t=r,e=n,u()}}function oF(t,e,r,n){var i,a=function(t,e,r){r=+r;const n=(e=+e)<(t=+t),i=n?rN(e,t,r):rN(t,e,r);return(n?-1:1)*(i<0?1/-i:i)}(t,e,r);switch((n=fP(null==n?",f":n)).type){case"s":var s=Math.max(Math.abs(t),Math.abs(e));return null!=n.precision||isNaN(i=function(t,e){return Math.max(0,3*Math.max(-8,Math.min(8,Math.floor(uP(e)/3)))-uP(Math.abs(t)))}(a,s))||(n.precision=i),wP(n,s);case"":case"e":case"g":case"p":case"r":null!=n.precision||isNaN(i=function(t,e){return t=Math.abs(t),e=Math.abs(e)-t,Math.max(0,uP(e)-uP(t))+1}(a,Math.max(Math.abs(t),Math.abs(e))))||(n.precision=i-("e"===n.type));break;case"f":case"%":null!=n.precision||isNaN(i=function(t){return Math.max(0,-uP(Math.abs(t)))}(a))||(n.precision=i-2*("%"===n.type))}return yP(n)}function lF(){var t=sF()(rF,rF);return t.copy=function(){return e=t,lF().domain(e.domain()).range(e.range()).interpolate(e.interpolate()).clamp(e.clamp()).unknown(e.unknown());var e},QI.apply(t,arguments),function(t){var e=t.domain;return t.ticks=function(t){var r=e();return eN(r[0],r[r.length-1],null==t?10:t)},t.tickFormat=function(t,r){var n=e();return oF(n[0],n[n.length-1],null==t?10:t,r)},t.nice=function(r){null==r&&(r=10);var n,i,a=e(),s=0,o=a.length-1,l=a[s],c=a[o],u=10;for(c<l&&(i=l,l=c,c=i,i=s,s=o,o=i);u-- >0;){if((i=rN(l,c,r))===n)return a[s]=l,a[o]=c,e(a);if(i>0)l=Math.floor(l/i)*i,c=Math.ceil(c/i)*i;else{if(!(i<0))break;l=Math.ceil(l*i)/i,c=Math.floor(c*i)/i}n=i}return t},t}(t)}function cF(t){return function(){return t}}function uF(t){this._context=t}function hF(t){return new uF(t)}function dF(t){return t[0]}function fF(t){return t[1]}function pF(t,e){var r=cF(!0),n=null,i=hF,a=null,s=function(t){let e=3;return t.digits=function(r){if(!arguments.length)return e;if(null==r)e=null;else{const t=Math.floor(r);if(!(t>=0))throw new RangeError(`invalid digits: ${r}`);e=t}return t},()=>new KO(e)}(o);function o(o){var l,c,u,h=(o=function(t){return"object"==typeof t&&"length"in t?t:Array.from(t)}(o)).length,d=!1;for(null==n&&(a=i(u=s())),l=0;l<=h;++l)!(l<h&&r(c=o[l],l,o))===d&&((d=!d)?a.lineStart():a.lineEnd()),d&&a.point(+t(c,l,o),+e(c,l,o));if(u)return a=null,u+""||null}return t="function"==typeof t?t:void 0===t?dF:cF(t),e="function"==typeof e?e:void 0===e?fF:cF(e),o.x=function(e){return arguments.length?(t="function"==typeof e?e:cF(+e),o):t},o.y=function(t){return arguments.length?(e="function"==typeof t?t:cF(+t),o):e},o.defined=function(t){return arguments.length?(r="function"==typeof t?t:cF(!!t),o):r},o.curve=function(t){return arguments.length?(i=t,null!=n&&(a=i(n)),o):i},o.context=function(t){return arguments.length?(null==t?n=a=null:a=i(n=t),o):n},o}function mF(t,e,r){this.k=t,this.x=e,this.y=r}uF.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){(this._line||0!==this._line&&1===this._point)&&this._context.closePath(),this._line=1-this._line},point:function(t,e){switch(t=+t,e=+e,this._point){case 0:this._point=1,this._line?this._context.lineTo(t,e):this._context.moveTo(t,e);break;case 1:this._point=2;default:this._context.lineTo(t,e)}}},mF.prototype={constructor:mF,scale:function(t){return 1===t?this:new mF(this.k*t,this.x,this.y)},translate:function(t,e){return 0===t&0===e?this:new mF(this.k,this.x+this.k*t,this.y+this.k*e)},apply:function(t){return[t[0]*this.k+this.x,t[1]*this.k+this.y]},applyX:function(t){return t*this.k+this.x},applyY:function(t){return t*this.k+this.y},invert:function(t){return[(t[0]-this.x)/this.k,(t[1]-this.y)/this.k]},invertX:function(t){return(t-this.x)/this.k},invertY:function(t){return(t-this.y)/this.k},rescaleX:function(t){return t.copy().domain(t.range().map(this.invertX,this).map(t.invert,t))},rescaleY:function(t){return t.copy().domain(t.range().map(this.invertY,this).map(t.invert,t))},toString:function(){return"translate("+this.x+","+this.y+") scale("+this.k+")"}},mF.prototype;class gF extends zT{getComputedStyleValue(t){return getComputedStyle(this).getPropertyValue(t).trim()}static get greys(){const t="#999999",e={white:"#ffffff"};return e.light75=TR(t,"#ffffff")(.75),e.light50=TR(t,"#ffffff")(.5),e.light25=TR(t,"#ffffff")(.25),e.grey=t,e.dark25=TR(t,"#000000")(.25),e.dark50=TR(t,"#000000")(.5),e.dark75=TR(t,"#000000")(.75),e.black="#000000",e}static get shadows(){return{elevations:[0,2,4,8,16],baselineColor:"#000000",baselineColorString:"0, 0, 0",inverseBaselineColor:"#FFFFFF",inverseBaselineColorString:"255, 255, 255",opacityUmbra:.2,opacityPenumbra:.14,opacityAmbient:.12,opacityBoost:.2,mapUmbra:{0:{x:0,y:0,b:0,s:0},2:{x:0,y:3,b:1,s:-2},4:{x:0,y:2,b:4,s:-1},8:{x:0,y:5,b:5,s:-3},16:{x:0,y:8,b:10,s:-5}},mapPenumbra:{0:{x:0,y:0,b:0,s:0},2:{x:0,y:2,b:2,s:0},4:{x:0,y:4,b:5,s:0},8:{x:0,y:8,b:10,s:1},16:{x:0,y:16,b:24,s:2}},mapAmbient:{0:{x:0,y:0,b:0,s:0},2:{x:0,y:1,b:5,s:0},4:{x:0,y:1,b:10,s:0},8:{x:0,y:3,b:14,s:2},16:{x:0,y:6,b:30,s:5}}}}static cssBoxShadow(t,e=!1){const r=this.shadows.opacityUmbra+this.shadows.opacityBoost,n=this.shadows.opacityPenumbra+this.shadows.opacityBoost,i=this.shadows.opacityAmbient+this.shadows.opacityBoost,a=e?`rgba(${this.shadows.inverseBaselineColorString}, ${r})`:`rgba(${this.shadows.baselineColorString}, ${r})`,s=e?`rgba(${this.shadows.inverseBaselineColorString}, ${n})`:`rgba(${this.shadows.baselineColorString}, ${n})`,o=e?`rgba(${this.shadows.inverseBaselineColorString}, ${i})`:`rgba(${this.shadows.baselineColorString}, ${i})`,l=this.shadows.mapUmbra[t],c=this.shadows.mapPenumbra[t],u=this.shadows.mapAmbient[t];return`${`${l.y/2}px ${l.y}px ${l.b}px ${l.s}px`} ${a}, ${`${c.y/2}px ${c.y}px ${c.b}px ${c.s}px`} ${s}, ${`${u.y/2}px ${u.y}px ${u.b}px ${u.s}px`} ${o}`}static get svgFilters(){const t=gF.shadows,e=t.elevations.map(e=>yT`
    ...
    `}static get styles(){return PM`
      :host {
        ---shadow-0: var(--shadow-0, ${OM(this.cssBoxShadow(0))});
        ---shadow-2: var(--shadow-2, ${OM(this.cssBoxShadow(2))});
        ---shadow-4: var(--shadow-4, ${OM(this.cssBoxShadow(4))});
        ---shadow-8: var(--shadow-8, ${OM(this.cssBoxShadow(8))});

        ---color-background: var(--color-background, ${OM(this.greys.white)});
        ---color-border: var(--color-border, ${OM(this.greys.light75)});
        ---color-text: var(--color-text, ${OM(this.greys.dark75)});
        ---color-text-inverse: var(--color-text-inverse, ${OM(this.greys.white)});
        ---color-link: var(--color-link, ${OM(this.greys.dark25)});
        ---color-element-background: var(--color-element-background, ${OM(this.greys.light75)});
        ---color-element-disabled: var(--color-element-disabled, ${OM(this.greys.light50)});
        ---color-element-enabled: var(--color-element-enabled, ${OM(this.greys.dark25)});
        ---color-element-selected: var(--color-element-selected, ${OM(this.greys.grey)});
        ---color-element-border: var(--color-element-border, ${OM(this.greys.dark50)});
        ---color-element-emphasis: var(--color-element-emphasis, ${OM(this.greys.dark75)});
    ...
    `}}customElements.define("decidables-button",class extends gF{static get properties(){return{disabled:{attribute:"disabled",type:Boolean,reflect:!0}}}constructor(){super(),this.disabled=!1}static get styles(){return[super.styles,PM`
        :host {
...
const bF=t=>t??kT;customElements.define("decidables-slider",class extends gF{static get properties(){return{disabled:{attribute:"disabled",type:Boolean,reflect:!0},scale:{attribute:"scale",type:Boolean,reflect:!0},max:{attribute:"max",type:Number,reflect:!0},min:{attribute:"min",type:Number,reflect:!0},step:{attribute:"step",type:Number,reflect:!0},value:{attribute:"value",type:Number,reflect:!0},nonlinear:{attribute:!1,type:Boolean,reflect:!1}}}constructor(){super(),this.disabled=!1,this.scale=!1,this.max=void 0,this.min=void 0,this.step=void 0,this.value=void 0,this.nonlinear=!1,this.rangeMax=void 0,this.rangeMin=void 0,this.rangeStep=void 0,this.rangeValue=void 0,this.toRange=void 0,this.fromRange=void 0}nonlinearRange(t,e,r){this.nonlinear=t,this.toRange=t?e:void 0,this.fromRange=t?r:void 0}rangeChanged(t){this.value=this.nonlinear?this.fromRange(t.target.value):t.target.value,this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0}))}rangeInputted(t){this.value=this.nonlinear?this.fromRange(t.target.value):t.target.value}spinnerInputted(t){this.value=t.target.value}willUpdate(){this.rangeMax=void 0===this.max?void 0:this.nonlinear?this.toRange(this.max):this.max,this.rangeMin=void 0===this.min?void 0:this.nonlinear?this.toRange(this.min):this.min,this.rangeStep=void 0===this.step?void 0:this.nonlinear?"any":this.step,this.rangeValue=void 0===this.value?void 0:this.nonlinear?this.toRange(this.value):this.value}static get styles(){return[super.styles,PM`
      ...
      <div class="range">
        <input ?disabled=${this.disabled} type="range" id="slider" min=${bF(this.rangeMin)} max=${bF(this.rangeMax)} step=${bF(this.rangeStep)} .value=${this.rangeValue} @change=${this.rangeChanged.bind(this)} @input=${this.rangeInputted.bind(this)}>
        ${this.scale?vT`
            <div class="datalist">
              <div class="option">${bF(this.max)}</div>
              <div class="option">${bF(this.min)}</div>
            </div>
          `:vT``}
      </div>
      <decidables-spinner ?disabled=${this.disabled} min=${bF(this.min)} max=${bF(this.max)} step=${bF(this.step)} .value=${this.value} @input=${this.spinnerInputted.bind(this)}></decidables-spinner>
    `}});customElements.define("decidables-spinner",class extends gF{static get properties(){return{disabled:{attribute:"disabled",type:Boolean,reflect:!0},max:{attribute:"max",type:Number,reflect:!0},min:{attribute:"min",type:Number,reflect:!0},step:{attribute:"step",type:Number,reflect:!0},value:{attribute:"value",type:Number,reflect:!0}}}constructor(){super(),this.disabled=!1,this.max=void 0,this.min=void 0,this.step=void 0,this.value=void 0}inputted(t){this.value=t.target.value}static get styles(){return[super.styles,PM`
        :host {
      ...
      <label>
        <slot></slot>
        <input ?disabled=${this.disabled} type="number" min=${bF(this.min)} max=${bF(this.max)} step=${bF(this.step)} .value=${this.value} @input=${this.inputted.bind(this)}>
      </label>
    `}});customElements.define("decidables-switch",class extends gF{static get properties(){return{checked:{attribute:"checked",type:Boolean,reflect:!0},disabled:{attribute:"disabled",type:Boolean,reflect:!0}}}constructor(){super(),this.checked=!1,this.disabled=!1}changed(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0}))}static get styles(){return[super.styles,PM`
        :host {
          display: flex;
    ...
    `}});customElements.define("decidables-toggle",class extends gF{static get properties(){return{disabled:{attribute:"disabled",type:Boolean,reflect:!0}}}constructor(){super(),this.disabled=!1}static get styles(){return[super.styles,PM`
        fieldset {
          display: flex;
    ...
    `}});customElements.define("decidables-toggle-option",class extends gF{static get properties(){return{checked:{attribute:"checked",type:Boolean,reflect:!0},disabled:{attribute:"disabled",type:Boolean,reflect:!0},name:{attribute:"name",type:String,reflect:!0},value:{attribute:"value",type:String,reflect:!0}}}constructor(){super(),this.checked=!1,this.disabled=!1,this.name=void 0,this.value=void 0}changed(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked,value:this.value},bubbles:!0}))}static get styles(){return[super.styles,PM`
        :host {
          display: flex;
        }
    ...
    `}});const vF={fromAttribute:t=>t.split(/\s+/).map(t=>Number.parseFloat(t)),toAttribute:t=>t.length?t.map(t=>t.toFixed(3)).join(" "):null},yF={fromAttribute:t=>new Set(t.split(/\s+/)),toAttribute:t=>t.size?[...t].join(" "):null};function wF(t){return class extends t{static get properties(){return{width:{attribute:!1,type:Number,reflect:!1},height:{attribute:!1,type:Number,reflect:!1},rem:{attribute:!1,type:Number,reflect:!1}}}constructor(){super(),this.width=NaN,this.height=NaN,this.rem=NaN}getDimensions(){this.width=parseFloat(this.getComputedStyleValue("width"),10),this.height=parseFloat(this.getComputedStyleValue("height"),10),this.rem=parseFloat(getComputedStyle(document.documentElement).getPropertyValue("font-size"),10)}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(this.getDimensions.bind(this)),this.resizeObserver.observe(this)}disconnectedCallback(){this.resizeObserver.unobserve(this),super.disconnectedCallback()}}}var xF={h:"#4daf4a",m:"#ff7f00",fa:"#377eb8",cr:"#e41a1c",hr:"#ffff33",far:"#984ea3",acc:"#999999",d:"#f781bf",c:"#a65628",s:"#4545d0",present:"#f032e6",absent:"#10dbc9",correct:"#ffffff",error:"#000000",nr:"#cccccc"};class kF extends gF{static get properties(){return{interactive:{attribute:"interactive",type:Boolean,reflect:!0}}}constructor(){super(),this.interactive=!1}static get colors(){return xF}static get lights(){return Object.keys(kF.colors).reduce((t,e)=>(t[e]=TR(kF.colors[e],"#ffffff")(.5),t),{})}static get darks(){return Object.keys(kF.colors).reduce((t,e)=>(t[e]=TR(kF.colors[e],"#000000")(.5),t),{})}static get styles(){return[super.styles,PM`
        :host {
          ---color-h: var(--color-h, ${OM(this.colors.h)});
          ---color-m: var(--color-m, ${OM(this.colors.m)});
          ---color-fa: var(--color-fa, ${OM(this.colors.fa)});
          ---color-cr: var(--color-cr, ${OM(this.colors.cr)});
          ---color-hr: var(--color-hr, ${OM(this.colors.hr)});
          ---color-far: var(--color-far, ${OM(this.colors.far)});
          ---color-acc: var(--color-acc, ${OM(this.colors.acc)});
          ---color-d: var(--color-d, ${OM(this.colors.d)});
          ---color-c: var(--color-c, ${OM(this.colors.c)});
          ---color-s: var(--color-s, ${OM(this.colors.s)});
          ---color-present: var(--color-present, ${OM(this.colors.present)});
          ---color-absent: var(--color-absent, ${OM(this.colors.absent)});
          ---color-correct: var(--color-correct, ${OM(this.colors.correct)});
          ---color-error: var(--color-error, ${OM(this.colors.error)});
          ---color-nr: var(--color-nr, ${OM(this.colors.nr)});

          ---color-h-light: var(--color-h-light, ${OM(this.lights.h)});
          ---color-m-light: var(--color-m-light, ${OM(this.lights.m)});
          ---color-fa-light: var(--color-fa-light, ${OM(this.lights.fa)});
          ---color-cr-light: var(--color-cr-light, ${OM(this.lights.cr)});
          ---color-hr-light: var(--color-hr-light, ${OM(this.lights.hr)});
          ---color-far-light: var(--color-far-light, ${OM(this.lights.far)});
          ---color-acc-light: var(--color-acc-light, ${OM(this.lights.acc)});
          ---color-d-light: var(--color-d-light, ${OM(this.lights.d)});
          ---color-c-light: var(--color-c-light, ${OM(this.lights.c)});
          ---color-s-light: var(--color-s-light, ${OM(this.lights.s)});
          ---color-present-light: var(--color-present-light, ${OM(this.lights.present)});
          ---color-absent-light: var(--color-absent-light, ${OM(this.lights.absent)});
          ---color-correct-light: var(--color-correct-light, ${OM(this.lights.correct)});
          ---color-error-light: var(--color-error-light, ${OM(this.lights.error)});
          ---color-nr-light: var(--color-nr-light, ${OM(this.lights.nr)});

          ---color-h-dark: var(--color-h-dark, ${OM(this.darks.h)});
          ---color-m-dark: var(--color-m-dark, ${OM(this.darks.m)});
          ---color-fa-dark: var(--color-fa-dark, ${OM(this.darks.fa)});
          ---color-cr-dark: var(--color-cr-dark, ${OM(this.darks.cr)});
          ---color-hr-dark: var(--color-hr-dark, ${OM(this.darks.hr)});
          ---color-far-dark: var(--color-far-dark, ${OM(this.darks.far)});
          ---color-acc-dark: var(--color-acc-dark, ${OM(this.darks.acc)});
          ---color-d-dark: var(--color-d-dark, ${OM(this.darks.d)});
          ---color-c-dark: var(--color-c-dark, ${OM(this.darks.c)});
          ---color-s-dark: var(--color-s-dark, ${OM(this.darks.s)});
          ---color-present-dark: var(--color-present-dark, ${OM(this.darks.present)});
          ---color-absent-dark: var(--color-absent-dark, ${OM(this.darks.absent)});
          ---color-correct-dark: var(--color-correct-dark, ${OM(this.darks.correct)});
          ---color-error-dark: var(--color-error-dark, ${OM(this.darks.error)});
          ---color-nr-dark: var(--color-nr-dark, ${OM(this.darks.nr)});
        }
      `]}}customElements.define("detectable-control",class extends kF{static get properties(){return{trials:{attribute:"trials",type:Number,reflect:!0},duration:{attribute:"duration",type:Number,reflect:!0},coherence:{attribute:"coherence",type:Number,reflect:!0},payoff:{attribute:"payoff",type:Number,reflect:!0},color:{attribute:"color",type:String,reflect:!0},zRoc:{attribute:"z-roc",type:Boolean,reflect:!0},run:{attribute:"run",type:Boolean,reflect:!0},pause:{attribute:"pause",type:Boolean,reflect:!0},reset:{attribute:"reset",type:Boolean,reflect:!0},state:{attribute:!1,type:String,reflect:!1}}}constructor(){super(),this.trials=void 0,this.duration=void 0,this.coherence=void 0,this.payoff=void 0,this.colors=["none","accuracy","stimulus","response","outcome","all"],this.color=void 0,this.zRoc=void 0,this.run=!1,this.pause=!1,this.reset=!1,this.states=["resetted","running","paused","ended"],this.state="resetted"}setTrials(t){this.trials=t.target.value,this.dispatchEvent(new CustomEvent("detectable-control-trials",{detail:{trials:this.trials},bubbles:!0}))}setDuration(t){this.duration=t.target.value,this.dispatchEvent(new CustomEvent("detectable-control-duration",{detail:{duration:this.duration},bubbles:!0}))}setCoherence(t){this.coherence=t.target.value,this.dispatchEvent(new CustomEvent("detectable-control-coherence",{detail:{coherence:this.coherence},bubbles:!0}))}setPayoff(t){this.payoff=t.target.value,this.dispatchEvent(new CustomEvent("detectable-control-payoff",{detail:{payoff:this.payoff},bubbles:!0}))}chooseColor(t){this.color=t.target.value,this.dispatchEvent(new CustomEvent("detectable-control-color",{detail:{color:this.color},bubbles:!0}))}flipZRoc(t){this.zRoc=t.target.checked,this.dispatchEvent(new CustomEvent("detectable-control-z-roc",{detail:{zRoc:this.zRoc},bubbles:!0}))}doRun(){this.state="running",this.dispatchEvent(new CustomEvent("detectable-control-run",{detail:{},bubbles:!0}))}doPause(){this.state="paused",this.dispatchEvent(new CustomEvent("detectable-control-pause",{detail:{},bubbles:!0}))}doReset(){this.state="resetted",this.dispatchEvent(new CustomEvent("detectable-control-reset",{detail:{},bubbles:!0}))}complete(){this.state="ended"}static get styles(){return[super.styles,PM`
        :host {
      ...
      `]}render(){return vT`
      <div class="holder">
        ${null!=this.trials?vT`<decidables-slider min="1" max="100" step="1" .value=${this.trials} @change=${this.setTrials.bind(this)} @input=${this.setTrials.bind(this)}>Trials</decidables-slider>`:vT``}
        ${null!=this.duration?vT`<decidables-slider min="10" max="2000" step="10" .value=${this.duration} @change=${this.setDuration.bind(this)} @input=${this.setDuration.bind(this)}>Duration</decidables-slider>`:vT``}
        ${null!=this.coherence?vT`<decidables-slider min="0" max="1" step=".01" .value=${this.coherence} @change=${this.setCoherence.bind(this)} @input=${this.setCoherence.bind(this)}>Coherence</decidables-slider>`:vT``}
        ${null!=this.payoff?vT`<decidables-slider class="payoff" min="0" max="100" step="1" .value=${this.payoff} @change=${this.setPayoff.bind(this)} @input=${this.setPayoff.bind(this)}>Payoff</decidables-slider>`:vT``}
        ${null!=this.color?vT`
      ...
      `]}render(){const t=new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",minimumFractionDigits:0,maximumFractionDigits:0}),e=e=>t.formatToParts(e).map(({type:t,value:e})=>"minusSign"===t?"−":e).reduce((t,e)=>t+e);return vT`
      <div class="holder">
        <div class="responses">
        ...
        ${this.trial||"none"!==this.feedback||"total"===this.payoff?vT`
            <div class="feedbacks">
              ${this.trial?vT`
                  <div class="trial">
      ...
      `]}willUpdate(){this.alignState()}render(){const t=new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",minimumFractionDigits:0,maximumFractionDigits:0}),e=e=>t.formatToParts(e).map(({type:t,value:e})=>"minusSign"===t?"−":e).reduce((t,e)=>t+e);let r,n,i,a,s,o,l,c,u;return this.numeric?(r=vT`
        <decidables-spinner ?disabled=${!this.interactive} min="0" .value="${this.h}" @input=${this.hInput.bind(this)}>
          <span>Hits</span>
          ${this.payoff?vT`<span class="payoff">${e(this.hPayoff)}</span>`:vT``}
        </decidables-spinner>
      `,n=vT`
        <decidables-spinner ?disabled=${!this.interactive} min="0" .value="${this.m}" @input=${this.mInput.bind(this)}>
          <span>Misses</span>
          ${this.payoff?vT`<span class="payoff">${e(this.mPayoff)}</span>`:vT``}
        </decidables-spinner>
      `,i=vT`
        <decidables-spinner ?disabled=${!this.interactive} min="0" .value="${this.fa}" @input=${this.faInput.bind(this)}>
          <span>False Alarms</span>
          ${this.payoff?vT`<span class="payoff">${e(this.faPayoff)}</span>`:vT``}
        </decidables-spinner>
      `,a=vT`
        <decidables-spinner ?disabled=${!this.interactive} min="0" .value="${this.cr}" @input=${this.crInput.bind(this)}>
          <span>Correct Rejections</span>
          ${this.payoff?vT`<span class="payoff">${e(this.crPayoff)}</span>`:vT``}
        </decidables-spinner>
      `,s=vT`
      ...
      `):(r=vT`<span>Hits</span>
        ${this.payoff?vT`<span class="payoff">${e(this.hPayoff)}</span>`:vT``}`,n=vT`<span>Misses</span>
        ${this.payoff?vT`<span class="payoff">${e(this.mPayoff)}</span>`:vT``}`,i=vT`<span>False Alarms</span>
        ${this.payoff?vT`<span class="payoff">${e(this.faPayoff)}</span>`:vT``}`,a=vT`<span>Correct Rejections</span>
        ${this.payoff?vT`<span class="payoff">${e(this.crPayoff)}</span>`:vT``}`,s=vT`<span>Hit Rate</span>`,o=vT`<span>False Alarm Rate</span>`,l=vT`<span>Accuracy</span>`,c=vT`<span>Positive Predictive Value</span>`,u=vT`<span>False Omission Rate</span>`),vT`
      <table class=${this.numeric?"numeric":""}>
        ...
        <tbody>
          <tr>
            ...
            ${this.summary.has("stimulusRates")?vT`
          ...
          ${this.summary.has("responseRates")||this.summary.has("accuracy")?vT`
              <tr>
                <td colspan="2"></td>
                ${this.summary.has("responseRates")?vT`
      ...
      `]}render(){return vT``}update(t){if(super.update(t),Number.isNaN(this.width)||Number.isNaN(this.height)||Number.isNaN(this.rem))return;const e=this.width,r=this.height,n=Math.min(e,r),i=.25*this.rem,a=.25*this.rem,s=.25*this.rem,o=n-(i+a),l=n-(s+.25*this.rem);this.xScale=lF().domain([-1,1]).range([0,l]),this.yScale=lF().domain([1,-1]).range([0,o]);const c=OC(this.renderRoot).selectAll(".main").data([{width:this.width,height:this.height,rem:this.rem}]),u=c.enter().append("svg").classed("main",!0),h=u.merge(c).attr("viewBox",`0 0 ${n} ${n}`);u.append("clipPath").attr("id","clip-rdk-task").append("circle"),h.select("clipPath circle").attr("cx",this.xScale(0)).attr("cy",this.yScale(0)).attr("r",this.xScale(1)-this.xScale(0));const d=u.append("g").classed("plot",!0),f=h.select(".plot").attr("transform",`translate(${s}, ${i})`),p=d.append("g").classed("underlayer",!0),m=f.select(".underlayer");p.append("circle").classed("background",!0),m.select(".background").attr("cx",this.xScale(0)).attr("cy",this.yScale(0)).attr("r",this.xScale(1)-this.xScale(0)),d.append("g").classed("content",!0).attr("clip-path","url(#clip-rdk-task)");f.select(".content").selectAll(".dots").data([[],[]]).enter().append("g").classed("dots",!0).classed("coherent",(t,e)=>e===this.COHERENT).classed("random",(t,e)=>e===this.RANDOM);const g=d.append("g").classed("overlayer",!0),b=f.select(".overlayer");g.append("circle").classed("outline",!0),b.select(".outline").attr("cx",this.xScale(0)).attr("cy",this.yScale(0)).attr("r",this.xScale(1)-this.yScale(0)),(this.firstUpdate||t.has("running"))&&(this.running?(this.pauseTime&&(this.baseTime+=nO()-this.pauseTime,this.pauseTime=0),this.runner=function(t,e,r){var n=new aO,i=e;return n._restart=n.restart,n.restart=function(t,e,r){e=+e,r=null==r?nO():+r,n._restart(function a(s){s+=i,n._restart(a,i+=e,r),t(s)},e,r)},n.restart(t,e,r),n}(this.run.bind(this),20)):void 0!==this.runner&&(this.runner.stop(),this.pauseTime=nO())),this.firstUpdate=!1}reset(){void 0!==this.runner&&this.runner.stop(),this.running=!1,this.trial=0,this.state="resetted",this.baseTime=0,this.pauseTime=0,this.startTime=0,this.lastTime=0,this.signal=void 0,this.currentDirection=void 0;const t=OC(this.renderRoot).select(".content").selectAll(".dots").data([[],[]]).selectAll(".dot").data(t=>t);t.exit().remove();OC(this.renderRoot).select(".content").selectAll(".fixation").data([]).exit().remove();OC(this.renderRoot).select(".content").selectAll(".query").data([]).exit().remove()}run(){const t=nO(),e=this.baseTime?t-this.baseTime:0,r=this.baseTime?e-this.startTime:0,n=this.baseTime?e-this.lastTime:0;this.lastTime=e;let i=!1;if("resetted"===this.state?(this.state="iti",this.baseTime=t,this.startTime=0,this.dispatchEvent(new CustomEvent("rdk-block-start",{detail:{trials:this.trials},bubbles:!0}))):"iti"===this.state&&r>=this.iti?(i=!0,this.trial+=1,this.state="stimulus",this.startTime=e,this.signal=Math.random()<this.probability?"present":"absent",this.currentDirection="absent"===this.signal?void 0:this.direction>=0?this.direction:360*Math.random(),this.dispatchEvent(new CustomEvent("rdk-trial-start",{detail:{trials:this.trials,duration:this.duration,wait:this.wait,iti:this.iti,trial:this.trial,signal:this.signal},bubbles:!0}))):"stimulus"===this.state&&r>=this.duration?(this.state="wait",this.startTime=e,this.dispatchEvent(new CustomEvent("rdk-trial-middle",{detail:{trials:this.trials,duration:this.duration,wait:this.wait,iti:this.iti,trial:this.trial,signal:this.signal},bubbles:!0}))):"wait"===this.state&&r>=this.wait&&(this.dispatchEvent(new CustomEvent("rdk-trial-end",{detail:{trials:this.trials,duration:this.duration,wait:this.wait,iti:this.iti,trial:this.trial,signal:this.signal},bubbles:!0})),this.trial>=this.trials?(this.runner.stop(),this.running=!1,this.state="ended",this.baseTime=0,this.pauseTime=0,this.startTime=0,this.lastTime=0,this.signal=void 0,this.currentDirection=void 0,this.dispatchEvent(new CustomEvent("rdk-block-end",{detail:{trials:this.trial},bubbles:!0}))):(this.state="iti",this.startTime=e)),"stimulus"===this.state){this.dots[this.COHERENT].length="present"===this.signal?Math.round(this.count*this.coherence):0,this.dots[this.RANDOM].length="present"===this.signal?this.count-this.dots[this.COHERENT].length:this.count;for(let t=0;t<this.dots.length;t+=1)for(let r=0;r<this.dots[t].length;r+=1){const a=void 0===this.dots[t][r];a&&(this.dots[t][r]={});const s=this.dots[t][r];if(i||a){s.direction=t===this.RANDOM?360*Math.random():this.currentDirection,s.birth=e-Math.floor(Math.random()*this.lifetime);const r=2*Math.random()*Math.PI,n=Math.sqrt(Math.random());s.x=this.xScale(n*Math.cos(r)),s.y=this.yScale(n*Math.sin(r))}else if(e>s.birth+this.lifetime){s.birth+=this.lifetime,s.direction=t===this.RANDOM?360*Math.random():this.currentDirection;const e=2*Math.random()*Math.PI,r=Math.sqrt(Math.random());s.x=this.xScale(r*Math.cos(e)),s.y=this.yScale(r*Math.sin(e))}else{t===this.COHERENT&&(s.direction=this.currentDirection);const e=s.direction*(Math.PI/180);s.dx=this.speed*(n/1e3)*Math.cos(e),s.dy=this.speed*(n/1e3)*Math.sin(e),s.x+=s.dx,s.y+=s.dy;(s.x-this.xScale(0))**2+(s.y-this.yScale(0))**2>(this.xScale(1)-this.xScale(0))**2&&(s.x=-(s.x-this.xScale(0))+this.xScale(0),s.y=-(s.y-this.yScale(0))+this.yScale(0))}}}const a=OC(this.renderRoot).select(".content").selectAll(".fixation").data("iti"===this.state?[!0]:[]),s=a.enter().append("g").classed("fixation",!0);s.append("line").attr("x1",this.xScale(-.1)).attr("y1",this.xScale(0)).attr("x2",this.xScale(.1)).attr("y2",this.xScale(0)),s.append("line").attr("x1",this.xScale(0)).attr("y1",this.xScale(-.1)).attr("x2",this.xScale(0)).attr("y2",this.xScale(.1)),a.exit().remove();const o=OC(this.renderRoot).select(".content").selectAll(".dots").data("stimulus"===this.state?this.dots:[[],[]]).selectAll(".dot").data(t=>t);o.enter().append("circle").classed("dot",!0).merge(o).attr("cx",t=>t.x).attr("cy",t=>t.y),o.exit().remove();const l=OC(this.renderRoot).select(".content").selectAll(".query").data("wait"===this.state?[!0]:[]);l.enter().append("g").classed("query",!0).append("text").attr("x",this.xScale(0)).attr("y",this.xScale(0)).attr("text-anchor","middle").attr("alignment-baseline","middle").text("?"),l.exit().remove()}}function EF(t,e){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(t);e&&(n=n.filter(function(e){return Object.getOwnPropertyDescriptor(t,e).enumerable})),r.push.apply(r,n)}return r}function MF(t){return MF="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},MF(t)}function TF(t,e,r){return e in t?Object.defineProperty(t,e,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[e]=r,t}function NF(){return NF=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var r=arguments[e];for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(t[n]=r[n])}return t},NF.apply(this,arguments)}function CF(t,e){(null==e||e>t.length)&&(e=t.length);for(var r=0,n=new Array(e);r<e;r++)n[r]=t[r];return n}function RF(t,e){var r="undefined"!=typeof Symbol&&t[Symbol.iterator]||t["@@iterator"];if(!r){if(Array.isArray(t)||(r=function(t,e){if(t){if("string"==typeof t)return CF(t,e);var r=Object.prototype.toString.call(t).slice(8,-1);return"Object"===r&&t.constructor&&(r=t.constructor.name),"Map"===r||"Set"===r?Array.from(t):"Arguments"===r||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?CF(t,e):void 0}}(t))||e){r&&(t=r);var n=0,i=function(){};return{s:i,n:function(){return n>=t.length?{done:!0}:{done:!1,value:t[n++]}},e:function(t){throw t},f:i}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var a,s=!0,o=!1;return{s:function(){r=r.call(t)},n:function(){var t=r.next();return s=t.done,t},e:function(t){o=!0,a=t},f:function(){try{s||null==r.return||r.return()}finally{if(o)throw a}}}}function OF(t,e){var r=[],n=[];return t.length&&function t(e,i){if(1===e.length)r.push(e[0]),n.push(e[0]);else{for(var a=Array(e.length-1),s=0;s<a.length;s++)0===s&&r.push(e[0]),s===a.length-1&&n.push(e[s+1]),a[s]=[(1-i)*e[s][0]+i*e[s+1][0],(1-i)*e[s][1]+i*e[s+1][1]];t(a,i)}}(t,e),{left:r,right:n.reverse()}}function PF(t){var e={};return 4===t.length&&(e.x2=t[2][0],e.y2=t[2][1]),t.length>=3&&(e.x1=t[1][0],e.y1=t[1][1]),e.x=t[t.length-1][0],e.y=t[t.length-1][1],4===t.length?e.type="C":3===t.length?e.type="Q":e.type="L",e}function IF(t,e,r){var n=[[t.x,t.y]];return null!=e.x1&&n.push([e.x1,e.y1]),null!=e.x2&&n.push([e.x2,e.y2]),n.push([e.x,e.y]),function(t,e){for(var r=[],n=t,i=1/(e=e||2),a=0;a<e-1;a++){var s=OF(n,i/(1-i*a));r.push(s.left),n=s.right}return r.push(n),r}(n,r).map(PF)}customElements.define("rdk-task",AF);var FF=/[MLCSTQAHVZmlcstqahv]|-?[\d.e+-]+/g,DF={M:["x","y"],L:["x","y"],H:["x"],V:["y"],C:["x1","y1","x2","y2","x","y"],S:["x2","y2","x","y"],Q:["x1","y1","x","y"],T:["x","y"],A:["rx","ry","xAxisRotation","largeArcFlag","sweepFlag","x","y"],Z:[]};function jF(t,e){for(var r=Array(t),n=0;n<t;n++)r[n]=e;return r}function zF(t){return"".concat(t.type).concat(DF[t.type].map(function(e){return t[e]}).join(","))}function qF(t,e,r){var n=t.length-1,i=e.length-1,a=n/i,s=jF(i).reduce(function(e,n,i){var s=Math.floor(a*i);if(r&&s<t.length-1&&r(t[s],t[s+1])){var o=a*i%1<.5;e[s]&&(o?s>0?s-=1:s<t.length-1&&(s+=1):s<t.length-1?s+=1:s>0&&(s-=1))}return e[s]=(e[s]||0)+1,e},[]),o=s.reduce(function(e,r,n){if(n===t.length-1){var i=jF(r,NF({},t[t.length-1]));return"M"===i[0].type&&i.forEach(function(t){t.type="L"}),e.concat(i)}return e.concat(function(t,e,r){var n=[];if("L"===e.type||"Q"===e.type||"C"===e.type)n=n.concat(IF(t,e,r));else{var i=NF({},t);"M"===i.type&&(i.type="L"),(n=n.concat(jF(r-1).map(function(){return i}))).push(e)}return n}(t[n],t[n+1],r))},[]);return o.unshift(t[0]),o}function UF(t){for(var e,r,n=(t||"").match(FF)||[],i=[],a=0;a<n.length;++a)if(e=DF[n[a]]){r={type:n[a]};for(var s=0;s<e.length;++s)r[e[s]]=+n[a+s+1];a+=e.length,i.push(r)}return i}function LF(t,e,r){var n=null==t?[]:t.slice(),i=null==e?[]:e.slice(),a="object"===MF(r)?r:{excludeSegment:r,snapEndsToInput:!0},s=a.excludeSegment,o=a.snapEndsToInput;if(!n.length&&!i.length)return function(){return[]};var l=!(0!==n.length&&"Z"!==n[n.length-1].type||0!==i.length&&"Z"!==i[i.length-1].type);n.length>0&&"Z"===n[n.length-1].type&&n.pop(),i.length>0&&"Z"===i[i.length-1].type&&i.pop(),n.length?i.length||i.push(n[0]):n.push(i[0]),0!==Math.abs(i.length-n.length)&&(i.length>n.length?n=qF(n,i,s):i.length<n.length&&(i=qF(i,n,s))),n=n.map(function(t,e){return function(t,e){var r={x1:"x",y1:"y",x2:"x",y2:"y"},n=["xAxisRotation","largeArcFlag","sweepFlag"];if(t.type!==e.type&&"M"!==e.type.toUpperCase()){var i={};Object.keys(e).forEach(function(a){var s=e[a],o=t[a];void 0===o&&(n.includes(a)?o=s:(void 0===o&&r[a]&&(o=t[r[a]]),void 0===o&&(o=0))),i[a]=o}),i.type=e.type,t=i}return t}(t,i[e])});var c=n.map(function(t){return function(t){for(var e=1;e<arguments.length;e++){var r=null!=arguments[e]?arguments[e]:{};e%2?EF(Object(r),!0).forEach(function(e){TF(t,e,r[e])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):EF(Object(r)).forEach(function(e){Object.defineProperty(t,e,Object.getOwnPropertyDescriptor(r,e))})}return t}({},t)});return l&&(c.push({type:"Z"}),n.push({type:"Z"})),function(t){if(1===t&&o)return null==e?[]:e;if(0===t)return n;for(var r=0;r<c.length;++r){var a,s=n[r],l=i[r],u=c[r],h=RF(DF[u.type]);try{for(h.s();!(a=h.n()).done;){var d=a.value;u[d]=(1-t)*s[d]+t*l[d],"largeArcFlag"!==d&&"sweepFlag"!==d||(u[d]=Math.round(u[d]))}}catch(t){h.e(t)}finally{h.f()}}return c}}Object.keys(DF).forEach(function(t){DF[t.toLowerCase()]=DF[t]});const HF={aliceblue:[240,248,255],antiquewhite:[250,235,215],aqua:[0,255,255],aquamarine:[127,255,212],azure:[240,255,255],beige:[245,245,220],bisque:[255,228,196],black:[0,0,0],blanchedalmond:[255,235,205],blue:[0,0,255],blueviolet:[138,43,226],brown:[165,42,42],burlywood:[222,184,135],cadetblue:[95,158,160],chartreuse:[127,255,0],chocolate:[210,105,30],coral:[255,127,80],cornflowerblue:[100,149,237],cornsilk:[255,248,220],crimson:[220,20,60],cyan:[0,255,255],darkblue:[0,0,139],darkcyan:[0,139,139],darkgoldenrod:[184,134,11],darkgray:[169,169,169],darkgreen:[0,100,0],darkgrey:[169,169,169],darkkhaki:[189,183,107],darkmagenta:[139,0,139],darkolivegreen:[85,107,47],darkorange:[255,140,0],darkorchid:[153,50,204],darkred:[139,0,0],darksalmon:[233,150,122],darkseagreen:[143,188,143],darkslateblue:[72,61,139],darkslategray:[47,79,79],darkslategrey:[47,79,79],darkturquoise:[0,206,209],darkviolet:[148,0,211],deeppink:[255,20,147],deepskyblue:[0,191,255],dimgray:[105,105,105],dimgrey:[105,105,105],dodgerblue:[30,144,255],firebrick:[178,34,34],floralwhite:[255,250,240],forestgreen:[34,139,34],fuchsia:[255,0,255],gainsboro:[220,220,220],ghostwhite:[248,248,255],gold:[255,215,0],goldenrod:[218,165,32],gray:[128,128,128],green:[0,128,0],greenyellow:[173,255,47],grey:[128,128,128],honeydew:[240,255,240],hotpink:[255,105,180],indianred:[205,92,92],indigo:[75,0,130],ivory:[255,255,240],khaki:[240,230,140],lavender:[230,230,250],lavenderblush:[255,240,245],lawngreen:[124,252,0],lemonchiffon:[255,250,205],lightblue:[173,216,230],lightcoral:[240,128,128],lightcyan:[224,255,255],lightgoldenrodyellow:[250,250,210],lightgray:[211,211,211],lightgreen:[144,238,144],lightgrey:[211,211,211],lightpink:[255,182,193],lightsalmon:[255,160,122],lightseagreen:[32,178,170],lightskyblue:[135,206,250],lightslategray:[119,136,153],lightslategrey:[119,136,153],lightsteelblue:[176,196,222],lightyellow:[255,255,224],lime:[0,255,0],limegreen:[50,205,50],linen:[250,240,230],magenta:[255,0,255],maroon:[128,0,0],mediumaquamarine:[102,205,170],mediumblue:[0,0,205],mediumorchid:[186,85,211],mediumpurple:[147,112,219],mediumseagreen:[60,179,113],mediumslateblue:[123,104,238],mediumspringgreen:[0,250,154],mediumturquoise:[72,209,204],mediumvioletred:[199,21,133],midnightblue:[25,25,112],mintcream:[245,255,250],mistyrose:[255,228,225],moccasin:[255,228,181],navajowhite:[255,222,173],navy:[0,0,128],oldlace:[253,245,230],olive:[128,128,0],olivedrab:[107,142,35],orange:[255,165,0],orangered:[255,69,0],orchid:[218,112,214],palegoldenrod:[238,232,170],palegreen:[152,251,152],paleturquoise:[175,238,238],palevioletred:[219,112,147],papayawhip:[255,239,213],peachpuff:[255,218,185],peru:[205,133,63],pink:[255,192,203],plum:[221,160,221],powderblue:[176,224,230],purple:[128,0,128],rebeccapurple:[102,51,153],red:[255,0,0],rosybrown:[188,143,143],royalblue:[65,105,225],saddlebrown:[139,69,19],salmon:[250,128,114],sandybrown:[244,164,96],seagreen:[46,139,87],seashell:[255,245,238],sienna:[160,82,45],silver:[192,192,192],skyblue:[135,206,235],slateblue:[106,90,205],slategray:[112,128,144],slategrey:[112,128,144],snow:[255,250,250],springgreen:[0,255,127],steelblue:[70,130,180],tan:[210,180,140],teal:[0,128,128],thistle:[216,191,216],tomato:[255,99,71],turquoise:[64,224,208],violet:[238,130,238],wheat:[245,222,179],white:[255,255,255],whitesmoke:[245,245,245],yellow:[255,255,0],yellowgreen:[154,205,50]};for(const t in HF)Object.freeze(HF[t]);var BF=Object.freeze(HF);const VF=Object.create(null);for(const t in BF)Object.hasOwn(BF,t)&&(VF[BF[t]]=t);const WF={to:{},get:{}};function XF(t,e,r){return Math.min(Math.max(e,t),r)}function YF(t){const e=Math.round(t).toString(16).toUpperCase();return e.length<2?"0"+e:e}WF.get=function(t){let e,r;switch(t.slice(0,3).toLowerCase()){case"hsl":e=WF.get.hsl(t),r="hsl";break;case"hwb":e=WF.get.hwb(t),r="hwb";break;default:e=WF.get.rgb(t),r="rgb"}return e?{model:r,value:e}:null},WF.get.rgb=function(t){if(!t)return null;let e,r,n,i=[0,0,0,1];if(e=t.match(/^#([a-f\d]{6})([a-f\d]{2})?$/i)){for(n=e[2],e=e[1],r=0;r<3;r++){const t=2*r;i[r]=Number.parseInt(e.slice(t,t+2),16)}n&&(i[3]=Number.parseInt(n,16)/255)}else if(e=t.match(/^#([a-f\d]{3,4})$/i)){for(e=e[1],n=e[3],r=0;r<3;r++)i[r]=Number.parseInt(e[r]+e[r],16);n&&(i[3]=Number.parseInt(n+n,16)/255)}else if(e=t.match(/^rgba?\(\s*([+-]?(?:\d*\.)?\d+(?:e\d+)?)(?=[\s,])\s*(?:,\s*)?([+-]?(?:\d*\.)?\d+(?:e\d+)?)(?=[\s,])\s*(?:,\s*)?([+-]?(?:\d*\.)?\d+(?:e\d+)?)\s*(?:[\s,|/]\s*([+-]?(?:\d*\.)?\d+(?:e\d+)?)(%?)\s*)?\)$/i)){for(r=0;r<3;r++)i[r]=Number.parseFloat(e[r+1]);e[4]&&(i[3]=e[5]?.01*Number.parseFloat(e[4]):Number.parseFloat(e[4]))}else{if(!(e=t.match(/^rgba?\(\s*([+-]?[\d.]+)%\s*,?\s*([+-]?[\d.]+)%\s*,?\s*([+-]?[\d.]+)%\s*(?:[\s,|/]\s*([+-]?[\d.]+)(%?)\s*)?\)$/i)))return(e=t.toLowerCase().match(/^(\w+)$/))?"transparent"===e[1]?[0,0,0,0]:Object.hasOwn(BF,e[1])?(i=BF[e[1]].slice(),i[3]=1,i):null:null;for(r=0;r<3;r++)i[r]=Math.round(2.55*Number.parseFloat(e[r+1]));e[4]&&(i[3]=e[5]?.01*Number.parseFloat(e[4]):Number.parseFloat(e[4]))}for(r=0;r<3;r++)i[r]=XF(i[r],0,255);return i[3]=XF(i[3],0,1),i},WF.get.hsl=function(t){if(!t)return null;const e=t.match(/^hsla?\(\s*([+-]?(?:\d{0,3}\.)?\d+)(?:deg)?\s*,?\s*([+-]?[\d.]+)%\s*,?\s*([+-]?[\d.]+)%\s*(?:[,|/]\s*([+-]?(?=\.\d|\d)(?:0|[1-9]\d*)?(?:\.\d*)?(?:e[+-]?\d+)?)\s*)?\)$/i);if(e){const t=Number.parseFloat(e[4]);return[(Number.parseFloat(e[1])%360+360)%360,XF(Number.parseFloat(e[2]),0,100),XF(Number.parseFloat(e[3]),0,100),XF(Number.isNaN(t)?1:t,0,1)]}return null},WF.get.hwb=function(t){if(!t)return null;const e=t.match(/^hwb\(\s*([+-]?\d{0,3}(?:\.\d+)?)(?:deg)?\s*[\s,]\s*([+-]?[\d.]+)%\s*[\s,]\s*([+-]?[\d.]+)%\s*(?:[\s,]\s*([+-]?(?=\.\d|\d)(?:0|[1-9]\d*)?(?:\.\d*)?(?:e[+-]?\d+)?)\s*)?\)$/i);if(e){const t=Number.parseFloat(e[4]);return[(Number.parseFloat(e[1])%360+360)%360,XF(Number.parseFloat(e[2]),0,100),XF(Number.parseFloat(e[3]),0,100),XF(Number.isNaN(t)?1:t,0,1)]}return null},WF.to.hex=function(...t){return"#"+YF(t[0])+YF(t[1])+YF(t[2])+(t[3]<1?YF(Math.round(255*t[3])):"")},WF.to.rgb=function(...t){return t.length<4||1===t[3]?"rgb("+Math.round(t[0])+", "+Math.round(t[1])+", "+Math.round(t[2])+")":"rgba("+Math.round(t[0])+", "+Math.round(t[1])+", "+Math.round(t[2])+", "+t[3]+")"},WF.to.rgb.percent=function(...t){const e=Math.round(t[0]/255*100),r=Math.round(t[1]/255*100),n=Math.round(t[2]/255*100);return t.length<4||1===t[3]?"rgb("+e+"%, "+r+"%, "+n+"%)":"rgba("+e+"%, "+r+"%, "+n+"%, "+t[3]+")"},WF.to.hsl=function(...t){return t.length<4||1===t[3]?"hsl("+t[0]+", "+t[1]+"%, "+t[2]+"%)":"hsla("+t[0]+", "+t[1]+"%, "+t[2]+"%, "+t[3]+")"},WF.to.hwb=function(...t){let e="";return t.length>=4&&1!==t[3]&&(e=", "+t[3]),"hwb("+t[0]+", "+t[1]+"%, "+t[2]+"%"+e+")"},WF.to.keyword=function(...t){return VF[t.slice(0,3)]};const KF={};for(const t of Object.keys(BF))KF[BF[t]]=t;const ZF={rgb:{channels:3,labels:"rgb"},hsl:{channels:3,labels:"hsl"},hsv:{channels:3,labels:"hsv"},hwb:{channels:3,labels:"hwb"},cmyk:{channels:4,labels:"cmyk"},xyz:{channels:3,labels:"xyz"},lab:{channels:3,labels:"lab"},oklab:{channels:3,labels:["okl","oka","okb"]},lch:{channels:3,labels:"lch"},oklch:{channels:3,labels:["okl","okc","okh"]},hex:{channels:1,labels:["hex"]},keyword:{channels:1,labels:["keyword"]},ansi16:{channels:1,labels:["ansi16"]},ansi256:{channels:1,labels:["ansi256"]},hcg:{channels:3,labels:["h","c","g"]},apple:{channels:3,labels:["r16","g16","b16"]},gray:{channels:1,labels:["gray"]}},GF=(6/29)**3;function JF(t){const e=t>.0031308?1.055*t**(1/2.4)-.055:12.92*t;return Math.min(Math.max(0,e),1)}function QF(t){return t>.04045?((t+.055)/1.055)**2.4:t/12.92}for(const t of Object.keys(ZF)){if(!("channels"in ZF[t]))throw new Error("missing channels property: "+t);if(!("labels"in ZF[t]))throw new Error("missing channel labels property: "+t);if(ZF[t].labels.length!==ZF[t].channels)throw new Error("channel and label counts mismatch: "+t);const{channels:e,labels:r}=ZF[t];delete ZF[t].channels,delete ZF[t].labels,Object.defineProperty(ZF[t],"channels",{value:e}),Object.defineProperty(ZF[t],"labels",{value:r})}function tD(t,e){return(t[0]-e[0])**2+(t[1]-e[1])**2+(t[2]-e[2])**2}function eD(t){const e=function(){const t={},e=Object.keys(ZF);for(let{length:r}=e,n=0;n<r;n++)t[e[n]]={distance:-1,parent:null};return t}(),r=[t];for(e[t].distance=0;r.length>0;){const t=r.pop(),n=Object.keys(ZF[t]);for(let{length:i}=n,a=0;a<i;a++){const i=n[a],s=e[i];-1===s.distance&&(s.distance=e[t].distance+1,s.parent=t,r.unshift(i))}}return e}function rD(t,e){return function(r){return e(t(r))}}function nD(t,e){const r=[e[t].parent,t];let n=ZF[e[t].parent][t],i=e[t].parent;for(;e[i].parent;)r.unshift(e[i].parent),n=rD(ZF[e[i].parent][i],n),i=e[i].parent;return n.conversion=r,n}function iD(t){const e=eD(t),r={},n=Object.keys(e);for(let{length:t}=n,i=0;i<t;i++){const t=n[i];null!==e[t].parent&&(r[t]=nD(t,e))}return r}ZF.rgb.hsl=function(t){const e=t[0]/255,r=t[1]/255,n=t[2]/255,i=Math.min(e,r,n),a=Math.max(e,r,n),s=a-i;let o,l;switch(a){case i:o=0;break;case e:o=(r-n)/s;break;case r:o=2+(n-e)/s;break;case n:o=4+(e-r)/s}o=Math.min(60*o,360),o<0&&(o+=360);const c=(i+a)/2;return l=a===i?0:c<=.5?s/(a+i):s/(2-a-i),[o,100*l,100*c]},ZF.rgb.hsv=function(t){let e,r,n,i,a;const s=t[0]/255,o=t[1]/255,l=t[2]/255,c=Math.max(s,o,l),u=c-Math.min(s,o,l),h=function(t){return(c-t)/6/u+.5};if(0===u)i=0,a=0;else{switch(a=u/c,e=h(s),r=h(o),n=h(l),c){case s:i=n-r;break;case o:i=1/3+e-n;break;case l:i=2/3+r-e}i<0?i+=1:i>1&&(i-=1)}return[360*i,100*a,100*c]},ZF.rgb.hwb=function(t){const e=t[0],r=t[1];let n=t[2];const i=ZF.rgb.hsl(t)[0],a=1/255*Math.min(e,Math.min(r,n));return n=1-1/255*Math.max(e,Math.max(r,n)),[i,100*a,100*n]},ZF.rgb.oklab=function(t){const e=QF(t[0]/255),r=QF(t[1]/255),n=QF(t[2]/255),i=Math.cbrt(.4122214708*e+.5363325363*r+.0514459929*n),a=Math.cbrt(.2119034982*e+.6806995451*r+.1073969566*n),s=Math.cbrt(.0883024619*e+.2817188376*r+.6299787005*n);return[100*(.2104542553*i+.793617785*a-.0040720468*s),100*(1.9779984951*i-2.428592205*a+.4505937099*s),100*(.0259040371*i+.7827717662*a-.808675766*s)]},ZF.rgb.cmyk=function(t){const e=t[0]/255,r=t[1]/255,n=t[2]/255,i=Math.min(1-e,1-r,1-n);return[100*((1-e-i)/(1-i)||0),100*((1-r-i)/(1-i)||0),100*((1-n-i)/(1-i)||0),100*i]},ZF.rgb.keyword=function(t){const e=KF[t];if(e)return e;let r,n=Number.POSITIVE_INFINITY;for(const e of Object.keys(BF)){const i=tD(t,BF[e]);i<n&&(n=i,r=e)}return r},ZF.keyword.rgb=function(t){return[...BF[t]]},ZF.rgb.xyz=function(t){const e=QF(t[0]/255),r=QF(t[1]/255),n=QF(t[2]/255);return[100*(.4124564*e+.3575761*r+.1804375*n),100*(.2126729*e+.7151522*r+.072175*n),100*(.0193339*e+.119192*r+.9503041*n)]},ZF.rgb.lab=function(t){const e=ZF.rgb.xyz(t);let r=e[0],n=e[1],i=e[2];r/=95.047,n/=100,i/=108.883,r=r>GF?r**(1/3):7.787*r+16/116,n=n>GF?n**(1/3):7.787*n+16/116,i=i>GF?i**(1/3):7.787*i+16/116;return[116*n-16,500*(r-n),200*(n-i)]},ZF.hsl.rgb=function(t){const e=t[0]/360,r=t[1]/100,n=t[2]/100;let i,a;if(0===r)return a=255*n,[a,a,a];const s=n<.5?n*(1+r):n+r-n*r,o=2*n-s,l=[0,0,0];for(let t=0;t<3;t++)i=e+1/3*-(t-1),i<0&&i++,i>1&&i--,a=6*i<1?o+6*(s-o)*i:2*i<1?s:3*i<2?o+(s-o)*(2/3-i)*6:o,l[t]=255*a;return l},ZF.hsl.hsv=function(t){const e=t[0];let r=t[1]/100,n=t[2]/100,i=r;const a=Math.max(n,.01);n*=2,r*=n<=1?n:2-n,i*=a<=1?a:2-a;return[e,100*(0===n?2*i/(a+i):2*r/(n+r)),100*((n+r)/2)]},ZF.hsv.rgb=function(t){const e=t[0]/60,r=t[1]/100;let n=t[2]/100;const i=Math.floor(e)%6,a=e-Math.floor(e),s=255*n*(1-r),o=255*n*(1-r*a),l=255*n*(1-r*(1-a));switch(n*=255,i){case 0:return[n,l,s];case 1:return[o,n,s];case 2:return[s,n,l];case 3:return[s,o,n];case 4:return[l,s,n];case 5:return[n,s,o]}},ZF.hsv.hsl=function(t){const e=t[0],r=t[1]/100,n=t[2]/100,i=Math.max(n,.01);let a,s;s=(2-r)*n;const o=(2-r)*i;return a=r*i,a/=o<=1?o:2-o,a=a||0,s/=2,[e,100*a,100*s]},ZF.hwb.rgb=function(t){const e=t[0]/360;let r=t[1]/100,n=t[2]/100;const i=r+n;let a;i>1&&(r/=i,n/=i);const s=Math.floor(6*e),o=1-n;a=6*e-s,1&s&&(a=1-a);const l=r+a*(o-r);let c,u,h;switch(s){default:case 6:case 0:c=o,u=l,h=r;break;case 1:c=l,u=o,h=r;break;case 2:c=r,u=o,h=l;break;case 3:c=r,u=l,h=o;break;case 4:c=l,u=r,h=o;break;case 5:c=o,u=r,h=l}return[255*c,255*u,255*h]},ZF.cmyk.rgb=function(t){const e=t[0]/100,r=t[1]/100,n=t[2]/100,i=t[3]/100;return[255*(1-Math.min(1,e*(1-i)+i)),255*(1-Math.min(1,r*(1-i)+i)),255*(1-Math.min(1,n*(1-i)+i))]},ZF.xyz.rgb=function(t){const e=t[0]/100,r=t[1]/100,n=t[2]/100;let i,a,s;return i=3.2404542*e+-1.5371385*r+-.4985314*n,a=-.969266*e+1.8760108*r+.041556*n,s=.0556434*e+-.2040259*r+1.0572252*n,i=JF(i),a=JF(a),s=JF(s),[255*i,255*a,255*s]},ZF.xyz.lab=function(t){let e=t[0],r=t[1],n=t[2];e/=95.047,r/=100,n/=108.883,e=e>GF?e**(1/3):7.787*e+16/116,r=r>GF?r**(1/3):7.787*r+16/116,n=n>GF?n**(1/3):7.787*n+16/116;return[116*r-16,500*(e-r),200*(r-n)]},ZF.xyz.oklab=function(t){const e=t[0]/100,r=t[1]/100,n=t[2]/100,i=Math.cbrt(.8189330101*e+.3618667424*r-.1288597137*n),a=Math.cbrt(.0329845436*e+.9293118715*r+.0361456387*n),s=Math.cbrt(.0482003018*e+.2643662691*r+.633851707*n);return[100*(.2104542553*i+.793617785*a-.0040720468*s),100*(1.9779984951*i-2.428592205*a+.4505937099*s),100*(.0259040371*i+.7827717662*a-.808675766*s)]},ZF.oklab.oklch=function(t){return ZF.lab.lch(t)},ZF.oklab.xyz=function(t){const e=t[0]/100,r=t[1]/100,n=t[2]/100,i=(.999999998*e+.396337792*r+.215803758*n)**3,a=(1.000000008*e-.105561342*r-.063854175*n)**3,s=(1.000000055*e-.089484182*r-1.291485538*n)**3;return[100*(1.227013851*i-.55779998*a+.281256149*s),100*(-.040580178*i+1.11225687*a-.071676679*s),100*(-.076381285*i-.421481978*a+1.58616322*s)]},ZF.oklab.rgb=function(t){const e=t[0]/100,r=t[1]/100,n=t[2]/100,i=(e+.3963377774*r+.2158037573*n)**3,a=(e-.1055613458*r-.0638541728*n)**3,s=(e-.0894841775*r-1.291485548*n)**3;return[255*JF(4.0767416621*i-3.3077115913*a+.2309699292*s),255*JF(-1.2684380046*i+2.6097574011*a-.3413193965*s),255*JF(-.0041960863*i-.7034186147*a+1.707614701*s)]},ZF.oklch.oklab=function(t){return ZF.lch.lab(t)},ZF.lab.xyz=function(t){let e,r,n;r=(t[0]+16)/116,e=t[1]/500+r,n=r-t[2]/200;const i=r**3,a=e**3,s=n**3;return r=i>GF?i:(r-16/116)/7.787,e=a>GF?a:(e-16/116)/7.787,n=s>GF?s:(n-16/116)/7.787,e*=95.047,r*=100,n*=108.883,[e,r,n]},ZF.lab.lch=function(t){const e=t[0],r=t[1],n=t[2];let i;i=360*Math.atan2(n,r)/2/Math.PI,i<0&&(i+=360);return[e,Math.sqrt(r*r+n*n),i]},ZF.lch.lab=function(t){const e=t[0],r=t[1],n=t[2]/360*2*Math.PI;return[e,r*Math.cos(n),r*Math.sin(n)]},ZF.rgb.ansi16=function(t,e=null){const[r,n,i]=t;let a=null===e?ZF.rgb.hsv(t)[2]:e;if(a=Math.round(a/50),0===a)return 30;let s=30+(Math.round(i/255)<<2|Math.round(n/255)<<1|Math.round(r/255));return 2===a&&(s+=60),s},ZF.hsv.ansi16=function(t){return ZF.rgb.ansi16(ZF.hsv.rgb(t),t[2])},ZF.rgb.ansi256=function(t){const e=t[0],r=t[1],n=t[2];if(e>>4==r>>4&&r>>4==n>>4)return e<8?16:e>248?231:Math.round((e-8)/247*24)+232;return 16+36*Math.round(e/255*5)+6*Math.round(r/255*5)+Math.round(n/255*5)},ZF.ansi16.rgb=function(t){let e=(t=t[0])%10;if(0===e||7===e)return t>50&&(e+=3.5),e=e/10.5*255,[e,e,e];const r=.5*(Math.trunc(t>50)+1);return[(1&e)*r*255,(e>>1&1)*r*255,(e>>2&1)*r*255]},ZF.ansi256.rgb=function(t){if((t=t[0])>=232){const e=10*(t-232)+8;return[e,e,e]}let e;t-=16;return[Math.floor(t/36)/5*255,Math.floor((e=t%36)/6)/5*255,e%6/5*255]},ZF.rgb.hex=function(t){const e=(((255&Math.round(t[0]))<<16)+((255&Math.round(t[1]))<<8)+(255&Math.round(t[2]))).toString(16).toUpperCase();return"000000".slice(e.length)+e},ZF.hex.rgb=function(t){const e=t.toString(16).match(/[a-f\d]{6}|[a-f\d]{3}/i);if(!e)return[0,0,0];let r=e[0];3===e[0].length&&(r=[...r].map(t=>t+t).join(""));const n=Number.parseInt(r,16);return[n>>16&255,n>>8&255,255&n]},ZF.rgb.hcg=function(t){const e=t[0]/255,r=t[1]/255,n=t[2]/255,i=Math.max(Math.max(e,r),n),a=Math.min(Math.min(e,r),n),s=i-a;let o;return o=s<=0?0:i===e?(r-n)/s%6:i===r?2+(n-e)/s:4+(e-r)/s,o/=6,o%=1,[360*o,100*s,100*(s<1?a/(1-s):0)]},ZF.hsl.hcg=function(t){const e=t[1]/100,r=t[2]/100,n=r<.5?2*e*r:2*e*(1-r);let i=0;return n<1&&(i=(r-.5*n)/(1-n)),[t[0],100*n,100*i]},ZF.hsv.hcg=function(t){const e=t[1]/100,r=t[2]/100,n=e*r;let i=0;return n<1&&(i=(r-n)/(1-n)),[t[0],100*n,100*i]},ZF.hcg.rgb=function(t){const e=t[0]/360,r=t[1]/100,n=t[2]/100;if(0===r)return[255*n,255*n,255*n];const i=[0,0,0],a=e%1*6,s=a%1,o=1-s;let l=0;switch(Math.floor(a)){case 0:i[0]=1,i[1]=s,i[2]=0;break;case 1:i[0]=o,i[1]=1,i[2]=0;break;case 2:i[0]=0,i[1]=1,i[2]=s;break;case 3:i[0]=0,i[1]=o,i[2]=1;break;case 4:i[0]=s,i[1]=0,i[2]=1;break;default:i[0]=1,i[1]=0,i[2]=o}return l=(1-r)*n,[255*(r*i[0]+l),255*(r*i[1]+l),255*(r*i[2]+l)]},ZF.hcg.hsv=function(t){const e=t[1]/100,r=e+t[2]/100*(1-e);let n=0;return r>0&&(n=e/r),[t[0],100*n,100*r]},ZF.hcg.hsl=function(t){const e=t[1]/100,r=t[2]/100*(1-e)+.5*e;let n=0;return r>0&&r<.5?n=e/(2*r):r>=.5&&r<1&&(n=e/(2*(1-r))),[t[0],100*n,100*r]},ZF.hcg.hwb=function(t){const e=t[1]/100,r=e+t[2]/100*(1-e);return[t[0],100*(r-e),100*(1-r)]},ZF.hwb.hcg=function(t){const e=t[1]/100,r=1-t[2]/100,n=r-e;let i=0;return n<1&&(i=(r-n)/(1-n)),[t[0],100*n,100*i]},ZF.apple.rgb=function(t){return[t[0]/65535*255,t[1]/65535*255,t[2]/65535*255]},ZF.rgb.apple=function(t){return[t[0]/255*65535,t[1]/255*65535,t[2]/255*65535]},ZF.gray.rgb=function(t){return[t[0]/100*255,t[0]/100*255,t[0]/100*255]},ZF.gray.hsl=function(t){return[0,0,t[0]]},ZF.gray.hsv=ZF.gray.hsl,ZF.gray.hwb=function(t){return[0,100,t[0]]},ZF.gray.cmyk=function(t){return[0,0,0,t[0]]},ZF.gray.lab=function(t){return[t[0],0,0]},ZF.gray.hex=function(t){const e=255&Math.round(t[0]/100*255),r=((e<<16)+(e<<8)+e).toString(16).toUpperCase();return"000000".slice(r.length)+r},ZF.rgb.gray=function(t){return[(t[0]+t[1]+t[2])/3/255*100]};const aD={},sD=Object.keys(ZF);function oD(t){const e=function(...e){const r=e[0];return null==r?r:(r.length>1&&(e=r),t(e))};return"conversion"in t&&(e.conversion=t.conversion),e}function lD(t){const e=function(...e){const r=e[0];if(null==r)return r;r.length>1&&(e=r);const n=t(e);if("object"==typeof n)for(let{length:t}=n,e=0;e<t;e++)n[e]=Math.round(n[e]);return n};return"conversion"in t&&(e.conversion=t.conversion),e}for(const t of sD){aD[t]={},Object.defineProperty(aD[t],"channels",{value:ZF[t].channels}),Object.defineProperty(aD[t],"labels",{value:ZF[t].labels});const e=iD(t),r=Object.keys(e);for(const n of r){const r=e[n];aD[t][n]=lD(r),aD[t][n].raw=oD(r)}}const cD=["keyword","gray","hex"],uD={};for(const t of Object.keys(aD))uD[[...aD[t].labels].sort().join("")]=t;const hD={};function dD(t,e){if(!(this instanceof dD))return new dD(t,e);if(e&&e in cD&&(e=null),e&&!(e in aD))throw new Error("Unknown model: "+e);let r,n;if(null==t)this.model="rgb",this.color=[0,0,0],this.valpha=1;else if(t instanceof dD)this.model=t.model,this.color=[...t.color],this.valpha=t.valpha;else if("string"==typeof t){const e=WF.get(t);if(null===e)throw new Error("Unable to parse color from string: "+t);this.model=e.model,n=aD[this.model].channels,this.color=e.value.slice(0,n),this.valpha="number"==typeof e.value[n]?e.value[n]:1}else if(t.length>0){this.model=e||"rgb",n=aD[this.model].channels;const r=Array.prototype.slice.call(t,0,n);this.color=gD(r,n),this.valpha="number"==typeof t[n]?t[n]:1}else if("number"==typeof t)this.model="rgb",this.color=[t>>16&255,t>>8&255,255&t],this.valpha=1;else{this.valpha=1;const e=Object.keys(t);"alpha"in t&&(e.splice(e.indexOf("alpha"),1),this.valpha="number"==typeof t.alpha?t.alpha:0);const n=e.sort().join("");if(!(n in uD))throw new Error("Unable to parse color from object: "+JSON.stringify(t));this.model=uD[n];const{labels:i}=aD[this.model],a=[];for(r=0;r<i.length;r++)a.push(t[i[r]]);this.color=gD(a)}if(hD[this.model])for(n=aD[this.model].channels,r=0;r<n;r++){const t=hD[this.model][r];t&&(this.color[r]=t(this.color[r]))}this.valpha=Math.max(0,Math.min(1,this.valpha)),Object.freeze&&Object.freeze(this)}dD.prototype={toString(){return this.string()},toJSON(){return this[this.model]()},string(t){let e=this.model in WF.to?this:this.rgb();e=e.round("number"==typeof t?t:1);const r=1===e.valpha?e.color:[...e.color,this.valpha];return WF.to[e.model](...r)},percentString(t){const e=this.rgb().round("number"==typeof t?t:1),r=1===e.valpha?e.color:[...e.color,this.valpha];return WF.to.rgb.percent(...r)},array(){return 1===this.valpha?[...this.color]:[...this.color,this.valpha]},object(){const t={},{channels:e}=aD[this.model],{labels:r}=aD[this.model];for(let n=0;n<e;n++)t[r[n]]=this.color[n];return 1!==this.valpha&&(t.alpha=this.valpha),t},unitArray(){const t=this.rgb().color;return t[0]/=255,t[1]/=255,t[2]/=255,1!==this.valpha&&t.push(this.valpha),t},unitObject(){const t=this.rgb().object();return t.r/=255,t.g/=255,t.b/=255,1!==this.valpha&&(t.alpha=this.valpha),t},round(t){return t=Math.max(t||0,0),new dD([...this.color.map(fD(t)),this.valpha],this.model)},alpha(t){return void 0!==t?new dD([...this.color,Math.max(0,Math.min(1,t))],this.model):this.valpha},red:pD("rgb",0,mD(255)),green:pD("rgb",1,mD(255)),blue:pD("rgb",2,mD(255)),hue:pD(["hsl","hsv","hsl","hwb","hcg"],0,t=>(t%360+360)%360),saturationl:pD("hsl",1,mD(100)),lightness:pD("hsl",2,mD(100)),saturationv:pD("hsv",1,mD(100)),value:pD("hsv",2,mD(100)),chroma:pD("hcg",1,mD(100)),gray:pD("hcg",2,mD(100)),white:pD("hwb",1,mD(100)),wblack:pD("hwb",2,mD(100)),cyan:pD("cmyk",0,mD(100)),magenta:pD("cmyk",1,mD(100)),yellow:pD("cmyk",2,mD(100)),black:pD("cmyk",3,mD(100)),x:pD("xyz",0,mD(95.047)),y:pD("xyz",1,mD(100)),z:pD("xyz",2,mD(108.833)),l:pD("lab",0,mD(100)),a:pD("lab",1),b:pD("lab",2),keyword(t){return void 0!==t?new dD(t):aD[this.model].keyword(this.color)},hex(t){return void 0!==t?new dD(t):WF.to.hex(...this.rgb().round().color)},hexa(t){if(void 0!==t)return new dD(t);const e=this.rgb().round().color;let r=Math.round(255*this.valpha).toString(16).toUpperCase();return 1===r.length&&(r="0"+r),WF.to.hex(...e)+r},rgbNumber(){const t=this.rgb().color;return(255&t[0])<<16|(255&t[1])<<8|255&t[2]},luminosity(){const t=this.rgb().color,e=[];for(const[r,n]of t.entries()){const t=n/255;e[r]=t<=.04045?t/12.92:((t+.055)/1.055)**2.4}return.2126*e[0]+.7152*e[1]+.0722*e[2]},contrast(t){const e=this.luminosity(),r=t.luminosity();return e>r?(e+.05)/(r+.05):(r+.05)/(e+.05)},level(t){const e=this.contrast(t);return e>=7?"AAA":e>=4.5?"AA":""},isDark(){const t=this.rgb().color;return(2126*t[0]+7152*t[1]+722*t[2])/1e4<128},isLight(){return!this.isDark()},negate(){const t=this.rgb();for(let e=0;e<3;e++)t.color[e]=255-t.color[e];return t},lighten(t){const e=this.hsl();return e.color[2]+=e.color[2]*t,e},darken(t){const e=this.hsl();return e.color[2]-=e.color[2]*t,e},saturate(t){const e=this.hsl();return e.color[1]+=e.color[1]*t,e},desaturate(t){const e=this.hsl();return e.color[1]-=e.color[1]*t,e},whiten(t){const e=this.hwb();return e.color[1]+=e.color[1]*t,e},blacken(t){const e=this.hwb();return e.color[2]+=e.color[2]*t,e},grayscale(){const t=this.rgb().color,e=.3*t[0]+.59*t[1]+.11*t[2];return dD.rgb(e,e,e)},fade(t){return this.alpha(this.valpha-this.valpha*t)},opaquer(t){return this.alpha(this.valpha+this.valpha*t)},rotate(t){const e=this.hsl();let r=e.color[0];return r=(r+t)%360,r=r<0?360+r:r,e.color[0]=r,e},mix(t,e){if(!t||!t.rgb)throw new Error('Argument to "mix" was not a Color instance, but rather an instance of '+typeof t);const r=t.rgb(),n=this.rgb(),i=void 0===e?.5:e,a=2*i-1,s=r.alpha()-n.alpha(),o=((a*s===-1?a:(a+s)/(1+a*s))+1)/2,l=1-o;return dD.rgb(o*r.red()+l*n.red(),o*r.green()+l*n.green(),o*r.blue()+l*n.blue(),r.alpha()*i+n.alpha()*(1-i))}};for(const t of Object.keys(aD)){if(cD.includes(t))continue;const{channels:e}=aD[t];dD.prototype[t]=function(...e){return this.model===t?new dD(this):e.length>0?new dD(e,t):new dD([...(r=aD[this.model][t].raw(this.color),Array.isArray(r)?r:[r]),this.valpha],t);var r},dD[t]=function(...r){let n=r[0];return"number"==typeof n&&(n=gD(r,e)),new dD(n,t)}}function fD(t){return function(e){return function(t,e){return Number(t.toFixed(e))}(e,t)}}function pD(t,e,r){t=Array.isArray(t)?t:[t];for(const n of t)(hD[n]||=[])[e]=r;return t=t[0],function(n){let i;return void 0!==n?(r&&(n=r(n)),i=this[t](),i.color[e]=n,i):(i=this[t]().color[e],r&&(i=r(i)),i)}}function mD(t){return function(e){return Math.max(0,Math.min(t,e))}}function gD(t,e){for(let r=0;r<e;r++)"number"!=typeof t[r]&&(t[r]=0);return t}class bD extends(wF(kF)){static get properties(){return{contour:{attribute:"contour",type:String,reflect:!0},point:{attribute:"point",type:String,reflect:!0},isoD:{attribute:"iso-d",type:String,reflect:!0},isoC:{attribute:"iso-c",type:String,reflect:!0},zRoc:{attribute:"z-roc",type:Boolean,reflect:!0},far:{attribute:"far",type:Number,reflect:!0},hr:{attribute:"hr",type:Number,reflect:!0},d:{attribute:!1,type:Number,reflect:!1},c:{attribute:!1,type:Number,reflect:!1},s:{attribute:!1,type:Number,reflect:!1}}}constructor(){super(),this.firstUpdate=!0,this.drag=!1,this.sdt=!1,this.contours=["sensitivity","bias","accuracy"],this.contour=void 0,this.points=["all","first","rest","none"],this.point="all",this.isoDs=["all","first","rest","none"],this.isoD="first",this.isoCs=["all","first","rest","none"],this.isoC="first",this.zRoc=!1,this.far=.25,this.hr=.75,this.s=_F.s.DEFAULT,this.label="",this.locations=[{name:"default",far:this.far,hr:this.hr,s:this.s,label:""}],this.pointArray=[],this.isoDArray=[],this.isoCArray=[],this.alignState()}alignState(){this.locations[0].hr=this.hr,this.locations[0].far=this.far,this.locations[0].s=this.s,this.locations[0].label=this.label,this.d=_F.hrFar2D(this.hr,this.far,this.s),this.c=_F.hrFar2C(this.hr,this.far,this.s),this.pointArray=[],this.isoDArray=[],this.isoCArray=[],this.locations.forEach((t,e)=>{t.d=_F.hrFar2D(t.hr,t.far,t.s),t.c=_F.hrFar2C(t.hr,t.far,t.s),0!==e||"first"!==this.point&&"all"!==this.point?e>0&&("rest"===this.point||"all"===this.point)&&this.pointArray.push(t):this.pointArray.push(t),0!==e||"first"!==this.isoD&&"all"!==this.isoD?e>0&&("rest"===this.isoD||"all"===this.isoD)&&this.isoDArray.push(t):this.isoDArray.push(t),0!==e||"first"!==this.isoC&&"all"!==this.isoC?e>0&&("rest"===this.isoC||"all"===this.isoC)&&this.isoCArray.push(t):this.isoCArray.push(t)})}set(t,e,r="default",n="",i=1){"default"===r&&(this.hr=t,this.far=e,this.s=i,this.label=n);const a=this.locations.find(t=>t.name===r);void 0===a?this.locations.push({name:r,far:e,hr:t,s:i,label:n}):(a.hr=t,a.far=e,a.s=i,a.label=n),this.requestUpdate()}setWithSDT(t,e,r="default",n="",i=1){"default"===r&&(this.hr=_F.dC2Hr(t,e,i),this.far=_F.dC2Far(t,e,i),this.s=i,this.label=n);const a=this.locations.find(t=>t.name===r);void 0===a?this.locations.push({name:r,far:_F.dC2Far(t,e,i),hr:_F.dC2Hr(t,e,i),s:i,label:n}):(a.hr=_F.dC2Hr(t,e,i),a.far=_F.dC2Far(t,e,i),a.s=i,a.label=n),this.sdt=!0,this.requestUpdate()}static get styles(){return[super.styles,PM`
        :host {
          display: inline-block;
      ...
      `]}render(){return vT``}willUpdate(){this.alignState()}update(t){if(super.update(t),Number.isNaN(this.width)||Number.isNaN(this.height)||Number.isNaN(this.rem))return;const e=this.width,r=this.height,n=Math.min(e,r),i=2*this.rem,a=3*this.rem,s=3*this.rem,o=n-(i+a),l=n-(s+2*this.rem),c=parseInt(this.getComputedStyleValue("---transition-duration"),10),u=lF().domain(this.zRoc?[-3,3]:[0,1]).range([0,l]);this.xScale=u;const h=lF().domain(this.zRoc?[3,-3]:[1,0]).range([0,o]);this.yScale=h;const d=VC().subject((t,e)=>({x:this.xScale(this.zRoc?_F.far2Zfar(e.far):e.far),y:this.yScale(this.zRoc?_F.hr2Zhr(e.hr):e.hr)})).on("start",t=>{OC(t.currentTarget).classed("dragging",!0)}).on("drag",(t,e)=>{this.drag=!0;const r=this.zRoc?_F.zfar2Far(this.xScale.invert(t.x)):this.xScale.invert(t.x),n=this.zRoc?_F.zhr2Hr(this.yScale.invert(t.y)):this.yScale.invert(t.y);e.far=r<.001?.001:r>.999?.999:r,e.hr=n<=.001?.001:n>=.999?.999:n,"default"===e.name&&(this.far=e.far,this.hr=e.hr),this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("roc-point-change",{detail:{name:e.name,far:e.far,hr:e.hr,d:e.d,c:e.c,s:e.s,label:e.label},bubbles:!0}))}).on("end",t=>{OC(t.currentTarget).classed("dragging",!1)}),f=pF().x(t=>u(this.zRoc?_F.far2Zfar(t.far):t.far)).y(t=>h(this.zRoc?_F.hr2Zhr(t.hr):t.hr)),p=OC(this.renderRoot).selectAll(".main").data([{width:this.width,height:this.height,rem:this.rem}]),m=p.enter().append("svg").classed("main",!0).each((t,e,r)=>{DT(kF.svgFilters,r[e])}),g=m.merge(p).attr("viewBox",`0 0 ${n} ${n}`),b=m.append("g").classed("plot",!0),v=g.select(".plot").attr("transform",`translate(${s}, ${i})`);b.append("clipPath").attr("id","clip-roc-space").append("rect"),v.select("clipPath rect").attr("height",o+1).attr("width",l+1);const y=b.append("g").classed("underlayer",!0),w=v.select(".underlayer");if(y.append("rect").classed("background",!0),w.select(".background").attr("height",o).attr("width",l),this.firstUpdate||t.has("contour")||t.has("zRoc")||t.has("width")||t.has("height")||t.has("rem")||t.has("s"))if(void 0!==this.contour){const t=100,e=[];for(let r=.5,n=0;r<t;r+=1)for(let i=.5;i<t;i+=1,n+=1){const a=this.zRoc?_F.zhr2Hr(i/t*6-3):i/t,s=this.zRoc?_F.zfar2Far(6*(1-r/t)-3):1-r/t;e[n]="bias"===this.contour?_F.hrFar2C(a,s,this.s):"sensitivity"===this.contour?_F.hrFar2D(a,s,this.s):"accuracy"===this.contour?_F.hrFar2Acc(a,s):null}const r="bias"===this.contour?aN(-3,3,.25):"sensitivity"===this.contour?aN(-6,6,.5):"accuracy"===this.contour?aN(0,1,.05):null,n=iP().size([t,t]).thresholds(r),i=this.getComputedStyleValue("bias"===this.contour?"---color-element-background":"sensitivity"===this.contour?"---color-d":"accuracy"===this.contour?"---color-acc-dark":null),a=this.getComputedStyleValue("bias"===this.contour?"---color-c":"sensitivity"===this.contour||"accuracy"===this.contour?"---color-element-background":null),s=lF().domain(WT(r)).interpolate(()=>TR(dD(i).hex(),dD(a).hex())),o=w.selectAll(".plot-contour").data([this.contour]),u=o.enter().append("g").classed("plot-contour",!0).merge(o).selectAll(".contour").data(n(e));u.enter().append("path").classed("contour",!0).merge(u).transition().duration(2*c).ease(UO).attrTween("d",(e,r,n)=>function(t,e,r){var n=UF(t),i=UF(e),a="object"===MF(r)?r:{excludeSegment:r,snapEndsToInput:!0},s=a.excludeSegment,o=a.snapEndsToInput;if(!n.length&&!i.length)return function(){return""};var l=LF(n,i,{excludeSegment:s,snapEndsToInput:o});return function(t){if(1===t&&o)return null==e?"":e;var r,n="",i=RF(l(t));try{for(i.s();!(r=i.n()).done;)n+=zF(r.value)}catch(t){i.e(t)}finally{i.f()}return n}}(OC(n[r]).attr("d"),YI(JI().scale(l/t))(e))).attr("fill",t=>s(t.value)),u.exit().remove();const h=w.selectAll(".title-contour").data([this.contour]);h.enter().append("text").classed("title-contour",!0).attr("text-anchor","middle").merge(h).classed("math-var","bias"===this.contour||"sensitivity"===this.contour).attr("transform","bias"===this.contour||"sensitivity"===this.contour?`translate(${l+1.25*this.rem}, ${this.rem})`:"accuracy"===this.contour?`translate(${l+1.125*this.rem}, ${this.rem})`:null).text("bias"===this.contour?"c":"sensitivity"===this.contour?"d′":"accuracy"===this.contour?"Acc":null);const d=100,f=[];for(let e=.5,r=0;e<d;e+=1,r+=4)f[r]="bias"===this.contour?-(e/t*6-3):"sensitivity"===this.contour?e/t*12-6:"accuracy"===this.contour?e/t:null,f[r+1]=f[r],f[r+2]=f[r],f[r+3]=f[r];const p=iP().size([4,d]).thresholds(r),m=lF().domain("bias"===this.contour?[3,-3]:"sensitivity"===this.contour?[6,-6]:"accuracy"===this.contour?[1,0]:null).range([0,10*this.rem]),g=w.selectAll(".legend-contour").data([this.contour]),b=g.enter().append("g").classed("legend-contour",!0),v=b.merge(g).attr("transform","bias"===this.contour||"sensitivity"===this.contour?`translate(${l+1.25*this.rem}, ${1.5*this.rem})`:"accuracy"===this.contour?`translate(${l+1.5*this.rem}, ${1.5*this.rem})`:null);g.exit().remove(),b.append("g").classed("axis-contour",!0),v.select(".axis-contour").call(mN(m).ticks(7).tickSize(0)).attr("font-size",null).attr("font-family",null);const y=v.selectAll(".contour").data(p(f));y.enter().append("path").classed("contour",!0).merge(y).attr("d",YI(JI().scale(10*this.rem/d))).attr("fill",t=>s(t.value)),y.exit().remove()}else{w.selectAll(".plot-contour").data([]).exit().remove();w.selectAll(".title-contour").data([]).exit().remove();w.selectAll(".legend-contour").data([]).exit().remove()}y.append("g").classed("axis-x",!0);w.select(".axis-x").attr("transform",`translate(0, ${o})`).transition().duration(2*c).ease(UO).call(pN(u)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null);const x=y.append("text").classed("title-x",!0).attr("text-anchor","middle");x.append("tspan").classed("z math-var",!0),x.append("tspan").classed("name",!0);const k=w.select(".title-x").attr("transform",`translate(${l/2}, ${o+2.25*this.rem})`);k.select("tspan.z").text(this.zRoc?"z":""),k.select("tspan.name").text(this.zRoc?"(False Alarm Rate)":"False Alarm Rate"),y.append("g").classed("axis-y",!0);w.select(".axis-y").transition().duration(2*c).ease(UO).call(mN(h)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null);const $=y.append("text").classed("title-y",!0).attr("text-anchor","middle");$.append("tspan").classed("z math-var",!0),$.append("tspan").classed("name",!0);const S=w.select(".title-y").attr("transform",`translate(${-2*this.rem}, ${o/2})rotate(-90)`);S.select("tspan.z").text(this.zRoc?"z":""),S.select("tspan.name").text(this.zRoc?"(Hit Rate)":"Hit Rate"),y.append("line").classed("diagonal",!0),w.select(".diagonal").attr("x1",this.zRoc?u(-3):u(0)).attr("y1",this.zRoc?h(-3):h(0)).attr("x2",this.zRoc?u(3):u(1)).attr("y2",this.zRoc?h(3):h(1)),b.append("g").classed("content",!0);const _=v.select(".content"),A=_.selectAll(".curve-iso-d").data(this.isoDArray,t=>t.name),E=A.enter().append("path").classed("curve-iso-d",!0).attr("clip-path","url(#clip-roc-space)").merge(A);this.firstUpdate||t.has("zRoc")?E.transition().duration(this.drag?0:2*c).ease(UO).attr("d",t=>f(aN(u.range()[0],u.range()[1]+1,1).map(e=>({far:this.zRoc?_F.zfar2Far(u.invert(e)):u.invert(e),hr:this.zRoc?_F.dFar2Hr(t.d,_F.zfar2Far(u.invert(e)),t.s):_F.dFar2Hr(t.d,u.invert(e),t.s)})))):this.sdt?E.transition().duration(this.drag?0:c).ease(UO).attrTween("d",(t,e,r)=>{const n=r[e];n.hr=void 0,n.far=void 0;const i=jR(void 0!==n.d?n.d:t.d,t.d),a=jR(void 0!==n.s?n.s:t.s,t.s);return t=>{n.d=i(t),n.s=a(t);const e=aN(u.range()[0],u.range()[1]+1,1).map(t=>({far:this.zRoc?_F.zfar2Far(u.invert(t)):u.invert(t),hr:this.zRoc?_F.dFar2Hr(n.d,_F.zfar2Far(u.invert(t)),n.s):_F.dFar2Hr(n.d,u.invert(t),n.s)}));return f(e)}}):E.transition().duration(this.drag?0:c).ease(UO).attrTween("d",(t,e,r)=>{const n=r[e];n.d=void 0,n.s=void 0;const i=jR(void 0!==n.hr?n.hr:t.hr,t.hr),a=jR(void 0!==n.far?n.far:t.far,t.far);return e=>{n.hr=i(e),n.far=a(e);const r=aN(u.range()[0],u.range()[1]+1,1).map(e=>({far:this.zRoc?_F.zfar2Far(u.invert(e)):u.invert(e),hr:this.zRoc?_F.dFar2Hr(_F.hrFar2D(n.hr,n.far,t.s),_F.zfar2Far(u.invert(e)),t.s):_F.dFar2Hr(_F.hrFar2D(n.hr,n.far,t.s),u.invert(e),t.s)}));return f(r)}}),A.exit().remove();const M=_.selectAll(".curve-iso-c").data(this.isoCArray,t=>t.name),T=M.enter().append("path").classed("curve-iso-c",!0).attr("clip-path","url(#clip-roc-space)").merge(M);this.firstUpdate||t.has("zRoc")?T.transition().duration(this.drag?0:2*c).ease(UO).attr("d",t=>f(aN(u.range()[0],u.range()[1]+1,1).map(e=>({far:this.zRoc?_F.zfar2Far(u.invert(e)):u.invert(e),hr:this.zRoc?_F.cFar2Hr(t.c,_F.zfar2Far(u.invert(e)),t.s):_F.cFar2Hr(t.c,u.invert(e),t.s)})))):this.sdt?T.transition().duration(this.drag?0:c).ease(UO).attrTween("d",(t,e,r)=>{const n=r[e];n.hr=void 0,n.far=void 0;const i=jR(void 0!==n.c?n.c:t.c,t.c),a=jR(void 0!==n.s?n.s:t.s,t.s);return t=>{n.c=i(t),n.s=a(t);const e=aN(u.range()[0],u.range()[1]+1,1).map(t=>({far:this.zRoc?_F.zfar2Far(u.invert(t)):u.invert(t),hr:this.zRoc?_F.cFar2Hr(n.c,_F.zfar2Far(u.invert(t)),n.s):_F.cFar2Hr(n.c,u.invert(t),n.s)}));return f(e)}}):T.transition().duration(this.drag?0:c).ease(UO).attrTween("d",(t,e,r)=>{const n=r[e];n.c=void 0,n.s=void 0;const i=jR(void 0!==n.hr?n.hr:t.hr,t.hr),a=jR(void 0!==n.far?n.far:t.far,t.far);return e=>{n.hr=i(e),n.far=a(e);const r=aN(u.range()[0],u.range()[1]+1,1).map(e=>({far:this.zRoc?_F.zfar2Far(u.invert(e)):u.invert(e),hr:this.zRoc?_F.cFar2Hr(_F.hrFar2C(n.hr,n.far,t.s),_F.zfar2Far(u.invert(e)),t.s):_F.cFar2Hr(_F.hrFar2C(n.hr,n.far,t.s),u.invert(e),t.s)}));return f(r)}}),M.exit().remove();const N=_.selectAll(".point").data(this.pointArray,t=>t.name),C=N.enter().append("g").classed("point",!0);C.append("circle").classed("circle touch",!0),C.append("text").classed("label",!0);const R=C.merge(N);R.select("text").text(t=>t.label),(this.firstUpdate||t.has("interactive"))&&(this.interactive?R.attr("tabindex",0).classed("interactive",!0).call(d).on("keydown",(t,e)=>{if(["ArrowUp","ArrowDown","ArrowRight","ArrowLeft"].includes(t.key)){let r=this.zRoc?_F.hr2Zhr(e.hr):e.hr,n=this.zRoc?_F.far2Zfar(e.far):e.far;switch(t.key){case"ArrowUp":r+=this.zRoc?t.shiftKey?.05:.25:t.shiftKey?.01:.05;break;case"ArrowDown":r-=this.zRoc?t.shiftKey?.05:.25:t.shiftKey?.01:.05;break;case"ArrowRight":n+=this.zRoc?t.shiftKey?.05:.25:t.shiftKey?.01:.05;break;case"ArrowLeft":n-=this.zRoc?t.shiftKey?.05:.25:t.shiftKey?.01:.05}r=this.zRoc?_F.zhr2Hr(r):r,n=this.zRoc?_F.zfar2Far(n):n,r=r<.001?.001:r>.999?.999:r,n=n<.001?.001:n>.999?.999:n,r===e.hr&&n===e.far||(e.hr=r,e.far=n,"default"===e.name&&(this.hr=e.hr,this.far=e.far),this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("roc-point-change",{detail:{name:e.name,far:e.far,hr:e.hr,d:e.d,c:e.c,s:e.s,label:e.label},bubbles:!0}))),t.preventDefault()}}):R.attr("tabindex",null).classed("interactive",!1).on("drag",null).on("keydown",null)),this.firstUpdate||t.has("zRoc")?R.transition().duration(this.drag?0:2*c).ease(UO).attr("transform",(t,e,r)=>{const n=r[e];return n.d=void 0,n.c=void 0,n.s=void 0,`translate(\n            ${u(this.zRoc?_F.far2Zfar(t.far):t.far)},\n            ${h(this.zRoc?_F.hr2Zhr(t.hr):t.hr)}\n          )`}):this.sdt?R.transition().duration(this.drag?0:c).ease(UO).attrTween("transform",(t,e,r)=>{const n=r[e],i=jR(void 0!==n.d?n.d:t.d,t.d),a=jR(void 0!==n.c?n.c:t.c,t.c),s=jR(void 0!==n.s?n.s:t.s,t.s);return t=>(n.d=i(t),n.c=a(t),n.s=s(t),`translate(\n              ${u(this.zRoc?_F.far2Zfar(_F.dC2Far(n.d,n.c,n.s)):_F.dC2Far(n.d,n.c,n.s))},\n              ${h(this.zRoc?_F.hr2Zhr(_F.dC2Hr(n.d,n.c,n.s)):_F.dC2Hr(n.d,n.c,n.s))}\n            )`)}):R.transition().duration(this.drag?0:c).ease(UO).attr("transform",(t,e,r)=>{const n=r[e];return n.d=void 0,n.c=void 0,n.s=void 0,`translate(\n            ${u(this.zRoc?_F.far2Zfar(t.far):t.far)},\n            ${h(this.zRoc?_F.hr2Zhr(t.hr):t.hr)}\n          )`}),N.exit().remove(),this.drag=!1,this.sdt=!1,this.firstUpdate=!1}}customElements.define("roc-space",bD);class vD extends(wF(kF)){static get properties(){return{color:{attribute:"color",type:String,reflect:!0},distributions:{attribute:"distributions",type:Boolean,reflect:!0},threshold:{attribute:"threshold",type:Boolean,reflect:!0},unequal:{attribute:"unequal",type:Boolean,reflect:!0},sensitivity:{attribute:"sensitivity",type:Boolean,reflect:!0},bias:{attribute:"bias",type:Boolean,reflect:!0},variance:{attribute:"variance",type:Boolean,reflect:!0},histogram:{attribute:"histogram",type:Boolean,reflect:!0},d:{attribute:"d",type:Number,reflect:!0},c:{attribute:"c",type:Number,reflect:!0},s:{attribute:"s",type:Number,reflect:!0},far:{attribute:!1,type:Number,reflect:!1},hr:{attribute:!1,type:Number,reflect:!1},binWidth:{attribute:!1,type:Number,reflect:!1},trials:{attribute:!1,type:Array,reflect:!1}}}constructor(){super(),this.colors=["all","outcome","response","stimulus","none"],this.color="all",this.distributions=!1,this.threshold=!1,this.unequal=!1,this.sensitivity=!1,this.bias=!1,this.variance=!1,this.histogram=!1,this.d=_F.d.DEFAULT,this.c=_F.c.DEFAULT,this.s=_F.s.DEFAULT,this.binWidth=.25,this.signals=["present","absent"],this.responses=["present","absent"],this.trials=[],this.muN=NaN,this.muS=NaN,this.l=NaN,this.hS=NaN,this.binRange=[-3,3],this.h=0,this.m=0,this.fa=0,this.cr=0,this.firstUpdate=!0,this.drag=!1,this.alignState()}reset(){this.trials=[],this.h=0,this.m=0,this.fa=0,this.cr=0}trial(t,e,r,n,i){const a={new:!0,paused:!1};a.trial=t,a.signal=e,a.duration=r,a.wait=n,a.iti=i,a.evidence=SF.normal.sample(0,1),this.alignTrial(a),this.trials.push(a),this.requestUpdate()}alignTrial(t){return"present"===t.signal?(t.trueEvidence=t.evidence*this.s+this.muS,t.response=t.trueEvidence>this.l?"present":"absent",t.outcome="present"===t.response?"h":"m"):(t.trueEvidence=t.evidence+this.muN,t.response=t.trueEvidence>this.l?"present":"absent",t.outcome="present"===t.response?"fa":"cr"),t.new||(this[t.outcome]+=1),t}alignState(){this.far=_F.dC2Far(this.d,this.c,this.s),this.hr=_F.dC2Hr(this.d,this.c,this.s),this.muN=_F.d2MuN(this.d,this.s),this.muS=_F.d2MuS(this.d,this.s),this.l=_F.c2L(this.c,this.s),this.hS=_F.s2H(this.s),this.h=0,this.m=0,this.fa=0,this.cr=0;for(let t=0;t<this.trials.length;t+=1)this.alignTrial(this.trials[t])}static get styles(){return[super.styles,PM`
        :host {
          display: inline-block;
      ...
      `]}render(){return vT``}sendEvent(){this.dispatchEvent(new CustomEvent("sdt-model-change",{detail:{d:this.d,c:this.c,s:this.s,far:this.far,hr:this.hr,h:this.h,m:this.m,fa:this.fa,cr:this.cr},bubbles:!0}))}willUpdate(){this.alignState()}update(t){if(super.update(t),Number.isNaN(this.width)||Number.isNaN(this.height)||Number.isNaN(this.rem))return;const e=this.width,r=this.height;let n,i;e/r>1.8?(i=r,n=1.8*i):(n=e,i=n/1.8);const a=2*this.rem,s=3*this.rem,o=3*this.rem,l=i-(a+s),c=n-(o+(this.histogram&&this.distributions?3:.75)*this.rem),u=parseInt(this.getComputedStyleValue("---transition-duration"),10),h=lF().domain([-3,3]).range([0,c]),d=lF().domain([.5,0]).range([0,l]),f=h(this.binWidth)-h(0),p=lF().domain([l/f,0]).range([0,l]),m=VC().subject(()=>({x:h(this.l),y:0})).on("start",t=>{OC(t.currentTarget).classed("dragging",!0)}).on("drag",t=>{this.drag=!0;const e=h.invert(t.x),r=_F.l2C(e,this.s);this.c=r<_F.c.MIN?_F.c.MIN:r>_F.c.MAX?_F.c.MAX:r,this.alignState(),this.sendEvent()}).on("end",t=>{OC(t.currentTarget).classed("dragging",!1)}),g=VC().subject(()=>({x:h(this.muN),y:0})).on("start",t=>{OC(t.currentTarget).classed("dragging",!0)}).on("drag",t=>{this.drag=!0;const e=h.invert(t.x),r=_F.muN2D(e,this.s);this.d=r<_F.d.MIN?_F.d.MIN:r>_F.d.MAX?_F.d.MAX:r,this.alignState(),this.sendEvent()}).on("end",t=>{OC(t.currentTarget).classed("dragging",!1)}),b=VC().subject(()=>({x:h(this.muS),y:d(this.hS)})).on("start",(t,e)=>{OC(t.currentTarget).classed("dragging",!0),e.startX=t.x,e.startY=t.y,e.startHS=this.hS,e.startMuS=this.muS}).on("drag",(t,e)=>{this.drag=!0;let r=this.muS;this.interactive&&(r=h.invert(t.x));let n=this.hS;if(this.unequal&&(n=d.invert(t.y)),this.interactive&&this.unequal&&t.sourceEvent.shiftKey&&(Math.abs(t.x-e.startX)>Math.abs(t.y-e.startY)?n=e.startHS:r=e.startMuS),this.unequal){const t=_F.h2S(n);this.s=t<_F.s.MIN?_F.s.MIN:t>_F.s.MAX?_F.s.MAX:t;const e=_F.l2C(this.l,this.s);this.c=e<_F.c.MIN?_F.c.MIN:e>_F.c.MAX?_F.c.MAX:e}const i=_F.muS2D(r,this.s);this.d=i<_F.d.MIN?_F.d.MIN:i>_F.d.MAX?_F.d.MAX:i,this.alignState(),this.sendEvent()}).on("end",t=>{OC(t.currentTarget).classed("dragging",!1)}),v=pF().x(t=>h(t.e)).y(t=>d(t.p)),y=OC(this.renderRoot).selectAll(".main").data([{width:this.width,height:this.height,rem:this.rem}]),w=y.enter().append("svg").classed("main",!0).each((t,e,r)=>{DT(kF.svgFilters,r[e])}),x=w.merge(y).attr("viewBox",`0 0 ${n} ${i}`),k=w.append("g").classed("plot",!0),$=x.select(".plot").attr("transform",`translate(${o}, ${a})`),S=k.append("g").classed("underlayer",!0),_=$.select(".underlayer");S.append("rect").classed("background",!0),_.select(".background").attr("height",l).attr("width",c),S.append("g").classed("axis-x",!0);_.select(".axis-x").attr("transform",`translate(0, ${l})`).call(pN(h)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null),S.append("text").classed("title-x",!0).attr("text-anchor","middle").text("Evidence"),_.select(".title-x").attr("transform",`translate(${c/2}, ${l+2.25*this.rem})`);const A=_.selectAll(".axis-y").data(this.distributions?[{}]:[]);A.enter().append("g").classed("axis-y",!0).merge(A).call(mN(d).ticks(5)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null),A.exit().remove();const E=_.selectAll(".title-y").data(this.distributions?[{}]:[]);E.enter().append("text").classed("title-y",!0).attr("text-anchor","middle").text("Probability").merge(E).attr("transform",`translate(${-2*this.rem}, ${l/2})rotate(-90)`),E.exit().remove();const M=_.selectAll(".axis-y2").data(this.histogram?[{}]:[]);var T;M.enter().append("g").classed("axis-y2",!0).merge(M).attr("transform",this.distributions?`translate(${c}, 0)`:"").call(this.distributions?(T=p,fN(2,T)).ticks(10):mN(p).ticks(10)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null),M.exit().remove();const N=_.selectAll(".title-y2").data(this.histogram?[{}]:[]);N.enter().append("text").classed("title-y2",!0).attr("text-anchor","middle").text("Count").merge(N).attr("transform",this.distributions?`translate(${c+1.5*this.rem}, ${l/2})rotate(90)`:`translate(${-1.5*this.rem}, ${l/2})rotate(-90)`),N.exit().remove(),k.append("g").classed("content",!0);const C=$.select(".content"),R=C.selectAll(".signal-noise").data(this.distributions?[{}]:[]),O=R.enter().append("g").classed("signal-noise",!0),P=O.merge(R);R.exit().remove();const I=O.append("g").classed("noise",!0),F=P.selectAll(".noise").attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?t=>{if(["ArrowRight","ArrowLeft"].includes(t.key)){let e=this.muN;switch(t.key){case"ArrowRight":e+=t.shiftKey?.01:.1;break;case"ArrowLeft":e-=t.shiftKey?.01:.1}const r=_F.muN2D(e,this.s);this.d=r<_F.d.MIN?_F.d.MIN:r>_F.d.MAX?_F.d.MAX:r,this.alignState(),this.sendEvent(),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?F.call(g):F.on(".drag",null)),I.append("path").classed("curve-cr",!0),F.select(".curve-cr").transition().duration(this.drag?0:u).ease(UO).attrTween("d",(t,e,r)=>{const n=r[e],i=jR(void 0!==n.d?n.d:this.d,this.d),a=jR(void 0!==n.c?n.c:this.c,this.c),s=jR(void 0!==n.s?n.s:this.s,this.s);return t=>{n.d=i(t),n.c=a(t),n.s=s(t);const e=aN(h.domain()[0],_F.c2L(n.c,n.s),.05).map(t=>({e:t,p:SF.normal.pdf(t,_F.d2MuN(n.d,n.s),1)}));return e.push({e:_F.c2L(n.c,n.s),p:SF.normal.pdf(_F.c2L(n.c,n.s),_F.d2MuN(n.d,n.s),1)}),e.push({e:_F.c2L(n.c,n.s),p:0}),e.push({e:h.domain()[0],p:0}),v(e)}}),I.append("path").classed("curve-fa",!0),F.select(".curve-fa").transition().duration(this.drag?0:u).ease(UO).attrTween("d",(t,e,r)=>{const n=r[e],i=jR(void 0!==n.d?n.d:this.d,this.d),a=jR(void 0!==n.c?n.c:this.c,this.c),s=jR(void 0!==n.s?n.s:this.s,this.s);return t=>{n.d=i(t),n.c=a(t),n.s=s(t);const e=aN(_F.c2L(n.c,n.s),h.domain()[1],.05).map(t=>({e:t,p:SF.normal.pdf(t,_F.d2MuN(n.d,n.s),1)}));return e.push({e:h.domain()[1],p:SF.normal.pdf(h.domain()[1],_F.d2MuN(n.d,n.s),1)}),e.push({e:h.domain()[1],p:0}),e.push({e:_F.c2L(n.c,n.s),p:0}),v(e)}}),I.append("path").classed("curve-noise",!0),F.select(".curve-noise").transition().duration(this.drag?0:u).ease(UO).attrTween("d",(t,e,r)=>{const n=r[e],i=jR(void 0!==n.d?n.d:this.d,this.d),a=jR(void 0!==n.s?n.s:this.s,this.s);return t=>{n.d=i(t),n.s=a(t);const e=aN(h.domain()[0],h.domain()[1],.05).map(t=>({e:t,p:SF.normal.pdf(t,_F.d2MuN(n.d,n.s),1)}));return e.push({e:h.domain()[1],p:SF.normal.pdf(h.domain()[1],_F.d2MuN(n.d,n.s),1)}),v(e)}});const D=O.append("g").classed("signal",!0),j=P.selectAll(".signal").attr("tabindex",this.interactive||this.unequal?0:null).classed("interactive",this.interactive).classed("unequal",this.unequal).on("keydown.sensitivity",this.interactive?t=>{if(["ArrowRight","ArrowLeft"].includes(t.key)){let e=this.muS;switch(t.key){case"ArrowRight":e+=t.shiftKey?.01:.1;break;case"ArrowLeft":e-=t.shiftKey?.01:.1}const r=_F.muS2D(e,this.s);this.d=r<_F.d.MIN?_F.d.MIN:r>_F.d.MAX?_F.d.MAX:r,this.alignState(),this.sendEvent(),t.preventDefault()}}:null).on("keydown.variance",this.unequal?t=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let e=this.hS;switch(t.key){case"ArrowUp":e+=t.shiftKey?.002:.02;break;case"ArrowDown":e-=t.shiftKey?.002:.02}e=e<0?0:e;const r=_F.h2S(e);this.s=r<_F.s.MIN?_F.s.MIN:r>_F.s.MAX?_F.s.MAX:r,this.d=_F.muN2D(this.muN,this.s),this.c=_F.l2C(this.l,this.s),this.alignState(),this.sendEvent(),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive")||t.has("unequal"))&&(this.interactive||this.unequal?j.call(b):j.on(".drag",null)),D.append("path").classed("curve-m",!0),j.select(".curve-m").transition().duration(this.drag?0:u).ease(UO).attrTween("d",(t,e,r)=>{const n=r[e],i=jR(void 0!==n.d?n.d:this.d,this.d),a=jR(void 0!==n.c?n.c:this.c,this.c),s=jR(void 0!==n.s?n.s:this.s,this.s);return t=>{n.d=i(t),n.c=a(t),n.s=s(t);const e=aN(h.domain()[0],_F.c2L(n.c,n.s),.05).map(t=>({e:t,p:SF.normal.pdf(t,_F.d2MuS(n.d,n.s),n.s)}));return e.push({e:_F.c2L(n.c,n.s),p:SF.normal.pdf(_F.c2L(n.c,n.s),_F.d2MuS(n.d,n.s),n.s)}),e.push({e:_F.c2L(n.c,n.s),p:0}),e.push({e:h.domain()[0],p:0}),v(e)}}),D.append("path").classed("curve-h",!0),j.select(".curve-h").transition().duration(this.drag?0:u).ease(UO).attrTween("d",(t,e,r)=>{const n=r[e],i=jR(void 0!==n.d?n.d:this.d,this.d),a=jR(void 0!==n.c?n.c:this.c,this.c),s=jR(void 0!==n.s?n.s:this.s,this.s);return t=>{n.d=i(t),n.c=a(t),n.s=s(t);const e=aN(_F.c2L(n.c,n.s),h.domain()[1],.05).map(t=>({e:t,p:SF.normal.pdf(t,_F.d2MuS(n.d,n.s),n.s)}));return e.push({e:h.domain()[1],p:SF.normal.pdf(h.domain()[1],_F.d2MuS(n.d,n.s),n.s)}),e.push({e:h.domain()[1],p:0}),e.push({e:_F.c2L(n.c,n.s),p:0}),v(e)}}),D.append("path").classed("curve-signal",!0),j.select(".curve-signal").transition().duration(this.drag?0:u).ease(UO).attrTween("d",(t,e,r)=>{const n=r[e],i=jR(void 0!==n.d?n.d:this.d,this.d),a=jR(void 0!==n.s?n.s:this.s,this.s);return t=>{n.d=i(t),n.s=a(t);const e=aN(h.domain()[0],h.domain()[1],.05).map(t=>({e:t,p:SF.normal.pdf(t,_F.d2MuS(n.d,n.s),n.s)}));return e.push({e:h.domain()[1],p:SF.normal.pdf(h.domain()[1],_F.d2MuS(n.d,n.s),n.s)}),v(e)}});const z=C.selectAll(".measure-d").data(this.sensitivity?[{}]:[]),q=z.enter().append("g").classed("measure-d",!0);q.append("line").classed("line",!0),q.append("line").classed("cap-left",!0),q.append("line").classed("cap-right",!0);const U=q.append("text").classed("label",!0);U.append("tspan").classed("d math-var",!0).text("d′"),U.append("tspan").classed("equals",!0).text(" = "),U.append("tspan").classed("value",!0);const L=q.merge(z);L.select(".line").transition().duration(this.drag?0:u).ease(UO).attr("x1",h(this.muN)).attr("y1",d(.43)).attr("x2",h(this.muS)).attr("y2",d(.43)),L.select(".cap-left").transition().duration(this.drag?0:u).ease(UO).attr("x1",h(this.muN)).attr("y1",d(.43)+5).attr("x2",h(this.muN)).attr("y2",d(.43)-5),L.select(".cap-right").transition().duration(this.drag?0:u).ease(UO).attr("x1",h(this.muS)).attr("y1",d(.43)+5).attr("x2",h(this.muS)).attr("y2",d(.43)-5);L.select(".label").transition().duration(this.drag?0:u).ease(UO).attr("x",h(this.muN>this.muS?this.muN:this.muS)+5).attr("y",d(.43)+3).select(".value").tween("text",(t,e,r)=>{const n=r[e],i=jR(void 0!==n.d?n.d:this.d,this.d);return t=>{n.d=i(t),OC(n).text(yP(".3")(n.d))}}),z.exit().remove();const H=C.selectAll(".measure-c").data(this.bias?[{}]:[]),B=H.enter().append("g").classed("measure-c",!0);B.append("line").classed("line",!0),B.append("line").classed("cap-zero",!0);const V=B.append("text").classed("label",!0);V.append("tspan").classed("c math-var",!0).text("c"),V.append("tspan").classed("equals",!0).text(" = "),V.append("tspan").classed("value",!0);const W=B.merge(H);W.select(".line").transition().duration(this.drag?0:u).ease(UO).attr("x1",h(this.l)).attr("y1",d(.47)).attr("x2",h(0)).attr("y2",d(.47)),W.select(".cap-zero").transition().duration(this.drag?0:u).ease(UO).attr("x1",h(0)).attr("y1",d(.47)+5).attr("x2",h(0)).attr("y2",d(.47)-5);W.select(".label").transition().duration(this.drag?0:u).ease(UO).attr("x",h(0)+(this.l<0?5:-5)).attr("y",d(.47)+3).attr("text-anchor",this.c<0?"start":"end").select(".value").tween("text",(t,e,r)=>{const n=r[e],i=jR(void 0!==n.c?n.c:this.c,this.c);return t=>{n.c=i(t),OC(n).text(yP(".3")(n.c))}}),H.exit().remove();const X=C.selectAll(".measure-s").data(this.variance?[{}]:[]),Y=X.enter().append("g").classed("measure-s",!0);Y.append("line").classed("line",!0),Y.append("line").classed("cap-left",!0),Y.append("line").classed("cap-right",!0);const K=Y.append("text").classed("label",!0);K.append("tspan").classed("s math-var",!0).text("σ"),K.append("tspan").classed("equals",!0).text(" = "),K.append("tspan").classed("value",!0);const Z=Y.merge(X);Z.select(".line").transition().duration(this.drag?0:u).ease(UO).attr("x1",h(this.muS-this.s)).attr("y1",d(SF.normal.pdf(this.s,0,this.s))+10/this.s).attr("x2",h(this.muS+this.s)).attr("y2",d(SF.normal.pdf(this.s,0,this.s))+10/this.s),Z.select(".cap-left").transition().duration(this.drag?0:u).ease(UO).attr("x1",h(this.muS-this.s)).attr("y1",d(SF.normal.pdf(this.s,0,this.s))+10/this.s+5).attr("x2",h(this.muS-this.s)).attr("y2",d(SF.normal.pdf(this.s,0,this.s))+10/this.s-5),Z.select(".cap-right").transition().duration(this.drag?0:u).ease(UO).attr("x1",h(this.muS+this.s)).attr("y1",d(SF.normal.pdf(this.s,0,this.s))+10/this.s+5).attr("x2",h(this.muS+this.s)).attr("y2",d(SF.normal.pdf(this.s,0,this.s))+10/this.s-5);Z.select(".label").transition().duration(this.drag?0:u).ease(UO).attr("x",h(this.muS)).attr("y",d(SF.normal.pdf(this.s,0,this.s))+10/this.s-3).select(".value").tween("text",(t,e,r)=>{const n=r[e],i=jR(void 0!==n.s?n.s:this.s,this.s);return t=>{n.s=i(t),OC(n).text(yP(".3")(n.s))}}),X.exit().remove();const G=C.selectAll(".threshold").data(this.threshold?[{}]:[]),J=G.enter().append("g").classed("threshold",!0);J.append("line").classed("line",!0),J.append("line").classed("line touch",!0),J.append("circle").classed("handle touch",!0);const Q=J.merge(G).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive);(this.firstUpdate||t.has("interactive"))&&(this.interactive?Q.call(m).on("keydown",t=>{if(["ArrowRight","ArrowLeft"].includes(t.key)){let e=this.l;switch(t.key){case"ArrowRight":e+=t.shiftKey?.01:.1;break;case"ArrowLeft":e-=t.shiftKey?.01:.1}const r=_F.l2C(e,this.s);this.c=r<_F.c.MIN?_F.c.MIN:r>_F.c.MAX?_F.c.MAX:r,this.alignState(),this.sendEvent(),t.preventDefault()}}):Q.on("drag",null).on("keydown",null)),Q.select(".line").transition().duration(this.drag?0:u).ease(UO).attr("x1",h(this.l)).attr("y1",d(0)).attr("x2",h(this.l)).attr("y2",d(.54)),Q.select(".line.touch").transition().duration(this.drag?0:u).ease(UO).attr("x1",h(this.l)).attr("y1",d(0)).attr("x2",h(this.l)).attr("y2",d(.54)),Q.select(".handle").transition().duration(this.drag?0:u).ease(UO).attr("cx",h(this.l)).attr("cy",d(.54)),G.exit().remove();const tt=C.selectAll(".histogram").data(this.histogram?[{}]:[]),et=tt.enter().append("g").classed("histogram",!0).merge(tt);if(tt.exit().remove(),this.histogram){const t=function(){var t=YT,e=WT,r=iN;function n(n){Array.isArray(n)||(n=Array.from(n));var i,a,s,o=n.length,l=new Array(o);for(i=0;i<o;++i)l[i]=t(n[i],i,n);var c=e(l),u=c[0],h=c[1],d=r(l,u,h);if(!Array.isArray(d)){const t=h,r=+d;if(e===WT&&([u,h]=nN(u,h,r)),(d=eN(u,h,r))[0]<=u&&(s=rN(u,h,r)),d[d.length-1]>=h)if(t>=h&&e===WT){const t=rN(u,h,r);isFinite(t)&&(t>0?h=(Math.floor(h/t)+1)*t:t<0&&(h=(Math.ceil(h*-t)+1)/-t))}else d.pop()}for(var f=d.length,p=0,m=f;d[p]<=u;)++p;for(;d[m-1]>h;)--m;(p||m<f)&&(d=d.slice(p,m),f=m-p);var g,b=new Array(f+1);for(i=0;i<=f;++i)(g=b[i]=[]).x0=i>0?d[i-1]:u,g.x1=i<f?d[i]:h;if(isFinite(s)){if(s>0)for(i=0;i<o;++i)null!=(a=l[i])&&u<=a&&a<=h&&b[Math.min(f,Math.floor((a-u)/s))].push(n[i]);else if(s<0)for(i=0;i<o;++i)if(null!=(a=l[i])&&u<=a&&a<=h){const t=Math.floor((u-a)*s);b[Math.min(f,t+(d[t]<=a))].push(n[i])}}else for(i=0;i<o;++i)null!=(a=l[i])&&u<=a&&a<=h&&b[VT(d,a,0,f)].push(n[i]);return b}return n.value=function(e){return arguments.length?(t="function"==typeof e?e:ZT(e),n):t},n.domain=function(t){return arguments.length?(e="function"==typeof t?t:ZT([t[0],t[1]]),n):e},n.thresholds=function(t){return arguments.length?(r="function"==typeof t?t:ZT(Array.isArray(t)?KT.call(t):t),n):r},n}().value(t=>t.trueEvidence).domain(h.domain()).thresholds(aN(this.binRange[0],this.binRange[1],this.binWidth)),e=t(this.trials);let r=-1,n=-1;for(let t=0;t<e.length;t+=1)for(let i=0;i<e[t].length;i+=1)e[t][i].binValue=e[t].x0,e[t][i].binCount=i,0===t&&(r=i),t===e.length-1&&(n=i);for(let t=0;t<this.trials.length;t+=1)this.trials[t].trueEvidence<this.binRange[0]&&(r+=1,this.trials[t].binCount=r,this.trials[t].binValue=e[0].x0),this.trials[t].trueEvidence>this.binRange[1]&&(n+=1,this.trials[t].binCount=n,this.trials[t].binValue=e[e.length-1].x0);const i=et.selectAll(".trial").data(this.trials,t=>t.trial),a=i.enter().append("rect").attr("stroke-width",3).attr("data-new-trial-ease-time",0).attr("stroke",this.getComputedStyleValue("---color-acc")).attr("fill",this.getComputedStyleValue("---color-acc-light")).merge(i).attr("class",t=>`trial ${t.outcome}`).attr("width",f-3).attr("height",f-3),s=a.filter(t=>t.new&&!t.paused);if(!s.empty()){const t=s.attr("data-new-trial-ease-time"),e=e=>lF().domain([0,1]).range([t,1])(e),r=e=>r=>lF().domain([e(t),1]).range([0,1])(e(r));s.transition("new").duration(e=>Math.floor((.75*e.duration+.25*e.wait)*(1-t))).ease(e).attr("data-new-trial-ease-time",1).attrTween("stroke",(t,e,n)=>{const i=n[e],a=TR(i.getAttribute("stroke"),"stimulus"===this.color?"present"===t.signal?this.getComputedStyleValue("---color-hr"):this.getComputedStyleValue("---color-far"):"response"===this.color?this.getComputedStyleValue(`---color-${t.response}`):"outcome"===this.color||"all"===this.color?this.getComputedStyleValue(`---color-${t.outcome}`):this.getComputedStyleValue("---color-acc"));return t=>a(r(qO)(t))}).attrTween("fill",(t,e,n)=>{const i=n[e],a=TR(i.getAttribute("fill"),"stimulus"===this.color?"present"===t.signal?this.getComputedStyleValue("---color-hr-light"):this.getComputedStyleValue("---color-far-light"):"response"===this.color?this.getComputedStyleValue(`---color-${t.response}-light`):"outcome"===this.color||"all"===this.color?this.getComputedStyleValue(`---color-${t.outcome}-light`):this.getComputedStyleValue("---color-acc-light"));return t=>a(r(qO)(t))}).attrTween("x",(t,e,n)=>{const i=jR(n[e].getAttribute("x"),h(t.binValue)+1.5);return t=>i(r(UO)(t))}).attrTween("y",(t,e,n)=>{const i=jR(n[e].getAttribute("y"),d(0)+1.5-(t.binCount+1)*f);return t=>i(r(qO)(t))}).on("end",(t,e,r)=>{r[e].removeAttribute("data-new-trial-ease-time"),t.new=!1,this.alignTrial(t),this.dispatchEvent(new CustomEvent("detectable-response",{detail:{stimulus:t.signal,response:t.response,outcome:t.outcome,h:this.h,m:this.m,fa:this.fa,cr:this.cr,nr:0},bubbles:!0}))})}const o=a.filter(t=>t.new&&t.paused);if(!o.empty()){const t=o.attr("data-new-trial-ease-time");o.transition().duration(u).ease(UO).attr("x",e=>jR(0,h(e.binValue)+1.5)(UO(t))).attr("y",e=>jR(0,d(0)+1.5-(e.binCount+1)*f)(qO(t))).attr("stroke",e=>TR(this.getComputedStyleValue("---color-acc"),"stimulus"===this.color?"present"===e.signal?this.getComputedStyleValue("---color-hr"):this.getComputedStyleValue("---color-far"):"response"===this.color?this.getComputedStyleValue(`---color-${e.response}`):"outcome"===this.color||"all"===this.color?this.getComputedStyleValue(`---color-${e.outcome}`):this.getComputedStyleValue("---color-acc"))(qO(t))).attr("fill",e=>TR(this.getComputedStyleValue("---color-acc-light"),"stimulus"===this.color?"present"===e.signal?this.getComputedStyleValue("---color-hr-light"):this.getComputedStyleValue("---color-far-light"):"response"===this.color?this.getComputedStyleValue(`---color-${e.response}-light`):"outcome"===this.color||"all"===this.color?this.getComputedStyleValue(`---color-${e.outcome}-light`):this.getComputedStyleValue("---color-acc-light"))(qO(t)))}a.filter(t=>!t.new).transition().duration(u).ease(UO).attr("x",t=>h(t.binValue)+1.5).attr("y",t=>d(0)+1.5-(t.binCount+1)*f).attr("stroke",t=>"stimulus"===this.color?"present"===t.signal?this.getComputedStyleValue("---color-hr"):this.getComputedStyleValue("---color-far"):"response"===this.color?this.getComputedStyleValue(`---color-${t.response}`):"outcome"===this.color||"all"===this.color?this.getComputedStyleValue(`---color-${t.outcome}`):this.getComputedStyleValue("---color-acc")).attr("fill",t=>"stimulus"===this.color?"present"===t.signal?this.getComputedStyleValue("---color-hr-light"):this.getComputedStyleValue("---color-far-light"):"response"===this.color?this.getComputedStyleValue(`---color-${t.response}-light`):"outcome"===this.color||"all"===this.color?this.getComputedStyleValue(`---color-${t.outcome}-light`):this.getComputedStyleValue("---color-acc-light")),i.exit().transition().duration(u).ease(zO).attrTween("stroke",(t,e,r)=>{const n=r[e],i=TR(n.getAttribute("stroke"),this.getComputedStyleValue("---color-acc"));return t=>i(qO(t))}).attrTween("fill",(t,e,r)=>{const n=r[e],i=TR(n.getAttribute("fill"),this.getComputedStyleValue("---color-acc-light"));return t=>i(qO(t))}).attrTween("x",(t,e,r)=>{const n=jR(r[e].getAttribute("x"),0);return t=>n(qO(t))}).attrTween("y",(t,e,r)=>{const n=jR(r[e].getAttribute("y"),0);return t=>n(UO(t))}).remove()}const rt=k.append("g").classed("overlayer",!0),nt=$.select(".overlayer");rt.append("rect").classed("background",!0),nt.select(".background").attr("height",l).attr("width",c),this.drag=!1,this.firstUpdate=!1}pauseTrial(){const t=OC(this.renderRoot).select(".trial[data-new-trial-ease-time]");t.interrupt("new"),t.datum(t=>(t.paused=!0,t))}resumeTrial(){OC(this.renderRoot).select(".trial[data-new-trial-ease-time]").datum(t=>(t.paused=!1,t)),this.requestUpdate()}}customElements.define("sdt-model",vD);customElements.define("sdt-parameters",class extends kF{static get properties(){return{d:{attribute:"d",type:Number,reflect:!0},c:{attribute:"c",type:Number,reflect:!0},s:{attribute:"s",type:Number,reflect:!0}}}constructor(){super(),this.d=void 0,this.c=void 0,this.s=void 0}setSensitivity(t){this.d=+t.target.value,this.dispatchEvent(new CustomEvent("sdt-parameters-d",{detail:{d:this.d},bubbles:!0}))}setBias(t){this.c=+t.target.value,this.dispatchEvent(new CustomEvent("sdt-parameters-c",{detail:{c:this.c},bubbles:!0}))}setVariance(t){this.s=+t.target.value,this.dispatchEvent(new CustomEvent("sdt-parameters-s",{detail:{s:this.s},bubbles:!0}))}static get styles(){return[super.styles,PM`
        :host {
          display: inline-block;
        }
      ...
      `]}render(){return vT`
      <div class="holder">
        ${null!=this.d?vT`<decidables-slider class="d"
          ...
          ><div>Sensitivity<br><span class="math-var">d′</span></div></decidables-slider>`:vT``}
        ${null!=this.c?vT`<decidables-slider class="c"
            ?disabled=${!this.interactive}
            scale
            min=${_F.c.MIN}
            max=${_F.c.MAX}
          ...
          ><div>Bias<br><span class="math-var">c</span></div></decidables-slider>`:vT``}
        ${null!=this.s?vT`<decidables-slider class="s"
            ?disabled=${!this.interactive}
            scale
            min=${_F.s.MIN}
            max=${_F.s.MAX}
          ...
          ><div>Variance<br><span class="math-var">σ</span></div></decidables-slider>`:vT``}
      </div>`}});class yD extends(function(t){return class extends t{static get properties(){return{numeric:{attribute:"numeric",type:Boolean,reflect:!0}}}constructor(){super(),this.numeric=!1}static get styles(){return[super.styles,PM`
          :host {
        ...
        `]}}}(kF)){static get styles(){return[super.styles,PM`
        /* Color scheme */
        .h {
          background: var(---color-h-light);
        }
      ...
      `]}}customElements.define("sdt-equation-dc2far",class extends yD{static get properties(){return{unequal:{attribute:"unequal",type:Boolean,reflect:!0},d:{attribute:"d",type:Number,reflect:!0},c:{attribute:"c",type:Number,reflect:!0},s:{attribute:"s",type:Number,reflect:!0},far:{attribute:!1,type:Number,reflect:!1}}}constructor(){super(),this.unequal=!1,this.d=_F.d.DEFAULT,this.c=_F.c.DEFAULT,this.s=_F.s.DEFAULT,this.alignState()}alignState(){this.far=_F.dC2Far(this.d,this.c,this.s)}sendEvent(){this.dispatchEvent(new CustomEvent("sdt-equation-dc2far-change",{detail:{d:this.d,c:this.c,s:this.s,far:this.far},bubbles:!0}))}dInput(t){this.d=parseFloat(t.target.value),this.alignState(),this.sendEvent()}cInput(t){this.c=parseFloat(t.target.value),this.alignState(),this.sendEvent()}sInput(t){this.s=parseFloat(t.target.value),this.alignState(),this.sendEvent()}willUpdate(){this.alignState()}render(){let t,e,r,n;return this.numeric?(t=wT`<mtable><mtr><mtd><mtext>
        ...
        </mtext></mtd></mtr></mtable>`,e=wT`<mtable><mtr><mtd><mtext>
        ...
        </mtext></mtd></mtr></mtable>`,r=wT`<mtable><mtr><mtd><mtext>
        ...
        </mtext></mtd></mtr></mtable>`,n=wT`<mtable><mtr><mtd><mtext>
        ...
        </mtext></mtd></mtr></mtable>`):(t=wT`<mi mathvariant="normal" class="math-id d">d′</mi>`,e=wT`<mi mathvariant="normal" class="math-id c">c</mi>`,r=wT`<mi mathvariant="normal" class="math-id s">σ</mi>`,n=wT`<mtext class="math-id far">False Alarm Rate</mtext>`),vT`<div class="holder">
      <math display="block">
        <semantics>
          <mrow>
            ${n}
          ...
          <annotation encoding="application/x-tex">
            ${this.unequal?wT`\\text{False Alarm Rate} = \\Phi{\\left({\\left[\\frac{1 + \\sigma^2}{2}\\right]}^{\\frac{1}{2}}
                  {\\left[\\frac{-d'}{1 + \\sigma} - c\\right]}\\right)}`:wT`\\text{False Alarm Rate} = \\Phi(-\\frac{d'}{2} - c)`}
          </annotation>
          <annotation encoding="application/x-asciimath">
            ${this.unequal?wT`"False Alarm Rate" = Phi([(1 + sigma^2) / 2]^(1/2)[(-d') / (1 + sigma) - c])`:wT`"False Alarm Rate" = Phi(-(d') / 2 - c)`}
          </annotation>
        </semantics>
      </math>
    </div>`}});customElements.define("sdt-equation-dc2hr",class extends yD{static get properties(){return{unequal:{attribute:"unequal",type:Boolean,reflect:!0},d:{attribute:"d",type:Number,reflect:!0},c:{attribute:"c",type:Number,reflect:!0},s:{attribute:"s",type:Number,reflect:!0},hr:{attribute:!1,type:Number,reflect:!1}}}constructor(){super(),this.unequal=!1,this.d=_F.d.DEFAULT,this.c=_F.c.DEFAULT,this.s=_F.s.DEFAULT,this.alignState()}alignState(){this.hr=_F.dC2Hr(this.d,this.c,this.s)}sendEvent(){this.dispatchEvent(new CustomEvent("sdt-equation-dc2hr-change",{detail:{d:this.d,c:this.c,s:this.s,hr:this.hr},bubbles:!0}))}dInput(t){this.d=parseFloat(t.target.value),this.alignState(),this.sendEvent()}cInput(t){this.c=parseFloat(t.target.value),this.alignState(),this.sendEvent()}sInput(t){this.s=parseFloat(t.target.value),this.alignState(),this.sendEvent()}willUpdate(){this.alignState()}render(){let t,e,r,n;return this.numeric?(t=wT`<mtable><mtr><mtd><mtext>
          <decidables-spinner class="math d"
            ?disabled=${!this.interactive}
            step=${_F.d.STEP}
            .value=${this.d}
        ...
        </mtext></mtd></mtr></mtable>`):(t=wT`<mi mathvariant="normal" class="math-id d">d′</mi>`,e=wT`<mi mathvariant="normal" class="math-id c">c</mi>`,r=wT`<mi mathvariant="normal" class="math-id s">σ</mi>`,n=wT`<mtext class="math-id hr">Hit Rate</mtext>`),vT`<div class="holder">
      <math display="block">
        <semantics>
          <mrow>
            ${n}
          ...
          <annotation encoding="application/x-tex">
            ${this.unequal?wT`\\text{Hit Rate} = \\Phi{\\left({\\left[\\frac{1 + \\sigma^2}{2}\\right]}^{\\frac{1}{2}}
                  {\\left[\\frac{d'}{1 + \\sigma} - \\frac{c}{\\sigma}\\right]}\\right)}`:wT`\\text{Hit Rate} = \\Phi(\\frac{d'}{2} - c)`}
          </annotation>
          <annotation encoding="application/x-asciimath">
            ${this.unequal?wT`"Hit Rate" = Phi([(1 + sigma^2) / 2]^(1/2)[(d') / (1 + sigma) - c / sigma])`:wT`"Hit Rate" = Phi((d') / 2 - c)`}
          </annotation>
        </semantics>
      </math>
    </div>`}});customElements.define("sdt-equation-facr2far",class extends yD{static get properties(){return{fa:{attribute:"false-alarms",type:Number,reflect:!0},cr:{attribute:"correct-rejections",type:Number,reflect:!0},far:{attribute:!1,type:Number,reflect:!1}}}constructor(){super(),this.fa=0,this.cr=0,this.alignState()}alignState(){this.far=_F.faCr2Far(this.fa,this.cr)}sendEvent(){this.dispatchEvent(new CustomEvent("sdt-equation-facr2far-change",{detail:{fa:this.fa,cr:this.cr,far:this.far},bubbles:!0}))}faInput(t){this.fa=parseInt(t.target.value,10),this.alignState(),this.sendEvent()}crInput(t){this.cr=parseInt(t.target.value,10),this.alignState(),this.sendEvent()}willUpdate(){this.alignState()}render(){let t,e,r;return this.numeric?(t=wT`<mtable><mtr><mtd><mtext>
        ...
        </mtext></mtd></mtr></mtable>`):(t=wT`<mtext class="math-id fa">False Alarms</mtext>`,e=wT`<mtext class="math-id cr">Correct Rejections</mtext>`,r=wT`<mtext class="math-id far">False Alarm Rate</mtext>`),vT`<div class="holder">
      <math display="block">
        <semantics>
          <mrow>
            ${r}
    ...
    </div>`}});customElements.define("sdt-equation-hfa2ppv",class extends yD{static get properties(){return{h:{attribute:"hits",type:Number,reflect:!0},fa:{attribute:"false-alarms",type:Number,reflect:!0},ppv:{attribute:!1,type:Number,reflect:!1}}}constructor(){super(),this.h=0,this.fa=0,this.alignState()}alignState(){this.ppv=_F.hFa2Ppv(this.h,this.fa)}sendEvent(){this.dispatchEvent(new CustomEvent("sdt-equation-hfa2ppv-change",{detail:{h:this.h,fa:this.fa,ppv:this.ppv},bubbles:!0}))}hInput(t){this.h=parseInt(t.target.value,10),this.alignState(),this.sendEvent()}faInput(t){this.fa=parseInt(t.target.value,10),this.alignState(),this.sendEvent()}willUpdate(){this.alignState()}render(){let t,e,r;return this.numeric?(t=wT`<mtable><mtr><mtd><mtext>
        ...
        </mtext></mtd></mtr></mtable>`):(t=wT`<mtext class="math-id h">Hits</mtext>`,e=wT`<mtext class="math-id fa">False Alarms</mtext>`,r=wT`<mtext class="math-id ppv">Positive Predictive Value</mtext>`),vT`<div class="holder">
      <math display="block">
        <semantics>
          <mrow>
            ${r}
    ...
    </div>`}});customElements.define("sdt-equation-hm2hr",class extends yD{static get properties(){return{h:{attribute:"hits",type:Number,reflect:!0},m:{attribute:"misses",type:Number,reflect:!0},hr:{attribute:!1,type:Number,reflect:!1}}}constructor(){super(),this.h=0,this.m=0,this.alignState()}alignState(){this.hr=_F.hM2Hr(this.h,this.m)}sendEvent(){this.dispatchEvent(new CustomEvent("sdt-equation-hm2hr-change",{detail:{h:this.h,m:this.m,hr:this.hr},bubbles:!0}))}hInput(t){this.h=parseInt(t.target.value,10),this.alignState(),this.sendEvent()}mInput(t){this.m=parseInt(t.target.value,10),this.alignState(),this.sendEvent()}willUpdate(){this.alignState()}render(){let t,e,r;return this.numeric?(t=wT`<mtable><mtr><mtd><mtext>
          <decidables-spinner class="math h"
            ?disabled=${!this.interactive}
            min="0"
            .value=${this.h}
        ...
        </mtext></mtd></mtr></mtable>`):(t=wT`<mtext class="math-id h">Hits</mtext>`,e=wT`<mtext class="math-id m">Misses</mtext>`,r=wT`<mtext class="math-id hr">Hit Rate</mtext>`),vT`<div class="holder">
      <math display="block">
        <semantics>
          <mrow>
            ${r}
    ...
    </div>`}});customElements.define("sdt-equation-hmfacr2acc",class extends yD{static get properties(){return{h:{attribute:"hits",type:Number,reflect:!0},m:{attribute:"misses",type:Number,reflect:!0},fa:{attribute:"false-alarms",type:Number,reflect:!0},cr:{attribute:"correct-rejections",type:Number,reflect:!0},acc:{attribute:!1,type:Number,reflect:!1}}}constructor(){super(),this.h=0,this.m=0,this.fa=0,this.cr=0,this.alignState()}alignState(){this.acc=_F.hMFaCr2Acc(this.h,this.m,this.fa,this.cr)}sendEvent(){this.dispatchEvent(new CustomEvent("sdt-equation-hmfacr2acc-change",{detail:{h:this.h,m:this.m,fa:this.fa,cr:this.cr,acc:this.acc},bubbles:!0}))}hInput(t){this.h=parseInt(t.target.value,10),this.alignState(),this.sendEvent()}mInput(t){this.m=parseInt(t.target.value,10),this.alignState(),this.sendEvent()}faInput(t){this.fa=parseInt(t.target.value,10),this.alignState(),this.sendEvent()}crInput(t){this.cr=parseInt(t.target.value,10),this.alignState(),this.sendEvent()}willUpdate(){this.alignState()}render(){let t,e,r,n,i;return this.numeric?(t=wT`<mtable><mtr><mtd><mtext>
          <decidables-spinner class="math h"
            ?disabled=${!this.interactive}
            min="0"
            .value=${this.h}
        ...
        </mtext></mtd></mtr></mtable>`,i=wT`<mtable><mtr><mtd><mtext>
        ...
        </mtext></mtd></mtr></mtable>`):(t=wT`<mtext class="math-id h">Hits</mtext>`,e=wT`<mtext class="math-id m">Misses</mtext>`,r=wT`<mtext class="math-id fa">False Alarms</mtext>`,n=wT`<mtext class="math-id cr">Correct Rejections</mtext>`,i=wT`<mtext class="math-id acc">Accuracy</mtext>`),vT`<div class="holder">
      <math display="block">
        <semantics>
          <mrow>
            ${i}
    ...
    </div>`}});customElements.define("sdt-equation-hrfar2c",class extends yD{static get properties(){return{unequal:{attribute:"unequal",type:Boolean,reflect:!0},hr:{attribute:"hit-rate",type:Number,reflect:!0},far:{attribute:"false-alarm-rate",type:Number,reflect:!0},s:{attribute:"s",type:Number,reflect:!0},c:{attribute:!1,type:Number,reflect:!1}}}constructor(){super(),this.unequal=!1,this.hr=0,this.far=0,this.s=_F.s.DEFAULT,this.alignState()}alignState(){this.c=_F.hrFar2C(this.hr,this.far,this.s)}sendEvent(){this.dispatchEvent(new CustomEvent("sdt-equation-hrfar2c-change",{detail:{hr:this.hr,far:this.far,s:this.s,c:this.c},bubbles:!0}))}hrInput(t){this.hr=parseFloat(t.target.value),this.alignState(),this.sendEvent()}farInput(t){this.far=parseFloat(t.target.value),this.alignState(),this.sendEvent()}sInput(t){this.s=parseFloat(t.target.value),this.alignState(),this.sendEvent()}willUpdate(){this.alignState()}render(){let t,e,r,n;return this.numeric?(t=wT`<mtable><mtr><mtd><mtext>
          <decidables-spinner class="math hr"
            ?disabled=${!this.interactive}
            min="0"
            max="1"
        ...
        </mtext></mtd></mtr></mtable>`):(t=wT`<mtext class="math-id hr">Hit Rate</mtext>`,e=wT`<mtext class="math-id far">False Alarm Rate</mtext>`,r=wT`<mi mathvariant="normal" class="math-id s">σ</mi>`,n=wT`<mi mathvariant="normal" class="math-id c">c</mi>`),vT`<div class="holder">
      <math display="block">
        <semantics>
          <mrow>
            ${n}
          ...
          <annotation encoding="application/x-tex">
            ${this.unequal?wT`d' = \\left(\\frac{1 + \\sigma^2}{2}\\right)^{-\\frac{1}{2}}
                \\left(\\frac{-\\sigma}{1 + \\sigma}\\right)
                \\left[\\Phi^{-1}(\\text{Hit Rate}) - \\Phi^{-1}(\\text{False Alarm Rate}) \\right]`:wT`d' = \\frac{-\\left[\\Phi^{-1}(\\text{Hit Rate}) - \\Phi^{-1}(\\text{False Alarm Rate})\\right]}{2}`}
          </annotation>
          <annotation encoding="application/x-asciimath">
            ${this.unequal?wT`d' = ((1 + sigma^2) / 2)^(-1/2)
                (sigma / (1 + sigma))
                [Phi^(-1)("Hit Rate") - Phi^(-1)("False Alarm Rate")]`:wT`d' = (-[Phi^-1("Hit Rate") - Phi^-1("False Alarm Rate")]) / 2`}
          </annotation>
        </semantics>
      </math>
    </div>`}});customElements.define("sdt-equation-hrfar2d",class extends yD{static get properties(){return{unequal:{attribute:"unequal",type:Boolean,reflect:!0},hr:{attribute:"hit-rate",type:Number,reflect:!0},far:{attribute:"false-alarm-rate",type:Number,reflect:!0},s:{attribute:"s",type:Number,reflect:!0},d:{attribute:!1,type:Number,reflect:!1}}}constructor(){super(),this.unequal=!1,this.hr=0,this.far=0,this.s=_F.s.DEFAULT,this.alignState()}alignState(){this.d=_F.hrFar2D(this.hr,this.far,this.s)}sendEvent(){this.dispatchEvent(new CustomEvent("sdt-equation-hrfar2d-change",{detail:{hr:this.hr,far:this.far,s:this.s,d:this.d},bubbles:!0}))}hrInput(t){this.hr=parseFloat(t.target.value),this.alignState(),this.sendEvent()}farInput(t){this.far=parseFloat(t.target.value),this.alignState(),this.sendEvent()}sInput(t){this.s=parseFloat(t.target.value),this.alignState(),this.sendEvent()}willUpdate(){this.alignState()}render(){let t,e,r,n;return this.numeric?(t=wT`<mtable><mtr><mtd><mtext>
          <decidables-spinner class="math hr"
            ?disabled=${!this.interactive}
            min="0"
            max="1"
        ...
        </mtext></mtd></mtr></mtable>`):(t=wT`<mtext class="math-id hr">Hit Rate</mtext>`,e=wT`<mtext class="math-id far">False Alarm Rate</mtext>`,r=wT`<mi mathvariant="normal" class="math-id s">σ</mi>`,n=wT`<mi mathvariant="normal" class="math-id d">d′</mi>`),vT`<div class="holder">
      <math display="block">
        <semantics>
          <mrow>
            ${n}
          ...
          <annotation encoding="application/x-tex">
            ${this.unequal?wT`d' = \\left(\\frac{1 + \\sigma^2}{2}\\right)^{-\\frac{1}{2}}
                \\left[\\sigma \\Phi^{-1}(\\text{Hit Rate}) - \\Phi^{-1}(\\text{False Alarm Rate}) \\right]`:wT`d' = \\Phi^{-1}(\\text{Hit Rate}) - \\Phi^{-1}(\\text{False Alarm Rate})`}
          </annotation>
          <annotation encoding="application/x-asciimath">
            ${this.unequal?wT`d' = ((1 + sigma^2) / 2)^(-1/2)
                [sigma Phi^(-1)("Hit Rate") - Phi^(-1)("False Alarm Rate")]`:wT`d' = Phi^-1("Hit Rate") - Phi^-1("False Alarm Rate")`}
          </annotation>
        </semantics>
      </math>
    </div>`}});customElements.define("sdt-equation-mcr2fomr",class extends yD{static get properties(){return{m:{attribute:"misses",type:Number,reflect:!0},cr:{attribute:"correct-rejections",type:Number,reflect:!0},fomr:{attribute:!1,type:Number,reflect:!1}}}constructor(){super(),this.m=0,this.cr=0,this.alignState()}alignState(){this.fomr=_F.mCr2Fomr(this.m,this.cr)}sendEvent(){this.dispatchEvent(new CustomEvent("sdt-equation-mcr2fomr-change",{detail:{m:this.m,cr:this.cr,fomr:this.fomr},bubbles:!0}))}mInput(t){this.m=parseInt(t.target.value,10),this.alignState(),this.sendEvent()}crInput(t){this.cr=parseInt(t.target.value,10),this.alignState(),this.sendEvent()}willUpdate(){this.alignState()}render(){let t,e,r;return this.numeric?(t=wT`<mtable><mtr><mtd><mtext>
          <decidables-spinner class="math m"
            ?disabled=${!this.interactive}
            min="0"
            .value=${this.m}
        ...
        </mtext></mtd></mtr></mtable>`):(t=wT`<mtext class="math-id m">Misses</mtext>`,e=wT`<mtext class="math-id cr">Correct Rejections</mtext>`,r=wT`<mtext class="math-id fomr">False Omission Rate</mtext>`),vT`<div class="holder">
      <math display="block">
        <semantics>
          <mrow>
            ${r}
    ...
    </div>`}});class wD extends kF{static get styles(){return[super.styles,PM`
        :host {
          display: inline-block;
