...
const o=t=>t??E;class DecidablesSlider extends DecidablesElement{static get properties(){return{disabled:{attribute:"disabled",type:Boolean,reflect:!0},scale:{attribute:"scale",type:Boolean,reflect:!0},max:{attribute:"max",type:Number,reflect:!0},min:{attribute:"min",type:Number,reflect:!0},step:{attribute:"step",type:Number,reflect:!0},value:{attribute:"value",type:Number,reflect:!0},nonlinear:{attribute:!1,type:Boolean,reflect:!1}}}constructor(){super(),this.disabled=!1,this.scale=!1,this.max=void 0,this.min=void 0,this.step=void 0,this.value=void 0,this.nonlinear=!1,this.rangeMax=void 0,this.rangeMin=void 0,this.rangeStep=void 0,this.rangeValue=void 0,this.toRange=void 0,this.fromRange=void 0}nonlinearRange(t,e,r){this.nonlinear=t,this.toRange=t?e:void 0,this.fromRange=t?r:void 0}rangeChanged(t){this.value=this.nonlinear?this.fromRange(t.target.value):t.target.value,this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0}))}rangeInputted(t){this.value=this.nonlinear?this.fromRange(t.target.value):t.target.value}spinnerInputted(t){this.value=t.target.value}willUpdate(){this.rangeMax=void 0===this.max?void 0:this.nonlinear?this.toRange(this.max):this.max,this.rangeMin=void 0===this.min?void 0:this.nonlinear?this.toRange(this.min):this.min,this.rangeStep=void 0===this.step?void 0:this.nonlinear?"any":this.step,this.rangeValue=void 0===this.value?void 0:this.nonlinear?this.toRange(this.value):this.value}static get styles(){return[super.styles,i$3`
    ...
    `}}customElements.define("decidables-toggle-option",DecidablesToggleOption);const DecidablesConverterArray={fromAttribute:t=>t.split(/\s+/).map(t=>Number.parseFloat(t)),toAttribute:t=>t.length?t.map(t=>t.toFixed(3)).join(" "):null},DecidablesConverterSet={fromAttribute:t=>new Set(t.split(/\s+/)),toAttribute:t=>t.size?[...t].join(" "):null};function DecidablesMixinResizeable(t){return class extends t{static get properties(){return{width:{attribute:!1,type:Number,reflect:!1},height:{attribute:!1,type:Number,reflect:!1},rem:{attribute:!1,type:Number,reflect:!1}}}constructor(){super(),this.width=NaN,this.height=NaN,this.rem=NaN}getDimensions(){this.width=parseFloat(this.getComputedStyleValue("width"),10),this.height=parseFloat(this.getComputedStyleValue("height"),10),this.rem=parseFloat(getComputedStyle(document.documentElement).getPropertyValue("font-size"),10)}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(this.getDimensions.bind(this)),this.resizeObserver.observe(this)}disconnectedCallback(){this.resizeObserver.unobserve(this),super.disconnectedCallback()}}}var data={colors:{h:"#4daf4a",m:"#ff7f00",fa:"#377eb8",cr:"#e41a1c",hr:"#ffff33",far:"#984ea3",acc:"#999999",d:"#f781bf",c:"#a65628",s:"#4545d0",present:"#f032e6",absent:"#10dbc9",correct:"#ffffff",error:"#000000",nr:"#cccccc"}},colors=data.colors;class DetectableElement extends DecidablesElement{static get properties(){return{interactive:{attribute:"interactive",type:Boolean,reflect:!0}}}constructor(){super(),this.interactive=!1}static get colors(){return colors}static get lights(){return Object.keys(DetectableElement.colors).reduce((t,e)=>(t[e]=interpolateRgb(DetectableElement.colors[e],"#ffffff")(.5),t),{})}static get darks(){return Object.keys(DetectableElement.colors).reduce((t,e)=>(t[e]=interpolateRgb(DetectableElement.colors[e],"#000000")(.5),t),{})}static get styles(){return[super.styles,i$3`
      ...
      `]}render(){return x$1`
      <div class="holder">
        ${null!=this.trials?x$1`<decidables-slider min="1" max="100" step="1" .value=${this.trials} @change=${this.setTrials.bind(this)} @input=${this.setTrials.bind(this)}>Trials</decidables-slider>`:x$1``}
        ${null!=this.duration?x$1`<decidables-slider min="10" max="2000" step="10" .value=${this.duration} @change=${this.setDuration.bind(this)} @input=${this.setDuration.bind(this)}>Duration</decidables-slider>`:x$1``}
        ${null!=this.coherence?x$1`<decidables-slider min="0" max="1" step=".01" .value=${this.coherence} @change=${this.setCoherence.bind(this)} @input=${this.setCoherence.bind(this)}>Coherence</decidables-slider>`:x$1``}
        ${null!=this.payoff?x$1`<decidables-slider class="payoff" min="0" max="100" step="1" .value=${this.payoff} @change=${this.setPayoff.bind(this)} @input=${this.setPayoff.bind(this)}>Payoff</decidables-slider>`:x$1``}
        ${null!=this.color?x$1`
      ...
      `]}render(){return x$1``}sendEvent(){this.dispatchEvent(new CustomEvent("sdt-model-change",{detail:{d:this.d,c:this.c,s:this.s,far:this.far,hr:this.hr,h:this.h,m:this.m,fa:this.fa,cr:this.cr},bubbles:!0}))}willUpdate(){this.alignState()}update(t){if(super.update(t),Number.isNaN(this.width)||Number.isNaN(this.height)||Number.isNaN(this.rem))return;const e=this.width,r=this.height;let n,a;e/r>1.8?(a=r,n=1.8*a):(n=e,a=n/1.8);const i=2*this.rem,o=3*this.rem,s=3*this.rem,l=a-(i+o),c=n-(s+(this.histogram&&this.distributions?3:.75)*this.rem),u=parseInt(this.getComputedStyleValue("---transition-duration"),10),h=linear().domain([-3,3]).range([0,c]),d=linear().domain([.5,0]).range([0,l]),p=h(this.binWidth)-h(0),f=linear().domain([l/p,0]).range([0,l]),$=drag().subject(()=>({x:h(this.l),y:0})).on("start",t=>{select(t.currentTarget).classed("dragging",!0)}).on("drag",t=>{this.drag=!0;const e=h.invert(t.x),r=SDTMath.l2C(e,this.s);this.c=r<SDTMath.c.MIN?SDTMath.c.MIN:r>SDTMath.c.MAX?SDTMath.c.MAX:r,this.alignState(),this.sendEvent()}).on("end",t=>{select(t.currentTarget).classed("dragging",!1)}),g=drag().subject(()=>({x:h(this.muN),y:0})).on("start",t=>{select(t.currentTarget).classed("dragging",!0)}).on("drag",t=>{this.drag=!0;const e=h.invert(t.x),r=SDTMath.muN2D(e,this.s);this.d=r<SDTMath.d.MIN?SDTMath.d.MIN:r>SDTMath.d.MAX?SDTMath.d.MAX:r,this.alignState(),this.sendEvent()}).on("end",t=>{select(t.currentTarget).classed("dragging",!1)}),b=drag().subject(()=>({x:h(this.muS),y:d(this.hS)})).on("start",(t,e)=>{select(t.currentTarget).classed("dragging",!0),e.startX=t.x,e.startY=t.y,e.startHS=this.hS,e.startMuS=this.muS}).on("drag",(t,e)=>{this.drag=!0;let r=this.muS;this.interactive&&(r=h.invert(t.x));let n=this.hS;if(this.unequal&&(n=d.invert(t.y)),this.interactive&&this.unequal&&t.sourceEvent.shiftKey&&(Math.abs(t.x-e.startX)>Math.abs(t.y-e.startY)?n=e.startHS:r=e.startMuS),this.unequal){const t=SDTMath.h2S(n);this.s=t<SDTMath.s.MIN?SDTMath.s.MIN:t>SDTMath.s.MAX?SDTMath.s.MAX:t;const e=SDTMath.l2C(this.l,this.s);this.c=e<SDTMath.c.MIN?SDTMath.c.MIN:e>SDTMath.c.MAX?SDTMath.c.MAX:e}const a=SDTMath.muS2D(r,this.s);this.d=a<SDTMath.d.MIN?SDTMath.d.MIN:a>SDTMath.d.MAX?SDTMath.d.MAX:a,this.alignState(),this.sendEvent()}).on("end",t=>{select(t.currentTarget).classed("dragging",!1)}),m=line().x(t=>h(t.e)).y(t=>d(t.p)),y=select(this.renderRoot).selectAll(".main").data([{width:this.width,height:this.height,rem:this.rem}]),v=y.enter().append("svg").classed("main",!0).each((t,e,r)=>{B(DetectableElement.svgFilters,r[e])}),S=v.merge(y).attr("viewBox",`0 0 ${n} ${a}`),E=v.append("g").classed("plot",!0),T=S.select(".plot").attr("transform",`translate(${s}, ${i})`),w=E.append("g").classed("underlayer",!0),_=T.select(".underlayer");w.append("rect").classed("background",!0),_.select(".background").attr("height",l).attr("width",c),w.append("g").classed("axis-x",!0);_.select(".axis-x").attr("transform",`translate(0, ${l})`).call(axisBottom(h)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null),w.append("text").classed("title-x",!0).attr("text-anchor","middle").text("Evidence"),_.select(".title-x").attr("transform",`translate(${c/2}, ${l+2.25*this.rem})`);const x=_.selectAll(".axis-y").data(this.distributions?[{}]:[]);x.enter().append("g").classed("axis-y",!0).merge(x).call(axisLeft(d).ticks(5)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null),x.exit().remove();const A=_.selectAll(".title-y").data(this.distributions?[{}]:[]);A.enter().append("text").classed("title-y",!0).attr("text-anchor","middle").text("Probability").merge(A).attr("transform",`translate(${-2*this.rem}, ${l/2})rotate(-90)`),A.exit().remove();const I=_.selectAll(".axis-y2").data(this.histogram?[{}]:[]);I.enter().append("g").classed("axis-y2",!0).merge(I).attr("transform",this.distributions?`translate(${c}, 0)`:"").call(this.distributions?axisRight(f).ticks(10):axisLeft(f).ticks(10)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null),I.exit().remove();const O=_.selectAll(".title-y2").data(this.histogram?[{}]:[]);O.enter().append("text").classed("title-y2",!0).attr("text-anchor","middle").text("Count").merge(O).attr("transform",this.distributions?`translate(${c+1.5*this.rem}, ${l/2})rotate(90)`:`translate(${-1.5*this.rem}, ${l/2})rotate(-90)`),O.exit().remove(),E.append("g").classed("content",!0);const C=T.select(".content"),R=C.selectAll(".signal-noise").data(this.distributions?[{}]:[]),N=R.enter().append("g").classed("signal-noise",!0),M=N.merge(R);R.exit().remove();const P=N.append("g").classed("noise",!0),D=M.selectAll(".noise").attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?t=>{if(["ArrowRight","ArrowLeft"].includes(t.key)){let e=this.muN;switch(t.key){case"ArrowRight":e+=t.shiftKey?.01:.1;break;case"ArrowLeft":e-=t.shiftKey?.01:.1}const r=SDTMath.muN2D(e,this.s);this.d=r<SDTMath.d.MIN?SDTMath.d.MIN:r>SDTMath.d.MAX?SDTMath.d.MAX:r,this.alignState(),this.sendEvent(),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?D.call(g):D.on(".drag",null)),P.append("path").classed("curve-cr",!0),D.select(".curve-cr").transition().duration(this.drag?0:u).ease(cubicOut).attrTween("d",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.d?n.d:this.d,this.d),i=interpolate$1(void 0!==n.c?n.c:this.c,this.c),o=interpolate$1(void 0!==n.s?n.s:this.s,this.s);return t=>{n.d=a(t),n.c=i(t),n.s=o(t);const e=range(h.domain()[0],SDTMath.c2L(n.c,n.s),.05).map(t=>({e:t,p:jStat.normal.pdf(t,SDTMath.d2MuN(n.d,n.s),1)}));return e.push({e:SDTMath.c2L(n.c,n.s),p:jStat.normal.pdf(SDTMath.c2L(n.c,n.s),SDTMath.d2MuN(n.d,n.s),1)}),e.push({e:SDTMath.c2L(n.c,n.s),p:0}),e.push({e:h.domain()[0],p:0}),m(e)}}),P.append("path").classed("curve-fa",!0),D.select(".curve-fa").transition().duration(this.drag?0:u).ease(cubicOut).attrTween("d",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.d?n.d:this.d,this.d),i=interpolate$1(void 0!==n.c?n.c:this.c,this.c),o=interpolate$1(void 0!==n.s?n.s:this.s,this.s);return t=>{n.d=a(t),n.c=i(t),n.s=o(t);const e=range(SDTMath.c2L(n.c,n.s),h.domain()[1],.05).map(t=>({e:t,p:jStat.normal.pdf(t,SDTMath.d2MuN(n.d,n.s),1)}));return e.push({e:h.domain()[1],p:jStat.normal.pdf(h.domain()[1],SDTMath.d2MuN(n.d,n.s),1)}),e.push({e:h.domain()[1],p:0}),e.push({e:SDTMath.c2L(n.c,n.s),p:0}),m(e)}}),P.append("path").classed("curve-noise",!0),D.select(".curve-noise").transition().duration(this.drag?0:u).ease(cubicOut).attrTween("d",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.d?n.d:this.d,this.d),i=interpolate$1(void 0!==n.s?n.s:this.s,this.s);return t=>{n.d=a(t),n.s=i(t);const e=range(h.domain()[0],h.domain()[1],.05).map(t=>({e:t,p:jStat.normal.pdf(t,SDTMath.d2MuN(n.d,n.s),1)}));return e.push({e:h.domain()[1],p:jStat.normal.pdf(h.domain()[1],SDTMath.d2MuN(n.d,n.s),1)}),m(e)}});const k=N.append("g").classed("signal",!0),j=M.selectAll(".signal").attr("tabindex",this.interactive||this.unequal?0:null).classed("interactive",this.interactive).classed("unequal",this.unequal).on("keydown.sensitivity",this.interactive?t=>{if(["ArrowRight","ArrowLeft"].includes(t.key)){let e=this.muS;switch(t.key){case"ArrowRight":e+=t.shiftKey?.01:.1;break;case"ArrowLeft":e-=t.shiftKey?.01:.1}const r=SDTMath.muS2D(e,this.s);this.d=r<SDTMath.d.MIN?SDTMath.d.MIN:r>SDTMath.d.MAX?SDTMath.d.MAX:r,this.alignState(),this.sendEvent(),t.preventDefault()}}:null).on("keydown.variance",this.unequal?t=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let e=this.hS;switch(t.key){case"ArrowUp":e+=t.shiftKey?.002:.02;break;case"ArrowDown":e-=t.shiftKey?.002:.02}e=e<0?0:e;const r=SDTMath.h2S(e);this.s=r<SDTMath.s.MIN?SDTMath.s.MIN:r>SDTMath.s.MAX?SDTMath.s.MAX:r,this.d=SDTMath.muN2D(this.muN,this.s),this.c=SDTMath.l2C(this.l,this.s),this.alignState(),this.sendEvent(),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive")||t.has("unequal"))&&(this.interactive||this.unequal?j.call(b):j.on(".drag",null)),k.append("path").classed("curve-m",!0),j.select(".curve-m").transition().duration(this.drag?0:u).ease(cubicOut).attrTween("d",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.d?n.d:this.d,this.d),i=interpolate$1(void 0!==n.c?n.c:this.c,this.c),o=interpolate$1(void 0!==n.s?n.s:this.s,this.s);return t=>{n.d=a(t),n.c=i(t),n.s=o(t);const e=range(h.domain()[0],SDTMath.c2L(n.c,n.s),.05).map(t=>({e:t,p:jStat.normal.pdf(t,SDTMath.d2MuS(n.d,n.s),n.s)}));return e.push({e:SDTMath.c2L(n.c,n.s),p:jStat.normal.pdf(SDTMath.c2L(n.c,n.s),SDTMath.d2MuS(n.d,n.s),n.s)}),e.push({e:SDTMath.c2L(n.c,n.s),p:0}),e.push({e:h.domain()[0],p:0}),m(e)}}),k.append("path").classed("curve-h",!0),j.select(".curve-h").transition().duration(this.drag?0:u).ease(cubicOut).attrTween("d",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.d?n.d:this.d,this.d),i=interpolate$1(void 0!==n.c?n.c:this.c,this.c),o=interpolate$1(void 0!==n.s?n.s:this.s,this.s);return t=>{n.d=a(t),n.c=i(t),n.s=o(t);const e=range(SDTMath.c2L(n.c,n.s),h.domain()[1],.05).map(t=>({e:t,p:jStat.normal.pdf(t,SDTMath.d2MuS(n.d,n.s),n.s)}));return e.push({e:h.domain()[1],p:jStat.normal.pdf(h.domain()[1],SDTMath.d2MuS(n.d,n.s),n.s)}),e.push({e:h.domain()[1],p:0}),e.push({e:SDTMath.c2L(n.c,n.s),p:0}),m(e)}}),k.append("path").classed("curve-signal",!0),j.select(".curve-signal").transition().duration(this.drag?0:u).ease(cubicOut).attrTween("d",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.d?n.d:this.d,this.d),i=interpolate$1(void 0!==n.s?n.s:this.s,this.s);return t=>{n.d=a(t),n.s=i(t);const e=range(h.domain()[0],h.domain()[1],.05).map(t=>({e:t,p:jStat.normal.pdf(t,SDTMath.d2MuS(n.d,n.s),n.s)}));return e.push({e:h.domain()[1],p:jStat.normal.pdf(h.domain()[1],SDTMath.d2MuS(n.d,n.s),n.s)}),m(e)}});const F=C.selectAll(".measure-d").data(this.sensitivity?[{}]:[]),L=F.enter().append("g").classed("measure-d",!0);L.append("line").classed("line",!0),L.append("line").classed("cap-left",!0),L.append("line").classed("cap-right",!0);const U=L.append("text").classed("label",!0);U.append("tspan").classed("d math-var",!0).text("d′"),U.append("tspan").classed("equals",!0).text(" = "),U.append("tspan").classed("value",!0);const H=L.merge(F);H.select(".line").transition().duration(this.drag?0:u).ease(cubicOut).attr("x1",h(this.muN)).attr("y1",d(.43)).attr("x2",h(this.muS)).attr("y2",d(.43)),H.select(".cap-left").transition().duration(this.drag?0:u).ease(cubicOut).attr("x1",h(this.muN)).attr("y1",d(.43)+5).attr("x2",h(this.muN)).attr("y2",d(.43)-5),H.select(".cap-right").transition().duration(this.drag?0:u).ease(cubicOut).attr("x1",h(this.muS)).attr("y1",d(.43)+5).attr("x2",h(this.muS)).attr("y2",d(.43)-5);H.select(".label").transition().duration(this.drag?0:u).ease(cubicOut).attr("x",h(this.muN>this.muS?this.muN:this.muS)+5).attr("y",d(.43)+3).select(".value").tween("text",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.d?n.d:this.d,this.d);return t=>{n.d=a(t),select(n).text(format(".3")(n.d))}}),F.exit().remove();const q=C.selectAll(".measure-c").data(this.bias?[{}]:[]),z=q.enter().append("g").classed("measure-c",!0);z.append("line").classed("line",!0),z.append("line").classed("cap-zero",!0);const V=z.append("text").classed("label",!0);V.append("tspan").classed("c math-var",!0).text("c"),V.append("tspan").classed("equals",!0).text(" = "),V.append("tspan").classed("value",!0);const K=z.merge(q);K.select(".line").transition().duration(this.drag?0:u).ease(cubicOut).attr("x1",h(this.l)).attr("y1",d(.47)).attr("x2",h(0)).attr("y2",d(.47)),K.select(".cap-zero").transition().duration(this.drag?0:u).ease(cubicOut).attr("x1",h(0)).attr("y1",d(.47)+5).attr("x2",h(0)).attr("y2",d(.47)-5);K.select(".label").transition().duration(this.drag?0:u).ease(cubicOut).attr("x",h(0)+(this.l<0?5:-5)).attr("y",d(.47)+3).attr("text-anchor",this.c<0?"start":"end").select(".value").tween("text",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.c?n.c:this.c,this.c);return t=>{n.c=a(t),select(n).text(format(".3")(n.c))}}),q.exit().remove();const G=C.selectAll(".measure-s").data(this.variance?[{}]:[]),W=G.enter().append("g").classed("measure-s",!0);W.append("line").classed("line",!0),W.append("line").classed("cap-left",!0),W.append("line").classed("cap-right",!0);const Y=W.append("text").classed("label",!0);Y.append("tspan").classed("s math-var",!0).text("σ"),Y.append("tspan").classed("equals",!0).text(" = "),Y.append("tspan").classed("value",!0);const X=W.merge(G);X.select(".line").transition().duration(this.drag?0:u).ease(cubicOut).attr("x1",h(this.muS-this.s)).attr("y1",d(jStat.normal.pdf(this.s,0,this.s))+10/this.s).attr("x2",h(this.muS+this.s)).attr("y2",d(jStat.normal.pdf(this.s,0,this.s))+10/this.s),X.select(".cap-left").transition().duration(this.drag?0:u).ease(cubicOut).attr("x1",h(this.muS-this.s)).attr("y1",d(jStat.normal.pdf(this.s,0,this.s))+10/this.s+5).attr("x2",h(this.muS-this.s)).attr("y2",d(jStat.normal.pdf(this.s,0,this.s))+10/this.s-5),X.select(".cap-right").transition().duration(this.drag?0:u).ease(cubicOut).attr("x1",h(this.muS+this.s)).attr("y1",d(jStat.normal.pdf(this.s,0,this.s))+10/this.s+5).attr("x2",h(this.muS+this.s)).attr("y2",d(jStat.normal.pdf(this.s,0,this.s))+10/this.s-5);X.select(".label").transition().duration(this.drag?0:u).ease(cubicOut).attr("x",h(this.muS)).attr("y",d(jStat.normal.pdf(this.s,0,this.s))+10/this.s-3).select(".value").tween("text",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.s?n.s:this.s,this.s);return t=>{n.s=a(t),select(n).text(format(".3")(n.s))}}),G.exit().remove();const Z=C.selectAll(".threshold").data(this.threshold?[{}]:[]),Q=Z.enter().append("g").classed("threshold",!0);Q.append("line").classed("line",!0),Q.append("line").classed("line touch",!0),Q.append("circle").classed("handle touch",!0);const J=Q.merge(Z).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive);(this.firstUpdate||t.has("interactive"))&&(this.interactive?J.call($).on("keydown",t=>{if(["ArrowRight","ArrowLeft"].includes(t.key)){let e=this.l;switch(t.key){case"ArrowRight":e+=t.shiftKey?.01:.1;break;case"ArrowLeft":e-=t.shiftKey?.01:.1}const r=SDTMath.l2C(e,this.s);this.c=r<SDTMath.c.MIN?SDTMath.c.MIN:r>SDTMath.c.MAX?SDTMath.c.MAX:r,this.alignState(),this.sendEvent(),t.preventDefault()}}):J.on("drag",null).on("keydown",null)),J.select(".line").transition().duration(this.drag?0:u).ease(cubicOut).attr("x1",h(this.l)).attr("y1",d(0)).attr("x2",h(this.l)).attr("y2",d(.54)),J.select(".line.touch").transition().duration(this.drag?0:u).ease(cubicOut).attr("x1",h(this.l)).attr("y1",d(0)).attr("x2",h(this.l)).attr("y2",d(.54)),J.select(".handle").transition().duration(this.drag?0:u).ease(cubicOut).attr("cx",h(this.l)).attr("cy",d(.54)),Z.exit().remove();const tt=C.selectAll(".histogram").data(this.histogram?[{}]:[]),et=tt.enter().append("g").classed("histogram",!0).merge(tt);if(tt.exit().remove(),this.histogram){const t=bin().value(t=>t.trueEvidence).domain(h.domain()).thresholds(range(this.binRange[0],this.binRange[1],this.binWidth)),e=t(this.trials);let r=-1,n=-1;for(let t=0;t<e.length;t+=1)for(let a=0;a<e[t].length;a+=1)e[t][a].binValue=e[t].x0,e[t][a].binCount=a,0===t&&(r=a),t===e.length-1&&(n=a);for(let t=0;t<this.trials.length;t+=1)this.trials[t].trueEvidence<this.binRange[0]&&(r+=1,this.trials[t].binCount=r,this.trials[t].binValue=e[0].x0),this.trials[t].trueEvidence>this.binRange[1]&&(n+=1,this.trials[t].binCount=n,this.trials[t].binValue=e[e.length-1].x0);const a=et.selectAll(".trial").data(this.trials,t=>t.trial),i=a.enter().append("rect").attr("stroke-width",3).attr("data-new-trial-ease-time",0).attr("stroke",this.getComputedStyleValue("---color-acc")).attr("fill",this.getComputedStyleValue("---color-acc-light")).merge(a).attr("class",t=>`trial ${t.outcome}`).attr("width",p-3).attr("height",p-3),o=i.filter(t=>t.new&&!t.paused);if(!o.empty()){const t=o.attr("data-new-trial-ease-time"),e=e=>linear().domain([0,1]).range([t,1])(e),r=e=>r=>linear().domain([e(t),1]).range([0,1])(e(r));o.transition("new").duration(e=>Math.floor((.75*e.duration+.25*e.wait)*(1-t))).ease(e).attr("data-new-trial-ease-time",1).attrTween("stroke",(t,e,n)=>{const a=n[e],i=interpolateRgb(a.getAttribute("stroke"),"stimulus"===this.color?"present"===t.signal?this.getComputedStyleValue("---color-hr"):this.getComputedStyleValue("---color-far"):"response"===this.color?this.getComputedStyleValue(`---color-${t.response}`):"outcome"===this.color||"all"===this.color?this.getComputedStyleValue(`---color-${t.outcome}`):this.getComputedStyleValue("---color-acc"));return t=>i(r(cubicIn)(t))}).attrTween("fill",(t,e,n)=>{const a=n[e],i=interpolateRgb(a.getAttribute("fill"),"stimulus"===this.color?"present"===t.signal?this.getComputedStyleValue("---color-hr-light"):this.getComputedStyleValue("---color-far-light"):"response"===this.color?this.getComputedStyleValue(`---color-${t.response}-light`):"outcome"===this.color||"all"===this.color?this.getComputedStyleValue(`---color-${t.outcome}-light`):this.getComputedStyleValue("---color-acc-light"));return t=>i(r(cubicIn)(t))}).attrTween("x",(t,e,n)=>{const a=interpolate$1(n[e].getAttribute("x"),h(t.binValue)+1.5);return t=>a(r(cubicOut)(t))}).attrTween("y",(t,e,n)=>{const a=interpolate$1(n[e].getAttribute("y"),d(0)+1.5-(t.binCount+1)*p);return t=>a(r(cubicIn)(t))}).on("end",(t,e,r)=>{r[e].removeAttribute("data-new-trial-ease-time"),t.new=!1,this.alignTrial(t),this.dispatchEvent(new CustomEvent("detectable-response",{detail:{stimulus:t.signal,response:t.response,outcome:t.outcome,h:this.h,m:this.m,fa:this.fa,cr:this.cr,nr:0},bubbles:!0}))})}const s=i.filter(t=>t.new&&t.paused);if(!s.empty()){const t=s.attr("data-new-trial-ease-time");s.transition().duration(u).ease(cubicOut).attr("x",e=>interpolate$1(0,h(e.binValue)+1.5)(cubicOut(t))).attr("y",e=>interpolate$1(0,d(0)+1.5-(e.binCount+1)*p)(cubicIn(t))).attr("stroke",e=>interpolateRgb(this.getComputedStyleValue("---color-acc"),"stimulus"===this.color?"present"===e.signal?this.getComputedStyleValue("---color-hr"):this.getComputedStyleValue("---color-far"):"response"===this.color?this.getComputedStyleValue(`---color-${e.response}`):"outcome"===this.color||"all"===this.color?this.getComputedStyleValue(`---color-${e.outcome}`):this.getComputedStyleValue("---color-acc"))(cubicIn(t))).attr("fill",e=>interpolateRgb(this.getComputedStyleValue("---color-acc-light"),"stimulus"===this.color?"present"===e.signal?this.getComputedStyleValue("---color-hr-light"):this.getComputedStyleValue("---color-far-light"):"response"===this.color?this.getComputedStyleValue(`---color-${e.response}-light`):"outcome"===this.color||"all"===this.color?this.getComputedStyleValue(`---color-${e.outcome}-light`):this.getComputedStyleValue("---color-acc-light"))(cubicIn(t)))}i.filter(t=>!t.new).transition().duration(u).ease(cubicOut).attr("x",t=>h(t.binValue)+1.5).attr("y",t=>d(0)+1.5-(t.binCount+1)*p).attr("stroke",t=>"stimulus"===this.color?"present"===t.signal?this.getComputedStyleValue("---color-hr"):this.getComputedStyleValue("---color-far"):"response"===this.color?this.getComputedStyleValue(`---color-${t.response}`):"outcome"===this.color||"all"===this.color?this.getComputedStyleValue(`---color-${t.outcome}`):this.getComputedStyleValue("---color-acc")).attr("fill",t=>"stimulus"===this.color?"present"===t.signal?this.getComputedStyleValue("---color-hr-light"):this.getComputedStyleValue("---color-far-light"):"response"===this.color?this.getComputedStyleValue(`---color-${t.response}-light`):"outcome"===this.color||"all"===this.color?this.getComputedStyleValue(`---color-${t.outcome}-light`):this.getComputedStyleValue("---color-acc-light")),a.exit().transition().duration(u).ease(linear$1).attrTween("stroke",(t,e,r)=>{const n=r[e],a=interpolateRgb(n.getAttribute("stroke"),this.getComputedStyleValue("---color-acc"));return t=>a(cubicIn(t))}).attrTween("fill",(t,e,r)=>{const n=r[e],a=interpolateRgb(n.getAttribute("fill"),this.getComputedStyleValue("---color-acc-light"));return t=>a(cubicIn(t))}).attrTween("x",(t,e,r)=>{const n=interpolate$1(r[e].getAttribute("x"),0);return t=>n(cubicIn(t))}).attrTween("y",(t,e,r)=>{const n=interpolate$1(r[e].getAttribute("y"),0);return t=>n(cubicOut(t))}).remove()}const rt=E.append("g").classed("overlayer",!0),nt=T.select(".overlayer");rt.append("rect").classed("background",!0),nt.select(".background").attr("height",l).attr("width",c),this.drag=!1,this.firstUpdate=!1}pauseTrial(){const t=select(this.renderRoot).select(".trial[data-new-trial-ease-time]");t.interrupt("new"),t.datum(t=>(t.paused=!0,t))}resumeTrial(){select(this.renderRoot).select(".trial[data-new-trial-ease-time]").datum(t=>(t.paused=!1,t)),this.requestUpdate()}}customElements.define("sdt-model",SDTModel);class SDTParameters extends DetectableElement{static get properties(){return{d:{attribute:"d",type:Number,reflect:!0},c:{attribute:"c",type:Number,reflect:!0},s:{attribute:"s",type:Number,reflect:!0}}}constructor(){super(),this.d=void 0,this.c=void 0,this.s=void 0}setSensitivity(t){this.d=+t.target.value,this.dispatchEvent(new CustomEvent("sdt-parameters-d",{detail:{d:this.d},bubbles:!0}))}setBias(t){this.c=+t.target.value,this.dispatchEvent(new CustomEvent("sdt-parameters-c",{detail:{c:this.c},bubbles:!0}))}setVariance(t){this.s=+t.target.value,this.dispatchEvent(new CustomEvent("sdt-parameters-s",{detail:{s:this.s},bubbles:!0}))}static get styles(){return[super.styles,i$3`
        :host {
          display: inline-block;
        }
      ...
      `]}render(){return x$1`
      <div class="holder">
        ${null!=this.d?x$1`<decidables-slider class="d"
          ...
          ><div>Sensitivity<br><span class="math-var">d′</span></div></decidables-slider>`:x$1``}
        ${null!=this.c?x$1`<decidables-slider class="c"
            ?disabled=${!this.interactive}
            scale
            min=${SDTMath.c.MIN}
            max=${SDTMath.c.MAX}
          ...
          ><div>Bias<br><span class="math-var">c</span></div></decidables-slider>`:x$1``}
        ${null!=this.s?x$1`<decidables-slider class="s"
            ?disabled=${!this.interactive}
            scale
            min=${SDTMath.s.MIN}
            max=${SDTMath.s.MAX}
          ...
          ><div>Variance<br><span class="math-var">σ</span></div></decidables-slider>`:x$1``}
      </div>`}}customElements.define("sdt-parameters",SDTParameters);class SDTEquation extends DetectableElement{static get properties(){return{numeric:{attribute:"numeric",type:Boolean,reflect:!0}}}constructor(){super(),this.numeric=!1}static get styles(){return[super.styles,i$3`
        :host {
          display: block;
    ...
    `}}customElements.define("sdt-equation-mcr2fomr",SDTEquationMCr2Fomr);class SDTExample extends DetectableElement{static get styles(){return[super.styles,i$3`
        :host {
          display: inline-block;
