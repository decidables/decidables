...
const o=t=>t??E;class DecidablesSlider extends DecidablesElement{static get properties(){return{disabled:{attribute:"disabled",type:Boolean,reflect:!0},scale:{attribute:"scale",type:Boolean,reflect:!0},max:{attribute:"max",type:Number,reflect:!0},min:{attribute:"min",type:Number,reflect:!0},step:{attribute:"step",type:Number,reflect:!0},value:{attribute:"value",type:Number,reflect:!0},nonlinear:{attribute:!1,type:Boolean,reflect:!1}}}constructor(){super(),this.disabled=!1,this.scale=!1,this.max=void 0,this.min=void 0,this.step=void 0,this.value=void 0,this.nonlinear=!1,this.rangeMax=void 0,this.rangeMin=void 0,this.rangeStep=void 0,this.rangeValue=void 0,this.toRange=void 0,this.fromRange=void 0}nonlinearRange(t,e,r){this.nonlinear=t,this.toRange=t?e:void 0,this.fromRange=t?r:void 0}rangeChanged(t){this.value=this.nonlinear?this.fromRange(t.target.value):t.target.value,this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0}))}rangeInputted(t){this.value=this.nonlinear?this.fromRange(t.target.value):t.target.value}spinnerInputted(t){this.value=t.target.value}willUpdate(){this.rangeMax=void 0===this.max?void 0:this.nonlinear?this.toRange(this.max):this.max,this.rangeMin=void 0===this.min?void 0:this.nonlinear?this.toRange(this.min):this.min,this.rangeStep=void 0===this.step?void 0:this.nonlinear?"any":this.step,this.rangeValue=void 0===this.value?void 0:this.nonlinear?this.toRange(this.value):this.value}static get styles(){return[super.styles,i$3`
    ...
    `}}customElements.define("itc-option",ITCOption);class ITCChoice extends DiscountableElement{static get properties(){return{state:{attribute:"state",type:String,reflect:!0},as:{attribute:"amount-ss",type:Number,reflect:!0},ds:{attribute:"delay-ss",type:Number,reflect:!0},al:{attribute:"amount-ll",type:Number,reflect:!0},dl:{attribute:"delay-ll",type:Number,reflect:!0}}}constructor(){super(),this.states=["choice","fixation","blank"],this.state="choice",this.as=10,this.ds=5,this.al=40,this.dl=30}static get styles(){return[super.styles,i$3`
      ...
      `]}render(){return x$1``}willUpdate(){this.alignState()}update(t){if(super.update(t),Number.isNaN(this.width)||Number.isNaN(this.height)||Number.isNaN(this.rem))return;const e=this.width,r=this.height;let n,a;e/r>1.5?(a=r,n=1.5*a):(n=e,a=n/1.5);const i=1*this.rem,o=3*this.rem,s=3.75*this.rem,l=3.25*this.rem,c=a-(i+o),u=n-(s+l),h=.75*this.rem,d=.5*c,p=.25*c-h,f=.75*this.rem,g=.9*u,m=.1*u-f,$=parseInt(this.getComputedStyleValue("---transition-duration"),10),y=linear().domain([this.scale.time.min,this.scale.time.max]).range([0,g]),b=linear().domain([this.scale.evidence.min,this.scale.evidence.max]).range([d,0]),v=linear().domain([this.scale.density.min,this.scale.density.max]).range([p,0]),E=linear().domain([this.scale.density.min,this.scale.density.max]).range([0,p]),T=linear().domain([0,1]).range([0,c]),S=drag().subject((t,e)=>({x:y(e.t0),y:b(e.startingPoint)})).on("start",t=>{select(t.currentTarget).classed("dragging",!0)}).on("drag",t=>{this.drag=!0;const e=!!t.sourceEvent.shiftKey&&(Math.abs(t.x-t.subject.x)>Math.abs(t.y-t.subject.y)?"t0":"z");let r=y.invert(t.x),n=(b.invert(t.y)+this.a/2)/this.a;r="z"===e?y.invert(t.subject.x):r<DDMMath.t0.MIN?DDMMath.t0.MIN:r>DDMMath.t0.MAX?DDMMath.t0.MAX:r,n="t0"===e?(b.invert(t.subject.y)+this.a/2)/this.a:n<DDMMath.z.MIN?DDMMath.z.MIN:n>DDMMath.z.MAX?DDMMath.z.MAX:n,this.t0=r,this.z=n,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-t0",{detail:{t0:this.t0},bubbles:!0})),this.dispatchEvent(new CustomEvent("ddm-model-z",{detail:{z:this.z},bubbles:!0}))}).on("end",t=>{select(t.currentTarget).classed("dragging",!1),this.drag=!1}),w=drag().on("start",t=>{select(t.currentTarget).classed("dragging",!0)}).on("drag",t=>{this.drag=!0;let e=(b.invert(t.y)-this.startingPoint)/(y.invert(t.x)-this.t0)*1e3;e=e<DDMMath.v.MIN?DDMMath.v.MIN:e>DDMMath.v.MAX?DDMMath.v.MAX:e,this.v=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-v",{detail:{v:this.v},bubbles:!0}))}).on("end",t=>{select(t.currentTarget).classed("dragging",!1),this.drag=!1}),x=drag().subject((t,e)=>({x:0,y:b(e.value)})).on("start",t=>{select(t.currentTarget).classed("dragging",!0)}).on("drag",t=>{this.drag=!0;const e=b.invert(t.y);let r=Math.abs(2*e);r=r<DDMMath.a.MIN?DDMMath.a.MIN:r>DDMMath.a.MAX?DDMMath.a.MAX:r,this.a=r,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-a",{detail:{a:this.a},bubbles:!0}))}).on("end",t=>{select(t.currentTarget).classed("dragging",!1),this.drag=!1}),A=line().x(t=>y(t.t)).y(t=>b(t.e)),_=line().x(t=>y(t.t)).y(t=>v(t.d)),I=line().x(t=>y(t.t)).y(t=>E(t.d)),O=select(this.renderRoot).selectAll(".main").data([{width:this.width,height:this.height,rem:this.rem}]),C=O.enter().append("svg").classed("main",!0).html(AccumulableElement.svgDefs),R=C.append("defs"),M=t=>{R.append("marker").attr("id",`measure-arrow-${t}`).attr("class",`measure-arrow ${t}`).attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","2").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10").append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("d","M -3 -3 l 6 3 l -6 3 z")},N=t=>{const e=R.append("marker").attr("id",`measure-arrow-cap-${t}`).attr("class",`measure-arrow cap ${t}`).attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","2").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10");e.append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("d","M -3 -3 l 6 3 l -6 3 z"),e.append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("stroke-width","2").attr("d","M 4 -4 l 0 8")};M("a"),M("z"),N("v"),M("t0"),N("t0");const k=t=>{R.append("marker").attr("id",`model-sd-cap-${t}`).attr("class",`model-sd cap ${t}`).attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","0").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10").append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("stroke-width","2").attr("d","M 0 -4 l 0 8"),R.append("marker").attr("id",`data-sd-cap-${t}`).attr("class",`data-sd cap ${t}`).attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","0").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10").append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("stroke-width","2").attr("d","M 0 -3 l 0 6")};k("error"),k("correct");const D=R.append("linearGradient").attr("id","path-animate").attr("gradientUnits","userSpaceOnUse").attr("color-interpolation","linearRGB").attr("x1","0").attr("x2","0").attr("y1",b(this.bounds.upper)).attr("y2",b(this.bounds.lower));D.append("stop").classed("stop-0",!0).attr("offset","0%"),D.append("stop").classed("stop-100",!0).attr("offset","100%");const P=C.merge(O).attr("viewBox",`0 0 ${n} ${a}`),U=P.selectAll(".plot.density").data([{outcome:"correct",data:{meanRT:this.data.correctMeanRT,sdRT:this.data.correctSDRT},model:{meanRT:this.model.correctMeanRT,sdRT:this.model.correctSDRT,dist:this.model.correctDist},densityScale:v,densityLine:_,alignDistribution:this.alignCorrectDistribution.bind(this)},{outcome:"error",data:{meanRT:this.data.errorMeanRT,sdRT:this.data.errorSDRT},model:{meanRT:this.model.errorMeanRT,sdRT:this.model.errorSDRT,dist:this.model.errorDist},densityScale:E,densityLine:I,alignDistribution:this.alignErrorDistribution.bind(this)}]),L=C.append("g").classed("plot evidence",!0),j=U.enter().append("g").attr("class",t=>`plot density ${t.outcome}`),F=C.append("g").classed("plot accuracy",!0),B=P.select(".plot.evidence").attr("transform",`translate(${s}, ${i+p+h})`),H=j.merge(U).attr("transform",t=>`translate(${s}, ${"correct"===t.outcome?i:i+p+d+2*h})`),z=P.select(".plot.accuracy").attr("transform",`translate(${s+g+f}, ${i})`);L.append("clipPath").attr("id","clip-evidence").append("rect"),B.select("clipPath rect").attr("y",b(this.bounds.upper)).attr("height",b(this.bounds.lower)-b(this.bounds.upper)+1).attr("width",g+1);const V=L.append("g").classed("underlayer",!0),K=j.append("g").classed("underlayer",!0),q=F.append("g").classed("underlayer",!0),G=B.select(".underlayer"),W=H.select(".underlayer"),Y=z.select(".underlayer");L.append("g").classed("content",!0).append("g").classed("paths",!0);const X=j.append("g").classed("content",!0);F.append("g").classed("content",!0);const Z=B.select(".content"),J=H.select(".content"),Q=z.select(".content");L.append("g").classed("overlayer",!0),j.append("g").classed("overlayer",!0),F.append("g").classed("overlayer",!0);const tt=B.select(".overlayer"),et=H.select(".overlayer");V.append("rect").classed("background",!0),K.append("rect").classed("background",!0),G.select(".background").transition().duration(this.drag?0:$).ease(cubicOut).attr("y",b(this.bounds.upper)).attr("height",b(this.bounds.lower)-b(this.bounds.upper)).attr("width",g),W.select(".background").transition().duration($).ease(cubicOut).attr("height",p).attr("width",g),K.filter(t=>"error"===t.outcome).append("g").classed("axis time",!0);const rt=W.filter(t=>"error"===t.outcome).select(".axis.time").attr("transform",`translate(0, ${p+.25*this.rem})`);rt.transition().duration($).ease(cubicOut).call(axisBottom(y)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null);const nt=K.filter(t=>"error"===t.outcome).append("text").classed("title time",!0).attr("text-anchor","middle");nt.append("tspan").classed("name",!0).text("Time (ms)"),W.filter(t=>"error"===t.outcome).select(".title.time").transition().duration($).ease(cubicOut).attr("transform",`translate(${g/2}, ${p+2.5*this.rem})`),V.append("g").classed("axis evidence",!0),K.append("g").attr("class",t=>`axis density ${t.outcome}`),q.append("g").classed("axis accuracy",!0);const at=G.select(".axis.evidence").attr("transform",`translate(${-.25*this.rem}, 0)`),it=W.select(".axis.density").attr("transform",`translate(${-.25*this.rem}, 0)`),ot=Y.select(".axis.accuracy").attr("transform",`translate(${m+.25*this.rem}, 0)`),st=at.transition().duration($).ease(cubicOut).call(axisLeft(b)).attr("font-size",null).attr("font-family",null),lt=it.transition().duration($).ease(cubicOut).each((t,e,r)=>{axisLeft(t.densityScale).ticks(2)(select(r[e]))}).attr("font-size",null).attr("font-family",null),ct=ot.transition().duration($).ease(cubicOut).call(axisRight(T)).attr("font-size",null).attr("font-family",null);st.selectAll("line, path").attr("stroke",null),lt.selectAll("line, path").attr("stroke",null),ct.selectAll("line, path").attr("stroke",null);const ut=V.append("text").classed("title evidence",!0).attr("text-anchor","middle"),ht=K.append("text").attr("class",t=>`title density ${t.outcome}`).attr("text-anchor","middle"),dt=q.append("text").classed("title accuracy",!0).attr("text-anchor","middle");ut.append("tspan").classed("name",!0).text("Evidence"),ht.append("tspan").classed("name",!0).text("Density"),dt.append("tspan").classed("name",!0).text("Accuracy"),G.select(".title.evidence").transition().duration($).ease(cubicOut).attr("transform",`translate(${-2.5*this.rem}, ${d/2})rotate(-90)`),W.select(".title.density").transition().duration($).ease(cubicOut).attr("transform",`translate(${-2.5*this.rem}, ${p/2})rotate(-90)`),Y.select(".title.accuracy").transition().duration($).ease(cubicOut).attr("transform",`translate(${m+2.25*this.rem}, ${c/2})rotate(90)`);const pt=Z.select(".paths").selectAll(".path").data(this.data.trials.filter(t=>void 0!==t.path)),ft=local(),gt=pt.enter().append("g").classed("path",!0).attr("data-new-trial-ease-time",0).on("pointerenter",(t,e)=>{if(!this.drag){select(t.currentTarget).classed("highlight",!0).raise();const r=tt.append("g").classed(`rt-label ${e.outcome}`,!0),n=r.append("rect"),a=r.append("text").text(`RT = ${e.rt.toFixed()}`).attr("x",y(e.rt)).attr("y","correct"===e.outcome?b(this.bounds.upper)-.25*this.rem:b(this.bounds.lower)+.125*this.rem).node().getBBox();n.attr("x",a.x-.125*this.rem).attr("y",a.y+.125*this.rem).attr("width",a.width+.25*this.rem).attr("height",a.height-.25*this.rem),ft.set(t.currentTarget,r)}}).on("pointerout",(t,e)=>{this.drag||(select(t.currentTarget).classed("highlight",!1).lower(),t.currentTarget.parentNode.insertBefore(t.currentTarget,t.currentTarget.parentNode.children[e.index]),ft.get(t.currentTarget).remove())});gt.append("path").classed("curve",!0).attr("clip-path","url(#clip-evidence)").attr("pathLength",1).attr("stroke-dashoffset",1);const mt=gt.merge(pt).attr("class",t=>`path ${t.outcome}`);mt.select(".curve").transition().duration(this.drag?0:$).ease(cubicOut).attr("stroke",t=>this.getComputedStyleValue(`---color-${t.outcome}`)).attrTween("d",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.a?n.a:this.a,this.a),i=interpolate$1(void 0!==n.z?n.z:this.z,this.z),o=interpolate$1(void 0!==n.v?n.v:this.v,this.v),s=interpolate$1(void 0!==n.t0?n.t0:this.t0,this.t0);return e=>{n.a=a(e),n.z=i(e),n.v=o(e),n.t0=s(e);const r=this.alignPath(t.seed,n.a,n.z,n.v,n.t0);return A(r)}});const $t=mt.filter(t=>t.animate&&!this.paused);if(!$t.empty()){const t=$t.attr("data-new-trial-ease-time"),e=e=>linear().domain([0,1]).range([t,1])(e),r=e=>r=>linear().domain([e(t),1]).range([0,1])(e(r));$t.classed("animate",!0).select(".curve").attr("stroke-dasharray",1),$t.transition("new").duration(e=>Math.floor(1.5*e.rt*(1-t))).ease(e).attr("data-new-trial-ease-time",1).select(".curve").attrTween("stroke-dashoffset",(t,e,n)=>{const a=interpolate$1(n[e].getAttribute("stroke-dashoffset"),0);return t=>a(r(linear$1)(t))}).on("end",(t,e,r)=>{select(r[e].parentElement).classed("animate",!1).attr("data-new-trial-ease-time",null),t.animate=!1,this.animate=!1,this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("accumulable-response",{detail:{outcome:t.outcome,data:this.data,model:this.model},bubbles:!0}))})}const yt=mt.filter(t=>t.animate&&this.paused);if(!yt.empty()){const t=yt.attr("data-new-trial-ease-time");yt.classed("animate",!0).select(".curve").attr("stroke-dasharray",1).attr("stroke-dashoffset",()=>interpolate$1(1,0)(linear$1(t)))}mt.filter(t=>!t.animate).attr("data-new-trial-ease-time",null),pt.exit().remove();const bt=X.append("g").attr("class",t=>`dist ${t.outcome}`);bt.append("path").classed("curve",!0),J.select(".dist").select(".curve").transition().duration(this.drag?0:$).ease(cubicOut).attrTween("d",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.a?n.a:this.a,this.a),i=interpolate$1(void 0!==n.z?n.z:this.z,this.z),o=interpolate$1(void 0!==n.v?n.v:this.v,this.v),s=interpolate$1(void 0!==n.t0?n.t0:this.t0,this.t0);return e=>{n.a=a(e),n.z=i(e),n.v=o(e),n.t0=s(e);const r=t.alignDistribution(n.a,n.z,n.v,n.t0);return t.densityLine(r)}});const vt=Z.selectAll(".rt").data(this.data.trials),Et=vt.enter().append("g");Et.append("line").classed("mark",!0).attr("x1",t=>y(t.rt)).attr("x2",t=>y(t.rt)).attr("y1",t=>"correct"===t.outcome?b(1)-.125*this.rem:b(-1)+.125*this.rem).attr("y2",t=>"correct"===t.outcome?b(1)-.675*this.rem:b(-1)+.675*this.rem);const Tt=Et.merge(vt).attr("class",t=>`rt ${t.outcome}`);Tt.filter(t=>!t.animate).select(".mark").transition().duration(this.drag?0:$).ease(cubicOut).attr("stroke",t=>this.getComputedStyleValue(`---color-${t.outcome}`)).attr("x1",t=>y(t.rt)).attr("x2",t=>y(t.rt)).attr("y1",t=>"correct"===t.outcome?b(1)-.125*this.rem:b(-1)+.125*this.rem).attr("y2",t=>"correct"===t.outcome?b(1)-.675*this.rem:b(-1)+.675*this.rem),vt.exit().remove();const St=Q.selectAll(".accuracy.model").data([this.model.accuracy,1-this.model.accuracy]),wt=St.enter().append("g").attr("class",(t,e)=>"accuracy model "+(0===e?"correct":"error"));wt.append("rect").classed("bar",!0).attr("x",0),wt.merge(St).select("rect").transition().duration(this.drag?0:$).ease(cubicOut).attr("y",(t,e)=>T(0===e?0:1-t)).attr("width",m).attr("height",t=>T(t)),St.exit().remove();const xt=Q.selectAll(".accuracy.data").data(Number.isNaN(this.data.accuracy)?[]:[this.data.accuracy]),At=xt.enter().append("g").classed("accuracy data",!0);At.append("line").classed("mark",!0);const _t=At.merge(xt).attr("class",t=>"accuracy data "+(t<this.model.accuracy.correct?"correct":"error"));_t.select(".mark").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",0+.25*this.rem).attr("x2",m-.25*this.rem).attr("y1",t=>T(t)-1).attr("y2",t=>T(t)-1),xt.exit().remove();const It=tt.selectAll(".boundary").data([{bound:"upper",value:this.bounds.upper},{bound:"lower",value:this.bounds.lower}]),Ot=It.enter().append("g").attr("class",(t,e)=>"boundary "+(0===e?"correct":"error"));Ot.append("line").classed("line",!0),Ot.append("line").classed("line touch",!0);const Ct=Ot.merge(It).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?(t,e)=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let{a:r}=this;switch(t.key){case"ArrowUp":r+="upper"===e.bound?t.shiftKey?DDMMath.a.STEP:DDMMath.a.JUMP:t.shiftKey?-.01:-.1;break;case"ArrowDown":r+="upper"===e.bound?t.shiftKey?-.01:-.1:t.shiftKey?DDMMath.a.STEP:DDMMath.a.JUMP}r=r<DDMMath.a.MIN?DDMMath.a.MIN:r>DDMMath.a.MAX?DDMMath.a.MAX:r,this.a=r,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-a",{detail:{a:this.a},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?Ct.call(x):Ct.on(".drag",null)),Ct.select(".line").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",y(this.scale.time.min)).attr("x2",y(this.scale.time.max)).attr("y1",t=>b(t.value)).attr("y2",t=>b(t.value)),Ct.select(".line.touch").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",y(this.scale.time.min)).attr("x2",y(this.scale.time.max)).attr("y1",t=>b(t.value)).attr("y2",t=>b(t.value)),It.exit().remove();const Rt=tt.selectAll(".drift").data([{v:this.v,t0:this.t0,startingPoint:this.startingPoint}]),Mt=Rt.enter().append("g").classed("drift",!0);Mt.append("line").classed("line",!0),Mt.append("line").classed("line touch",!0),Mt.append("path").classed("arrow",!0),Mt.append("path").classed("arrow touch",!0);const Nt=Mt.merge(Rt).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?t=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let{v:e}=this;switch(t.key){case"ArrowUp":e+=t.shiftKey?DDMMath.v.STEP:DDMMath.v.JUMP;break;case"ArrowDown":e-=t.shiftKey?DDMMath.v.STEP:DDMMath.v.JUMP}e=e<DDMMath.v.MIN?DDMMath.v.MIN:e>DDMMath.v.MAX?DDMMath.v.MAX:e,this.v=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-v",{detail:{v:this.v},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?Nt.call(w):Nt.on(".drag",null));const kt=(b(0)-b(1))/(y(1)-y(0));Nt.transition().duration(this.drag?0:$).ease(cubicOut).attr("transform",t=>`translate(${y(t.t0)}, ${b(t.startingPoint)})\n          rotate(${-Math.atan(t.v/1e3*kt)*(180/Math.PI)})`),Nt.select(".line").attr("x2",y(200)),Nt.select(".line.touch").attr("x2",y(200)),Nt.select(".arrow").attr("d",`\n        M ${y(200)-.5*this.rem},${.5*-this.rem}\n        l ${.5*this.rem},${.5*this.rem}\n        l ${.5*-this.rem},${.5*this.rem}\n      `),Nt.select(".arrow.touch").attr("d",`\n        M ${y(200)-.5*this.rem},${.5*-this.rem}\n        l ${.5*this.rem},${.5*this.rem}\n        l ${.5*-this.rem},${.5*this.rem}\n      `),Rt.exit().remove();const Dt=tt.selectAll(".t0z").data([{t0:this.t0,startingPoint:this.startingPoint}]),Pt=Dt.enter().append("g").classed("t0z",!0);Pt.append("line").classed("line",!0),Pt.append("line").classed("line touch",!0),Pt.append("circle").classed("point touch",!0);const Ut=Pt.merge(Dt).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?t=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let{z:e}=this;switch(t.key){case"ArrowUp":e+=t.shiftKey?DDMMath.z.STEP:DDMMath.z.JUMP;break;case"ArrowDown":e-=t.shiftKey?DDMMath.z.STEP:DDMMath.z.JUMP}e=e<DDMMath.z.MIN?DDMMath.z.MIN:e>DDMMath.z.MAX?DDMMath.z.MAX:e,this.z=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-z",{detail:{z:this.z},bubbles:!0})),t.preventDefault()}if(["ArrowLeft","ArrowRight"].includes(t.key)){let e=this.t0;switch(t.key){case"ArrowRight":e+=t.shiftKey?DDMMath.t0.STEP:DDMMath.t0.JUMP;break;case"ArrowLeft":e-=t.shiftKey?DDMMath.t0.STEP:DDMMath.t0.JUMP}e=e<DDMMath.t0.MIN?DDMMath.t0.MIN:e>DDMMath.t0.MAX?DDMMath.t0.MAX:e,this.t0=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-t0",{detail:{t0:this.t0},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?Ut.call(S):Ut.on(".drag",null)),Ut.select(".line").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",y(0)).attr("x2",t=>y(t.t0)).attr("y1",t=>b(t.startingPoint)).attr("y2",t=>b(t.startingPoint)),Ut.select(".line.touch").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",y(0)).attr("x2",t=>y(t.t0)).attr("y1",t=>b(t.startingPoint)).attr("y2",t=>b(t.startingPoint)),Ut.select(".point").transition().duration(this.drag?0:$).ease(cubicOut).attr("cx",t=>y(t.t0)).attr("cy",t=>b(t.startingPoint)),Dt.exit().remove();const Lt=tt.selectAll(".measure.a").data(this.measures?[this.a]:[]),jt=Lt.enter().append("g").classed("measure a",!0);jt.append("line").classed("line",!0).attr("marker-start","url(#measure-arrow-a)").attr("marker-end","url(#measure-arrow-a)");const Ft=jt.append("text").classed("label",!0);Ft.append("tspan").classed("a math-var",!0).text("a"),Ft.append("tspan").classed("equals",!0).text(" = "),Ft.append("tspan").classed("value",!0);const Bt=jt.merge(Lt);Bt.select(".line").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",y(this.scale.time.max)-.75*this.rem).attr("y1",b(this.bounds.upper)+2).attr("x2",y(this.scale.time.max)-.75*this.rem).attr("y2",b(this.bounds.lower)-2);Bt.select(".label").transition().duration(this.drag?0:$).ease(cubicOut).attr("x",y(this.scale.time.max)).attr("y",b(this.bounds.upper)-.25*this.rem).select(".value").text(format(".2f")(this.a)),Lt.exit().remove();const Ht=tt.selectAll(".measure.z").data(this.measures?[this.z]:[]),zt=Ht.enter().append("g").classed("measure z",!0);zt.append("line").classed("line",!0).attr("marker-start","url(#measure-arrow-z)").attr("marker-end","url(#measure-arrow-z)");const Vt=zt.append("text").classed("label",!0);Vt.append("tspan").classed("z math-var",!0).text("z"),Vt.append("tspan").classed("equals",!0).text(" = "),Vt.append("tspan").classed("value",!0);const Kt=zt.merge(Ht);Kt.select(".line").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",y(this.scale.time.min)+.75*this.rem).attr("y1",b(this.startingPoint)+2).attr("x2",y(this.scale.time.min)+.75*this.rem).attr("y2",b(this.bounds.lower)-2);Kt.select(".label").transition().duration(this.drag?0:$).ease(cubicOut).attr("x",y(this.scale.time.min)).attr("y",b(this.bounds.lower)+.125*this.rem).select(".value").text(format(".0%")(this.z)),Ht.exit().remove();const qt=tt.selectAll(".measure.v").data(this.measures?[this.v]:[]),Gt=qt.enter().append("g").classed("measure v",!0);Gt.append("path").classed("line",!0).attr("marker-start","url(#measure-arrow-cap-v)").attr("marker-end","url(#measure-arrow-cap-v)");const Wt=Gt.append("text").classed("label",!0);Wt.append("tspan").classed("v math-var",!0).text("v"),Wt.append("tspan").classed("equals",!0).text(" = "),Wt.append("tspan").classed("value",!0);const Yt=y(200)-y(0)+.75*this.rem,Xt=2/Yt,Zt=Math.atan(this.v/1e3*kt)-Xt,Jt=Math.cos(Zt)*Yt,Qt=Math.sin(Zt)*Yt,te=Gt.merge(qt);te.select(".line").transition().duration(this.drag?0:$).ease(cubicOut).attr("d",`\n        M ${y(this.t0+200)+.75*this.rem}, ${b(this.startingPoint)-2}\n        A ${y(200)-y(0)} ${y(200)-y(0)} 0 0 0 ${y(this.t0)+Jt} ${b(this.startingPoint)-Qt}\n      `);te.select(".label").transition().duration(this.drag?0:$).ease(cubicOut).attr("x",y(this.t0+200)+.5*this.rem).attr("y",b(this.bounds.upper)-.25*this.rem).select(".value").text(format(".2f")(this.v)),qt.exit().remove();const ee=tt.selectAll(".measure.t0").data(this.measures?[this.t0]:[]),re=ee.enter().append("g").classed("measure t0",!0);re.append("line").classed("line",!0).attr("marker-start","url(#measure-arrow-t0)").attr("marker-end","url(#measure-arrow-cap-t0)");const ne=re.append("text").classed("label",!0);ne.append("tspan").classed("t0 math-var",!0).text("t₀"),ne.append("tspan").classed("equals",!0).text(" = "),ne.append("tspan").classed("value",!0);const ae=re.merge(ee);ae.select(".line").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",y(0)+2).attr("y1",b(this.startingPoint)-.75*this.rem).attr("x2",y(this.t0)-2).attr("y2",b(this.startingPoint)-.75*this.rem);ae.select(".label").transition().duration(this.drag?0:$).ease(cubicOut).attr("x",y(this.t0)+.25*this.rem).attr("y",b(this.bounds.upper)-.25*this.rem).select(".value").text(format("d")(this.t0)),ee.exit().remove();const ie=et.selectAll(".model.mean").data(t=>this.means?[t]:[]),oe=ie.enter().append("g").attr("class",t=>`model mean ${t.outcome}`);oe.append("line").classed("indicator",!0);oe.merge(ie).select(".indicator").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",t=>y(t.model.meanRT)).attr("x2",t=>y(t.model.meanRT)).attr("y1",t=>t.densityScale(this.scale.density.min)).attr("y2",t=>t.densityScale(this.scale.density.max)),ie.exit().remove();const se=et.selectAll(".data.mean").data(t=>this.means&&!Number.isNaN(t.data.meanRT)?[t]:[]),le=se.enter().append("g").attr("class",t=>`data mean ${t.outcome}`);le.append("line").classed("indicator",!0).attr("y1",t=>t.densityScale(0)+("correct"===t.outcome?.125:-.125)*this.rem).attr("y2",t=>t.densityScale(0)+("correct"===t.outcome?.675:-.675)*this.rem);le.merge(se).select(".indicator").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",t=>y(t.data.meanRT)).attr("x2",t=>y(t.data.meanRT)).attr("y1",t=>t.densityScale(0)+("correct"===t.outcome?.125:-.125)*this.rem).attr("y2",t=>t.densityScale(0)+("correct"===t.outcome?.675:-.675)*this.rem),se.exit().select(".indicator").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",0).attr("x2",0).on("end",(t,e,r)=>{select(r[e].parentElement).remove()});const ce=et.selectAll(".model.sd").data(t=>this.sds?[t]:[]),ue=ce.enter().append("g").attr("class",t=>`model sd ${t.outcome}`);ue.append("line").classed("indicator",!0).attr("marker-start",t=>`url(#model-sd-cap-${t.outcome})`).attr("marker-end",t=>`url(#model-sd-cap-${t.outcome})`);ue.merge(ce).select(".indicator").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",t=>y(t.model.meanRT-t.model.sdRT/2)).attr("x2",t=>y(t.model.meanRT+t.model.sdRT/2)).attr("y1",t=>t.densityScale(5)).attr("y2",t=>t.densityScale(5)),ce.exit().remove();const he=et.selectAll(".data.sd").data(t=>!this.sds||Number.isNaN(t.data.meanRT)||Number.isNaN(t.data.sdRT)?[]:[t]),de=he.enter().append("g").attr("class",t=>`data sd ${t.outcome}`);de.append("line").classed("indicator",!0).attr("marker-start",t=>`url(#data-sd-cap-${t.outcome})`).attr("marker-end",t=>`url(#data-sd-cap-${t.outcome})`).attr("y1",t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem).attr("y2",t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem);de.merge(he).select(".indicator").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",t=>y(t.data.meanRT-t.data.sdRT/2)).attr("x2",t=>y(t.data.meanRT+t.data.sdRT/2)).attr("y1",t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem).attr("y2",t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem),he.exit().select(".indicator").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",0).attr("x2",0).on("end",(t,e,r)=>{select(r[e].parentElement).remove()}),this.firstUpdate=!1}}customElements.define("ddm-model",DDMModel);class RDK2AFCTask extends(DecidablesMixinResizeable(AccumulableElement)){static get properties(){return{coherence:{attribute:"coherence",type:Number,reflect:!0},count:{attribute:"count",type:Number,reflect:!0},probability:{attribute:"probability",type:Number,reflect:!0},duration:{attribute:"duration",type:Number,reflect:!0},wait:{attribute:"wait",type:Number,reflect:!0},iti:{attribute:"iti",type:Number,reflect:!0},trials:{attribute:"trials",type:Number,reflect:!0},running:{attribute:"running",type:Boolean,reflect:!0},lifetime:{attribute:!1,type:Number,reflect:!1},speed:{attribute:!1,type:Number,reflect:!1}}}constructor(){super(),this.coherence=.5,this.count=100,this.probability=.5,this.duration=2e3,this.wait=2e3,this.iti=2e3,this.trials=5,this.running=!1,this.lifetime=400,this.speed=50,this.firstUpdate=!0,this.COHERENT=0,this.RANDOM=1,this.dots=[[],[]],this.trial=0,this.states=["resetted","iti","stimulus","wait","ended"],this.state="resetted",this.baseTime=0,this.pauseTime=0,this.startTime=0,this.lastTime=0,this.LEFT=180,this.RIGHT=0,this.currentDirection=void 0,this.signals=["left","right"],this.signal=void 0,this.runner=void 0,this.xScale=void 0,this.yScale=void 0}static get styles(){return[super.styles,i$3`
        :host {
          display: inline-block;
