...
const o=t=>t??E;class DecidablesSlider extends DecidablesElement{static get properties(){return{disabled:{attribute:"disabled",type:Boolean,reflect:!0},scale:{attribute:"scale",type:Boolean,reflect:!0},max:{attribute:"max",type:Number,reflect:!0},min:{attribute:"min",type:Number,reflect:!0},step:{attribute:"step",type:Number,reflect:!0},value:{attribute:"value",type:Number,reflect:!0},nonlinear:{attribute:!1,type:Boolean,reflect:!1}}}constructor(){super(),this.disabled=!1,this.scale=!1,this.max=void 0,this.min=void 0,this.step=void 0,this.value=void 0,this.nonlinear=!1,this.rangeMax=void 0,this.rangeMin=void 0,this.rangeStep=void 0,this.rangeValue=void 0,this.toRange=void 0,this.fromRange=void 0}nonlinearRange(t,e,r){this.nonlinear=t,this.toRange=t?e:void 0,this.fromRange=t?r:void 0}rangeChanged(t){this.value=this.nonlinear?this.fromRange(t.target.value):t.target.value,this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0}))}rangeInputted(t){this.value=this.nonlinear?this.fromRange(t.target.value):t.target.value}spinnerInputted(t){this.value=t.target.value}willUpdate(){this.rangeMax=void 0===this.max?void 0:this.nonlinear?this.toRange(this.max):this.max,this.rangeMin=void 0===this.min?void 0:this.nonlinear?this.toRange(this.min):this.min,this.rangeStep=void 0===this.step?void 0:this.nonlinear?"any":this.step,this.rangeValue=void 0===this.value?void 0:this.nonlinear?this.toRange(this.value):this.value}static get styles(){return[super.styles,i$3`
    ...
    `}}customElements.define("itc-option",ITCOption);class ITCChoice extends DiscountableElement{static get properties(){return{state:{attribute:"state",type:String,reflect:!0},as:{attribute:"amount-ss",type:Number,reflect:!0},ds:{attribute:"delay-ss",type:Number,reflect:!0},al:{attribute:"amount-ll",type:Number,reflect:!0},dl:{attribute:"delay-ll",type:Number,reflect:!0}}}constructor(){super(),this.states=["choice","fixation","blank"],this.state="choice",this.as=10,this.ds=5,this.al=40,this.dl=30}static get styles(){return[super.styles,i$3`
      ...
      `]}render(){return x$1``}willUpdate(){this.alignState()}update(t){if(super.update(t),Number.isNaN(this.width)||Number.isNaN(this.height)||Number.isNaN(this.rem))return;const e=this.width,r=this.height;let n,a;e/r>1.5?(a=r,n=1.5*a):(n=e,a=n/1.5);const i=1*this.rem,o=3*this.rem,s=3.75*this.rem,l=3.25*this.rem,c=a-(i+o),u=n-(s+l),h=.75*this.rem,d=.5*c,p=.25*c-h,f=.75*this.rem,g=.9*u,m=.1*u-f,$=parseInt(this.getComputedStyleValue("---transition-duration"),10),y=linear().domain([this.scale.time.min,this.scale.time.max]).range([0,g]),b=linear().domain([this.scale.evidence.min,this.scale.evidence.max]).range([d,0]),v=linear().domain([this.scale.density.min,this.scale.density.max]).range([p,0]),E=linear().domain([this.scale.density.min,this.scale.density.max]).range([0,p]),T=linear().domain([0,1]).range([0,c]),S=drag().subject((t,e)=>({x:y(e.t0),y:b(e.startingPoint)})).on("start",t=>{select(t.currentTarget).classed("dragging",!0)}).on("drag",t=>{this.drag=!0;const e=!!t.sourceEvent.shiftKey&&(Math.abs(t.x-t.subject.x)>Math.abs(t.y-t.subject.y)?"t0":"z");let r=y.invert(t.x),n=(b.invert(t.y)+this.a/2)/this.a;r="z"===e?y.invert(t.subject.x):r<DDMMath.t0.MIN?DDMMath.t0.MIN:r>DDMMath.t0.MAX?DDMMath.t0.MAX:r,n="t0"===e?(b.invert(t.subject.y)+this.a/2)/this.a:n<DDMMath.z.MIN?DDMMath.z.MIN:n>DDMMath.z.MAX?DDMMath.z.MAX:n,this.t0=r,this.z=n,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-t0",{detail:{t0:this.t0},bubbles:!0})),this.dispatchEvent(new CustomEvent("ddm-model-z",{detail:{z:this.z},bubbles:!0}))}).on("end",t=>{select(t.currentTarget).classed("dragging",!1),this.drag=!1}),w=drag().on("start",t=>{select(t.currentTarget).classed("dragging",!0)}).on("drag",t=>{this.drag=!0;let e=(b.invert(t.y)-this.startingPoint)/(y.invert(t.x)-this.t0)*1e3;e=e<DDMMath.v.MIN?DDMMath.v.MIN:e>DDMMath.v.MAX?DDMMath.v.MAX:e,this.v=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-v",{detail:{v:this.v},bubbles:!0}))}).on("end",t=>{select(t.currentTarget).classed("dragging",!1),this.drag=!1}),x=drag().subject((t,e)=>({x:0,y:b(e.value)})).on("start",t=>{select(t.currentTarget).classed("dragging",!0)}).on("drag",t=>{this.drag=!0;const e=b.invert(t.y);let r=Math.abs(2*e);r=r<DDMMath.a.MIN?DDMMath.a.MIN:r>DDMMath.a.MAX?DDMMath.a.MAX:r,this.a=r,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-a",{detail:{a:this.a},bubbles:!0}))}).on("end",t=>{select(t.currentTarget).classed("dragging",!1),this.drag=!1}),A=line().x(t=>y(t.t)).y(t=>b(t.e)),_=line().x(t=>y(t.t)).y(t=>v(t.d)),I=line().x(t=>y(t.t)).y(t=>E(t.d)),O=select(this.renderRoot).selectAll(".main").data([{width:this.width,height:this.height,rem:this.rem}]),C=O.enter().append("svg").classed("main",!0).html(AccumulableElement.svgDefs),R=C.append("defs");R.append("marker").attr("id","measure-arrow").attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","2").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10").append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("d","M -3 -3 l 6 3 l -6 3 z"),R.append("marker").attr("id","model-sd-cap").attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","0").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10").append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("stroke-width","2").attr("d","M 0 -4 l 0 8"),R.append("marker").attr("id","data-sd-cap").attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","0").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10").append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("stroke-width","2").attr("d","M 0 -3 l 0 6");const M=R.append("linearGradient").attr("id","path-animate").attr("gradientUnits","userSpaceOnUse").attr("color-interpolation","linearRGB").attr("x1","0").attr("x2","0").attr("y1",b(this.bounds.upper)).attr("y2",b(this.bounds.lower));M.append("stop").classed("stop-0",!0).attr("offset","0%"),M.append("stop").classed("stop-100",!0).attr("offset","100%");const N=C.merge(O).attr("viewBox",`0 0 ${n} ${a}`),D=N.selectAll(".plot.density").data([{outcome:"correct",data:{meanRT:this.data.correctMeanRT,sdRT:this.data.correctSDRT},model:{meanRT:this.model.correctMeanRT,sdRT:this.model.correctSDRT,dist:this.model.correctDist},densityScale:v,densityLine:_,alignDistribution:this.alignCorrectDistribution.bind(this)},{outcome:"error",data:{meanRT:this.data.errorMeanRT,sdRT:this.data.errorSDRT},model:{meanRT:this.model.errorMeanRT,sdRT:this.model.errorSDRT,dist:this.model.errorDist},densityScale:E,densityLine:I,alignDistribution:this.alignErrorDistribution.bind(this)}]),k=C.append("g").classed("plot evidence",!0),P=D.enter().append("g").attr("class",t=>`plot density ${t.outcome}`),U=C.append("g").classed("plot accuracy",!0),L=N.select(".plot.evidence").attr("transform",`translate(${s}, ${i+p+h})`),j=P.merge(D).attr("transform",t=>`translate(${s}, ${"correct"===t.outcome?i:i+p+d+2*h})`),F=N.select(".plot.accuracy").attr("transform",`translate(${s+g+f}, ${i})`);k.append("clipPath").attr("id","clip-evidence").append("rect"),L.select("clipPath rect").attr("y",b(this.bounds.upper)).attr("height",b(this.bounds.lower)-b(this.bounds.upper)+1).attr("width",g+1);const B=k.append("g").classed("underlayer",!0),H=P.append("g").classed("underlayer",!0),z=U.append("g").classed("underlayer",!0),V=L.select(".underlayer"),K=j.select(".underlayer"),q=F.select(".underlayer");k.append("g").classed("content",!0).append("g").classed("paths",!0);const G=P.append("g").classed("content",!0);U.append("g").classed("content",!0);const W=L.select(".content"),Y=j.select(".content"),X=F.select(".content");k.append("g").classed("overlayer",!0),P.append("g").classed("overlayer",!0),U.append("g").classed("overlayer",!0);const Z=L.select(".overlayer"),J=j.select(".overlayer");B.append("rect").classed("background",!0),H.append("rect").classed("background",!0),V.select(".background").transition().duration(this.drag?0:$).ease(cubicOut).attr("y",b(this.bounds.upper)).attr("height",b(this.bounds.lower)-b(this.bounds.upper)).attr("width",g),K.select(".background").transition().duration($).ease(cubicOut).attr("height",p).attr("width",g),H.filter(t=>"error"===t.outcome).append("g").classed("axis time",!0);const Q=K.filter(t=>"error"===t.outcome).select(".axis.time").attr("transform",`translate(0, ${p+.25*this.rem})`);Q.transition().duration($).ease(cubicOut).call(axisBottom(y)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null);const tt=H.filter(t=>"error"===t.outcome).append("text").classed("title time",!0).attr("text-anchor","middle");tt.append("tspan").classed("name",!0).text("Time (ms)"),K.filter(t=>"error"===t.outcome).select(".title.time").transition().duration($).ease(cubicOut).attr("transform",`translate(${g/2}, ${p+2.5*this.rem})`),B.append("g").classed("axis evidence",!0),H.append("g").attr("class",t=>`axis density ${t.outcome}`),z.append("g").classed("axis accuracy",!0);const et=V.select(".axis.evidence").attr("transform",`translate(${-.25*this.rem}, 0)`),rt=K.select(".axis.density").attr("transform",`translate(${-.25*this.rem}, 0)`),nt=q.select(".axis.accuracy").attr("transform",`translate(${m+.25*this.rem}, 0)`),at=et.transition().duration($).ease(cubicOut).call(axisLeft(b)).attr("font-size",null).attr("font-family",null),it=rt.transition().duration($).ease(cubicOut).each((t,e,r)=>{axisLeft(t.densityScale).ticks(2)(select(r[e]))}).attr("font-size",null).attr("font-family",null),ot=nt.transition().duration($).ease(cubicOut).call(axisRight(T)).attr("font-size",null).attr("font-family",null);at.selectAll("line, path").attr("stroke",null),it.selectAll("line, path").attr("stroke",null),ot.selectAll("line, path").attr("stroke",null);const st=B.append("text").classed("title evidence",!0).attr("text-anchor","middle"),lt=H.append("text").attr("class",t=>`title density ${t.outcome}`).attr("text-anchor","middle"),ct=z.append("text").classed("title accuracy",!0).attr("text-anchor","middle");st.append("tspan").classed("name",!0).text("Evidence"),lt.append("tspan").classed("name",!0).text("Density"),ct.append("tspan").classed("name",!0).text("Accuracy"),V.select(".title.evidence").transition().duration($).ease(cubicOut).attr("transform",`translate(${-2.5*this.rem}, ${d/2})rotate(-90)`),K.select(".title.density").transition().duration($).ease(cubicOut).attr("transform",`translate(${-2.5*this.rem}, ${p/2})rotate(-90)`),q.select(".title.accuracy").transition().duration($).ease(cubicOut).attr("transform",`translate(${m+2.25*this.rem}, ${c/2})rotate(90)`);const ut=W.select(".paths").selectAll(".path").data(this.data.trials.filter(t=>void 0!==t.path)),ht=local(),dt=ut.enter().append("g").classed("path",!0).attr("data-new-trial-ease-time",0).on("pointerenter",(t,e)=>{if(!this.drag){select(t.currentTarget).classed("highlight",!0).raise();const r=Z.append("g").classed(`rt-label ${e.outcome}`,!0),n=r.append("rect"),a=r.append("text").text(`RT = ${e.rt.toFixed()}`).attr("x",y(e.rt)).attr("y","correct"===e.outcome?b(this.bounds.upper)-.25*this.rem:b(this.bounds.lower)+.125*this.rem).node().getBBox();n.attr("x",a.x-.125*this.rem).attr("y",a.y+.125*this.rem).attr("width",a.width+.25*this.rem).attr("height",a.height-.25*this.rem),ht.set(t.currentTarget,r)}}).on("pointerout",(t,e)=>{this.drag||(select(t.currentTarget).classed("highlight",!1).lower(),t.currentTarget.parentNode.insertBefore(t.currentTarget,t.currentTarget.parentNode.children[e.index]),ht.get(t.currentTarget).remove())});dt.append("path").classed("curve",!0).attr("clip-path","url(#clip-evidence)").attr("pathLength",1).attr("stroke-dashoffset",1);const pt=dt.merge(ut).attr("class",t=>`path ${t.outcome}`);pt.select(".curve").transition().duration(this.drag?0:$).ease(cubicOut).attr("stroke",t=>this.getComputedStyleValue(`---color-${t.outcome}`)).attrTween("d",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.a?n.a:this.a,this.a),i=interpolate$1(void 0!==n.z?n.z:this.z,this.z),o=interpolate$1(void 0!==n.v?n.v:this.v,this.v),s=interpolate$1(void 0!==n.t0?n.t0:this.t0,this.t0);return e=>{n.a=a(e),n.z=i(e),n.v=o(e),n.t0=s(e);const r=this.alignPath(t.seed,n.a,n.z,n.v,n.t0);return A(r)}});const ft=pt.filter(t=>t.animate&&!this.paused);if(!ft.empty()){const t=ft.attr("data-new-trial-ease-time"),e=e=>linear().domain([0,1]).range([t,1])(e),r=e=>r=>linear().domain([e(t),1]).range([0,1])(e(r));ft.classed("animate",!0).select(".curve").attr("stroke-dasharray",1),ft.transition("new").duration(e=>Math.floor(1.5*e.rt*(1-t))).ease(e).attr("data-new-trial-ease-time",1).select(".curve").attrTween("stroke-dashoffset",(t,e,n)=>{const a=interpolate$1(n[e].getAttribute("stroke-dashoffset"),0);return t=>a(r(linear$1)(t))}).on("end",(t,e,r)=>{select(r[e].parentElement).classed("animate",!1).attr("data-new-trial-ease-time",null),t.animate=!1,this.animate=!1,this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("accumulable-response",{detail:{outcome:t.outcome,data:this.data,model:this.model},bubbles:!0}))})}const gt=pt.filter(t=>t.animate&&this.paused);if(!gt.empty()){const t=gt.attr("data-new-trial-ease-time");gt.classed("animate",!0).select(".curve").attr("stroke-dasharray",1).attr("stroke-dashoffset",()=>interpolate$1(1,0)(linear$1(t)))}pt.filter(t=>!t.animate).attr("data-new-trial-ease-time",null),ut.exit().remove();const mt=G.append("g").attr("class",t=>`dist ${t.outcome}`);mt.append("path").classed("curve",!0),Y.select(".dist").select(".curve").transition().duration(this.drag?0:$).ease(cubicOut).attrTween("d",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.a?n.a:this.a,this.a),i=interpolate$1(void 0!==n.z?n.z:this.z,this.z),o=interpolate$1(void 0!==n.v?n.v:this.v,this.v),s=interpolate$1(void 0!==n.t0?n.t0:this.t0,this.t0);return e=>{n.a=a(e),n.z=i(e),n.v=o(e),n.t0=s(e);const r=t.alignDistribution(n.a,n.z,n.v,n.t0);return t.densityLine(r)}});const $t=W.selectAll(".rt").data(this.data.trials),yt=$t.enter().append("g");yt.append("line").classed("mark",!0).attr("x1",t=>y(t.rt)).attr("x2",t=>y(t.rt)).attr("y1",t=>"correct"===t.outcome?b(1)-.125*this.rem:b(-1)+.125*this.rem).attr("y2",t=>"correct"===t.outcome?b(1)-.675*this.rem:b(-1)+.675*this.rem);const bt=yt.merge($t).attr("class",t=>`rt ${t.outcome}`);bt.filter(t=>!t.animate).select(".mark").transition().duration(this.drag?0:$).ease(cubicOut).attr("stroke",t=>this.getComputedStyleValue(`---color-${t.outcome}`)).attr("x1",t=>y(t.rt)).attr("x2",t=>y(t.rt)).attr("y1",t=>"correct"===t.outcome?b(1)-.125*this.rem:b(-1)+.125*this.rem).attr("y2",t=>"correct"===t.outcome?b(1)-.675*this.rem:b(-1)+.675*this.rem),$t.exit().remove();const vt=X.selectAll(".accuracy.model").data([this.model.accuracy,1-this.model.accuracy]),Et=vt.enter().append("g").attr("class",(t,e)=>"accuracy model "+(0===e?"correct":"error"));Et.append("rect").classed("bar",!0).attr("x",0),Et.merge(vt).select("rect").transition().duration(this.drag?0:$).ease(cubicOut).attr("y",(t,e)=>T(0===e?0:1-t)).attr("width",m).attr("height",t=>T(t)),vt.exit().remove();const Tt=X.selectAll(".accuracy.data").data(Number.isNaN(this.data.accuracy)?[]:[this.data.accuracy]),St=Tt.enter().append("g").classed("accuracy data",!0);St.append("line").classed("mark",!0);const wt=St.merge(Tt).attr("class",t=>"accuracy data "+(t<this.model.accuracy.correct?"correct":"error"));wt.select(".mark").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",0+.25*this.rem).attr("x2",m-.25*this.rem).attr("y1",t=>T(t)-1).attr("y2",t=>T(t)-1),Tt.exit().remove();const xt=Z.selectAll(".boundary").data([{bound:"upper",value:this.bounds.upper},{bound:"lower",value:this.bounds.lower}]),At=xt.enter().append("g").attr("class",(t,e)=>"boundary "+(0===e?"correct":"error"));At.append("line").classed("line",!0),At.append("line").classed("line touch",!0);const _t=At.merge(xt).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?(t,e)=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let{a:r}=this;switch(t.key){case"ArrowUp":r+="upper"===e.bound?t.shiftKey?DDMMath.a.STEP:DDMMath.a.JUMP:t.shiftKey?-.01:-.1;break;case"ArrowDown":r+="upper"===e.bound?t.shiftKey?-.01:-.1:t.shiftKey?DDMMath.a.STEP:DDMMath.a.JUMP}r=r<DDMMath.a.MIN?DDMMath.a.MIN:r>DDMMath.a.MAX?DDMMath.a.MAX:r,this.a=r,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-a",{detail:{a:this.a},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?_t.call(x):_t.on(".drag",null)),_t.select(".line").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",y(this.scale.time.min)).attr("x2",y(this.scale.time.max)).attr("y1",t=>b(t.value)).attr("y2",t=>b(t.value)),_t.select(".line.touch").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",y(this.scale.time.min)).attr("x2",y(this.scale.time.max)).attr("y1",t=>b(t.value)).attr("y2",t=>b(t.value)),xt.exit().remove();const It=Z.selectAll(".drift").data([{v:this.v,t0:this.t0,startingPoint:this.startingPoint}]),Ot=It.enter().append("g").classed("drift",!0);Ot.append("line").classed("line",!0),Ot.append("line").classed("line touch",!0),Ot.append("path").classed("arrow",!0),Ot.append("path").classed("arrow touch",!0);const Ct=Ot.merge(It).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?t=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let{v:e}=this;switch(t.key){case"ArrowUp":e+=t.shiftKey?DDMMath.v.STEP:DDMMath.v.JUMP;break;case"ArrowDown":e-=t.shiftKey?DDMMath.v.STEP:DDMMath.v.JUMP}e=e<DDMMath.v.MIN?DDMMath.v.MIN:e>DDMMath.v.MAX?DDMMath.v.MAX:e,this.v=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-v",{detail:{v:this.v},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?Ct.call(w):Ct.on(".drag",null));const Rt=(b(0)-b(1))/(y(1)-y(0));Ct.transition().duration(this.drag?0:$).ease(cubicOut).attr("transform",t=>`translate(${y(t.t0)}, ${b(t.startingPoint)})\n          rotate(${-Math.atan(t.v/1e3*Rt)*(180/Math.PI)})`),Ct.select(".line").attr("x2",y(200)),Ct.select(".line.touch").attr("x2",y(200)),Ct.select(".arrow").attr("d",`\n        M ${y(200)-.5*this.rem},${.5*-this.rem}\n        l ${.5*this.rem},${.5*this.rem}\n        l ${.5*-this.rem},${.5*this.rem}\n      `),Ct.select(".arrow.touch").attr("d",`\n        M ${y(200)-.5*this.rem},${.5*-this.rem}\n        l ${.5*this.rem},${.5*this.rem}\n        l ${.5*-this.rem},${.5*this.rem}\n      `),It.exit().remove();const Mt=Z.selectAll(".t0z").data([{t0:this.t0,startingPoint:this.startingPoint}]),Nt=Mt.enter().append("g").classed("t0z",!0);Nt.append("line").classed("line",!0),Nt.append("line").classed("line touch",!0),Nt.append("circle").classed("point touch",!0);const Dt=Nt.merge(Mt).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?t=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let{z:e}=this;switch(t.key){case"ArrowUp":e+=t.shiftKey?DDMMath.z.STEP:DDMMath.z.JUMP;break;case"ArrowDown":e-=t.shiftKey?DDMMath.z.STEP:DDMMath.z.JUMP}e=e<DDMMath.z.MIN?DDMMath.z.MIN:e>DDMMath.z.MAX?DDMMath.z.MAX:e,this.z=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-z",{detail:{z:this.z},bubbles:!0})),t.preventDefault()}if(["ArrowLeft","ArrowRight"].includes(t.key)){let e=this.t0;switch(t.key){case"ArrowRight":e+=t.shiftKey?DDMMath.t0.STEP:DDMMath.t0.JUMP;break;case"ArrowLeft":e-=t.shiftKey?DDMMath.t0.STEP:DDMMath.t0.JUMP}e=e<DDMMath.t0.MIN?DDMMath.t0.MIN:e>DDMMath.t0.MAX?DDMMath.t0.MAX:e,this.t0=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-t0",{detail:{t0:this.t0},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?Dt.call(S):Dt.on(".drag",null)),Dt.select(".line").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",y(0)).attr("x2",t=>y(t.t0)).attr("y1",t=>b(t.startingPoint)).attr("y2",t=>b(t.startingPoint)),Dt.select(".line.touch").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",y(0)).attr("x2",t=>y(t.t0)).attr("y1",t=>b(t.startingPoint)).attr("y2",t=>b(t.startingPoint)),Dt.select(".point").transition().duration(this.drag?0:$).ease(cubicOut).attr("cx",t=>y(t.t0)).attr("cy",t=>b(t.startingPoint)),Mt.exit().remove();const kt=Z.selectAll(".measure.a").data(this.measures?[this.a]:[]),Pt=kt.enter().append("g").classed("measure a",!0);Pt.append("line").classed("line",!0).attr("marker-start","url(#measure-arrow)").attr("marker-end","url(#measure-arrow)");const Ut=Pt.append("text").classed("label",!0);Ut.append("tspan").classed("a math-var",!0).text("a"),Ut.append("tspan").classed("equals",!0).text(" = "),Ut.append("tspan").classed("value",!0);const Lt=Pt.merge(kt);Lt.select(".line").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",y(this.scale.time.max)-.75*this.rem).attr("y1",b(this.bounds.upper)+2).attr("x2",y(this.scale.time.max)-.75*this.rem).attr("y2",b(this.bounds.lower)-2);Lt.select(".label").transition().duration(this.drag?0:$).ease(cubicOut).attr("x",y(this.scale.time.max)).attr("y",b(this.bounds.upper)-.25*this.rem).select(".value").text(format(".2f")(this.a)),kt.exit().remove();const jt=Z.selectAll(".measure.z").data(this.measures?[this.z]:[]),Ft=jt.enter().append("g").classed("measure z",!0);Ft.append("line").classed("line",!0).attr("marker-start","url(#measure-arrow)").attr("marker-end","url(#measure-arrow)");const Bt=Ft.append("text").classed("label",!0);Bt.append("tspan").classed("z math-var",!0).text("z"),Bt.append("tspan").classed("equals",!0).text(" = "),Bt.append("tspan").classed("value",!0);const Ht=Ft.merge(jt);Ht.select(".line").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",y(this.scale.time.min)+.75*this.rem).attr("y1",b(this.startingPoint)+2).attr("x2",y(this.scale.time.min)+.75*this.rem).attr("y2",b(this.bounds.lower)-2);Ht.select(".label").transition().duration(this.drag?0:$).ease(cubicOut).attr("x",y(this.scale.time.min)).attr("y",b(this.bounds.lower)+.125*this.rem).select(".value").text(format(".0%")(this.z)),jt.exit().remove();const zt=Z.selectAll(".measure.v").data(this.measures?[this.v]:[]),Vt=zt.enter().append("g").classed("measure v",!0);Vt.append("path").classed("line",!0).attr("marker-start","url(#measure-arrow)").attr("marker-end","url(#measure-arrow)");const Kt=Vt.append("text").classed("label",!0);Kt.append("tspan").classed("v math-var",!0).text("v"),Kt.append("tspan").classed("equals",!0).text(" = "),Kt.append("tspan").classed("value",!0);const qt=Math.atan(this.v/1e3*Rt),Gt=y(200)-y(0)+.75*this.rem,Wt=Math.cos(qt)*Gt,Yt=Math.sin(qt)*Gt,Xt=Vt.merge(zt);Xt.select(".line").transition().duration(this.drag?0:$).ease(cubicOut).attr("d",`\n        M ${y(this.t0+200)+.75*this.rem}, ${b(this.startingPoint)}\n        A ${y(200)-y(0)} ${y(200)-y(0)} 0 0 0 ${y(this.t0)+Wt} ${b(this.startingPoint)-Yt}\n      `);Xt.select(".label").transition().duration(this.drag?0:$).ease(cubicOut).attr("x",y(this.t0+200)+.5*this.rem).attr("y",b(this.bounds.upper)-.25*this.rem).select(".value").text(format(".2f")(this.v)),zt.exit().remove();const Zt=Z.selectAll(".measure.t0").data(this.measures?[this.t0]:[]),Jt=Zt.enter().append("g").classed("measure t0",!0);Jt.append("line").classed("line",!0).attr("marker-start","url(#measure-arrow)").attr("marker-end","url(#measure-arrow)");const Qt=Jt.append("text").classed("label",!0);Qt.append("tspan").classed("t0 math-var",!0).text("t₀"),Qt.append("tspan").classed("equals",!0).text(" = "),Qt.append("tspan").classed("value",!0);const te=Jt.merge(Zt);te.select(".line").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",y(0)+2).attr("y1",b(this.startingPoint)-.75*this.rem).attr("x2",y(this.t0)-2).attr("y2",b(this.startingPoint)-.75*this.rem);te.select(".label").transition().duration(this.drag?0:$).ease(cubicOut).attr("x",y(this.t0)+.25*this.rem).attr("y",b(this.bounds.upper)-.25*this.rem).select(".value").text(format("d")(this.t0)),Zt.exit().remove();const ee=J.selectAll(".model.mean").data(t=>this.means?[t]:[]),re=ee.enter().append("g").attr("class",t=>`model mean ${t.outcome}`);re.append("line").classed("indicator",!0);re.merge(ee).select(".indicator").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",t=>y(t.model.meanRT)).attr("x2",t=>y(t.model.meanRT)).attr("y1",t=>t.densityScale(this.scale.density.min)).attr("y2",t=>t.densityScale(this.scale.density.max)),ee.exit().remove();const ne=J.selectAll(".data.mean").data(t=>this.means&&!Number.isNaN(t.data.meanRT)?[t]:[]),ae=ne.enter().append("g").attr("class",t=>`data mean ${t.outcome}`);ae.append("line").classed("indicator",!0).attr("y1",t=>t.densityScale(0)+("correct"===t.outcome?.125:-.125)*this.rem).attr("y2",t=>t.densityScale(0)+("correct"===t.outcome?.675:-.675)*this.rem);ae.merge(ne).select(".indicator").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",t=>y(t.data.meanRT)).attr("x2",t=>y(t.data.meanRT)).attr("y1",t=>t.densityScale(0)+("correct"===t.outcome?.125:-.125)*this.rem).attr("y2",t=>t.densityScale(0)+("correct"===t.outcome?.675:-.675)*this.rem),ne.exit().select(".indicator").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",0).attr("x2",0).on("end",(t,e,r)=>{select(r[e].parentElement).remove()});const ie=J.selectAll(".model.sd").data(t=>this.sds?[t]:[]),oe=ie.enter().append("g").attr("class",t=>`model sd ${t.outcome}`);oe.append("line").classed("indicator",!0).attr("marker-start","url(#model-sd-cap)").attr("marker-end","url(#model-sd-cap)");oe.merge(ie).select(".indicator").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",t=>y(t.model.meanRT-t.model.sdRT/2)).attr("x2",t=>y(t.model.meanRT+t.model.sdRT/2)).attr("y1",t=>t.densityScale(5)).attr("y2",t=>t.densityScale(5)),ie.exit().remove();const se=J.selectAll(".data.sd").data(t=>!this.sds||Number.isNaN(t.data.meanRT)||Number.isNaN(t.data.sdRT)?[]:[t]),le=se.enter().append("g").attr("class",t=>`data sd ${t.outcome}`);le.append("line").classed("indicator",!0).attr("marker-start","url(#data-sd-cap)").attr("marker-end","url(#data-sd-cap)").attr("y1",t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem).attr("y2",t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem);le.merge(se).select(".indicator").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",t=>y(t.data.meanRT-t.data.sdRT/2)).attr("x2",t=>y(t.data.meanRT+t.data.sdRT/2)).attr("y1",t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem).attr("y2",t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem),se.exit().select(".indicator").transition().duration(this.drag?0:$).ease(cubicOut).attr("x1",0).attr("x2",0).on("end",(t,e,r)=>{select(r[e].parentElement).remove()}),this.firstUpdate=!1}}customElements.define("ddm-model",DDMModel);class RDK2AFCTask extends(DecidablesMixinResizeable(AccumulableElement)){static get properties(){return{coherence:{attribute:"coherence",type:Number,reflect:!0},count:{attribute:"count",type:Number,reflect:!0},probability:{attribute:"probability",type:Number,reflect:!0},duration:{attribute:"duration",type:Number,reflect:!0},wait:{attribute:"wait",type:Number,reflect:!0},iti:{attribute:"iti",type:Number,reflect:!0},trials:{attribute:"trials",type:Number,reflect:!0},running:{attribute:"running",type:Boolean,reflect:!0},lifetime:{attribute:!1,type:Number,reflect:!1},speed:{attribute:!1,type:Number,reflect:!1}}}constructor(){super(),this.coherence=.5,this.count=100,this.probability=.5,this.duration=2e3,this.wait=2e3,this.iti=2e3,this.trials=5,this.running=!1,this.lifetime=400,this.speed=50,this.firstUpdate=!0,this.COHERENT=0,this.RANDOM=1,this.dots=[[],[]],this.trial=0,this.states=["resetted","iti","stimulus","wait","ended"],this.state="resetted",this.baseTime=0,this.pauseTime=0,this.startTime=0,this.lastTime=0,this.LEFT=180,this.RIGHT=0,this.currentDirection=void 0,this.signals=["left","right"],this.signal=void 0,this.runner=void 0,this.xScale=void 0,this.yScale=void 0}static get styles(){return[super.styles,i$3`
        :host {
          display: inline-block;
