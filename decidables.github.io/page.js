...
const o=t=>t??E;class DecidablesSlider extends DecidablesElement{static get properties(){return{disabled:{attribute:"disabled",type:Boolean,reflect:!0},scale:{attribute:"scale",type:Boolean,reflect:!0},max:{attribute:"max",type:Number,reflect:!0},min:{attribute:"min",type:Number,reflect:!0},step:{attribute:"step",type:Number,reflect:!0},value:{attribute:"value",type:Number,reflect:!0},nonlinear:{attribute:!1,type:Boolean,reflect:!1}}}constructor(){super(),this.disabled=!1,this.scale=!1,this.max=void 0,this.min=void 0,this.step=void 0,this.value=void 0,this.nonlinear=!1,this.rangeMax=void 0,this.rangeMin=void 0,this.rangeStep=void 0,this.rangeValue=void 0,this.toRange=void 0,this.fromRange=void 0}nonlinearRange(t,e,r){this.nonlinear=t,this.toRange=t?e:void 0,this.fromRange=t?r:void 0}rangeChanged(t){this.value=this.nonlinear?this.fromRange(t.target.value):t.target.value,this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0}))}rangeInputted(t){this.value=this.nonlinear?this.fromRange(t.target.value):t.target.value}spinnerInputted(t){this.value=t.target.value}willUpdate(){this.rangeMax=void 0===this.max?void 0:this.nonlinear?this.toRange(this.max):this.max,this.rangeMin=void 0===this.min?void 0:this.nonlinear?this.toRange(this.min):this.min,this.rangeStep=void 0===this.step?void 0:this.nonlinear?"any":this.step,this.rangeValue=void 0===this.value?void 0:this.nonlinear?this.toRange(this.value):this.value}static get styles(){return[super.styles,i$3`
    ...
    `}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(t=>{t.some(t=>"childList"===t.type||"attributes"===t.type&&t.target!==this)&&this.requestUpdate()}),this.mutationObserver.observe(this,{subtree:!0,childList:!0,attributes:!0})}disconnectedCallback(){this.mutationObserver.disconnect(),super.disconnectedCallback()}update(t){if(super.update(t),Number.isNaN(this.width)||Number.isNaN(this.height)||Number.isNaN(this.rem))return;const e=this.width,r=this.height,n=Math.min(e,r),a=n-(0+0),i=n-(0+0),s=this.querySelectorAll("risky-outcome"),o=s.length?-s[0].p:0,l=pie().startAngle(o*Math.PI-Math.PI).endAngle(o*Math.PI+Math.PI).sortValues(null).value(t=>t.p)(s),c=l.filter(t=>!t.data.interactive),u=l.filter(t=>t.data.interactive);function h(t){const e=(t+2*Math.PI)%(2*Math.PI);return e>Math.PI?e-2*Math.PI:e<-Math.PI?e+2*Math.PI:e}const d=drag().subject((t,e)=>{const r=h((e.endAngle+e.startAngle)/2),n=h(Math.atan2(t.y,t.x)+Math.PI/2);return s.forEach(t=>{t.startP=t.p}),{arcAngle:r,startAngle:h(n-r)}}).on("start",(t,e)=>{if(!e.data.interactive)return;select(t.currentTarget).classed("dragging",!0)}).on("drag",(t,e)=>{if(!e.data.interactive)return;const r=h(Math.atan2(t.y,t.x)+Math.PI/2),n=h(r-t.subject.arcAngle),a=h(t.subject.startAngle>0?n-t.subject.startAngle:t.subject.startAngle-n)/Math.PI,i=e.data.startP+a,o=i>.99?.99:i<.01?.01:i;s.forEach(t=>{t.p=t===e.data?o:t.startP/(1-e.data.startP)*(1-o)}),this.dispatchEvent(new CustomEvent("risky-outcome-change",{detail:{x:e.data.x,p:e.data.p,name:e.data.name},bubbles:!0}))}).on("end",(t,e)=>{if(!e.data.interactive)return;select(t.currentTarget).classed("dragging",!1)}),p=select(this.renderRoot).selectAll(".main").data([{width:this.width,height:this.height,rem:this.rem}]),f=p.enter().append("svg").classed("main",!0),m=f.merge(p).attr("viewBox",`0 0 ${n} ${n}`),g=f.append("g").classed("pie",!0),y=m.select(".pie").attr("transform",`translate(${i/2}, ${a/2})`);g.append("circle").classed("outline",!0),y.select(".outline").attr("r",Math.min(i,a)/2-1);const $=y.selectAll(".arc").data(l),b=$.enter().append("path").call(d).on("keydown",(t,e)=>{if(["ArrowUp","ArrowDown"].includes(t.key)){const r=e.data.p;let n=e.data.p;switch(t.key){case"ArrowUp":n-=t.shiftKey?.01:.05;break;case"ArrowDown":n+=t.shiftKey?.01:.05}const a=n>.99?.99:n<.01?.01:n;s.forEach(t=>{t.p=t===e.data?a:t.p/(1-r)*(1-a)}),this.dispatchEvent(new CustomEvent("risky-outcome-change",{detail:{x:e.data.x,p:e.data.p,name:e.data.name},bubbles:!0})),t.preventDefault()}});b.merge($).attr("tabindex",t=>u.includes(t)&&l.length>1?0:null).attr("class",t=>`arc ${t.data.name}`).classed("interactive",t=>u.includes(t)&&l.length>1).attr("d",arc().innerRadius(0).outerRadius(Math.min(i,a)/2-1)),$.exit().remove();const v=y.selectAll(".label.static").data(c),x=y.selectAll(".label.interactive").data(u),w=v.enter().append("text"),E=x.enter().append("foreignObject");E.append("xhtml:decidables-spinner").on("input",(t,e)=>{e.data.x=parseFloat(t.target.value),this.dispatchEvent(new CustomEvent("risky-outcome-change",{detail:{x:e.data.x,p:e.data.p,name:e.data.name},bubbles:!0}))}),w.merge(v).attr("class",t=>`label static ${t.data.name}`).attr("transform",t=>{if(1===l.length)return"translate(0, 0)";const e=Math.min(i,a)/2*.6;return`translate(${arc().innerRadius(e).outerRadius(e).centroid(t)})`}).text(t=>`$${t.data.x.toFixed(0)}`);const T=E.merge(x).attr("class",t=>`label interactive ${t.data.name}`).attr("transform",t=>{const e=parseFloat(this.getComputedStyleValue("--decidables-spinner-input-width")),r=parseFloat(this.getComputedStyleValue("--decidables-spinner-font-size")),n=parseFloat(getComputedStyle(document.documentElement).getPropertyValue("font-size"),10),s=e*n/-2,o=r*n*1.5/-2;if(1===l.length)return`translate(${s}, ${o})`;const c=Math.min(i,a)/2*.6,u=arc().innerRadius(c).outerRadius(c);return`translate(${u.centroid(t)[0]+s}, ${u.centroid(t)[1]+o})`});T.select("decidables-spinner").attr("value",t=>`${t.data.x.toFixed(0)}`),v.exit().remove(),x.exit().remove()}}customElements.define("risky-option",RiskyOption);class RiskyOutcome extends ProspectableElement{static get properties(){return{x:{attribute:"value",type:Number,reflect:!0},p:{attribute:"probability",type:Number,reflect:!0},name:{attribute:"name",type:String,reflect:!0}}}constructor(){super(),this.x=0,this.p=0,this.name=""}static get styles(){return[i$3`
      ...
      `]}render(){return x$1``}willUpdate(){this.alignState()}update(t){if(super.update(t),Number.isNaN(this.width)||Number.isNaN(this.height)||Number.isNaN(this.rem))return;const e=this.width,r=this.height;let n,a;e/r>1.8?(a=r,n=1.8*a):(n=e,a=n/1.8);const i=2*this.rem,s=3*this.rem,o=3*this.rem,l=a-(i+s),c=n-(o+2*this.rem),u=parseInt(this.getComputedStyleValue("---transition-duration"),10),h=linear().domain([this.scale.time.min,this.scale.time.max]).range([0,c]),d=linear().domain([this.scale.value.min,this.scale.value.max]).range([l,0]),p=line().x(t=>h(t.d)).y(t=>d(t.v)),f=select(this.renderRoot).selectAll(".main").data([{width:this.width,height:this.height,rem:this.rem}]),m=f.enter().append("svg").classed("main",!0);m.html(DiscountableElement.svgDefs);const g=m.merge(f).attr("viewBox",`0 0 ${n} ${a}`),y=m.append("g").classed("plot",!0),$=g.select(".plot").attr("transform",`translate(${o}, ${i})`);y.append("clipPath").attr("id","clip-htd-curves").append("rect"),$.select("clipPath rect").attr("height",l+1).attr("width",c+1);const b=y.append("g").classed("underlayer",!0),v=$.select(".underlayer");b.append("rect").classed("background",!0),v.select(".background").attr("height",l).attr("width",c),b.append("g").classed("axis-x",!0);v.select(".axis-x").attr("transform",`translate(0, ${d(0)})`).transition().duration(2*u).ease(cubicOut).call(axisBottom(h)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null);const x=b.append("text").classed("title-x",!0).attr("text-anchor","middle");x.append("tspan").classed("name",!0).text("Delay ("),x.append("tspan").classed("math-var d",!0).text("D"),x.append("tspan").classed("name",!0).text(")"),v.select(".title-x").attr("transform",`translate(${c/2}, ${l+2.25*this.rem})`),b.append("g").classed("axis-y",!0);v.select(".axis-y").transition().duration(2*u).ease(cubicOut).call(axisLeft(d)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null);const w=b.append("text").classed("title-y",!0).attr("text-anchor","middle");w.append("tspan").classed("name",!0).text("Value ("),w.append("tspan").classed("math-var v",!0).text("V"),w.append("tspan").classed("name",!0).text(")"),v.select(".title-y").attr("transform",`translate(${-2*this.rem}, ${l/2})rotate(-90)`),y.append("g").classed("content",!0);const E=$.select(".content").selectAll(".option").data(this.options.filter(t=>null!==t.a&&null!==t.d),t=>t.name),T=E.enter().append("g").classed("option",!0),S=T.append("g").classed("curve",!0).attr("clip-path","url(#clip-htd-curves)");S.append("path").classed("path",!0).attr("d",t=>{const e=range(h(t.d),h(0),-1).map(e=>({d:h.invert(e),v:HTDMath.adk2v(t.a,t.d-h.invert(e),this.k)}));return p(e)}).attr("stroke-dasharray",(t,e,r)=>{if(t.trial){return`0,${r[e].getTotalLength()}`}return"none"}),S.append("path").classed("path touch",!0).attr("d",t=>{const e=range(h(t.d),h(0),-1).map(e=>({d:h.invert(e),v:HTDMath.adk2v(t.a,t.d-h.invert(e),this.k)}));return p(e)}).attr("stroke-dasharray",(t,e,r)=>{if(t.trial){return`0,${r[e].getTotalLength()}`}return"none"});const A=T.append("g").classed("bar",!0);A.append("line").classed("line",!0).attr("x1",t=>h(t.d)).attr("x2",t=>h(t.d)).attr("y1",d(0)).attr("y2",t=>d(t.a)).attr("stroke-dasharray",(t,e,r)=>{if(t.trial){return`0,${r[e].getTotalLength()}`}return"none"}),A.append("line").classed("line touch",!0).attr("x1",t=>h(t.d)).attr("x2",t=>h(t.d)).attr("y1",d(0)).attr("y2",t=>d(t.a)).attr("stroke-dasharray",(t,e,r)=>{if(t.trial){return`0,${r[e].getTotalLength()}`}return"none"});const _=T.append("g").classed("point",!0).attr("transform",t=>`translate(${h(t.d)}, ${d(t.a)})`).attr("opacity",t=>t.trial?0:1);_.append("circle").classed("mark touch",!0),_.append("text").classed("label",!0);const C=T.merge(E);C.filter((t,e,r)=>this.interactive&&!select(r[e]).select(".curve").classed("interactive")).select(".curve").classed("interactive",!0).attr("tabindex",0).call(drag().subject(t=>({x:t.x,y:t.y})).on("start",t=>{select(t.currentTarget).classed("dragging",!0)}).on("drag",(t,e)=>{this.drag=!0;const r=e.d-h.invert(t.x),n=r<0?0:r>e.d?e.d:r,a=d.invert(t.y),i=a<=0?.001:a>e.a?e.a:a,s=HTDMath.adv2k(e.a,n,i);this.k=s<HTDMath.k.MIN?HTDMath.k.MIN:s>HTDMath.k.MAX?HTDMath.k.MAX:s,this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("htd-curves-change",{detail:{name:e.name,a:e.a,d:e.d,k:this.k,label:e.label},bubbles:!0}))}).on("end",t=>{select(t.currentTarget).classed("dragging",!1)})).on("keydown",(t,e)=>{if(["ArrowUp","ArrowDown","ArrowRight","ArrowLeft"].includes(t.key)){let{k:r}=this;switch(t.key){case"ArrowUp":case"ArrowLeft":r*=t.shiftKey?.95:.85;break;case"ArrowDown":case"ArrowRight":r*=t.shiftKey?1/.95:1/.85}r=r<HTDMath.k.MIN?HTDMath.k.MIN:r>HTDMath.k.MAX?HTDMath.k.MAX:r,r!==this.k&&(this.k=r,this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("htd-curves-change",{detail:{name:e.name,a:e.a,d:e.d,k:this.k,label:e.label},bubbles:!0}))),t.preventDefault()}}),C.filter((t,e,r)=>this.interactive&&!t.trial&&!select(r[e]).select(".bar").classed("interactive")).select(".bar").classed("interactive",!0).attr("tabindex",0).call(drag().subject((t,e)=>({x:h(e.d),y:d(e.a)})).on("start",t=>{select(t.currentTarget).classed("dragging",!0)}).on("drag",(t,e)=>{this.drag=!0;const r=h.invert(t.x);e.d=r<this.scale.time.min?this.scale.time.min:r>this.scale.time.max?this.scale.time.max:this.scale.time.round(r),"default"===e.name&&(this.d=e.d),this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("htd-curves-change",{detail:{name:e.name,a:e.a,d:e.d,k:this.k,label:e.label},bubbles:!0}))}).on("end",t=>{select(t.currentTarget).classed("dragging",!1)})).on("keydown",(t,e)=>{if(["ArrowLeft","ArrowRight"].includes(t.key)){let r=e.d;switch(t.key){case"ArrowRight":r+=t.shiftKey?1:5;break;case"ArrowLeft":r-=t.shiftKey?1:5}r=r<this.scale.time.min?this.scale.time.min:r>this.scale.time.max?this.scale.time.max:r,r!==e.d&&(e.d=r,"default"===e.name&&(this.d=e.d),this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("htd-curves-change",{detail:{name:e.name,a:e.a,d:e.d,k:this.k,label:e.label},bubbles:!0}))),t.preventDefault()}}),C.filter((t,e,r)=>this.interactive&&!t.trial&&!select(r[e]).select(".point").classed("interactive")).select(".point").classed("interactive",!0).attr("tabindex",0).call(drag().subject((t,e)=>({x:h(e.d),y:d(e.a)})).on("start",t=>{select(t.currentTarget).classed("dragging",!0)}).on("drag",(t,e)=>{this.drag=!0;const r=d.invert(t.y);e.a=r<this.scale.value.min?this.scale.value.min:r>this.scale.value.max?this.scale.value.max:this.scale.value.round(r),"default"===e.name&&(this.a=e.a),this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("htd-curves-change",{detail:{name:e.name,a:e.a,d:e.d,k:this.k,label:e.label},bubbles:!0}))}).on("end",t=>{select(t.currentTarget).classed("dragging",!1)})).on("keydown",(t,e)=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let r=e.a;switch(t.key){case"ArrowUp":r+=t.shiftKey?1:5;break;case"ArrowDown":r-=t.shiftKey?1:5}r=r<this.scale.value.min?this.scale.value.min:r>this.scale.value.max?this.scale.value.max:r,r!==e.a&&(e.a=r,"default"===e.name&&(this.a=e.a),this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("htd-curves-change",{detail:{name:e.name,a:e.a,d:e.d,k:this.k,label:e.label},bubbles:!0}))),t.preventDefault()}}),C.filter((t,e,r)=>!this.interactive&&select(r[e]).select(".curve").classed("interactive")).select(".curve").classed("interactive",!1).attr("tabindex",null).on("drag",null).on("keydown",null),C.filter((t,e,r)=>(!this.interactive||t.trial)&&select(r[e]).select(".bar").classed("interactive")).select(".bar").classed("interactive",!1).attr("tabindex",null).on("drag",null).on("keydown",null),C.filter((t,e,r)=>(!this.interactive||t.trial)&&select(r[e]).select(".point").classed("interactive")).select(".point").classed("interactive",!1).attr("tabindex",null).on("drag",null).on("keydown",null),C.filter(t=>t.new).select(".curve .path").transition().duration(u).delay(u+u/10).ease(linear$1).attrTween("stroke-dasharray",(t,e,r)=>{const n=r[e].getTotalLength();return interpolate$1(`0,${n}`,`${n},0`)}).on("end",t=>{t.new=!1,this.dispatchEvent(new CustomEvent("discountable-response",{detail:{trial:this.trialCount,as:this.as,ds:this.ds,al:this.al,dl:this.dl,response:this.response},bubbles:!0}))}),C.filter(t=>t.new).select(".curve .path.touch").transition().duration(u).delay(u+u/10).ease(linear$1).attrTween("stroke-dasharray",(t,e,r)=>{const n=r[e].getTotalLength();return interpolate$1(`0,${n}`,`${n},0`)}),C.filter(t=>t.new).select(".bar .line").transition().duration(u).ease(linear$1).attrTween("stroke-dasharray",(t,e,r)=>{const n=r[e].getTotalLength();return interpolate$1(`0,${n}`,`${n},${n}`)}),C.filter(t=>t.new).select(".bar .line.touch").transition().duration(u).ease(linear$1).attrTween("stroke-dasharray",(t,e,r)=>{const n=r[e].getTotalLength();return interpolate$1(`0,${n}`,`${n},${n}`)}),C.filter(t=>t.new).select(".point").transition().duration(u/10).delay(u).ease(linear$1).attrTween("opacity",()=>interpolate$1(0,1)),E.select(".curve .path").transition().duration(this.drag?0:this.firstUpdate?2*u:u).ease(cubicOut).attrTween("d",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.a?n.a:t.a,t.a),i=interpolate$1(void 0!==n.d?n.d:t.d,t.d);return t=>{n.a=a(t),n.d=i(t);const e=range(h(n.d),h(0),-1).map(t=>({d:h.invert(t),v:HTDMath.adk2v(n.a,n.d-h.invert(t),this.k)}));return p(e)}}),E.select(".curve .path.touch").transition().duration(this.drag?0:this.firstUpdate?2*u:u).ease(cubicOut).attrTween("d",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.a?n.a:t.a,t.a),i=interpolate$1(void 0!==n.d?n.d:t.d,t.d);return t=>{n.a=a(t),n.d=i(t);const e=range(h(n.d),h(0),-1).map(t=>({d:h.invert(t),v:HTDMath.adk2v(n.a,n.d-h.invert(t),this.k)}));return p(e)}}),E.select(".bar .line").transition().duration(this.drag?0:this.firstUpdate?2*u:u).ease(cubicOut).attrTween("x1",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.d?n.d:t.d,t.d);return t=>(n.d=a(t),`${h(n.d)}`)}).attrTween("x2",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.d?n.d:t.d,t.d);return t=>(n.d=a(t),`${h(n.d)}`)}).attrTween("y2",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.a?n.a:t.a,t.a);return t=>(n.a=a(t),`${d(n.a)}`)}),E.select(".bar .line.touch").transition().duration(this.drag?0:this.firstUpdate?2*u:u).ease(cubicOut).attrTween("x1",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.d?n.d:t.d,t.d);return t=>(n.d=a(t),`${h(n.d)}`)}).attrTween("x2",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.d?n.d:t.d,t.d);return t=>(n.d=a(t),`${h(n.d)}`)}).attrTween("y2",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.a?n.a:t.a,t.a);return t=>(n.a=a(t),`${d(n.a)}`)}),E.select(".point").transition().duration(this.drag?0:this.firstUpdate?2*u:u).ease(cubicOut).attrTween("transform",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.d?n.d:t.d,t.d),i=interpolate$1(void 0!==n.a?n.a:t.a,t.a);return t=>(n.d=a(t),n.a=i(t),`translate(${h(n.d)}, ${d(n.a)})`)}),C.select(".point .label").text(t=>t.label),E.exit().remove(),this.drag=!1,this.firstUpdate=!1}}customElements.define("htd-curves",HTDCurves);class ITCOption extends DiscountableElement{static get properties(){return{state:{attribute:"state",type:String,reflect:!0},a:{attribute:"amount",type:Number,reflect:!0},d:{attribute:"delay",type:Number,reflect:!0}}}constructor(){super(),this.states=["choice","fixation","blank"],this.state="choice",this.a=0,this.d=0}static get styles(){return[super.styles,i$3`
        :host {
          display: inline-block;
    ...
    `}}customElements.define("itc-option",ITCOption);class ITCChoice extends DiscountableElement{static get properties(){return{state:{attribute:"state",type:String,reflect:!0},as:{attribute:"amount-ss",type:Number,reflect:!0},ds:{attribute:"delay-ss",type:Number,reflect:!0},al:{attribute:"amount-ll",type:Number,reflect:!0},dl:{attribute:"delay-ll",type:Number,reflect:!0}}}constructor(){super(),this.states=["choice","fixation","blank"],this.state="choice",this.as=10,this.ds=5,this.al=40,this.dl=30}static get styles(){return[super.styles,i$3`
      ...
      `]}render(){return x$1``}willUpdate(){this.alignState()}update(t){if(super.update(t),Number.isNaN(this.width)||Number.isNaN(this.height)||Number.isNaN(this.rem))return;const e=this.width,r=this.height;let n,a;e/r>1.5?(a=r,n=1.5*a):(n=e,a=n/1.5);const i=1*this.rem,s=3*this.rem,o=3.75*this.rem,l=3.25*this.rem,c=a-(i+s),u=n-(o+l),h=.75*this.rem,d=.5*c,p=.25*c-h,f=.75*this.rem,m=.9*u,g=.1*u-f,y=parseInt(this.getComputedStyleValue("---transition-duration"),10),$=linear().domain([this.scale.time.min,this.scale.time.max]).range([0,m]),b=linear().domain([this.scale.evidence.min,this.scale.evidence.max]).range([d,0]),v=linear().domain([this.scale.density.min,this.scale.density.max]).range([p,0]),x=linear().domain([this.scale.density.min,this.scale.density.max]).range([0,p]),w=linear().domain([0,1]).range([0,c]),E=drag().subject((t,e)=>({x:$(e.t0),y:b(e.startingPoint)})).on("start",t=>{select(t.currentTarget).classed("dragging",!0)}).on("drag",t=>{this.drag=!0;const e=!!t.sourceEvent.shiftKey&&(Math.abs(t.x-t.subject.x)>Math.abs(t.y-t.subject.y)?"t0":"z");let r=$.invert(t.x),n=(b.invert(t.y)+this.a/2)/this.a;r="z"===e?$.invert(t.subject.x):r<DDMMath.t0.MIN?DDMMath.t0.MIN:r>DDMMath.t0.MAX?DDMMath.t0.MAX:r,n="t0"===e?(b.invert(t.subject.y)+this.a/2)/this.a:n<DDMMath.z.MIN?DDMMath.z.MIN:n>DDMMath.z.MAX?DDMMath.z.MAX:n,this.t0=r,this.z=n,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-t0",{detail:{t0:this.t0},bubbles:!0})),this.dispatchEvent(new CustomEvent("ddm-model-z",{detail:{z:this.z},bubbles:!0}))}).on("end",t=>{select(t.currentTarget).classed("dragging",!1),this.drag=!1}),T=drag().on("start",t=>{select(t.currentTarget).classed("dragging",!0)}).on("drag",t=>{this.drag=!0;let e=(b.invert(t.y)-this.startingPoint)/($.invert(t.x)-this.t0)*1e3;e=e<DDMMath.v.MIN?DDMMath.v.MIN:e>DDMMath.v.MAX?DDMMath.v.MAX:e,this.v=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-v",{detail:{v:this.v},bubbles:!0}))}).on("end",t=>{select(t.currentTarget).classed("dragging",!1),this.drag=!1}),S=drag().subject((t,e)=>({x:0,y:b(e.value)})).on("start",t=>{select(t.currentTarget).classed("dragging",!0)}).on("drag",t=>{this.drag=!0;const e=b.invert(t.y);let r=Math.abs(2*e);r=r<DDMMath.a.MIN?DDMMath.a.MIN:r>DDMMath.a.MAX?DDMMath.a.MAX:r,this.a=r,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-a",{detail:{a:this.a},bubbles:!0}))}).on("end",t=>{select(t.currentTarget).classed("dragging",!1),this.drag=!1}),A=line().x(t=>$(t.t)).y(t=>b(t.e)),_=line().x(t=>$(t.t)).y(t=>v(t.d)),C=line().x(t=>$(t.t)).y(t=>x(t.d)),R=select(this.renderRoot).selectAll(".main").data([{width:this.width,height:this.height,rem:this.rem}]),O=R.enter().append("svg").classed("main",!0).html(AccumulableElement.svgDefs),M=O.append("defs");M.append("marker").attr("id","measure-arrow").attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","2").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10").append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("d","M -3 -3 l 6 3 l -6 3 z"),M.append("marker").attr("id","model-sd-cap").attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","0").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10").append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("stroke-width","2").attr("d","M 0 -4 l 0 8"),M.append("marker").attr("id","data-sd-cap").attr("orient","auto-start-reverse").attr("markerUnits","userSpaceOnUse").attr("viewBox","-5 -5 10 10").attr("refX","0").attr("refY","0").attr("markerWidth","10").attr("markerHeight","10").append("path").attr("stroke","context-stroke").attr("fill","context-stroke").attr("stroke-width","2").attr("d","M 0 -3 l 0 6");const k=M.append("linearGradient").attr("id","path-animate").attr("gradientUnits","userSpaceOnUse").attr("color-interpolation","linearRGB").attr("x1","0").attr("x2","0").attr("y1",b(this.bounds.upper)).attr("y2",b(this.bounds.lower));k.append("stop").classed("stop-0",!0).attr("offset","0%"),k.append("stop").classed("stop-100",!0).attr("offset","100%");const I=O.merge(R).attr("viewBox",`0 0 ${n} ${a}`),N=I.selectAll(".plot.density").data([{outcome:"correct",data:{meanRT:this.data.correctMeanRT,sdRT:this.data.correctSDRT},model:{meanRT:this.model.correctMeanRT,sdRT:this.model.correctSDRT,dist:this.model.correctDist},densityScale:v,densityLine:_,alignDistribution:this.alignCorrectDistribution.bind(this)},{outcome:"error",data:{meanRT:this.data.errorMeanRT,sdRT:this.data.errorSDRT},model:{meanRT:this.model.errorMeanRT,sdRT:this.model.errorSDRT,dist:this.model.errorDist},densityScale:x,densityLine:C,alignDistribution:this.alignErrorDistribution.bind(this)}]),D=O.append("g").classed("plot evidence",!0),P=N.enter().append("g").attr("class",t=>`plot density ${t.outcome}`),L=O.append("g").classed("plot accuracy",!0),j=I.select(".plot.evidence").attr("transform",`translate(${o}, ${i+p+h})`),U=P.merge(N).attr("transform",t=>`translate(${o}, ${"correct"===t.outcome?i:i+p+d+2*h})`),F=I.select(".plot.accuracy").attr("transform",`translate(${o+m+f}, ${i})`);D.append("clipPath").attr("id","clip-evidence").append("rect"),j.select("clipPath rect").attr("y",b(this.bounds.upper)).attr("height",b(this.bounds.lower)-b(this.bounds.upper)+1).attr("width",m+1);const B=D.append("g").classed("underlayer",!0),H=P.append("g").classed("underlayer",!0),z=L.append("g").classed("underlayer",!0),V=j.select(".underlayer"),q=U.select(".underlayer"),K=F.select(".underlayer");D.append("g").classed("content",!0).append("g").classed("paths",!0);const W=P.append("g").classed("content",!0);L.append("g").classed("content",!0);const G=j.select(".content"),Y=U.select(".content"),X=F.select(".content");D.append("g").classed("overlayer",!0),P.append("g").classed("overlayer",!0),L.append("g").classed("overlayer",!0);const Z=j.select(".overlayer"),J=U.select(".overlayer");B.append("rect").classed("background",!0),H.append("rect").classed("background",!0),V.select(".background").transition().duration(this.drag?0:y).ease(cubicOut).attr("y",b(this.bounds.upper)).attr("height",b(this.bounds.lower)-b(this.bounds.upper)).attr("width",m),q.select(".background").transition().duration(y).ease(cubicOut).attr("height",p).attr("width",m),H.filter(t=>"error"===t.outcome).append("g").classed("axis time",!0);const Q=q.filter(t=>"error"===t.outcome).select(".axis.time").attr("transform",`translate(0, ${p+.25*this.rem})`);Q.transition().duration(y).ease(cubicOut).call(axisBottom($)).attr("font-size",null).attr("font-family",null).selectAll("line, path").attr("stroke",null);const tt=H.filter(t=>"error"===t.outcome).append("text").classed("title time",!0).attr("text-anchor","middle");tt.append("tspan").classed("name",!0).text("Time (ms)"),q.filter(t=>"error"===t.outcome).select(".title.time").transition().duration(y).ease(cubicOut).attr("transform",`translate(${m/2}, ${p+2.5*this.rem})`),B.append("g").classed("axis evidence",!0),H.append("g").attr("class",t=>`axis density ${t.outcome}`),z.append("g").classed("axis accuracy",!0);const et=V.select(".axis.evidence").attr("transform",`translate(${-.25*this.rem}, 0)`),rt=q.select(".axis.density").attr("transform",`translate(${-.25*this.rem}, 0)`),nt=K.select(".axis.accuracy").attr("transform",`translate(${g+.25*this.rem}, 0)`),at=et.transition().duration(y).ease(cubicOut).call(axisLeft(b)).attr("font-size",null).attr("font-family",null),it=rt.transition().duration(y).ease(cubicOut).each((t,e,r)=>{axisLeft(t.densityScale).ticks(2)(select(r[e]))}).attr("font-size",null).attr("font-family",null),st=nt.transition().duration(y).ease(cubicOut).call(axisRight(w)).attr("font-size",null).attr("font-family",null);at.selectAll("line, path").attr("stroke",null),it.selectAll("line, path").attr("stroke",null),st.selectAll("line, path").attr("stroke",null);const ot=B.append("text").classed("title evidence",!0).attr("text-anchor","middle"),lt=H.append("text").attr("class",t=>`title density ${t.outcome}`).attr("text-anchor","middle"),ct=z.append("text").classed("title accuracy",!0).attr("text-anchor","middle");ot.append("tspan").classed("name",!0).text("Evidence"),lt.append("tspan").classed("name",!0).text("Density"),ct.append("tspan").classed("name",!0).text("Accuracy"),V.select(".title.evidence").transition().duration(y).ease(cubicOut).attr("transform",`translate(${-2.5*this.rem}, ${d/2})rotate(-90)`),q.select(".title.density").transition().duration(y).ease(cubicOut).attr("transform",`translate(${-2.5*this.rem}, ${p/2})rotate(-90)`),K.select(".title.accuracy").transition().duration(y).ease(cubicOut).attr("transform",`translate(${g+2.25*this.rem}, ${c/2})rotate(90)`);const ut=G.select(".paths").selectAll(".path").data(this.data.trials.filter(t=>void 0!==t.path)),ht=local(),dt=ut.enter().append("g").classed("path",!0).attr("data-new-trial-ease-time",0).on("pointerenter",(t,e)=>{if(!this.drag){select(t.currentTarget).classed("highlight",!0).raise();const r=Z.append("g").classed(`rt-label ${e.outcome}`,!0),n=r.append("rect"),a=r.append("text").text(`RT = ${e.rt.toFixed()}`).attr("x",$(e.rt)).attr("y","correct"===e.outcome?b(this.bounds.upper)-.25*this.rem:b(this.bounds.lower)+.125*this.rem).node().getBBox();n.attr("x",a.x-.125*this.rem).attr("y",a.y+.125*this.rem).attr("width",a.width+.25*this.rem).attr("height",a.height-.25*this.rem),ht.set(t.currentTarget,r)}}).on("pointerout",(t,e)=>{this.drag||(select(t.currentTarget).classed("highlight",!1).lower(),t.currentTarget.parentNode.insertBefore(t.currentTarget,t.currentTarget.parentNode.children[e.index]),ht.get(t.currentTarget).remove())});dt.append("path").classed("curve",!0).attr("clip-path","url(#clip-evidence)").attr("pathLength",1).attr("stroke-dashoffset",1);const pt=dt.merge(ut).attr("class",t=>`path ${t.outcome}`);pt.select(".curve").transition().duration(this.drag?0:y).ease(cubicOut).attr("stroke",t=>this.getComputedStyleValue(`---color-${t.outcome}`)).attrTween("d",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.a?n.a:this.a,this.a),i=interpolate$1(void 0!==n.z?n.z:this.z,this.z),s=interpolate$1(void 0!==n.v?n.v:this.v,this.v),o=interpolate$1(void 0!==n.t0?n.t0:this.t0,this.t0);return e=>{n.a=a(e),n.z=i(e),n.v=s(e),n.t0=o(e);const r=this.alignPath(t.seed,n.a,n.z,n.v,n.t0);return A(r)}});const ft=pt.filter(t=>t.animate&&!this.paused);if(!ft.empty()){const t=ft.attr("data-new-trial-ease-time"),e=e=>linear().domain([0,1]).range([t,1])(e),r=e=>r=>linear().domain([e(t),1]).range([0,1])(e(r));ft.classed("animate",!0).select(".curve").attr("stroke-dasharray",1),ft.transition("new").duration(e=>Math.floor(1.5*e.rt*(1-t))).ease(e).attr("data-new-trial-ease-time",1).select(".curve").attrTween("stroke-dashoffset",(t,e,n)=>{const a=interpolate$1(n[e].getAttribute("stroke-dashoffset"),0);return t=>a(r(linear$1)(t))}).on("end",(t,e,r)=>{select(r[e].parentElement).classed("animate",!1).attr("data-new-trial-ease-time",null),t.animate=!1,this.animate=!1,this.alignState(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("accumulable-response",{detail:{outcome:t.outcome,data:this.data,model:this.model},bubbles:!0}))})}const mt=pt.filter(t=>t.animate&&this.paused);if(!mt.empty()){const t=mt.attr("data-new-trial-ease-time");mt.classed("animate",!0).select(".curve").attr("stroke-dasharray",1).attr("stroke-dashoffset",()=>interpolate$1(1,0)(linear$1(t)))}pt.filter(t=>!t.animate).attr("data-new-trial-ease-time",null),ut.exit().remove();const gt=W.append("g").attr("class",t=>`dist ${t.outcome}`);gt.append("path").classed("curve",!0),Y.select(".dist").select(".curve").transition().duration(this.drag?0:y).ease(cubicOut).attrTween("d",(t,e,r)=>{const n=r[e],a=interpolate$1(void 0!==n.a?n.a:this.a,this.a),i=interpolate$1(void 0!==n.z?n.z:this.z,this.z),s=interpolate$1(void 0!==n.v?n.v:this.v,this.v),o=interpolate$1(void 0!==n.t0?n.t0:this.t0,this.t0);return e=>{n.a=a(e),n.z=i(e),n.v=s(e),n.t0=o(e);const r=t.alignDistribution(n.a,n.z,n.v,n.t0);return t.densityLine(r)}});const yt=G.selectAll(".rt").data(this.data.trials),$t=yt.enter().append("g");$t.append("line").classed("mark",!0).attr("x1",t=>$(t.rt)).attr("x2",t=>$(t.rt)).attr("y1",t=>"correct"===t.outcome?b(1)-.125*this.rem:b(-1)+.125*this.rem).attr("y2",t=>"correct"===t.outcome?b(1)-.675*this.rem:b(-1)+.675*this.rem);const bt=$t.merge(yt).attr("class",t=>`rt ${t.outcome}`);bt.filter(t=>!t.animate).select(".mark").transition().duration(this.drag?0:y).ease(cubicOut).attr("stroke",t=>this.getComputedStyleValue(`---color-${t.outcome}`)).attr("x1",t=>$(t.rt)).attr("x2",t=>$(t.rt)).attr("y1",t=>"correct"===t.outcome?b(1)-.125*this.rem:b(-1)+.125*this.rem).attr("y2",t=>"correct"===t.outcome?b(1)-.675*this.rem:b(-1)+.675*this.rem),yt.exit().remove();const vt=X.selectAll(".accuracy.model").data([this.model.accuracy,1-this.model.accuracy]),xt=vt.enter().append("g").attr("class",(t,e)=>"accuracy model "+(0===e?"correct":"error"));xt.append("rect").classed("bar",!0).attr("x",0),xt.merge(vt).select("rect").transition().duration(this.drag?0:y).ease(cubicOut).attr("y",(t,e)=>w(0===e?0:1-t)).attr("width",g).attr("height",t=>w(t)),vt.exit().remove();const wt=X.selectAll(".accuracy.data").data(Number.isNaN(this.data.accuracy)?[]:[this.data.accuracy]),Et=wt.enter().append("g").classed("accuracy data",!0);Et.append("line").classed("mark",!0);const Tt=Et.merge(wt).attr("class",t=>"accuracy data "+(t<this.model.accuracy.correct?"correct":"error"));Tt.select(".mark").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",0+.25*this.rem).attr("x2",g-.25*this.rem).attr("y1",t=>w(t)-1).attr("y2",t=>w(t)-1),wt.exit().remove();const St=Z.selectAll(".boundary").data([{bound:"upper",value:this.bounds.upper},{bound:"lower",value:this.bounds.lower}]),At=St.enter().append("g").attr("class",(t,e)=>"boundary "+(0===e?"correct":"error"));At.append("line").classed("line",!0),At.append("line").classed("line touch",!0);const _t=At.merge(St).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?(t,e)=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let{a:r}=this;switch(t.key){case"ArrowUp":r+="upper"===e.bound?t.shiftKey?DDMMath.a.STEP:DDMMath.a.JUMP:t.shiftKey?-.01:-.1;break;case"ArrowDown":r+="upper"===e.bound?t.shiftKey?-.01:-.1:t.shiftKey?DDMMath.a.STEP:DDMMath.a.JUMP}r=r<DDMMath.a.MIN?DDMMath.a.MIN:r>DDMMath.a.MAX?DDMMath.a.MAX:r,this.a=r,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-a",{detail:{a:this.a},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?_t.call(S):_t.on(".drag",null)),_t.select(".line").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",$(this.scale.time.min)).attr("x2",$(this.scale.time.max)).attr("y1",t=>b(t.value)).attr("y2",t=>b(t.value)),_t.select(".line.touch").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",$(this.scale.time.min)).attr("x2",$(this.scale.time.max)).attr("y1",t=>b(t.value)).attr("y2",t=>b(t.value)),St.exit().remove();const Ct=Z.selectAll(".drift").data([{v:this.v,t0:this.t0,startingPoint:this.startingPoint}]),Rt=Ct.enter().append("g").classed("drift",!0);Rt.append("line").classed("line",!0),Rt.append("line").classed("line touch",!0),Rt.append("path").classed("arrow",!0),Rt.append("path").classed("arrow touch",!0);const Ot=Rt.merge(Ct).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?t=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let{v:e}=this;switch(t.key){case"ArrowUp":e+=t.shiftKey?DDMMath.v.STEP:DDMMath.v.JUMP;break;case"ArrowDown":e-=t.shiftKey?DDMMath.v.STEP:DDMMath.v.JUMP}e=e<DDMMath.v.MIN?DDMMath.v.MIN:e>DDMMath.v.MAX?DDMMath.v.MAX:e,this.v=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-v",{detail:{v:this.v},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?Ot.call(T):Ot.on(".drag",null));const Mt=(b(0)-b(1))/($(1)-$(0));Ot.transition().duration(this.drag?0:y).ease(cubicOut).attr("transform",t=>`translate(${$(t.t0)}, ${b(t.startingPoint)})\n          rotate(${-Math.atan(t.v/1e3*Mt)*(180/Math.PI)})`),Ot.select(".line").attr("x2",$(200)),Ot.select(".line.touch").attr("x2",$(200)),Ot.select(".arrow").attr("d",`\n        M ${$(200)-.5*this.rem},${.5*-this.rem}\n        l ${.5*this.rem},${.5*this.rem}\n        l ${.5*-this.rem},${.5*this.rem}\n      `),Ot.select(".arrow.touch").attr("d",`\n        M ${$(200)-.5*this.rem},${.5*-this.rem}\n        l ${.5*this.rem},${.5*this.rem}\n        l ${.5*-this.rem},${.5*this.rem}\n      `),Ct.exit().remove();const kt=Z.selectAll(".t0z").data([{t0:this.t0,startingPoint:this.startingPoint}]),It=kt.enter().append("g").classed("t0z",!0);It.append("line").classed("line",!0),It.append("line").classed("line touch",!0),It.append("circle").classed("point touch",!0);const Nt=It.merge(kt).attr("tabindex",this.interactive?0:null).classed("interactive",this.interactive).on("keydown",this.interactive?t=>{if(["ArrowUp","ArrowDown"].includes(t.key)){let{z:e}=this;switch(t.key){case"ArrowUp":e+=t.shiftKey?DDMMath.z.STEP:DDMMath.z.JUMP;break;case"ArrowDown":e-=t.shiftKey?DDMMath.z.STEP:DDMMath.z.JUMP}e=e<DDMMath.z.MIN?DDMMath.z.MIN:e>DDMMath.z.MAX?DDMMath.z.MAX:e,this.z=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-z",{detail:{z:this.z},bubbles:!0})),t.preventDefault()}if(["ArrowLeft","ArrowRight"].includes(t.key)){let e=this.t0;switch(t.key){case"ArrowRight":e+=t.shiftKey?DDMMath.t0.STEP:DDMMath.t0.JUMP;break;case"ArrowLeft":e-=t.shiftKey?DDMMath.t0.STEP:DDMMath.t0.JUMP}e=e<DDMMath.t0.MIN?DDMMath.t0.MIN:e>DDMMath.t0.MAX?DDMMath.t0.MAX:e,this.t0=e,this.alignState(),this.dispatchEvent(new CustomEvent("ddm-model-t0",{detail:{t0:this.t0},bubbles:!0})),t.preventDefault()}}:null);(this.firstUpdate||t.has("interactive"))&&(this.interactive?Nt.call(E):Nt.on(".drag",null)),Nt.select(".line").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",$(0)).attr("x2",t=>$(t.t0)).attr("y1",t=>b(t.startingPoint)).attr("y2",t=>b(t.startingPoint)),Nt.select(".line.touch").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",$(0)).attr("x2",t=>$(t.t0)).attr("y1",t=>b(t.startingPoint)).attr("y2",t=>b(t.startingPoint)),Nt.select(".point").transition().duration(this.drag?0:y).ease(cubicOut).attr("cx",t=>$(t.t0)).attr("cy",t=>b(t.startingPoint)),kt.exit().remove();const Dt=Z.selectAll(".measure.a").data(this.measures?[this.a]:[]),Pt=Dt.enter().append("g").classed("measure a",!0);Pt.append("line").classed("line",!0).attr("marker-start","url(#measure-arrow)").attr("marker-end","url(#measure-arrow)");const Lt=Pt.append("text").classed("label",!0);Lt.append("tspan").classed("a math-var",!0).text("a"),Lt.append("tspan").classed("equals",!0).text(" = "),Lt.append("tspan").classed("value",!0);const jt=Pt.merge(Dt);jt.select(".line").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",$(this.scale.time.max)-.75*this.rem).attr("y1",b(this.bounds.upper)+2).attr("x2",$(this.scale.time.max)-.75*this.rem).attr("y2",b(this.bounds.lower)-2);jt.select(".label").transition().duration(this.drag?0:y).ease(cubicOut).attr("x",$(this.scale.time.max)).attr("y",b(this.bounds.upper)-.25*this.rem).select(".value").text(format(".2f")(this.a)),Dt.exit().remove();const Ut=Z.selectAll(".measure.z").data(this.measures?[this.z]:[]),Ft=Ut.enter().append("g").classed("measure z",!0);Ft.append("line").classed("line",!0).attr("marker-start","url(#measure-arrow)").attr("marker-end","url(#measure-arrow)");const Bt=Ft.append("text").classed("label",!0);Bt.append("tspan").classed("z math-var",!0).text("z"),Bt.append("tspan").classed("equals",!0).text(" = "),Bt.append("tspan").classed("value",!0);const Ht=Ft.merge(Ut);Ht.select(".line").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",$(this.scale.time.min)+.75*this.rem).attr("y1",b(this.startingPoint)+2).attr("x2",$(this.scale.time.min)+.75*this.rem).attr("y2",b(this.bounds.lower)-2);Ht.select(".label").transition().duration(this.drag?0:y).ease(cubicOut).attr("x",$(this.scale.time.min)).attr("y",b(this.bounds.lower)+.125*this.rem).select(".value").text(format(".0%")(this.z)),Ut.exit().remove();const zt=Z.selectAll(".measure.v").data(this.measures?[this.v]:[]),Vt=zt.enter().append("g").classed("measure v",!0);Vt.append("path").classed("line",!0).attr("marker-start","url(#measure-arrow)").attr("marker-end","url(#measure-arrow)");const qt=Vt.append("text").classed("label",!0);qt.append("tspan").classed("v math-var",!0).text("v"),qt.append("tspan").classed("equals",!0).text(" = "),qt.append("tspan").classed("value",!0);const Kt=Math.atan(this.v/1e3*Mt),Wt=$(200)-$(0)+.75*this.rem,Gt=Math.cos(Kt)*Wt,Yt=Math.sin(Kt)*Wt,Xt=Vt.merge(zt);Xt.select(".line").transition().duration(this.drag?0:y).ease(cubicOut).attr("d",`\n        M ${$(this.t0+200)+.75*this.rem}, ${b(this.startingPoint)}\n        A ${$(200)-$(0)} ${$(200)-$(0)} 0 0 0 ${$(this.t0)+Gt} ${b(this.startingPoint)-Yt}\n      `);Xt.select(".label").transition().duration(this.drag?0:y).ease(cubicOut).attr("x",$(this.t0+200)+.5*this.rem).attr("y",b(this.bounds.upper)-.25*this.rem).select(".value").text(format(".2f")(this.v)),zt.exit().remove();const Zt=Z.selectAll(".measure.t0").data(this.measures?[this.t0]:[]),Jt=Zt.enter().append("g").classed("measure t0",!0);Jt.append("line").classed("line",!0).attr("marker-start","url(#measure-arrow)").attr("marker-end","url(#measure-arrow)");const Qt=Jt.append("text").classed("label",!0);Qt.append("tspan").classed("t0 math-var",!0).text("t₀"),Qt.append("tspan").classed("equals",!0).text(" = "),Qt.append("tspan").classed("value",!0);const te=Jt.merge(Zt);te.select(".line").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",$(0)+2).attr("y1",b(this.startingPoint)-.75*this.rem).attr("x2",$(this.t0)-2).attr("y2",b(this.startingPoint)-.75*this.rem);te.select(".label").transition().duration(this.drag?0:y).ease(cubicOut).attr("x",$(this.t0)+.25*this.rem).attr("y",b(this.bounds.upper)-.25*this.rem).select(".value").text(format("d")(this.t0)),Zt.exit().remove();const ee=J.selectAll(".model.mean").data(t=>this.means?[t]:[]),re=ee.enter().append("g").attr("class",t=>`model mean ${t.outcome}`);re.append("line").classed("indicator",!0);re.merge(ee).select(".indicator").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",t=>$(t.model.meanRT)).attr("x2",t=>$(t.model.meanRT)).attr("y1",t=>t.densityScale(this.scale.density.min)).attr("y2",t=>t.densityScale(this.scale.density.max)),ee.exit().remove();const ne=J.selectAll(".data.mean").data(t=>this.means&&!Number.isNaN(t.data.meanRT)?[t]:[]),ae=ne.enter().append("g").attr("class",t=>`data mean ${t.outcome}`);ae.append("line").classed("indicator",!0).attr("y1",t=>t.densityScale(0)+("correct"===t.outcome?.125:-.125)*this.rem).attr("y2",t=>t.densityScale(0)+("correct"===t.outcome?.675:-.675)*this.rem);ae.merge(ne).select(".indicator").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",t=>$(t.data.meanRT)).attr("x2",t=>$(t.data.meanRT)).attr("y1",t=>t.densityScale(0)+("correct"===t.outcome?.125:-.125)*this.rem).attr("y2",t=>t.densityScale(0)+("correct"===t.outcome?.675:-.675)*this.rem),ne.exit().select(".indicator").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",0).attr("x2",0).on("end",(t,e,r)=>{select(r[e].parentElement).remove()});const ie=J.selectAll(".model.sd").data(t=>this.sds?[t]:[]),se=ie.enter().append("g").attr("class",t=>`model sd ${t.outcome}`);se.append("line").classed("indicator",!0).attr("marker-start","url(#model-sd-cap)").attr("marker-end","url(#model-sd-cap)");se.merge(ie).select(".indicator").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",t=>$(t.model.meanRT-t.model.sdRT/2)).attr("x2",t=>$(t.model.meanRT+t.model.sdRT/2)).attr("y1",t=>t.densityScale(5)).attr("y2",t=>t.densityScale(5)),ie.exit().remove();const oe=J.selectAll(".data.sd").data(t=>!this.sds||Number.isNaN(t.data.meanRT)||Number.isNaN(t.data.sdRT)?[]:[t]),le=oe.enter().append("g").attr("class",t=>`data sd ${t.outcome}`);le.append("line").classed("indicator",!0).attr("marker-start","url(#data-sd-cap)").attr("marker-end","url(#data-sd-cap)").attr("y1",t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem).attr("y2",t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem);le.merge(oe).select(".indicator").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",t=>$(t.data.meanRT-t.data.sdRT/2)).attr("x2",t=>$(t.data.meanRT+t.data.sdRT/2)).attr("y1",t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem).attr("y2",t=>t.densityScale(0)+("correct"===t.outcome?.375:-.375)*this.rem),oe.exit().select(".indicator").transition().duration(this.drag?0:y).ease(cubicOut).attr("x1",0).attr("x2",0).on("end",(t,e,r)=>{select(r[e].parentElement).remove()}),this.firstUpdate=!1}}customElements.define("ddm-model",DDMModel);class RDK2AFCTask extends(DecidablesMixinResizeable(AccumulableElement)){static get properties(){return{coherence:{attribute:"coherence",type:Number,reflect:!0},count:{attribute:"count",type:Number,reflect:!0},probability:{attribute:"probability",type:Number,reflect:!0},duration:{attribute:"duration",type:Number,reflect:!0},wait:{attribute:"wait",type:Number,reflect:!0},iti:{attribute:"iti",type:Number,reflect:!0},trials:{attribute:"trials",type:Number,reflect:!0},running:{attribute:"running",type:Boolean,reflect:!0},lifetime:{attribute:!1,type:Number,reflect:!1},speed:{attribute:!1,type:Number,reflect:!1}}}constructor(){super(),this.coherence=.5,this.count=100,this.probability=.5,this.duration=2e3,this.wait=2e3,this.iti=2e3,this.trials=5,this.running=!1,this.lifetime=400,this.speed=50,this.firstUpdate=!0,this.COHERENT=0,this.RANDOM=1,this.dots=[[],[]],this.trial=0,this.states=["resetted","iti","stimulus","wait","ended"],this.state="resetted",this.baseTime=0,this.pauseTime=0,this.startTime=0,this.lastTime=0,this.LEFT=180,this.RIGHT=0,this.currentDirection=void 0,this.signals=["left","right"],this.signal=void 0,this.runner=void 0,this.xScale=void 0,this.yScale=void 0}static get styles(){return[super.styles,i$3`
        :host {
          display: inline-block;
